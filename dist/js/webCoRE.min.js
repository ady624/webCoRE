...
(function(a){angular.module("ui.bootstrap.contextMenu",[]).service("CustomService",function(){return{initialize:function(b){console.log("got here",b)}}}).directive("contextMenu",["$parse","$q","CustomService","$sce",function(g,i,c,n){var l=[];var d="New Item";var m=function(o){while(l.length&&(!o||l.length>o)){l.pop().remove()}};var h=function(v,x,u,o,q,s,w,r){var p=r("<a>");p.css("padding-right","8px");p.attr({tabindex:"-1",href:"#"});if(typeof x[0]==="string"){u=x[0]}else{if(typeof x[0]==="function"){u=x[0].call(v,v,o,q)}else{if(typeof x.text!=="undefined"){u=x.text}}}var t=i.when(u);s.push(t);t.then(function(y){if(w){p.css("cursor","default");p.append(r('<strong style="font-family:monospace;font-weight:bold;float:right;">&gt;</strong>'))}p.append(y)});return p};var e=function(y,p,q,A,s,v,t,u,r,o){var z=angular.isArray(A[1])||(A[1]&&angular.isFunction(A[1].then))?A[1]:angular.isArray(A[2])||(A[2]&&angular.isFunction(A[2].then))?A[2]:angular.isArray(A[3])||(A[3]&&angular.isFunction(A[3].then))?A[3]:null;var x=d;if(typeof A[0]==="function"||typeof A[0]==="string"||typeof A.text!=="undefined"){x=h(y,A,x,p,q,t,z,r)}else{if(typeof A.html==="function"){x=A.html(y)}else{if(typeof A.html!=="undefined"){x=A.html}}}v.append(x);var w=function(){if(typeof A.enabled!=="undefined"){return A.enabled.call(y,y,p,q,x)}else{if(typeof A[2]==="function"){return A[2].call(y,y,p,q,x)}else{return true}}};b(y,w(),A,s,v,z,q,x,p,r,o)};var k=function(p,r,q,o){i.all(o).then(function(){var s=q.pageY;var u=angular.element(p[0]).prop("offsetHeight");var x=window.scrollY+q.view.innerHeight;if(s>u&&x-s<u+20){s=q.pageY-u;if(r&&r>0){s+=q.event.currentTarget.offsetHeight}}else{if(x<=u){angular.element(p[0]).css({height:x-5,"overflow-y":"scroll"});s=0}else{if(x-s<u){var z=5;if(s<z){z=s}s=x-u-z}}}var t=q.pageX;var y=angular.element(p[0]).prop("offsetWidth");var v=q.view.innerWidth;var w=5;if(t>y&&v-t-w<y){t=v-y-w}else{if(v-t<y){var A=5;if(t<A+w){A=t+w}t=v-y-A-w}}p.css({display:"block",position:"absolute",left:t+"px",top:s+"px"})})};var b=function(x,u,z,t,v,y,r,w,p,s,o){if(u){var q=function(A){m(o+1);var B={pageX:p.pageX+t[0].offsetWidth-1,pageY:t[0].offsetTop+v[0].offsetTop-3,view:p.view||window,event:A};i.when(y).then(function(C){j(x,B,C,r,o+1)})};v.on("click",function(A){if(A.which==1){A.preventDefault();x.$apply(function(){if(y){q(A)}else{s(p.currentTarget).removeClass("context");m();if(angular.isFunction(z[1])){z[1].call(x,x,p,r,w,v)}else{z.click.call(x,x,p,r,w,v)}}})}});v.on("mouseover",function(A){x.$apply(function(){if(y){q(A)}else{m(o+1)}})})}else{v.on("click",function(A){A.preventDefault()});v.addClass("disabled")}};var j=function(y,p,z,r,o,x){if(!o){o=0}a(p.currentTarget).addClass("context");var t=a("<ul>");t.addClass("dropdown-menu");t.attr({role:"menu"});t.css({display:"block",position:"absolute",left:p.pageX+"px",top:p.pageY+"px","z-index":10000});var u=[];angular.forEach(z,function(A){var B=a("<li>");if(A===null){B.addClass("divider")}else{if(typeof A[0]==="object"){c.initialize(B,A)}else{e(y,p,r,A,t,B,u,i,a,o)}}t.append(B)});var w=Math.max(document.body.scrollHeight,document.documentElement.scrollHeight,document.body.offsetHeight,document.documentElement.offsetHeight,document.body.clientHeight,document.documentElement.clientHeight);a(document).find("body").append(t);k(t,o,p,u);function v(A){q(A)}function s(C){var B=a(C.target);var A=true;while(B.length){if(B.hasClass("dropdown-menu")){A=false;break}else{B=B.parent()}}if(A){q(C)}}function q(A){a(document.body).off("mousedown",s);a(document).off("scroll",v);a(p.originalTarget).removeClass("context");m()}if(o===0){a(document.body).on("mousedown",s);a(document).on("scroll",v)}y.$on("$destroy",function(){m()});l.push(t)};function f(){return"ontouchstart" in window||navigator.maxTouchPoints}return function(o,r,q){var p="contextmenu";if(q.contextMenuOn&&typeof(q.contextMenuOn)==="string"){p=q.contextMenuOn}r.on(p,function(s){if(!q.allowEventPropagation){s.stopPropagation();s.preventDefault()}if(f()&&r.attr("draggable")==="true"){return false}o.$apply(function(){var u=o.$eval(q.contextMenu);var v=q.contextMenuClass;var t=o.$eval(q.model);if(u instanceof Array){if(u.length===0){return}j(o,s,u,t,undefined,v)}else{throw'"'+q.contextMenu+'" not an array'}})})}}])})(window.angular.element);var app=angular.module("CoRE",["ng","ngRoute","ngSanitize","ngResource","ngDialog","ngAnimate","angular-svg-round-progressbar","angular-bootstrap-select","swipe","dndLists","ui.toggle","chart.js","smartArea","ui.bootstrap.contextMenu"]);var cdn="";var theme="";app.directive("head",["$rootScope","$compile",function(a,b){return{restrict:"E",link:function(d,e){var c='<link rel="stylesheet" ng-repeat="(routeCtrl, cssUrl) in routeStyles" ng-href="{{cssUrl}}" />';e.append(b(c)(d));d.routeStyles={};a.$on("$routeChangeStart",function(h,f,g){if(g&&g.$$route&&g.$$route.css){if(!angular.isArray(g.$$route.css)){g.$$route.css=[g.$$route.css]}angular.forEach(g.$$route.css,function(j){delete d.routeStyles[j]})}if(f&&f.$$route&&f.$$route.css){if(!angular.isArray(f.$$route.css)){f.$$route.css=[f.$$route.css]}angular.forEach(f.$$route.css,function(j){d.routeStyles[j]=j})}})}}}]);app.directive("ngWheel",["$parse",function(a){return function(e,c,b){var d=a(b.ngWheel);c.bind("wheel",function(f){e.$apply(function(){d(e,{$event:f})})})}}]);app.directive("textcomplete",["Textcomplete",function(a){return{restrict:"EA",scope:{members:"=",message:"=",callback:"&"},template:'<textarea ng-model="message" type="text"></textarea>',link:function(e,f,d){var b=e.members;var c=f.find("textarea");var g=new a(c,[{match:/(\b)(\w{2,})$/,search:function(h,j){j($.map(b,function(k){return k.toLowerCase().indexOf(h.toLowerCase())===0?k:null}))},index:2,replace:function(h){return"$1"+h+" "}}]);if(e.callback){e.$watch("message",function(j,h){e.callback()})}$(g).on({"textComplete:select":function(j,h){e.$apply(function(){e.message=h})},"textComplete:show":function(h){$(this).data("autocompleting",true)},"textComplete:hide":function(h){$(this).data("autocompleting",false)}})}}}]);app.directive("masonry",["$parse",function(a){return{restrict:"AC",link:function(f,g,d){f.items=[];var b=g[0];var c=angular.extend({itemSelector:"tile"},JSON.parse(d.masonry));var e=f.masonry=new Masonry(b,c);var h=0;f.update=function(){if(h){window.clearTimeout(h)}h=window.setTimeout(function(){h=0;e.reloadItems();e.layout();g.children(c.itemSelector).css("visibility","visible")},120)};f.update()}}}]).directive("masonryTile",function(){return{restrict:"AC",link:function(a,c){c.css("visibility","hidden");var b=c.parent("*[masonry]:first").scope(),d=b.update;imagesLoaded(c.get(0),d);c.ready(d)}}});app.directive("tileHeight",function(){var a={restrict:"A",link:function(f,g,b,c,d){var e=1;if(b.tileHeight){e=b.tileHeight}var h=function(){var j=g[0].parentElement.offsetWidth/Math.round(g[0].parentElement.offsetWidth/g[0].offsetWidth)*e;g.outerHeight(j)};f.$watch(b.tileHeight,function(j){e=1*j;h()});$(window).resize(h);h();f.$on("$destroy",function(){$(window).unbind("resize",h)})}};return a});app.directive("help",function(a){return function(e,c,b){var f=b.help?b.help:c.text();var d=angular.element("<wiki ng-click=\"wiki('"+f+'\')" class="fa fa-info-circle"></wiki>');c.append(a(d)(e))}});app.filter("orderObjectBy",function(){return function(a,d,c){var b=[];angular.forEach(a,function(f,e){b.push(Object.assign({id:e},f))});b.sort(function(f,e){return(f[d]>e[d]?1:-1)});if(c){b.reverse()}return b}});var config=app.config(["$routeProvider","$locationProvider","$sceDelegateProvider","$rootScopeProvider",function(b,a,e,d){d.digestTtl(10000);var c=".module.css";e.resourceUrlWhitelist(["self",cdn+"**"]);b.when("/",{templateUrl:cdn+theme+"html/modules/dashboard.module.html",controller:"dashboard",css:cdn+theme+"css/modules/dashboard"+c}).when("/register",{templateUrl:cdn+theme+"html/modules/register.module.html",controller:"register",css:cdn+theme+"css/modules/register"+c}).when("/init/:init",{redirectTo:function(f){app.initialInstanceUri=atou(f.init);return"/"}}).when("/piston/:pistonId",{templateUrl:cdn+theme+"html/modules/piston.module.html",controller:"piston",css:cdn+theme+"css/modules/piston"+c,reloadOnSearch:false}).when("/init/:instId1/:instId2",{redirectTo:function(f){app.initialInstanceUri=f.instId1+f.instId2;return"/"}}).otherwise({redirectTo:"/"});a.html5Mode(true)}]);config.factory("dataService",["$http","$location","$rootScope","$window","$q",function(B,h,j,n,w){var t={};var m="";var b=null;var A={};var y=null;var d={};var f={};var g="N7zqL6a8Texs4wY5y&y2YPLzus+_dZ%s";var q=g;var v=null;var k=function(C){return JSON.parse(C)};var u=function(C,E,D){return Array(E-String(C).length+1).join(D||"0")+C};var l=function(C){return u(C.getFullYear(),4)+"-"+u(1+C.getMonth(),2)+"-"+u(C.getDate(),2)+" "+u(C.getHours(),2)+":"+u(C.getMinutes(),2)+":"+u(C.getSeconds(),2)};var p=function(C){return JSON.stringify(C)};var o=function(E,C){try{return utoa(n.sjcl.encrypt(C?C:q,angular.toJson(E),{ks:256}))}catch(D){return null}};var z=function(D,C){try{return angular.fromJson(n.sjcl.decrypt(C?C:q,atou(D)))}catch(E){return null}};var s=function(C,E,D){n.localStorage.setItem("core."+C,o(E,D))};var c=function(C,D){return z(n.localStorage.getItem("core."+C),D)};var e=function(C){b=C;A[b.id]=b;s("locations",A)};var a=function(D){y=D;var C=f[y.id];if(!C){C={}}C.token=y.token?y.token:C.token;C.uri=y.uri?y.uri.replace(":443",""):C.uri;f[y.id]=C;delete (y.token);delete (y.uri);y.devices=y.devices?y.devices:(d[y.id]&&d[y.id].devices?d[y.id].devices:[]);y.virtualDevices=y.virtualDevices||{};d[y.id]=y;s("instances",d);s("store",f);s("instance",y.id,g);if((y.coreVersion)&&(version()!=y.coreVersion)){if(version()>y.coreVersion){r("A newer SmartApp version ("+version()+") is available, please update and publish both the parent and the child SmartApp in the SmartThings IDE.")}else{r("A newer UI version ("+y.coreVersion+") is available, please hard reload this web page to get the newest version.")}}};var r=function(C){if(v){v(C)}};t.setStatusCallback=function(C){v=C};t.saveToStore=function(C,D){return s(C,D)};t.loadFromStore=function(C){return c(C)};t.deleteInstance=function(C){if(C){if(C==y){y=null;s("instance",null,g)}delete (f[C.id]);delete (d[C.id]);s("instances",d);s("store",f)}};t.listLocations=function(){var C=[];for(lid in A){C.push(JSON.parse(JSON.stringify(A[lid])))}return C};t.getLocation=function(C){if(C){for(lid in A){if(lid==C){return JSON.parse(JSON.stringify(A[lid]))}}}else{return JSON.parse(JSON.stringify(b))}return null};t.listInstances=function(D){var C=[];for(iid in d){if(!D||(d[iid].locationId==D)){C.push(JSON.parse(JSON.stringify(d[iid])))}}return C};t.getInstanceCount=function(D){var C=0;for(iid in d){if(!D||(d[iid].locationId==D)){C++}}return C};t.getInstance=function(C){if(C){for(iid in d){if(iid==C){return JSON.parse(JSON.stringify(d[iid]))}}}else{try{return JSON.parse(JSON.stringify(y?y:(d?d[c("instance")]:null)))}catch(D){}}return null};t.getPistonInstance=function(C){for(iid in d){for(i in d[iid].pistons){if(d[iid].pistons[i].id==C){return JSON.parse(JSON.stringify(d[iid]))}}}return null};t.loadInstance=function(H,F,E,J,D){var C=H?f[H.id]:null;var G=!H||!(H.devices instanceof Object)||!(Object.keys(H.devices).length)?0:(H.deviceVersion?H.deviceVersion:0);if(!C){if((app.initialInstanceUri&&app.initialInstanceUri.length)||(F&&F.length)){F=app.initialInstanceUri?app.initialInstanceUri:F;if(F&&!(F instanceof Object)&&(F.length>=69)){F=F.substr(0,8)=="https://"?F:"https://"+F.substr(0,F.length-64)+".api.smartthings.com/api/token/"+F.substr(-64,8)+"-"+F.substr(-56,4)+"-"+F.substr(-52,4)+"-"+F.substr(-48,4)+"-"+F.substr(-44,12)+"/smartapps/installations/"+F.substr(-32,8)+"-"+F.substr(-24,4)+"-"+F.substr(-20,4)+"-"+F.substr(-16,4)+"-"+F.substr(-12)+"/"}C={uri:F};for(id in f){if(f[id].uri==F){C=f[id];if(d&&d[id]&&d[id].devices instanceof Object&&Object.keys(d[id].devices).length&&d[id].deviceVersion){G=d[id].deviceVersion}break}}}}delete (app.initialInstanceUri);if(!C){var I=c("instance");if(I){C=f[I];if(d&&d[I]&&d[I].devices instanceof Object&&Object.keys(d[I].devices).length&&d[I].deviceVersion){G=d[I].deviceVersion}}}if(!C){h.path("/register")}else{var D=document.getElementById("error");if(D){D.parentNode.removeChild(D)}}return B.jsonp((C?C.uri:"about:blank/")+"intf/dashboard/load?token="+(C&&C.token?C.token:"")+(E?"&pin="+E:"")+"&dev="+G,{jsonpCallbackParam:"callback"}).then(function(K){var L=K.data;if(L.now){adjustTimeOffset(L.now)}if(L.error&&C){L.uri=C.uri}if(L.location){e(L.location)}if(L.instance){a(L.instance)}return L;if(J){J(L)}},function(K){if(D){D(K)}})};t.tap=function(C){return B({method:"GET",url:"tap/"+C})};t.getApiUri=function(){var C=t.getInstance();si=f?f[C.id]:null;return si?si.uri:null};t.getPiston=function(F){var E=t.getPistonInstance(F);if(!E){E=t.getInstance()}si=f?f[E.id]:null;var D=!E||!(E.devices instanceof Object)||!(Object.keys(E.devices).length)?0:(E.deviceVersion?E.deviceVersion:0);var C=c("db.version",g);r("Loading piston...");return B.jsonp((si?si.uri:"about:blank/")+"intf/dashboard/piston/get?id="+F+"&db="+C+"&token="+(si&&si.token?si.token:"")+"&dev="+D,{jsonpCallbackParam:"callback"}).then(function(G){data=G.data;if(data.now){adjustTimeOffset(data.now)}if(data.dbVersion){s("db.version",data.dbVersion,g);s("db",data.db);r("Database updated to version "+data.dbVersion)}else{data.db=c("db");r()}if(data.location){e(data.location)}if(data.instance){a(data.instance)}return data})};t.getActivity=function(E,C){var D=t.getPistonInstance(E);if(!D){D=t.getInstance()}si=f?f[D.id]:null;return B.jsonp((si?si.uri:"about:blank/")+"intf/dashboard/piston/activity?id="+E+"&log="+(C?C:0)+"&token="+(si&&si.token?si.token:""),{jsonpCallbackParam:"callback"}).then(function(F){return F.data})};t.generateBackupBin=function(D,E){var C=t.getInstance();return B({method:"POST",url:"https://api.myjson.com/bins",data:D?(E?{d:o(D,g)}:{e:o(D,g+C.account.id)}):{},transformResponse:function(F){try{F=JSON.parse(F);if(F&&F.uri){F=F.uri.split("/");if(F&&F.length){return F[F.length-1]}}}catch(G){}return null}})};t.saveToBin=function(E,D){r("Saving piston to backup bin...");var C=t.getInstance();if(C&&C.account&&C.account.id){D={e:o(D,g+C.account.id)}}else{D={};E=null}return B({method:"PUT",url:"https://api.myjson.com/bins/"+E,data:D,transformResponse:function(F){r("Backup bin updated");return true}})};t.loadFromBin=function(D){r("Loading piston from backup bin...");var C=t.getInstance();if(!(C&&C.account&&C.account.id)){D=null}return B({method:"GET",url:"https://api.myjson.com/bins/"+D,transformResponse:function(E){if(D){try{E=JSON.parse(E);if(E&&E.e){return z(E.e,g+C.account.id)}if(E&&E.d){return z(E.d,g)}r()}catch(F){r("Sorry, an error occurred while importing the backup bin")}}return null}})};t.generateNewPistonName=function(){var C=t.getInstance();si=f?f[C.id]:null;return B.jsonp((si?si.uri:"about:blank/")+"intf/dashboard/piston/new?token="+(si&&si.token?si.token:""),{jsonpCallbackParam:"callback"}).then(function(D){return D.data})};t.createPiston=function(C,D,F){var E=t.getInstance();si=f?f[E.id]:null;return B.jsonp((si?si.uri:"about:blank/")+"intf/dashboard/piston/create?author="+encodeURIComponent(D)+"&name="+encodeURIComponent(C)+"&bin="+encodeURIComponent(F?F:"")+"&token="+(si&&si.token?si.token:""),{jsonpCallbackParam:"callback"}).then(function(G){return G.data})};var x=function(D,F,C,E){if(C<F.length){r("Saving piston chunk "+(C+1).toString()+" of "+F.length.toString()+"...");return B.jsonp((D?D.uri:"about:blank/")+"intf/dashboard/piston/set.chunk?chunk="+C.toString()+"&data="+encodeURIComponent(F[C])+"&token="+(D&&D.token?D.token:""),{jsonpCallbackParam:"callback"}).then(function(G){return x(D,F,C+1,E)})}else{r("Finishing up...");return B.jsonp((D?D.uri:"about:blank/")+"intf/dashboard/piston/set.end?bin="+encodeURIComponent(E)+"&token="+(D&&D.token?D.token:""),{jsonpCallbackParam:"callback"}).then(function(G){r();return G})}};t.setPiston=function(F,H){var E=t.getPistonInstance(F.id);if(!E){E=t.getInstance()}si=f?f[E.id]:null;var D=utoa(angular.toJson(F));var C=3076;if(F&&H){t.saveToBin(H,F)}if(D.length>C){var G=[].concat.apply([],D.split("").map(function(I,J){return J%C?[]:D.slice(J,J+C)},D));r("Preparing to save chunked piston...");return B.jsonp((si?si.uri:"about:blank/")+"intf/dashboard/piston/set.start?id="+F.id+"&chunks="+G.length.toString()+"&token="+(si&&si.token?si.token:""),{jsonpCallbackParam:"callback"}).then(function(I){if(I&&(I.status==200)&&I.data&&(I.data.status=="ST_READY")){return x(si,G,0,H)}})}else{r("Saving piston...");return B.jsonp((si?si.uri:"about:blank/")+"intf/dashboard/piston/set?id="+F.id+"&data="+D+"&bin="+encodeURIComponent(H)+"&token="+(si&&si.token?si.token:""),{jsonpCallbackParam:"callback"}).then(function(I){r();return I})}};t.pausePiston=function(C){var D=t.getPistonInstance(C);if(!D){D=t.getInstance()}si=f?f[D.id]:null;r("Pausing piston...");return B.jsonp((si?si.uri:"about:blank/")+"intf/dashboard/piston/pause?id="+C+"&token="+(si&&si.token?si.token:""),{jsonpCallbackParam:"callback"}).then(function(E){r();return E.data})};t.resumePiston=function(C){var D=t.getPistonInstance(C);if(!D){D=t.getInstance()}si=f?f[D.id]:null;r("Resuming piston...");return B.jsonp((si?si.uri:"about:blank/")+"intf/dashboard/piston/resume?id="+C+"&token="+(si&&si.token?si.token:""),{jsonpCallbackParam:"callback"}).then(function(E){r();return E.data})};t.deletePiston=function(C){var D=t.getPistonInstance(C);if(!D){D=t.getInstance()}si=f?f[D.id]:null;return B.jsonp((si?si.uri:"about:blank/")+"intf/dashboard/piston/delete?id="+C+"&token="+(si&&si.token?si.token:""),{jsonpCallbackParam:"callback"}).then(function(E){return E.data})};t.setVariable=function(C,F){var E=t.getInstance();si=f?f[E.id]:null;var D=F?utoa(angular.toJson(F)):"";return B.jsonp((si?si.uri:"about:blank/")+"intf/dashboard/variable/set?name="+C+"&value="+D+"&token="+(si&&si.token?si.token:""),{jsonpCallbackParam:"callback"}).then(function(G){return G.data})};t.evaluateExpression=function(D,G,C){var F=t.getPistonInstance(D);if(!F){F=t.getInstance()}si=f?f[F.id]:null;var E=utoa(angular.toJson(G));return B.jsonp((si?si.uri:"about:blank/")+"intf/dashboard/piston/evaluate?id="+D+"&expression="+E+"&dataType="+(C?encodeURIComponent(C):"")+"&token="+(si&&si.token?si.token:""),{jsonpCallbackParam:"callback"}).then(function(H){return H.data})};t.registerDashboard=function(C){return B.post("https://api.webcore.co/dashboard/register/"+C).then(function(D){return D.data})};t.registerHandler=function(){navigator.registerProtocolHandler("web+core","https://"+window.location.hostname+"/handler/%s","webCoRE")};t.determineDeviceType=function(C){if(C&&C.cn){if(C.cn.indexOf("Water Sensor")>=0){return"waterSensor"}if(C.cn.indexOf("Contact Sensor")>=0){return"contactSensor"}if(C.cn.indexOf("Thermostat")>=0){return"thermostat"}if(C.cn.indexOf("Garage Door Control")>=0){return"garageDoor"}if(C.cn.indexOf("Music Player")>=0){return"musicPlayer"}if(C.cn.indexOf("Door Control")>=0){return"door"}if(C.cn.indexOf("Presence Sensor")>=0){return"presenceSensor"}if(C.cn.indexOf("Motion Sensor")>=0){return"motionSensor"}if(C.cn.indexOf("Color Control")>=0){return"rgbBulb"}if(C.cn.indexOf("Color Temperature")>=0){return"whiteBulb"}if(C.cn.indexOf("Switch Level")>=0){return"dimmer"}if(C.cn.indexOf("Switch")>=0){return"switch"}if(C.cn.indexOf("Lock")>=0){return"lock"}if((C.cn.indexOf("Button")>=0)&&(C.cn.indexOf("Button")>=0)){return"keypad"}if(C.cn.indexOf("Button")>=0){return"button"}if(C.cn.indexOf("Temperature Measurement")>0){return"temperatureSensor"}}return"unknownDevice"};f=c("store");if(!f){f={}}A=c("locations");if(!A){A={}}d=c("instances");if(!d){d={}}window.ds=t;return t}]);app.run(["$rootScope","$window","$location",function(a,c,d){a.getTime=function(e){if(e){return e.format("h:mmtt")}};a.hasLocalStorage=false;try{c.localStorage.setItem("__initialization__test__",true);a.hasLocalStorage=true;c.localStorage.removeItem("__initialization__test__")}catch(b){console.log("ERROR: "+b)}a.$on("$viewContentLoaded",function(e){var f=d.path();if(f.startsWith("/init/")){f="/init"}if(f.startsWith("/piston/")){f="/piston"}c.ga("send","pageview",{page:f})});a.bytesToSize=function(e){var g=["bytes","kB","MB","GB","TB"];if(e==0){return"0 Byte"}var f=parseInt(Math.floor(Math.log(e)/Math.log(1024)));return(e/Math.pow(1024,f)).toFixed(f==0?0:2)+" "+g[f]}}]);Date.prototype.format=function(x,a){var r=["\x00","January","February","March","April","May","June","July","August","September","October","November","December"];var c=["\x01","Jan.","Feb.","Mar.","Apr.","May","June","July","Aug.","Sept.","Oct.","Nov.","Dec."];var b=["\x02","Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"];var g=["\x03","Sun","Mon","Tue","Wed","Thu","Fri","Sat"];function o(f,d){var h=f+"";d=d||2;while(h.length<d){h="0"+h}return h}var l=a?this.getUTCFullYear():this.getFullYear();x=x.replace(/(^|[^\\])yyyy+/g,"$1"+l);x=x.replace(/(^|[^\\])yy/g,"$1"+l.toString().substr(2,2));x=x.replace(/(^|[^\\])y/g,"$1"+l);var j=(a?this.getUTCMonth():this.getMonth())+1;x=x.replace(/(^|[^\\])MMMM+/g,"$1"+r[0]);x=x.replace(/(^|[^\\])MMM/g,"$1"+c[0]);x=x.replace(/(^|[^\\])MM/g,"$1"+o(j));x=x.replace(/(^|[^\\])M/g,"$1"+j);var B=a?this.getUTCDate():this.getDate();x=x.replace(/(^|[^\\])dddd+/g,"$1"+b[0]);x=x.replace(/(^|[^\\])ddd/g,"$1"+g[0]);x=x.replace(/(^|[^\\])dd/g,"$1"+o(B));x=x.replace(/(^|[^\\])d/g,"$1"+B);var n=a?this.getUTCHours():this.getHours();x=x.replace(/(^|[^\\])HH+/g,"$1"+o(n));x=x.replace(/(^|[^\\])H/g,"$1"+n);var z=n>12?n-12:n==0?12:n;x=x.replace(/(^|[^\\])hh+/g,"$1"+o(z));x=x.replace(/(^|[^\\])h/g,"$1"+z);var u=a?this.getUTCMinutes():this.getMinutes();x=x.replace(/(^|[^\\])mm+/g,"$1"+o(u));x=x.replace(/(^|[^\\])m/g,"$1"+u);var q=a?this.getUTCSeconds():this.getSeconds();x=x.replace(/(^|[^\\])ss+/g,"$1"+o(q));x=x.replace(/(^|[^\\])s/g,"$1"+q);var A=a?this.getUTCMilliseconds():this.getMilliseconds();x=x.replace(/(^|[^\\])fff+/g,"$1"+o(A,3));A=Math.round(A/10);x=x.replace(/(^|[^\\])ff/g,"$1"+o(A));A=Math.round(A/10);x=x.replace(/(^|[^\\])f/g,"$1"+A);var e=n<12?"AM":"PM";x=x.replace(/(^|[^\\])TT+/g,"$1"+e);x=x.replace(/(^|[^\\])T/g,"$1"+e.charAt(0));var p=e.toLowerCase();x=x.replace(/(^|[^\\])tt+/g,"$1"+p);x=x.replace(/(^|[^\\])t/g,"$1"+p.charAt(0));var C=-this.getTimezoneOffset();var k=a||!C?"Z":C>0?"+":"-";if(!a){C=Math.abs(C);var D=Math.floor(C/60);var v=C%60;k+=o(D)+":"+o(v)}x=x.replace(/(^|[^\\])K/g,"$1"+k);var w=(a?this.getUTCDay():this.getDay())+1;x=x.replace(new RegExp(b[0],"g"),b[w]);x=x.replace(new RegExp(g[0],"g"),g[w]);x=x.replace(new RegExp(r[0],"g"),r[j]);x=x.replace(new RegExp(c[0],"g"),c[j]);x=x.replace(/\\(.)/g,"$1");return x};function formatTime(c){try{var a=(new Date(c)).getTime()+(window.timeOffset?window.timeOffset:0);var f=new Date(a);return f.format("h:mm TT")}catch(b){}}function currentTime(){return(new Date()).getTime()+(window.timeOffset?window.timeOffset:0)}function utcToString(a){return(new Date(a)).toLocaleString()}function utcToTimeString(a){return(new Date(a)).toLocaleTimeString()}function utcToDateString(a){return(new Date(a)).toLocaleDateString()}function timeSince(e){if(!e){return"never"}switch(typeof e){case"number":break;case"string":e=+new Date(e);break;case"object":if(e.constructor===Date){e=e.getTime()}break;default:e=+new Date()}var d=[[60,"seconds",1],[120,"1 minute ago","1 minute from now"],[3600,"minutes",60],[7200,"1 hour ago","1 hour from now"],[86400,"hours",3600],[172800,"yesterday","tomorrow"],[604800,"days",86400],[1209600,"last week","next week"],[2419200,"weeks",604800],[4838400,"last month","next month"],[29030400,"months",2419200],[58060800,"last year","next year"],[2903040000,"years",29030400],[5806080000,"last century","next century"],[58060800000,"centuries",2903040000]];var g=(+new Date()+(window.timeOffset?window.timeOffset:0)-e)/1000,b="ago",f=1;if(g==0){return"Just now"}if(g<0){g=Math.abs(g);b="from now";f=2}var a=0,c;while(c=d[a++]){if(g<c[0]){if(typeof c[2]=="string"){return c[f]}else{return Math.floor(g/c[2])+" "+c[1]+" "+b}}}return e}function timeCounter(g){g+=window.timeOffset?window.timeOffset:0;var f=Math.ceil((0+g-(new Date().getTime()))/1000);var e=false;if(f<=0){if(f>-20){return"pending"}e=true;f=-f}var b="";if(f>86400){b=Math.floor(f/86400).toString()+"d ";f=f%86400}var d=Math.floor(f/3600);var a=Math.floor((f-d*3600)/60);var c=f%60;b+=(d>0?(d<10?"0":"")+d.toString()+":":"")+(a<10?"0":"")+a.toString()+":"+(c<10?"0":"")+c.toString();return b}function timeLeft(c,a){if(!c){return 0}c+=window.timeOffset?window.timeOffset:0;var b=Math.round((c-(new Date().getTime()))/1000);switch(a){case"h":return Math.floor(b/3600);break;case"m":return b>=3600?60:Math.floor(b/60);break;case"s":return b>=60?60:Math.floor(b%60);break}return b}function adjustTimeOffset(a){var b=a-(new Date()).getTime();if(isNaN(window.timeOffset)||(Math.abs(b)<Math.abs(window.timeOffset))){window.timeOffset=b}}Object.defineProperty(Array.prototype,"unique",{enumerable:false,value:function(){if(!this){return[]}var d={},c=[];for(var e=0,b=this.length;e<b;++e){if(d.hasOwnProperty(this[e])){continue}c.push(this[e]);d[this[e]]=1}return c}});function mobileCheck(){var a=false;(function(b){if(/(android|bb\d+|meego).+mobile|avantgo|bada\/|blackberry|blazer|compal|elaine|fennec|hiptop|iemobile|ip(hone|od)|iris|kindle|lge |maemo|midp|mmp|mobile.+firefox|netfront|opera m(ob|in)i|palm( os)?|phone|p(ixi|re)\/|plucker|pocket|psp|series(4|6)0|symbian|treo|up\.(browser|link)|vodafone|wap|windows ce|xda|xiino/i.test(b)||/1207|6310|6590|3gso|4thp|50[1-6]i|770s|802s|a wa|abac|ac(er|oo|s\-)|ai(ko|rn)|al(av|ca|co)|amoi|an(ex|ny|yw)|aptu|ar(ch|go)|as(te|us)|attw|au(di|\-m|r |s )|avan|be(ck|ll|nq)|bi(lb|rd)|bl(ac|az)|br(e|v)w|bumb|bw\-(n|u)|c55\/|capi|ccwa|cdm\-|cell|chtm|cldc|cmd\-|co(mp|nd)|craw|da(it|ll|ng)|dbte|dc\-s|devi|dica|dmob|do(c|p)o|ds(12|\-d)|el(49|ai)|em(l2|ul)|er(ic|k0)|esl8|ez([4-7]0|os|wa|ze)|fetc|fly(\-|_)|g1 u|g560|gene|gf\-5|g\-mo|go(\.w|od)|gr(ad|un)|haie|hcit|hd\-(m|p|t)|hei\-|hi(pt|ta)|hp( i|ip)|hs\-c|ht(c(\-| |_|a|g|p|s|t)|tp)|hu(aw|tc)|i\-(20|go|ma)|i230|iac( |\-|\/)|ibro|idea|ig01|ikom|im1k|inno|ipaq|iris|ja(t|v)a|jbro|jemu|jigs|kddi|keji|kgt( |\/)|klon|kpt |kwc\-|kyo(c|k)|le(no|xi)|lg( g|\/(k|l|u)|50|54|\-[a-w])|libw|lynx|m1\-w|m3ga|m50\/|ma(te|ui|xo)|mc(01|21|ca)|m\-cr|me(rc|ri)|mi(o8|oa|ts)|mmef|mo(01|02|bi|de|do|t(\-| |o|v)|zz)|mt(50|p1|v )|mwbp|mywa|n10[0-2]|n20[2-3]|n30(0|2)|n50(0|2|5)|n7(0(0|1)|10)|ne((c|m)\-|on|tf|wf|wg|wt)|nok(6|i)|nzph|o2im|op(ti|wv)|oran|owg1|p800|pan(a|d|t)|pdxg|pg(13|\-([1-8]|c))|phil|pire|pl(ay|uc)|pn\-2|po(ck|rt|se)|prox|psio|pt\-g|qa\-a|qc(07|12|21|32|60|\-[2-7]|i\-)|qtek|r380|r600|raks|rim9|ro(ve|zo)|s55\/|sa(ge|ma|mm|ms|ny|va)|sc(01|h\-|oo|p\-)|sdk\/|se(c(\-|0|1)|47|mc|nd|ri)|sgh\-|shar|sie(\-|m)|sk\-0|sl(45|id)|sm(al|ar|b3|it|t5)|so(ft|ny)|sp(01|h\-|v\-|v )|sy(01|mb)|t2(18|50)|t6(00|10|18)|ta(gt|lk)|tcl\-|tdg\-|tel(i|m)|tim\-|t\-mo|to(pl|sh)|ts(70|m\-|m3|m5)|tx\-9|up(\.b|g1|si)|utst|v400|v750|veri|vi(rg|te)|vk(40|5[0-3]|\-v)|vm40|voda|vulc|vx(52|53|60|61|70|80|81|83|85|98)|w3c(\-| )|webc|whit|wi(g |nc|nw)|wmlb|wonu|x700|yas\-|your|zeto|zte\-/i.test(b.substr(0,4))){a=true}})(navigator.userAgent||navigator.vendor||window.opera);return a}function mobileOrTabletCheck(){var a=false;(function(b){if(/(android|bb\d+|meego).+mobile|avantgo|bada\/|blackberry|blazer|compal|elaine|fennec|hiptop|iemobile|ip(hone|od)|iris|kindle|lge |maemo|midp|mmp|mobile.+firefox|netfront|opera m(ob|in)i|palm( os)?|phone|p(ixi|re)\/|plucker|pocket|psp|series(4|6)0|symbian|treo|up\.(browser|link)|vodafone|wap|windows ce|xda|xiino|android|ipad|playbook|silk/i.test(b)||/1207|6310|6590|3gso|4thp|50[1-6]i|770s|802s|a wa|abac|ac(er|oo|s\-)|ai(ko|rn)|al(av|ca|co)|amoi|an(ex|ny|yw)|aptu|ar(ch|go)|as(te|us)|attw|au(di|\-m|r |s )|avan|be(ck|ll|nq)|bi(lb|rd)|bl(ac|az)|br(e|v)w|bumb|bw\-(n|u)|c55\/|capi|ccwa|cdm\-|cell|chtm|cldc|cmd\-|co(mp|nd)|craw|da(it|ll|ng)|dbte|dc\-s|devi|dica|dmob|do(c|p)o|ds(12|\-d)|el(49|ai)|em(l2|ul)|er(ic|k0)|esl8|ez([4-7]0|os|wa|ze)|fetc|fly(\-|_)|g1 u|g560|gene|gf\-5|g\-mo|go(\.w|od)|gr(ad|un)|haie|hcit|hd\-(m|p|t)|hei\-|hi(pt|ta)|hp( i|ip)|hs\-c|ht(c(\-| |_|a|g|p|s|t)|tp)|hu(aw|tc)|i\-(20|go|ma)|i230|iac( |\-|\/)|ibro|idea|ig01|ikom|im1k|inno|ipaq|iris|ja(t|v)a|jbro|jemu|jigs|kddi|keji|kgt( |\/)|klon|kpt |kwc\-|kyo(c|k)|le(no|xi)|lg( g|\/(k|l|u)|50|54|\-[a-w])|libw|lynx|m1\-w|m3ga|m50\/|ma(te|ui|xo)|mc(01|21|ca)|m\-cr|me(rc|ri)|mi(o8|oa|ts)|mmef|mo(01|02|bi|de|do|t(\-| |o|v)|zz)|mt(50|p1|v )|mwbp|mywa|n10[0-2]|n20[2-3]|n30(0|2)|n50(0|2|5)|n7(0(0|1)|10)|ne((c|m)\-|on|tf|wf|wg|wt)|nok(6|i)|nzph|o2im|op(ti|wv)|oran|owg1|p800|pan(a|d|t)|pdxg|pg(13|\-([1-8]|c))|phil|pire|pl(ay|uc)|pn\-2|po(ck|rt|se)|prox|psio|pt\-g|qa\-a|qc(07|12|21|32|60|\-[2-7]|i\-)|qtek|r380|r600|raks|rim9|ro(ve|zo)|s55\/|sa(ge|ma|mm|ms|ny|va)|sc(01|h\-|oo|p\-)|sdk\/|se(c(\-|0|1)|47|mc|nd|ri)|sgh\-|shar|sie(\-|m)|sk\-0|sl(45|id)|sm(al|ar|b3|it|t5)|so(ft|ny)|sp(01|h\-|v\-|v )|sy(01|mb)|t2(18|50)|t6(00|10|18)|ta(gt|lk)|tcl\-|tdg\-|tel(i|m)|tim\-|t\-mo|to(pl|sh)|ts(70|m\-|m3|m5)|tx\-9|up(\.b|g1|si)|utst|v400|v750|veri|vi(rg|te)|vk(40|5[0-3]|\-v)|vm40|voda|vulc|vx(52|53|60|61|70|80|81|83|85|98)|w3c(\-| )|webc|whit|wi(g |nc|nw)|wmlb|wonu|x700|yas\-|your|zeto|zte\-/i.test(b.substr(0,4))){a=true}})(navigator.userAgent||navigator.vendor||window.opera);return a}function initBootstrapSelect(){$("select").selectpicker()}window.onerror=function myErrorHandler(c,b,a){alert("Error occured: "+c+" at "+b+" line "+a);return false};function mergeObjects(d,c){if(Object.assign){return Object.assign(d,c)}var a={};if(d instanceof Object){for(var b in d){a[b]=d[b]}}if(c instanceof Object){for(var b in c){a[b]=c[b]}}return a}function utoa(a){return window.btoa(unescape(encodeURIComponent(a)))}function atou(a){return decodeURIComponent(escape(window.atob(a)))}function copyToClipboard(a){if(document.selection){var b=document.body.createTextRange();b.moveToElementText(document.getElementById(a));b.select().createTextRange();document.execCommand("Copy")}else{if(window.getSelection){var b=document.createRange();b.selectNode(document.getElementById(a));window.getSelection().addRange(b);document.execCommand("Copy")}}}version=function(){return"v0.1.09c.20170503"};config.controller("dashboard",["$scope","$rootScope","dataService","$timeout","$interval","$location","$sce","$routeParams","ngDialog","$window",function(p,k,n,c,g,f,j,o,m,b){var a=null;var d=null;var h=null;p.initialized=false;p.loading=true;p.data=null;p.error="";p.designer={};p.locations=null;p.instances=null;p.requestId=0;p.activePistons=0;p.pausedPistons=0;p.dropDownMenu=false;p.view="piston";p.init=function(s,v,u){if(p.$$destroyed){return}if(h){c.cancel(h)}h=null;p.requestId++;var w=0+p.requestId;p.loading=!p.initialized||!p.instance;n.setStatusCallback(p.setStatus);n.loadInstance(s,v,u).then(function(x){if(p.$$destroyed){return}if(w!=p.requestId){return}if(x){if(x.error){switch(x.error){case"ERR_INVALID_TOKEN":p.dialogLogIn(x.name,x.uri);break}}else{p.initialized=true;p.location=n.getLocation();p.instance=n.getInstance();p.currentInstanceId=p.instance.id;p.instanceCount=n.getInstanceCount();if(!p.devices){p.devices=p.listAvailableDevices()}if(!p.virtualDevices){p.virtualDevices=p.listAvailableVirtualDevices()}window.scope=p;p.loading=false;p.activePistons=0;p.pausedPistons=0;for(pistonIndex in p.instance.pistons){var y=p.instance.pistons[pistonIndex];if(y.meta&&y.meta.a){p.activePistons++}else{p.pausedPistons++}}p.clock();p.render()}}else{p.dialogDeleteInstance(s)}})};p.closeNavBar=function(){if(!$("#navbar-btn").hasClass("collapsed")){$("#navbar-btn").click()}};p.render=function(){if(p.$$destroyed){return}if(!p.initialized){return}if(!d){d=g(p.clock,1000)}if(!h){h=c(p.init,5000)}};p.clock=function(){if(p.instance){for(pistonIndex in p.instance.pistons){var s=p.instance.pistons[pistonIndex];s.opacity=s.meta?p.getOpacity(s.meta.t):0}}};p.setStatus=function(s){if(a){c.cancel(a)}a=null;p.status=s;if(p.status){a=c(function(){p.setStatus()},10000)}};p.showDashboard=function(){p.view="dashboard";p.dropDownMenu=false};p.hideDashboard=function(){p.view="piston";p.dropDownMenu=false};p.onWheel=function(s){p.dropDownMenu=s&&s.originalEvent&&(s.currentTarget.scrollTop==0)&&(s.originalEvent.deltaY<0);return true};p.onSwipe=function(s,u){p.dropDownMenu=(s.currentTarget.scrollTop==0)&&(u=="down");return true};p.listLocations=function(){return n.listLocations()};p.listInstances=function(s){return n.listInstances(s)};p.listAllInstances=function(){var u=[];var s=p.listLocations();for(l in s){var v=n.listInstances(s[l].id);for(i in v){u.push({id:v[i].id,name:s[l].name+" \\ "+v[i].name,pistons:v[i].pistons})}}return u};p.listAvailableDevices=function(){var s=[];for(deviceIndex in p.instance.devices){var u=p.instance.devices[deviceIndex];s.push(mergeObjects({id:deviceIndex},u))}return s.sort(p.sortByName)};p.listAvailableVirtualDevices=function(){var s=[];for(deviceIndex in p.instance.virtualDevices){var u=p.instance.virtualDevices[deviceIndex];s.push(mergeObjects({id:deviceIndex},u))}return s.sort(p.sortByName)};p.sortByDisplay=function(u,s){return(u.d>s.d)?1:((s.d>u.d)?-1:0)};p.sortByName=function(u,s){return(u.n>s.n)?1:((s.n>u.n)?-1:0)};p.switchInstance=function(u){if(u!=p.instance.id){var s=n.getInstance(u);if(s){p.instance=null;if(h){c.cancel(h)}h=null;p.init(s);p.closeNavBar()}}};p.$on("$destroy",function(){if(a){c.cancel(a)}if(d){g.cancel(d)}if(h){c.cancel(h)}});p.openPiston=function(s){p.loading=true;p.initialized=false;f.path("piston/"+s)};p.newPiston=function(){p.loading=true;n.generateNewPistonName().then(function(s){p.loading=false;p.designer={};p.designer.author=n.loadFromStore("author.handle");p.designer.name=s.name;p.designer.page=0;p.designer.backup=!!n.loadFromStore("backup.auto");p.designer.disclaimer=!p.designer.backup;p.designer.items=[{type:"blank",name:"Create a blank piston",icon:"code",cssClass:"wide btn-default"},{type:"duplicate",name:"Create a duplicate piston",icon:"code",cssClass:"wide btn-info"},{type:"template",name:"Create a piston from a template",icon:"code",cssClass:"wide btn-success"},{type:"restore",name:"Restore a piston using a backup code",icon:"code",cssClass:"wide btn-warning"},{type:"import",name:"Import a piston from an external source",icon:"code",cssClass:"wide btn-danger"}];p.designer.dialog=m.open({template:"dialog-add-piston",className:"ngdialog-theme-default ngdialog-large",closeByDocument:false,disableAnimation:true,scope:p})})};p.movePiston=function(){p.designer={pistons:[],instance:""};p.designer.dialog=m.open({template:"dialog-move-piston",className:"ngdialog-theme-default ngdialog-large",closeByDocument:false,disableAnimation:true,scope:p})};p.movePistons=function(){alert("Sorry, not ready yet")};p.createPiston=function(){var s=function(u){p.closeDialog();p.initialized=false;f.path("piston/"+u.id).search({description:p.designer.description,type:p.designer.type,piston:p.designer.piston,bin:p.designer.bin})};p.loading=true;n.saveToStore("backup.auto",!!p.designer.backup);n.saveToStore("author.handle",p.designer.author);if(p.designer.backup){n.generateBackupBin().then(function(u){var v=u.data;n.createPiston(p.designer.name,p.designer.author,v).then(s)})}else{n.createPiston(p.designer.name,p.designer.author).then(s)}};p.dialogLogIn=function(s,u){if(h){c.cancel(h)}h=null;p.loading=false;p.initialized=false;p.designer={};p.designer.sender=s;p.designer.uri=u;p.designer.dialog=m.open({template:"dialog-auth",className:"ngdialog-theme-default ngdialog-large",closeByDocument:false,disableAnimation:true,scope:p})};p.logOut=function(){localStorage.clear();p.loading=true;p.initialized=false;f.path("register")};p.authenticate=function(){p.closeDialog();p.init(null,p.designer.uri,window.md5("pin:"+p.designer.password));p.designer=null};p.dialogDeleteInstance=function(s){if(s){p.loading=false;p.initialized=false;p.designer={};p.designer.sender=s.locationName+" \\ "+s.name;p.designer.instance=s;p.designer.dialog=m.open({template:"dialog-del-instance",className:"ngdialog-theme-default ngdialog-large",closeByDocument:false,disableAnimation:true,scope:p})}};p.deleteInstance=function(){p.closeDialog();n.deleteInstance(p.designer.instance);p.designer=null;p.init()};p.setDesignerType=function(s){p.designer.type=s;p.nextPage()};p.closeDialog=function(){if(p.designer.dialog){p.designer.dialog.close();p.designer.dialog=null}};p.nextPage=function(){p.designer.page++};p.prevPage=function(){if(p.designer.page){p.designer.page--}};p.getOpacity=function(s){if(!s){return 0}s=currentTime()-s;if((s<0)||(s>60000)){return 0}return 1-s/60000};p.breakList=function(s){return s.replace(/,/g,"<br/>")};var r=function(u){var v=u.getFullYear();var w=(1+u.getMonth()).toString();w=w.length>1?w:"0"+w;var s=u.getDate().toString();s=s.length>1?s:"0"+s;return w+"/"+s+"/"+v};p.getMonth=function(s){if(s){return["JAN","FEB","MAR","APR","MAY","JUN","JUL","AUG","SEP","OCT","NOV","DEC"][s.getMonth()]}};p.getDay=function(s){if(s){return("0"+s.getDate()).substr(-2)}};p.timeSince=timeSince;p.timeCounter=timeCounter;p.timeLeft=timeLeft;p.tap=function(s){n.tap(s).then(function(u){})};p.togglePiston=function(v,u){if((!v)&&(!p.viewerPiston||!p.viewerPiston.app)){return}var w=v?v.i:p.pistonId;if(w){c.cancel(tmrRefresh);var s=!(v?v.e:p.viewerPiston.app.enabled);if(v){v.e=s}else{p.viewerPiston.app.enabled=s}if(s){n.resumePiston(w).then(function(x){p.onRefresh(x)})}else{n.pausePiston(w).then(function(x){p.onRefresh(x)})}}if(u&&e.preventDefault){u.preventDefault()}if(u&&u.stopPropagation){u.stopPropagation()}};p.configurePiston=function(s){p.configuredPistonId=p.configuredPistonId==s.i?null:s.i};p.showPiston=function(s){document.body.scrollTop=0;p.viewerPiston=null;p.pistonId=s.i;p.refresh();window.onSwipeRight=p.hidePiston};p.hidePiston=function(){document.body.scrollTop=0;p.pistonId=null;window.onSwipeRight=null};p.prepareActions=function(v){var x=[];var s=[];var A=[];var B=(v.id<=0);var w=p.viewerPiston.tasks;var z=p.viewerPiston.app.actions;for(action in z){if(z[action].pid==v.id){if(z[action].t){var y=z[action].t;for(t in y){var u=0;for(task in w){if((w[task].type=="cmd")&&(w[task].ownerId==z[action].id)&&(w[task].taskId==y[t].i)){if((u==0)||(u>w[task].time)){u=w[task].time}}}y[t].time=u}}if(B){x.push(z[action])}else{if(z[action].rs==false){A.push(z[action])}else{s.push(z[action])}}}}var u=0;for(task in w){if((w[task].type=="evt")&&(w[task].ownerId==v.id)){if((u==0)||(u>w[task].time)){u=w[task].time}}}v.time=u;v.actions=x;v.trueActions=s;v.falseActions=A;v.$scope=p;if(v.children){for(child in v.children){p.prepareActions(v.children[child])}}};p.hadRecentActivity=function(s){return s&&s.le&&s.le.event&&s.le.event.date&&(timeLeft((new Date(s.le.event.date)).getTime())>-120)};p.toggleViewerOptions=function(){p.viewerPiston.showOptions=!p.viewerPiston.showOptions;p.closeNavBar()};p.getSecondaryStatementName=function(){var s=p.viewerPiston.app.mode;switch(s){case"Latching":return"BUT IF";case"Then-If":return"THEN IF";case"Else-If":return"ELSE IF";case"Or-If":return"OR IF";case"And-If":return"AND IF"}return"IF"};p.capturePiston=function(){var s=document.getElementById("viewerPanel");document.body.scrollTop=0;html2canvas(s).then(function(u){p.capturedImage=u.toDataURL("image/png");p.dialogCapture=m.open({template:"dialog-captured-image",className:"ngdialog-theme-default ngdialog-large",disableAnimation:true,scope:p,showClose:true})})};p.determineDeviceType=function(s){return n.determineDeviceType(s)};p.initSocialMedia=function(){b.FB.XFBML.parse()};p.init();var q=navigator.userAgent||navigator.vendor||window.opera;if(q.match(/Android/i)){p.android=true}p.url=window.location.href;p.mobile=window.mobileCheck();p.tablet=(!p.mobile)&&(window.mobileOrTabletCheck());p.formatTime=formatTime;p.utcToString=utcToString;p.$$postDigest(function(){b.FB.XFBML.parse()})}]);config.controller("register",["$scope","$rootScope","dataService","$timeout","$interval","$location","$sce","$routeParams","ngDialog","$window",function(k,g,i,c,e,d,f,j,h,b){var a=null;k.loading=false;k.code="";k.init=function(){};k.setStatus=function(m){if(a){c.cancel(a)}a=null;k.status=m;if(k.status){a=c(function(){k.setStatus()},10000)}};k.$on("$destroy",function(){if(a){c.cancel(a)}});k.register=function(){k.loading=true;i.registerDashboard(k.code).then(function(m){if(m&&(m.length>=80)&&(m.length<=128)){d.path("/init/"+m)}else{k.setStatus("Sorry, the registration code you provided did not work...")}k.loading=false})};k.init();var l=navigator.userAgent||navigator.vendor||window.opera;if(l.match(/Android/i)){k.android=true}k.url=window.location.href;k.mobile=window.mobileCheck();k.tablet=(!k.mobile)&&(window.mobileOrTabletCheck());k.formatTime=formatTime;k.utcToString=utcToString}]);config.controller("piston",["$scope","$rootScope","dataService","$timeout","$interval","$location","$sce","$routeParams","ngDialog","$window","$animate",function(x,s,v,g,k,j,r,w,u,f,m){var n;var b;var q;var h;x.lastLogEntry=0;x.error="";x.loading=true;x.initialized=false;x.mode="view";x.data=null;x.error="";x.pistonId=w.pistonId;x.piston=null;x.designer={};x.showAdvancedOptions=false;x.dk="N7zqL6a8Texs4wY5y&y2YPLzus+_dZ%s";x.params=j.search();x.insertIndexes={};if(x.params){j.search({})}x.stack={undo:[],redo:[]};x.weekDays=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"];x.yearMonths=["January","February","March","April","May","June","July","August","September","October","November","December"];x.render=function(A){if((x.mode=="view")&&(x.view.trace)){if(!h){h=k(x.render,1000)}if(x.trace){}}else{if(h){g.cancel(h)}h=null}};x.setStatus=function(A){if(A){console.log(A)}if(b){g.cancel(b)}b=null;x.status=A;if(x.status){b=g(function(){x.setStatus()},10000)}};x.listAllPistons=function(){var B=[];var A=v.listLocations();for(l in A){var C=v.listInstances(A[l].id);for(i in C){for(p in C[i].pistons){B.push({v:C[i].pistons[p].id,n:A[l].name+" \\ "+C[i].name+" \\ "+C[i].pistons[p].name})}}}return B};x.listAvailableContacts=function(){var B=[];for(i in x.instance.contacts){var A=x.instance.contacts[i];B.push({v:i,n:(A.f+" "+A.l).trim()+(A.p?" (PUSH)":(A.t?" ("+A.t+")":"")),an:A.an})}if(!B.length){B.push({v:"no one",n:"No available contacts"})}return B};x.getPistonName=function(C){var A=v.listLocations();for(l in A){var B=v.listInstances(A[l].id);for(i in B){for(p in B[i].pistons){if(B[i].pistons[p].id==C){return A[l].name+" \\ "+B[i].name+" \\ "+B[i].pistons[p].name}}}}return C};x.getModeName=function(A){for(modeIndex in x.location.modes){if(x.location.modes[modeIndex].id==A){return x.location.modes[modeIndex].name}}return A};x.updateActivity=function(A){if(x.$$destroyed){return}if(x.mode!="view"){return}if(q){g.cancel(q)}if(A){q=g(x.updateActivity,10000);return}v.getActivity(x.pistonId,x.lastLogEntry).then(function(B){if(x.$$destroyed){return}if(B.error=="ERR_INVALID_ID"){x.home();return}if(B&&B.activity){if(B.activity.state){x.state=B.activity.state}if(B.activity.logs&&B.activity.logs.length){x.logs=B.activity.logs.concat(x.logs)}if(B.activity.trace){x.trace=B.activity.trace}if(B.activity.localVars){x.localVars=B.activity.localVars}if(B.activity.memory){x.memory=B.activity.memory}if(B.activity.lastExecuted){x.lastExecuted=B.activity.lastExecuted}if(B.activity.nextSchedule){x.nextSchedule=B.activity.nextSchedule}if(B.activity.schedules){x.schedules=B.activity.schedules}if(B.activity.name){x.meta.name=B.activity.name}if(x.logs&&x.logs.length){x.lastLogEntry=x.logs[0].t}if(B.activity.globalVars){x.updateGlobalVars(B.activity.globalVars)}}q=g(x.updateActivity,3000)})};x.updateGlobalVars=function(A){x.globalVars=x.globalVars instanceof Object?x.globalVars:{};for(varName in A){var B=A[varName].t;var D=A[varName].v;var C=x.globalVars[varName];if(!C){x.globalVars[varName]={t:B,v:D}}else{if(C.t!=B){C.t=B}if(C.v!=D){C.v=D}}}for(varName in x.globalVars){if(!A[varName]){delete (x.globalVars[varName])}}};x.init=function(){if(x.$$destroyed){return}v.setStatusCallback(x.setStatus);x.loading=true;if(x.piston){x.loading=true}v.getPiston(x.pistonId).then(function(A){if(x.$$destroyed){return}try{var B=x.piston?!!x.showOptions:false;if(!A||!A.data||!A.data.piston){x.error=r.trustAsHtml("Sorry, an error occurred while retrieving the piston data.");x.loading=false;return}x.piston=A.data.piston;x.meta=A.data.meta?A.data.meta:{};x.db=A.db;x.location=v.getLocation();x.instance=v.getInstance();x.view=v.loadFromStore("view")||{variables:false,elseIfs:false,restrictions:false,whens:false,advancedStatements:false};x.subscriptions=A.data.subscriptions?A.data.subscriptions:{};x.logs=A.data.logs?A.data.logs:[];x.lastLogEntry=(x.logs&&x.logs.length)?x.logs[0].t:0;x.stats=A.data.stats?A.data.stats:{};x.state=A.data.state?A.data.state:"";x.trace=A.data.trace?A.data.trace:{};x.memory=A.data.memory?A.data.memory:0;x.lastExecuted=A.data.lastExecuted;x.nextSchedule=A.data.nextSchedule;x.schedules=A.data.schedules;x.initChart();if(x.instance&&x.instance.devices){x.anonymizeDevices(x.instance.devices)}if(x.instance&&x.instance.devices){x.anonymizeContacts(x.instance.contacts)}x.devices=x.listAvailableDevices();x.contacts=x.listAvailableContacts();x.virtualDevices=x.listAvailableVirtualDevices();window.scope=x;x.localVars=A.data.localVars;x.globalVars=x.instance.globalVars;x.systemVars=A.data.systemVars;x.systemVarNames=[];for(name in x.systemVars){x.systemVarNames.push(name)}x.meta.build=x.meta.build?1*x.meta.build:0;if(x.piston&&(x.meta.build==0)){x.piston.z=x.params&&x.params.description?x.params.description:"";x.mode="edit";if(x.params&&x.params.type!="blank"){switch(x.params.type){case"duplicate":if(x.params.piston){x.loading=true;v.getPiston(x.params.piston).then(function(D){x.loading=false;if(D&&D.data&&D.data.piston){x.piston.o=D.data.piston.o?D.data.piston.o:{};x.piston.r=D.data.piston.r?D.data.piston.r:[];x.piston.rn=!!D.data.piston.rn;x.piston.rop=D.data.piston.rop?D.data.piston.rop:"and";x.piston.s=D.data.piston.s?D.data.piston.s:[];x.piston.v=D.data.piston.v?D.data.piston.v:[]}x.initialized=true;x.loading=false});return}break;case"restore":if(x.params.bin){x.loading=true;v.loadFromBin(x.params.bin).then(function(D){var E=D.data;x.loading=false;if(E){x.piston.o=E.o?E.o:{};x.piston.r=E.r?E.r:[];x.piston.rn=!!E.rn;x.piston.rop=E.rop?E.rop:"and";x.piston.s=E.s?E.s:[];x.piston.v=E.v?E.v:[];x.piston.z=E.z?E.z:""}x.initialized=true;x.loading=false;if(!!E&&!!E.l){x.rebuildPiston(E.l)}});return}break}}}if(x.mode=="edit"){x.loadStack()}else{x.updateActivity(true)}x.piston.o=x.piston.o?x.piston.o:{cto:0,ced:0};x.piston.r=x.piston.r?x.piston.r:[];x.piston.s=x.piston.s?x.piston.s:[];x.piston.rop=x.piston.rop?x.piston.rop:"and";x.piston.rn=!!x.piston.rn;x.piston.v=x.piston.v?x.piston.v:[];x.piston.z=x.piston.z||"";x.initialized=true;x.loading=false;x.render()}catch(C){alert(C)}})};x.initChart=function(){x.chart={type:"bar",labels:[],series:["Event delay","Load time","Execution time","Update time"],data:[[],[],[],[]],onClick:function(C,B){},datasetOverride:[{cubicInterpolationMode:"monotone",lineTension:0,yAxisID:"y-axis-1",fill:true,pointRadius:0,borderColor:"#88bbee",borderWidth:0,backgroundColor:"#99ccff"},{cubicInterpolationMode:"monotone",lineTension:0,yAxisID:"y-axis-1",fill:true,pointRadius:0,borderColor:"#eebb88",borderWidth:"0px",backgroundColor:"#ffcc99"},{cubicInterpolationMode:"monotone",lineTension:0,yAxisID:"y-axis-1",fill:true,pointRadius:0,borderColor:"#ee88bb",borderWidth:"0px",backgroundColor:"#ff99cc"},{cubicInterpolationMode:"monotone",lineTension:0,yAxisID:"y-axis-1",fill:true,pointRadius:0,borderColor:"#999",borderWidth:1,backgroundColor:"#ccff99"}],options:{legend:{display:true},multiTooltipTemplate:"<%=datasetLabel%> : <%= value %>ms",showLines:true,fill:true,scales:{xAxes:[{type:"time"}],yAxes:[{id:"y-axis-1",stacked:true,type:"linear",display:true,position:"left"}]},pan:{enabled:true,mode:"x"},zoom:{enabled:true,mode:"x"}}};if(x.stats&&x.stats.timing){for(var A=0;A<x.stats.timing.length;A++){x.chart.labels.push(new Date(x.stats.timing[A].t));x.chart.data[0].push(x.stats.timing[A].d);x.chart.data[1].push(x.stats.timing[A].l);x.chart.data[2].push(x.stats.timing[A].e);x.chart.data[3].push(x.stats.timing[A].u)}}};x.$on("$destroy",function(){if(b){g.cancel(b)}if(n){g.cancel(n)}if(q){g.cancel(q)}if(h){g.cancel(h)}});x.copy=function(A){return angular.fromJson(angular.toJson(A))};x.home=function(){x.initialized=false;j.path("/")};x.toggleView=function(A){if(A){x.view[A]=!x.view[A]}v.saveToStore("view",x.view)};x.revealBin=function(){x.revealing=!x.revealing;if(n){g.cancel(n)}if(x.revealing){n=g(function(){x.revealing=false;n=null},10000)}};x.edit=function(){x.mode="edit";x.init();$("viewer")[0].scrollTop=0};x.cancel=function(){x.mode="view";x.init()};x.save=function(){x.loading=true;var A={id:x.pistonId,o:x.piston.o,s:x.piston.s,v:x.piston.v,r:x.piston.r,rop:x.piston.rop,rn:x.piston.rn,z:x.piston.z,n:x.meta.name};v.setPiston(A,x.meta.bin).then(function(B){x.loading=false;if(B&&B.data&&B.data.build){x.meta.active=B.data.active;x.meta.modified=B.data.modified;x.meta.build=B.data.build;x.saveStack(true);x.mode="view";x.init()}})};x.pause=function(){x.loading=true;v.pausePiston(x.pistonId).then(function(A){x.loading=false;if(A&&A.status&&(A.status=="ST_SUCCESS")){x.meta.active=A.active;x.subscriptions={};x.updateActivity()}})};x.resume=function(){x.loading=true;v.resumePiston(x.pistonId).then(function(A){x.loading=false;if(A&&A.status&&(A.status=="ST_SUCCESS")){x.meta.active=A.active;if(A.subscriptions){x.subscriptions=A.subscriptions}x.updateActivity()}})};x.del=function(){x.loading=true;v.deletePiston(x.pistonId).then(function(A){x.closeDialog();j.path("/")})};x.padComment=function(B,A){if(!B){B=""}A=A-6-B.length;while(A>0){B+=" ";A--}return"/* "+B+" */"};x.range=function(A){return new Array(A)};x.wiki=function(A){x.wikiUrl=r.trustAsUrl("https://wiki.webcore.co/"+A+"?content-only");f.mydialog=u.open({template:"dialog-wiki",className:"ngdialog-theme-default ngdialog-large ngdialog-wiki",closeByDocument:true,disableAnimation:true,scope:x})};x.formatVariableValue=function(B,A){if((B.v==null)&&!!A&&x.localVars){B=x.copy(B);B.v=x.localVars[A]}if((B.v==="")||(B.v===null)||((B.v instanceof Array)&&!B.v.length)){return"(not set)"}switch(B.t){case"time":return utcToTimeString(B.v);case"datetime":return utcToString(B.v);case"date":return utcToDateString(B.v);case"contact":return x.renderContactNameList(B.v);case"device":return x.renderDeviceNameList(B.v);default:return B.v}};x.deleteDialog=function(){x.designer.dialog=u.open({template:"dialog-del-piston",className:"ngdialog-theme-default ngdialog-large",closeByDocument:false,disableAnimation:true,scope:x})};x.listDevicesWithAttributes=function(B){if(!B||!(B instanceof Array)||!B.length){return x.instance.devices}var A={};for(d in x.instance.devices){var C=x.instance.devices[d];var D=0;for(a in C.a){if(B.indexOf(C.a[a].n)>=0){D++;if(D==B.length){break}}}if(D==B.length){A[d]=C}}return A};x.rebuildPiston=function(A){if(!A){return}for(key in A){var B=A[key];B.id="";switch(B.t){case"device":B.i=x.listDevicesWithAttributes(B.a);break;case"contact":B.i=x.instance.contacts;break;case"mode":B.i=x.instance.virtualDevices.mode.o;for(i in B.i){if(B.i[i]==B.n){B.id=i;break}}break;case"routine":B.i=x.instance.virtualDevices.routine.o;break}}x.designer={legend:A};x.designer.dialog=u.open({template:"dialog-rebuild-piston",className:"ngdialog-theme-default ngdialog-large",closeByDocument:false,disableAnimation:true,scope:x})};x.doRebuildPiston=function(){x.piston=x.compilePiston(x.piston,false,x.designer.legend);x.closeDialog()};x.getExpressionConfig=function(){var A=[];for(attribute in x.db.attributes){A.push(": "+attribute+"]")}return{autocomplete:[{words:[]},{words:x.listAutoCompleteFunctions(),cssClass:"hl kwd"},{words:x.listAutoCompleteVariables(),cssClass:"hl var"},{words:x.listAutoCompleteDevices(),cssClass:"hl dev"},{words:A,cssClass:"hl dev"},{words:[/([0-9]+)(\.[0-9]+)?/g],cssClass:"hl num"}]}};x.removeFromArray=function(C,B){if(!(C instanceof Array)){return}var A=C.indexOf(B);if(A!==-1){C.splice(A,1)}return C};x.deleteObject=function(C,B){var A=!C;if(A){C=x.designer.$obj;B=x.designer.parent}if(!C){return}if((B instanceof Array)&&(C)){x.autoSave();B=x.removeFromArray(B,C);if(A){x.closeDialog()}}if(B&&(B.t=="action")&&(B.k instanceof Array)&&(C)){x.autoSave();B.k=x.removeFromArray(B.k,C);if(A){x.closeDialog()}}};x.getIFTTTUri=function(A){var B=v.getApiUri();if(!B){return"An error has occurred retrieving the IFTTT Maker URL"}return B+"ifttt/"+A};x.toggleAdvancedOptions=function(){x.designer.showAdvancedOptions=!x.designer.showAdvancedOptions};x.getClipboard=function(){var A=v.loadFromStore("clipboard");if(!A){A=[]}return A};x.getClipboardItems=function(C){var B=x.getClipboard();var A=[];for(i in B){if(B[i].t.startsWith(C)){A.push(B[i])}}return A};x.saveToClipboard=function(B,A){var C=x.getClipboard();C.push({s:(new Date()).getTime(),t:A,o:x.copy(B)});if(C.length>MAX_STACK_SIZE){C=C.slice(-MAX_STACK_SIZE)}v.saveToStore("clipboard",C)};x.deleteClipboardItem=function(A){var B=x.getClipboard();x.removeFromArray(x.designer.clipboard,A);for(i=0;i<B.length;i++){if((B[i].s==A.s)&&(B[i].t==A.t)){break}}if(i<B.length){B.splice(i,1);v.saveToStore("clipboard",[])}};x.clearClipboard=function(){v.saveToStore("clipboard",[])};x.copySelection=function(){if(!x.selection){return}x.saveToClipboard(x.selection,x.selectionType)};x.cutSelection=function(){if(!x.selection){return}x.saveToClipboard(x.selection,x.selectionType);x.deleteObject(x.selection,x.selectionParent)};x.duplicateSelection=function(){if(!x.selection){return}if(!x.selectionParent){return}if(x.selectionParent instanceof Array){x.selectionParent.push(x.copy(x.selection))}};x.deleteSelection=function(){if(!x.selection){return}x.deleteObject(x.selection,x.selectionParent)};x.pasteItem=function(B){if(!B||!B.o||!x.designer||!x.designer.parent){return}var A=(x.designer.parent instanceof Array)?x.designer.parent:(B.t.startsWith("condition")&&x.designer.parent.c?x.designer.parent.c:(B.t.startsWith("restriction")&&x.designer.parent.r?x.designer.parent.r:(B.t.startsWith("task")&&x.designer.parent.k?x.designer.parent.k:null)));if(!A){return}A.push(x.copy(B.o));x.closeDialog()};x.contextMenu=function(B){var A=[];if(x.selection){A.push(["Copy selected "+x.selectionType,x.copySelection]);if(x.mode=="edit"){A.push(["Duplicate selected "+x.selectionType,x.duplicateSelection]);if(x.selectionParent){A.push(null);A.push(["Cut selected "+x.selectionType,x.cutSelection]);A.push(["Delete selected "+x.selectionType,x.deleteSelection])}}A.push(null)}A.push(["Clear clipboard",x.clearClipboard]);return A};x.select=function(B,C,A){if(!A){A="statement"}x.selection=B;x.selectionParent=C;x.selectionType=A};x.editSettings=function(){if(x.mode!="edit"){return}x.designer={name:x.meta.name,description:x.piston.z,automaticState:x.piston.o.mps?1:0,conditionOptimizations:x.piston.o.cto?1:0,executionParallelism:x.piston.o.pep?1:0,eventSubscriptions:x.piston.o.des?1:0,commandDelay:x.piston.o.ced?x.piston.o.ced:0};window.designer=x.designer;x.designer.dialog=u.open({template:"dialog-edit-settings",className:"ngdialog-theme-default ngdialog-large",closeByDocument:false,disableAnimation:true,scope:x})};x.updateSettings=function(){x.meta.name=x.designer.name;x.piston.z=x.designer.description;x.piston.o.mps=x.designer.automaticState?1:0;x.piston.o.pep=x.designer.executionParallelism?1:0;x.piston.o.cto=x.designer.conditionOptimizations?1:0;x.piston.o.des=x.designer.eventSubscriptions?1:0;x.piston.o.ced=isNaN(x.designer.commandDelay)?0:parseInt(x.designer.commandDelay);x.closeDialog()};x.addStatement=function(A){return x.editStatement(null,A)};x.editStatement=function(B,A){if(x.mode!="edit"){return}if(!B){B={};B.t=null;B.d=[];B.o="and";B.n=false;B.rop="and";B.rn=false;B.a="0";B.di=false;B.tcp="c";B.tep="";B.tsp="";B.ctp="i";B.s="local";B.z=""}x.designer={config:x.getExpressionConfig(),clipboard:B.t?[]:x.getClipboardItems("statement")};x.designer.$obj=B;x.designer.$statement=B;x.designer.$new=B.t?false:true;x.designer.type=B.t;x.designer.page=B.t?1:0;x.designer.operator=B.o;x.designer.not=B.n?"1":"0";x.designer.disabled=B.di?"1":"0";x.designer.roperator=B.rop;x.designer.rnot=B.rn?"1":"0";x.designer.description=B.z;x.designer.parent=A;x.designer.devices=B.d;x.designer.operand={data:x.copy(B.lo),multiple:false};x.designer.operand2={data:x.copy(B.lo2),multiple:false};x.designer.operand3={data:x.copy(B.lo3),multiple:false};x.designer.x=B.x;x.designer.autoDialogs=true;x.designer.tcp=B.tcp;x.designer.tep=B.tep;x.designer.tsp=B.tsp;x.designer.ctp=B.ctp||"i";x.designer.async=B.a;x.designer.ontypechanged=function(C,D){C.operand.requirePositiveNumber=false;C.operand2.requirePositiveNumber=false;C.operand3.requirePositiveNumber=false;switch(D){case"for":C.operand.dataType="decimal";C.operand2.dataType="decimal";C.operand3.dataType="decimal";C.operand.onlyAllowConstants=false;C.operand.hideMilliseconds=true;if(C.$new){C.operand.data={t:"c"}}if(C.$new){C.operand2.data={t:"c"}}if(C.$new){C.operand3.data={t:"c"}}x.validateOperand(C.operand,true);x.validateOperand(C.operand2,true);x.validateOperand(C.operand3,true);break;case"each":C.operand.dataType="devices";C.operand.onlyAllowConstants=false;C.operand.hideMilliseconds=true;if(C.$new){C.operand.data={t:"d"}}x.validateOperand(C.operand,true);break;case"switch":C.operand.dataType="";C.operand.onlyAllowConstants=false;C.operand.hideMilliseconds=true;if(C.$new){C.operand.data={t:"p"}}x.validateOperand(C.operand,true);break;case"every":C.operand.dataType="duration";if(C.$new){C.operand.data={t:"c",c:1,vt:"d"}}C.operand.onlyAllowConstants=true;C.operand.hideMilliseconds=true;C.operand2.dataType="time";var E=new Date();E.setSeconds(0,0);if(C.$new){C.operand2.data={t:"c",c:E}}C.operand3.dataType="duration";if(C.$new){C.operand3.data={t:"c",c:0,vt:"m"}}C.operand3.onlyAllowConstants=true;x.validateOperand(C.operand,true);x.validateOperand(C.operand2,true);x.validateOperand(C.operand3,true);break}x.refreshSelects()};window.designer=x.designer;x.designer.items={simple:[{type:"if",name:"If Block",icon:"code-fork",cssClass:"info",description:"An if block allows the piston to execute different actions depending on the truth result of a comparison or set of comparisons",button:"an if"},{type:"action",name:"Action",icon:"code",cssClass:"success",description:"An action allows the piston to control devices and execute tasks",button:"an action"},{type:"every",name:"Timer",icon:"clock-o",cssClass:"warning",description:"A timer will trigger execution of the piston at set time intervals",button:"a timer"}],advanced:[{type:"switch",name:"Switch",icon:"code-fork",cssClass:"info",description:"A switch statement compares an operand against a set of values and executes statements corresponding to those matches",button:"a switch"},{type:"do",name:"Do Block",icon:"code",cssClass:"success",description:"A do block can help organize several statements into a single block",button:"a do block"},{type:"on",name:"On event",icon:"code-fork",cssClass:"warning",description:"An on event executes its statements only when certain events happen",button:"an on event"},{type:"for",name:"For Loop",icon:"circle-o-notch",cssClass:"warning",description:"A for loop executes the same statements for a set number of iteration cycles",button:"a for loop"},{type:"each",name:"For Each Loop",icon:"circle-o-notch",cssClass:"warning",description:"An each loop executes the same statements for each device in a device list",button:"a for each loop"},{type:"while",name:"While Loop",icon:"circle-o-notch",cssClass:"warning",description:"A while loop executes the same statements for as long as a condition is met",button:"a while loop"},{type:"repeat",name:"Repeat Loop",icon:"circle-o-notch",cssClass:"warning",description:"A repeat loop executes the same statements until a condition is met",button:"a repeat loop"},{type:"break",name:"Break",icon:"ban",cssClass:"danger",description:"A break allows the interruption of the inner most switch, for loop, for each loop, while loop, or repeat loop",button:"a break"},{type:"exit",name:"Exit",icon:"ban",cssClass:"danger",description:"An exit interrupts the piston execution and exits immediately",button:"an exit"}]};x.designer.ontypechanged(x.designer,x.designer.type);x.designer.dialog=u.open({template:"dialog-edit-statement",className:"ngdialog-theme-default ngdialog-large",closeByDocument:false,disableAnimation:true,scope:x})};x.updateStatement=function(B,C){x.autoSave();var A=x.designer.$new?{t:x.designer.type}:x.designer.$statement;A.a=(x.designer.async=="1")||(["every","on"].indexOf(x.designer.type)>=0)?"1":"0";A.tcp=x.designer.tcp;A.tep=x.designer.tep;A.tsp=x.designer.tsp;A.z=x.designer.description;A.r=A.r?A.r:[];A.rop=x.designer.roperator;A.rn=x.designer.rnot=="1";A.di=x.designer.disabled=="1";switch(A.t){case"action":A.d=x.designer.devices;A.k=A.k?A.k:[];break;case"do":A.s=A.s?A.s:[];break;case"on":A.c=A.c?A.c:[];A.o="or";A.n=false;A.s=A.s?A.s:[];break;case"if":A.o=x.designer.operator;A.n=x.designer.not=="1";A.c=A.c?A.c:[];A.s=A.s?A.s:[];A.ei=A.ei?A.ei:[];A.e=A.e?A.e:[];break;case"switch":A.lo=x.designer.operand.data;A.cs=A.cs||[];A.e=A.e?A.e:[];A.ctp=x.designer.ctp;break;case"for":A.x=x.designer.x;A.lo=x.designer.operand.data;A.lo2=x.designer.operand2.data;A.lo3=x.designer.operand3.data;A.s=A.s?A.s:[];break;case"each":A.x=x.designer.x;A.lo=x.designer.operand.data;A.s=A.s?A.s:[];break;case"while":A.o=x.designer.operator;A.n=x.designer.not=="1";A.c=A.c?A.c:[];A.s=A.s?A.s:[];break;case"every":A.lo=x.designer.operand.data;A.lo2=x.designer.operand2.data;if(A.lo2.c instanceof Date){A.lo2.c=A.lo2.c.getHours()*60+A.lo2.c.getMinutes()}A.lo3=x.designer.operand3.data;A.s=A.s?A.s:[];break;case"repeat":A.o=x.designer.operator;A.n=x.designer.not=="1";A.c=A.c?A.c:[];A.s=A.s?A.s:[];break;case"break":break;case"exit":A.lo=x.designer.operand.data;break;default:A.t=null}if(A.t){A.$$html=null;if(x.designer.$new){if(x.designer.parent instanceof Array){x.designer.parent.push(A)}else{if((x.designer.parent.s)&&(x.designer.parent.s instanceof Array)){x.designer.parent.s.push(A)}else{x.designer.parent.s=[A]}}}else{x.designer.$statement=A}}x.closeDialog();if(B){switch(A.t){case"action":x.addTask(A);break;case"if":x.addCondition(A.c,false,C);break;case"on":x.addEvent(A.c);break;case"while":x.addCondition(A.c);break;case"do":case"for":case"each":case"repeat":x.addStatement(A.s);break;case"switch":x.addCase(A.cs);break}}};x.upgradeStatement=function(){x.updateStatement();var A=x.designer.$statement;if(A&&A.c&&(A.c instanceof Array)){A.c=[{t:"group",n:false,o:"and",c:A.c}]}};x.addCase=function(A){return x.editCase(null,A)};x.editCase=function(A,B){if(x.mode!="edit"){return}var C=A?false:true;if(!A){A={};A.t="s";A.s=[];A.ro={};A.ro2={};A.z=""}x.designer={config:x.getExpressionConfig()};x.designer.$obj=A;x.designer.$case=A;x.designer.$new=C;x.designer.parent=B;x.designer.type=A.t;x.designer.operand={data:A.ro,multiple:false};x.designer.operand2={data:A.ro2,multiple:false};x.designer.autoDialogs=true;window.designer=x.designer;x.validateOperand(x.designer.operand);x.validateOperand(x.designer.operand2);x.designer.dialog=u.open({template:"dialog-edit-case",className:"ngdialog-theme-default ngdialog-large",closeByDocument:false,disableAnimation:true,scope:x})};x.updateCase=function(B){x.autoSave();var A=x.designer.$case;A.t=x.designer.type;A.s=A.s||[];A.ro=x.designer.operand.data;A.ro2=x.designer.operand2.data;A.z=x.designer.description;if(A.t){A.$$html=null;A.$$html2=null;if(x.designer.$new){if(x.designer.parent instanceof Array){x.designer.parent.push(A)}else{if((x.designer.parent.cs)&&(x.designer.parent.cs instanceof Array)){x.designer.parent.cs.push(A)}else{x.designer.parent.cs=[A]}}}else{x.designer.$case=A}}x.closeDialog();if(B){x.addStatement(A.s)}};x.addEvent=function(A){return x.editEvent(null,A)};x.editEvent=function(C,A){if(x.mode!="edit"){return}var B=!C;if(!C){C={};C.t="event";C.lo={t:"p",d:[],a:null,g:"any",v:null,c:"",x:null,e:""};C.z="";C.sm="auto"}x.designer={config:x.getExpressionConfig(),clipboard:B?x.getClipboardItems("event"):[]};x.designer.$event=C;x.designer.$obj=C;x.designer.type=C.t;x.designer.$new=B;x.designer.parent=A;x.designer.comparison={event:true,type:"event",left:{data:C.lo?x.copy(C.lo):{},event:true}};x.validateComparison(x.designer.comparison,true);x.designer.smode=C.sm;x.designer.description=C.z;window.designer=x.designer;x.designer.dialog=u.open({template:"dialog-edit-event",className:"ngdialog-theme-default ngdialog-large",closeByDocument:false,disableAnimation:true,scope:x})};x.updateEvent=function(B){x.autoSave();var A=x.designer.$new?{t:x.designer.type}:x.designer.$event;A.lo=x.fixOperand(x.designer.comparison.left.data);A.sm=x.designer.smode;A.z=x.designer.description;if(A.t){A.$$html=null;if(x.designer.$new){if(x.designer.parent instanceof Array){x.designer.parent.push(A)}else{if((x.designer.parent.c)&&(x.designer.parent.c instanceof Array)){x.designer.parent.c.push(A)}else{x.designer.parent.c=[A]}}}else{x.designer.$event=A}}x.closeDialog();if(A.t&&B){x.addEvent(x.designer.parent)}};x.addCondition=function(A,B,C){return x.editCondition(null,A,B,C)};x.editCondition=function(E,A,C,D){if(x.mode!="edit"){return}var B=!E;if(!E){E={};E.t=D;E.d=[];E.n=false;E.o="and";E.lo={t:"p",d:[],a:null,g:"any",v:null,c:"",x:null,e:""};E.co=null;E.ro={t:"c",d:[],a:null,g:"any",v:null,c:"",x:null,e:""};E.ro2={t:"c",d:[],a:null,g:"any",v:null,c:"",x:null,e:""};E.to={t:"c",d:[],a:null,g:"any",v:null,c:"",x:null,e:""};E.to2={t:"c",d:[],a:null,g:"any",v:null,c:"",x:null,e:""};E.z="";E.sm="auto";E.ts=[];E.fs=[]}x.designer={config:x.getExpressionConfig(),clipboard:B?x.getClipboardItems("condition"):[]};x.designer.$condition=E;x.designer.$obj=E;x.designer.type=E.t;x.designer.$new=!D&&!!E.t?false:true;x.designer.newElseIf=C;x.designer.page=x.designer.$new&&!D?0:1;x.designer.parent=A;x.designer.devices=E.d;x.designer.not=E.n?"1":"0";x.designer.operator=E.o;x.designer.comparison={type:"condition",left:{data:E.lo?x.copy(E.lo):{},showSubDevices:true},operator:E.co,right:{data:E.ro?x.copy(E.ro):{}},right2:{data:E.ro2?x.copy(E.ro2):{}},time:{data:E.to?x.copy(E.to):{t:"c",c:0},dataType:"duration"},time2:{data:E.to2?x.copy(E.to2):{t:"c",c:0},dataType:"duration"}};x.validateComparison(x.designer.comparison,true);x.designer.smode=E.sm;x.designer.description=E.z;window.designer=x.designer;x.designer.items=[{type:"condition",name:"Condition",icon:"code",cssClass:"btn-info"},{type:"group",name:"Group",icon:"code-fork",cssClass:"btn-warning"}];x.designer.dialog=u.open({template:"dialog-edit-condition",className:"ngdialog-theme-default ngdialog-large",closeByDocument:false,disableAnimation:true,scope:x})};x.fixOperand=function(A){switch(A.vt){case"time":A.c=A.c instanceof Date?A.c.getHours()*60+A.c.getMinutes():A.c;break;case"date":case"datetime":A.c=A.c instanceof Date?A.c.getTime():(new Date(A.c)).getTime();break}return A};x.updateCondition=function(B){x.autoSave();var C=x.designer.$new?{t:x.designer.type}:x.designer.$condition;switch(C.t){case"condition":C.lo=x.fixOperand(x.designer.comparison.left.data);C.co=x.designer.comparison.operator;C.ro=x.fixOperand(x.designer.comparison.right.data);C.ro2=x.fixOperand(x.designer.comparison.right2.data);C.to=x.designer.comparison.time.data;C.to2=x.designer.comparison.time2.data;break;case"group":C.c=C.c?C.c:[];C.o=x.designer.operator;C.n=x.designer.not=="1";break}C.sm=x.designer.smode;C.ts=C.ts?C.ts:[];C.fs=C.fs?C.fs:[];C.z=x.designer.description;if(C.t){C.$$html=null;if(x.designer.$new){if(x.designer.newElseIf){var A={o:"and",n:false,c:[],s:[]};A.c.push(C);x.designer.parent.push(A)}else{if(x.designer.parent instanceof Array){x.designer.parent.push(C)}else{if((x.designer.parent.c)&&(x.designer.parent.c instanceof Array)){x.designer.parent.c.push(C)}else{x.designer.parent.c=[C]}}}}else{x.designer.$condition=C}}x.closeDialog();if(C.t&&B){x.addCondition(C.t=="group"?C:x.designer.parent)}};x.upgradeCondition=function(){x.updateCondition();var B=x.designer.parent;if(x.designer.$condition&&B&&(B instanceof Array)){var A=B.indexOf(x.designer.$condition);if(A>=0){var C={};C.t=x.designer.$condition.t;C.n=x.designer.$condition.n;C.o=x.designer.$condition.o;C.c=x.designer.$condition.c;x.designer.$condition={};x.designer.$condition.t="group";x.designer.$condition.n=false;x.designer.$condition.o="and";x.designer.$condition.c=[C];B[A]=x.designer.$condition}}};x.editConditionGroup=function(B,A){if(x.mode!="edit"){return}x.designer={operator:B.o||"and",not:B.n?"1":"0",description:B.z};x.designer.group=B;x.designer.$obj=B;x.designer.parent=A;window.designer=x.designer;x.designer.dialog=u.open({template:"dialog-edit-condition-group",className:"ngdialog-theme-default ngdialog-large",closeByDocument:false,disableAnimation:true,scope:x})};x.updateConditionGroup=function(){x.autoSave();var A=x.designer.group;A.n=x.designer.not=="1";A.o=x.designer.operator;A.z=x.designer.description;x.closeDialog()};x.addRestriction=function(A){return x.editRestriction(null,A)};x.editRestriction=function(A,B){if(x.mode!="edit"){return}var C=!A;if(!A){A={};A.t=null;A.d=[];A.rn=false;A.rop="and";A.lo={t:"p",d:[],a:null,g:"any",v:null,c:"",x:null,e:""};A.co=null;A.ro={t:"c",d:[],a:null,g:"any",v:null,c:"",x:null,e:""};A.ro2={t:"c",d:[],a:null,g:"any",v:null,c:"",x:null,e:""};A.to={t:"c",d:[],a:null,g:"any",v:null,c:"",x:null,e:""};A.to2={t:"c",d:[],a:null,g:"any",v:null,c:"",x:null,e:""};A.z=""}x.designer={config:x.getExpressionConfig(),clipboard:C?x.getClipboardItems("restriction"):[]};x.designer.$restriction=A;x.designer.$obj=A;x.designer.type=A.t;x.designer.$new=A.t?false:true;x.designer.page=x.designer.$new?0:1;x.designer.parent=B;x.designer.devices=A.d;x.designer.not=A.rn?"1":"0";x.designer.operator=A.rop;x.designer.comparison={type:"restriction",left:{data:A.lo?x.copy(A.lo):{}},operator:A.co,right:{data:A.ro?x.copy(A.ro):{}},right2:{data:A.ro2?x.copy(A.ro2):{}},time:{data:A.to?x.copy(A.to):{t:"c",c:0},dataType:"duration"},time2:{data:A.to2?x.copy(A.to2):{t:"c",c:0},dataType:"duration"}};x.validateComparison(x.designer.comparison,true);x.designer.smode=A.sm;x.designer.description=A.z;window.designer=x.designer;x.designer.items=[{type:"restriction",name:"Restriction",icon:"code",cssClass:"btn-info"},{type:"group",name:"Group",icon:"code-fork",cssClass:"btn-warning"}];x.designer.dialog=u.open({template:"dialog-edit-restriction",className:"ngdialog-theme-default ngdialog-large",closeByDocument:false,disableAnimation:true,scope:x})};x.updateRestriction=function(B){x.autoSave();var A=x.designer.$new?{t:x.designer.type}:x.designer.$restriction;switch(A.t){case"restriction":A.lo=x.fixOperand(x.designer.comparison.left.data);A.co=x.designer.comparison.operator;A.ro=x.fixOperand(x.designer.comparison.right.data);A.ro2=x.fixOperand(x.designer.comparison.right2.data);A.to=x.designer.comparison.time.data;A.to2=x.designer.comparison.time2.data;break;case"group":A.r=A.r?A.r:[];A.rop=x.designer.operator;A.rn=x.designer.not=="1";break}A.z=x.designer.description;if(A.t){A.$$html=null;if(x.designer.$new){if(x.designer.parent instanceof Array){x.designer.parent.push(A)}else{if((x.designer.parent.r)&&(x.designer.parent.r instanceof Array)){x.designer.parent.r.push(A)}else{x.designer.parent.r=[A]}}}else{x.designer.$restriction=A}}x.closeDialog();if(A.t&&B){x.addRestriction(A.t=="group"?A:x.designer.parent)}};x.upgradeRestriction=function(){x.updateRestriction();var C=x.designer.parent;if(x.designer.$restriction&&C&&(C instanceof Array)){var B=C.indexOf(x.designer.$restriction);if(B>=0){var A={};A.t=x.designer.$restriction.t;A.rn=x.designer.$restriction.rn;A.rop=x.designer.$restriction.rop;A.c=x.designer.$restriction.c;x.designer.$restriction={};x.designer.$restriction.t="group";x.designer.$restriction.rn=false;x.designer.$restriction.rop="and";x.designer.$restriction.c=[A];C[B]=x.designer.$restriction}}};x.editRestrictionGroup=function(B,A){if(x.mode!="edit"){return}x.designer={operator:B.rop||"and",not:B.rn?"1":"0",description:B.z};x.designer.group=B;x.designer.$obj=B;x.designer.parent=A;window.designer=x.designer;x.designer.dialog=u.open({template:"dialog-edit-restriction-group",className:"ngdialog-theme-default ngdialog-large",closeByDocument:false,disableAnimation:true,scope:x})};x.updateRestrictionGroup=function(){x.autoSave();var A=x.designer.group;A.rn=x.designer.not=="1";A.rop=x.designer.operator;A.z=x.designer.description;x.closeDialog()};x.addTask=function(A){return x.editTask(null,A)};x.editTask=function(B,C){if(x.mode!="edit"){return}if(!B){B={};B.c="";B.a="0";B.m="";B.z=""}var D=B.c?false:true;x.designer={clipboard:D?x.getClipboardItems("task"):[]};var A=D?x.insertIndexes[C.$$hashkey]:C.k.indexOf(B);if(isNaN(A)){A=C.k.length}x.designer.insertIndex=A;x.designer.$task=B;x.designer.$obj=B;x.designer.$new=D;x.designer.page=0;x.designer.parent=C;x.designer.command=B.c;x.designer.mode=B.m;x.designer.description=B.z;x.prepareParameters(B);window.designer=x.designer;window.scope=x;x.designer.commands=x.listAvailableCommands(C.d);$("a-ckolor-wheel").remove();x.designer.dialog=u.open({template:"dialog-edit-task",className:"ngdialog-theme-default ngdialog-large",closeByDocument:false,disableAnimation:true,scope:x})};x.updateTask=function(E){x.autoSave();var C=x.designer.$new?{}:x.designer.$task;C.c=x.designer.command;C.a=x.designer.async;C.z=x.designer.description;C.m=x.designer.mode;if(C.c){C.$$html=null;C.p=[];for(parameterIndex in x.designer.parameters){var D=x.designer.parameters[parameterIndex].data;if(D.t=="c"){switch(D.vt){case"time":D.c=D.c instanceof Date?D.c.getHours()*60+D.c.getMinutes():D.c;break;case"date":case"datetime":D.c=D.c instanceof Date?D.c.getTime():(new Date(D.c)).getTime();break}}C.p.push(D)}if(x.designer.$new){if((x.designer.parent)&&(x.designer.parent.k instanceof Array)){x.designer.parent.k.push(C);x.insertIndexes[parent.$$hashkey]=x.designer.insertIndex+1}}else{x.designer.$task=C}}var F=x.designer.parent.k;if(F&&F.length){var B=F.indexOf(C);var A=x.designer.insertIndex;if(A>B){A--}if(A>=F.length){A=F.length-1}if(x.designer.insertIndex!=B){F.splice(A,0,F.splice(B,1)[0])}}x.closeDialog();if(E){x.addTask(x.designer.parent)}};x.addVariable=function(){return x.editVariable(null)};x.editVariable=function(A){if(x.mode!="edit"){return}if(!A){A={};A.t="dynamic";A.n="";A.v={data:{}};A.a="d";A.z=""}if(A.v instanceof Array){A.v={data:{}}}x.designer={};x.designer.$variable=A;x.designer.$obj=A;x.designer.$new=A.n?false:true;x.designer.page=0;x.designer.parent=x.piston.v;x.designer.type=A.t;x.designer.assignment=A.a||"d";x.designer.name=A.n;x.designer.operand={data:A.v,multiple:false,dataType:A.t,optional:true};x.designer.description=A.z;window.designer=x.designer;window.scope=x;x.validateOperand(x.designer.operand);x.designer.dialog=u.open({template:"dialog-edit-variable",className:"ngdialog-theme-default ngdialog-large",closeByDocument:false,disableAnimation:true,scope:x});x.refreshSelects()};x.updateVariable=function(C){x.autoSave();var A=x.designer.$new?{}:x.designer.$variable;A.t=x.designer.operand.dataType;A.n=x.designer.name.trim().replace(/[^a-z0-9]|\s+|\r?\n|\r/gmi,"_");A.z=x.designer.description;A.a=x.designer.assignment;var B=x.fixOperand(x.designer.operand.data);switch(B.t){case"":A.v=null;break;default:A.v=B;break}A.$$html=null;if(x.designer.$new){x.piston.v.push(A)}else{x.designer.variable=A}x.closeDialog();if(C){x.addVariable()}};x.addGlobalVariable=function(){return x.editGlobalVariable(null)};x.editGlobalVariable=function(B){if(x.mode!="edit"){return}var A=x.globalVars[B];if(!A){A={t:"dynamic",v:""}}x.designer={};x.designer.$variableName=B;x.designer.$variable=A;x.designer.$obj=A;x.designer.$new=B?false:true;x.designer.name=B?""+B:"@";x.designer.type=A.t;x.designer.operand={data:{t:!A.v?"":(A.t=="device"?"d":"c"),c:A.v,d:A.v},multiple:false,dataType:A.t,optional:true,onlyAllowConstants:true};window.designer=x.designer;window.scope=x;x.validateOperand(x.designer.operand);x.designer.dialog=u.open({template:"dialog-edit-global-variable",className:"ngdialog-theme-default ngdialog-large",closeByDocument:false,disableAnimation:true,scope:x})};x.updateGlobalVariable=function(C){x.autoSave();var A=x.designer.$new?{}:x.designer.$variable;A.t=x.designer.operand.dataType;A.n=x.designer.name.trim().replace(/[^@a-z0-9]|\s+|\r?\n|\r/gmi,"_");var B=x.designer.operand.data;switch(B.t){case"":A.v=A.t=="device"?[]:null;break;case"c":A.v=B.c?B.c:"";break;case"d":A.v=B.d?B.d:[];break;default:A.v=null;break}delete (A.$$html);v.setVariable(x.designer.$variableName,A).then(function(D){if(D&&D.globalVars){x.updateGlobalVars(D.globalVars)}});x.closeDialog();if(C){x.addGlobalVariable()}};x.deleteGlobalVariable=function(){if((!x.designer)||(!x.designer.$variableName)){return}v.setVariable(x.designer.$variableName,null).then(function(A){if(A&&A.globalVars){x.updateGlobalVars(A.globalVars)}});x.closeDialog()};x.validateGlobalVariableName=function(){if(!x.designer){return false}var A=x.designer.name;if(!A){return false}if(!A.startsWith("@")){A="@"+A}while(A.startsWith("@@@")){A=A.substr(1)}if(x.designer.name!=A){x.designer.name=A}return A&&(A!="@")&&(A!="@@")&&((x.designer.$variableName==A)||!(x.globalVars[A]))};x.getDeviceAttributeValue=function(C,B){for(i in C.a){if(C.a[i].n==B){var A={v:C.a[i].v,t:C.a[i].v};if(A.v==undefined){A.v=""}if((B=="battery")&&(!isNaN(A.v))){A.t=A.t+"%";A.v=Math.floor(parseInt(A.v)/20);if(A.v>4){A.v=4}}if((B=="temperature")&&(!isNaN(A.v))){A.v=Math.round(parseFloat(A.v)).toString()+"°";A.t=A.v}return A}}return{v:"",t:""}};x.renderDevice=function(C){var E=x.getDeviceAttributeValue(C,"switch");var E=E?'class="fa fa-toggle-off" switch="'+E+'"':"";var B=["temperature","battery","switch","motion","presence"];var A="<div col>"+C.n+"</div>";for(a in B){var D=x.getDeviceAttributeValue(C,B[a]);A+="<div col "+B[a]+'="'+D.v+'" title="'+D.t+'"></div>'}return r.trustAsHtml(A)};x.drag=function(B,A){B.splice(A,1)};x.setDesignerType=function(A){x.designer.type=A;x.nextPage();if(x.designer.ontypechanged){x.designer.ontypechanged(x.designer,A)}};x.closeDialog=function(){x.saveStack();if(x.designer.dialog){x.designer.dialog.close();x.designer.dialog=null}};x.nextPage=function(){x.designer.page++;x.refreshSelects()};x.prevPage=function(){if(x.designer.page){x.designer.page--}};x.selectTaskIndex=function(A){if(x.designer){x.designer.insertIndex=A}};x.initLineNumbers=function(){s.lineNumber=0};x.getLineNumber=function(){return s.lineNumber};x.mergeObjects=function(D,C){if(Object.assign){return Object.assign(D,C)}var A={};for(var B in D){A[B]=D[B]}for(var B in C){A[B]=C[B]}return A};x.clearLogs=function(){x.logs=[]};x.prepareParameters=function(A){x.designer.parameters=[];var E=x.db.commands.physical[x.designer.command]||x.db.commands.virtual[x.designer.command];x.designer.parameters=[];x.designer.custom=false;if(E){for(parameterIndex in E.p){var F=x.copy(E.p[parameterIndex]);var C={data:{},name:F.n,dataType:F.t.toLowerCase(),multiple:false,optional:((F.t!="bool")&&(F.t!="boolean"))&&!!F.d,options:F.o,strict:!!F.s};var B=x.getAttributeById(F.t);if(B){C.attribute=B;C.dataType=B.t;C.allowMuliple=false;C.options=B.o}if(A&&A.p&&(A.p.length>parameterIndex)){C.data=x.copy(A.p[parameterIndex])}x.validateOperand(C);x.designer.parameters.push(C)}}else{x.designer.custom=!!x.designer.command;for(i in A.p){var D={dataType:A.p[i].vt,data:x.copy(A.p[i])};x.validateOperand(D);x.designer.parameters.push(D)}}if(x.designer.command=="setVariable"){x.designer.parameters[0].linkedOperand=x.designer.parameters[1];x.validateOperand(x.designer.parameters[0])}x.refreshSelects()};x.renameParameters=function(){if(!x.designer.custom){return}for(i in x.designer.parameters){x.designer.parameters[i].name="Parameter #"+(parseInt(i)+1).toString()+" ("+x.designer.parameters[i].dataType+")"}x.refreshSelects()};x.addParameter=function(A){if(!x.designer.custom){return}var B={dataType:A,name:"",data:{t:"c"}};x.validateOperand(B);x.designer.parameters.push(B);x.renameParameters()};x.deleteParameter=function(B){if(!x.designer.custom){return}var A=x.designer.parameters.indexOf(B);if(A>-1){x.designer.parameters.splice(A,1)}x.renameParameters()};x.getParameterInputType=function(A){switch(A.t){case"color":case"duration":case"enum":case"boolean":return A.t;case"number":return Math.abs(A.M-A.m)>360?"number":"range"}return"text"};x.getParameterMin=function(A){switch(A.t){case"level":case"saturation":case"hue":return 0;case"colorTemperature":return 1500}return null};x.getParameterMax=function(A){switch(A.t){case"level":case"saturation":return 100;case"hue":return 360;case"colorTemperature":return 10000}return null};x.getContactById=function(A){return x.instance.contacts[A]};x.getRoutineById=function(A){if(x.instance.virtualDevices.routine&&x.instance.virtualDevices.routine.o){return x.instance.virtualDevices.routine.o[A]}return null};x.getLocationModeById=function(A){if(x.instance.virtualDevices.mode&&x.instance.virtualDevices.mode.o){return x.instance.virtualDevices.mode.o[A]}return null};x.getDeviceById=function(A){if(A==x.location.id){return{id:A,n:x.location.name,an:"Location"}}return x.instance.devices[A]};x.getDeviceByName=function(A){for(deviceIndex in x.instance.devices){if(x.instance.devices[deviceIndex].n==A){return mergeObjects({id:deviceIndex},x.instance.devices[deviceIndex])}}return null};x.getVirtualDeviceById=function(A){if(A==x.location.id){return{id:A,name:x.location.name}}return x.instance.virtualDevices[A]};x.getCapabilityById=function(A){return x.db.capabilities[A]};x.getCapabilityByName=function(A){for(capabilityIndex in x.db.capabilities){if(x.db.capabilities[capabilityIndex].n==A){return mergeObjects({id:capabilityIndex},x.db.capabilities[capabilityIndex])}}return null};x.getCommandById=function(A){return x.db.commands.physical[A]||x.db.commands.virtual[A]};x.getCommandByName=function(A){for(commandIndex in x.db.commands.physical){if(x.db.commands.physical[commandIndex].n==A){return mergeObjects({id:commandIndex},x.db.commands.physical[commandIndex])}}for(commandIndex in x.db.commands.virtual){if(x.db.commands.virtual[commandIndex].n==A){return mergeObjects({id:commandIndex},x.db.commands.virtual[commandIndex])}}return null};x.getAttributeById=function(A){return x.db.attributes[A]};x.getAttributeByName=function(A){for(attributeIndex in x.db.attributes){if(x.db.attributes[attributeIndex].n==A){return x.db.attributes[attributeIndex]}}return null};x.getDeviceAttributeById=function(B,A){if(!B){return null}for(i in B.a){if(B.a[i].n==A){return B.a[i]}}return null};x.buildName=function(B,E,A,D){if((B==null)||(B==undefined)){return""}if(B instanceof Array){return x.buildNameList(B,"or","","",false,E,A,D)}if(A||(B.length==34)){for(deviceId in x.instance.virtualDevices){var C=x.instance.virtualDevices[deviceId];if(C.o){for(id in C.o){E=E||!A;if(B==id){return(!E?"'":"")+C.o[id]+(!E?"'":"")}}}}}return(!E?"'":"")+(D?D:"")+B+(!E?"'":"")};x.buildNameList=function(F,I,M,G,A,C,H,J){var B=1;var L="";for(i in F){var E="";var D=F[i];if(D instanceof Object){M=D.t?D.t:M;E=D.a?D.a:"[unknown]";D=D.n}var K=x.buildName(D,C,H,J);L+="<span "+(M?M:"")+(E?' an="'+E+'"':"")+(G?' class="'+G+'"':"")+">"+K+"</span>"+(A?"'"+(K.substr(-1)=="s"?"":"s"):"")+(B<F.length?"<span pun>"+(B==F.length-1?(F.length>2?", ":" ")+I+" ":", ")+"</span>":"");B++}return L.trim()};x.buildLocationModeNameList=function(B){var A=[];if(B instanceof Array){for(modeIndex in B){A.push(x.getModeName(B[modeIndex]))}if(A.length){return x.buildNameList(A,"or","lit","",false,true)}}return""};x.buildDeviceNameList=function(A){var C=[];if(A instanceof Array){for(deviceIndex in A){var B=x.getDeviceById(A[deviceIndex]);if(B){C.push({n:B.n,a:B.an,t:"dev"})}else{C.push({n:"{"+A[deviceIndex]+"}",t:"var"})}}if(C.length){return x.buildNameList(C,"and","dev","",false,true)}}return"Location"};x.buildContactNameList=function(C){var B=[];if(C instanceof Array){for(contactIndex in C){var A=x.getContactById(C[contactIndex]);if(A){B.push({n:(A.f+" "+A.l).trim()+" ("+A.t+"/"+(A.p?"PUSH":"SMS")+")",a:A.an,t:"cnt"})}else{B.push({n:"{"+C[contactIndex]+"}",a:A.an,t:"var"})}}if(B.length){return x.buildNameList(B,"and","cnt","",false,true)}}return"(empty)"};x.formatHour=function(A){return(!location.timeZone||location.timeZone.id.startsWith("America"))?((A%12?A%12:"12")+(A<12?"am":"pm")):("00"+A).substr(-2)};x.renderDeviceNameList=function(A){return r.trustAsHtml(x.buildDeviceNameList(A))};x.renderContactNameList=function(A){return r.trustAsHtml(x.buildContactNameList(A))};x.hasCommand=function(B,A){if(!B||!B.c){return false}return x.hasName(B.c,A)};x.hasName=function(B,A){if(!B||!B.length){return false}for(obj in B){if(B[obj]&&(B[obj].n===A)){return true}}return false};x.hasId=function(A,B){if(!A||!A.length){return false}for(obj in A){if(A[obj]&&(A[obj].id===B)){return true}}return false};x.listAvailableCommands=function(K){var C={};var H=K.length;for(deviceIndex in K){var D=K[deviceIndex]||"";var A=[];var J=false;if(D.startsWith(":")){var B=x.getDeviceById(K[deviceIndex]);A=B.c}else{J=true;A=x.db.commands.physical}for(commandIndex in A){var F=J?commandIndex:A[commandIndex].n;if(C[F]){C[F]+=1}else{C[F]=1}}}var L={common:[],partial:[],virtual:[]};for(F in C){var E=x.db.commands.physical[F];if(!E){E={n:F+"(..)",cm:true}}if(C[F]==H){L.common.push(mergeObjects({id:F},E))}else{L.partial.push(mergeObjects({id:F},E))}}for(F in x.db.commands.virtual){var E=x.db.commands.virtual[F];if(E.r){var G=0;for(deviceIndex in K){var D=K[deviceIndex]||"";var I=false;if(D.startsWith(":")){var B=x.getDeviceById(K[deviceIndex]);I=!!B;if(I){for(req in E.r){if(!x.hasCommand(B,E.r[req])){I=false;break}}}}else{I=true}if(I){G++}}if(G>0){if(G==H){if(!x.hasId(L.common,F)){L.common.push(mergeObjects({id:F,em:true},E))}}else{if(!x.hasId(L.partial,F)){L.partial.push(mergeObjects({id:F,em:true},E))}}}}else{L.virtual.push(mergeObjects({id:F},E))}}L.common.sort(x.sortByName);L.partial.sort(x.sortByName);L.virtual.sort(x.sortByName);return L};x.listAvailableDevices=function(){var A=[];for(deviceIndex in x.instance.devices){var B=x.instance.devices[deviceIndex];var C="";for(i in B.a){C+=":"+B.a[i].n+" "}A.push(mergeObjects({id:deviceIndex,tokens:C+B.n},B))}return A.sort(x.sortByName)};x.listAvailableVirtualDevices=function(){var A=[];for(deviceIndex in x.instance.virtualDevices){var B=x.instance.virtualDevices[deviceIndex];A.push(mergeObjects({id:deviceIndex},B))}return A.sort(x.sortByName)};x.escapeRegExp=function(A){return A};x.listAutoCompleteFunctions=function(){var A=[];for(functionIndex in x.db.functions){A.push((x.db.functions[functionIndex].d?x.db.functions[functionIndex].d:functionIndex)+"(")}return A.sort()};x.listAutoCompleteDevices=function(){var A=[];for(deviceIndex in x.instance.devices){var B=x.instance.devices[deviceIndex];A.push(x.escapeRegExp("["+B.n+" :"))}return A.sort()};x.listAutoCompleteVariables=function(){var A=[];for(varIndex in x.piston.v){var B=x.piston.v[varIndex];A.push(x.escapeRegExp(B.n))}if(x.systemVars){for(varName in x.systemVars){A.push(x.escapeRegExp(varName))}}if(x.globalVars){for(varName in x.globalVars){A.push(x.escapeRegExp(varName))}}return A.sort()};x.getVariableByName=function(A){if(x.systemVars&&x.systemVars[A]){return x.systemVars[A]}if(x.globalVars&&x.globalVars[A]){return x.globalVars[A]}for(varIndex in x.piston.v){if(x.piston.v[varIndex].n==A){return x.piston.v[varIndex]}}return null};x.getVariableValue=function(B,C){if(x.localVars){var A=x.localVars[B];if(A!=undefined){if(C=="datetime"){return utcToString(A)}return""+A}}return"(not set)"};x.autoAddVariable=function(B){if(!B){return false}B=B?B.trim():"";var A=x.getVariableByName(B);x.piston.v.push({t:"dynamic",n:B})};x.hasAttribute=function(B,A){for(a in B.a){if(B.a[a].n==A){return true}}return false};x.listAvailableAttributes=function(C,H){var A=[];var F=null;if(C&&C.length){var B={};var D=C.length;for(deviceIndex in C){F=x.getDeviceById(C[deviceIndex]);if(F){for(attributeIndex in F.a){var E=F.a[attributeIndex];if(!H||(E.n==H)){if(B[E.n]){B[E.n]+=1}else{B[E.n]=1}}}}else{for(attributeName in x.db.attributes){if(!H||(attributeName==H)){if(B[attributeName]){B[attributeName]+=1}else{B[attributeName]=1}}}}}for(attributeId in B){if(B[attributeId]==D){var E=x.getAttributeById(attributeId);if(E){A.push(mergeObjects({id:attributeId},E))}else{for(a in F.a){if(F.a[a].n==attributeId){E=F.a[a];break}}if(E){var G=mergeObjects({id:attributeId,c:true},E);G.n="⌂ "+G.n;G.t=(G.t||"string").toLowerCase().replace("number","decimal");A.push(G)}}}}A.sort(x.sortByName)}return A};x.sortByDisplay=function(B,A){return(B.d>A.d)?1:((A.d>B.d)?-1:0)};x.sortByName=function(B,A){B=B.n.toLowerCase();A=A.n.toLowerCase();return(B>A)?1:((A>B)?-1:0)};x.getStackData=function(){var A=angular.toJson(x.compilePiston(x.piston));return{hash:x.md5(A),timestamp:(new Date()).getTime(),data:angular.fromJson(A)}};x.autoSave=function(A){var B=A?false:true;A=A?A:x.stack.undo;pushToStack=true;var C=x.getStackData();if(A&&A.length){if(C.hash==A[A.length-1].hash){pushToStack=false}}if(pushToStack){A.push(C);if(A.length>MAX_STACK_SIZE){A=A.slice(-MAX_STACK_SIZE)}}if(B){x.stack.redo=[]}};x.objectToArray=function(B){var A=[];for(property in B){A.push({v:property,n:B[property]})}return A};x.saveStack=function(A){x.stack.current=x.getStackData();if(A){x.stack.current.timestamp=0}x.stack.build=x.meta.build;v.saveToStore("stack"+x.pistonId,x.stack)};x.loadStack=function(){x.stack=v.loadFromStore("stack"+x.pistonId);x.stack=x.stack instanceof Object?x.stack:{};x.stack.undo=(x.stack.undo instanceof Array?x.stack.undo:[]);x.stack.redo=(x.stack.redo instanceof Array?x.stack.redo:[]);if(x.stack.current instanceof Object&&x.stack.current.data&&(x.stack.build==x.meta.build)&&(x.meta.modified<x.stack.current.timestamp)){x.setStatus();x.dialogChooseVersion()}else{}};x.dialogChooseVersion=function(){x.designer.dialog=u.open({template:"dialog-choose-version",className:"ngdialog-theme-default ngdialog-large",closeByDocument:false,disableAnimation:true,scope:x})};x.chooseVersion=function(A){if(A){x.piston=x.stack.current.data}else{x.autoSave()}x.closeDialog()};x.undo=function(){if(x.stack&&x.stack.undo&&x.stack.undo.length){x.autoSave(x.stack.redo);x.stack.current=x.stack.undo.pop();x.piston=x.stack.current.data;x.saveStack()}};x.redo=function(){if(x.stack&&x.stack.redo&&x.stack.redo.length){x.autoSave(x.stack.undo);x.stack.current=x.stack.redo.pop();x.piston=x.stack.current.data;x.saveStack()}};x.localTimeToDate=function(B){B=B?B:0;var A=new Date();A.setHours(Math.floor(B/60));A.setMinutes(B%60);A.setSeconds(0);A.setMilliseconds(0);return A};x.validateOperand=function(R,A,Q){if(!!x.designer.comparison&&!Q){x.validateComparison(x.designer.comparison,A);return}R=R||{};if(!R.initialized||A){R.data=R.data||{};R.data.a=R.data.a||"";R.data.c=(R.data.c==undefined)||(R.data.c==null)?"":R.data.c;R.data.v=R.data.v||"";R.data.e=R.data.e||"";R.data.x=R.data.x||"";R.data.d=R.data.d||[];R.data.g=R.data.g||(R.multiple?"any":"avg");R.data.f=R.data.f||"l";R.options=R.options||[]}if(true||!R.initialized||A){var N=(R.dataType||"string").toLowerCase();if(N=="variables"){R.multiple=true;N="variable"}if(N=="devices"){R.multiple=true;N="device"}if(N=="pistons"){R.multiple=true;N="piston"}if(N=="routines"){R.multiple=true;N="routine"}if(N=="modes"){R.multiple=true;N="mode"}if(N=="alarmsystemstatus"){N="alarmSystemStatus"}if(N=="alarmsystemstatuses"){R.multiple=true;N="alarmSystemStatus"}if(N=="modes"){R.multiple=true;N="mode"}if(N=="enums"){R.multiple=true;N="enum"}if(N=="contacts"){R.multiple=true;N="contact"}if(N=="number"){N="decimal"}if(N=="bool"){N="boolean"}if((N=="enum")&&!R.options&&!R.options.length){N="string"}if(R.data.t==null){var I="";if(!R.optional){I=N=="variable"?"x":"c";if((x.designer.$condition)||(x.designer.$restriction)){I="p"}}R.data.t=I}switch(R.data.vt){case"time":if(!(R.data.c instanceof Date)){if(R.data.c!=undefined){R.data.c=x.localTimeToDate(R.data.c)}}break;case"date":case"datetime":if(!(R.data.c instanceof Date)){R.data.c=new Date(R.data.c);if(R.data.c=="Invalid Date"){R.data.c=new Date()}}break}R.onlyAllowConstants=R.onlyAllowConstants||(N=="piston")||(N=="routine")||(N=="askAlexaMacro");var T=!!R.strict;if(R.onlyAllowConstants||(N=="contact")){R.allowArgument=false;R.allowDevices=(N=="device");R.allowPhysical=false;R.allowVirtual=false;R.allowConstant=(N!="device");R.allowVariable=false;R.allowExpression=false}else{R.allowDevices=N=="device";R.allowPhysical=(N!="datetime")&&(N!="date")&&(N!="time")&&(N!="device")&&(N!="variable")&&(!T||(N!="boolean"))&&(N!="duration");R.allowPreset=(!R.event)&&(N=="datetime")||(N=="time")||(N=="color");R.allowVirtual=(!R.event)&&(N!="datetime")&&(N!="date")&&(N!="time")&&(N!="device")&&(N!="variable")&&(N!="decimal")&&(N!="integer")&&(N!="number")&&(N!="boolean")&&(N!="enum")&&(N!="color")&&(N!="duration");R.allowVariable=(N!="device"||((N=="device")&&R.multiple))&&(!T||(N!="boolean"));R.allowConstant=(!R.event)&&(N!="device")&&(N!="variable");R.allowArgument=(!R.event)&&(N!="device")&&(N!="variable");R.allowExpression=(!R.event)&&(N!="variable")&&(N!="enum")&&(!T||(N!="boolean"))}if(((R.data.t=="p")&&(!R.allowPhysical))||((R.data.t=="v")&&(!R.allowVirtual))){R.data.t="c"}if(!R.config){R.config=x.copy(x.getExpressionConfig());R.config.autocomplete[5].words=[/([0-9]+)(\.[0-9]+)?/g]}R.restrictAttribute=null;R.restrictType=null;switch(N){case"color":R.restrictAttribute="color";break;case"device":R.restrictType="device";break;case"integer":R.restrictType="integer";break;case"decimal":R.restrictType="integer,decimal";break;case"time":R.restrictType="datetime,time";break;case"date":case"datetime":R.restrictType="datetime,date";break}R.dataType=N;R.durationUnit=R.durationUnit||R.data.vt||"s";R.data.vt=N=="duration"?R.durationUnit:N}switch(N){case"enum":break;case"bool":case"boolean":R.options=["false","true"];break;case"mode":case"alarmSystemStatus":case"routine":R.options=x.objectToArray(x.instance.virtualDevices[N].o);break;case"piston":R.options=x.listAllPistons();break;case"contact":R.options=x.contacts;break;case"integer":case"decimal":case"duration":if((R.data.t=="c")&&(isNaN(R.data.c)||(R.data.c==""))){R.data.c=0}default:R.options=null}if((!R.multiple)&&(R.options)&&(R.options.length)&&(R.data.t=="c")){if(R.options[0] instanceof Object){var G=false;for(i in R.options){if(R.options[i].v==R.data.c){G=true;break}}if(!G){R.data.c=R.options[0].v}}else{if(R.options.indexOf(R.data.c)<0){R.data.c=R.options[0]}}}R.initialized=true;R.allowAggregation=true;R.allowAll=true;R.attributes=(R.data.t=="p")?x.listAvailableAttributes(R.data.d,R.restrictAttribute):[];R.valid=false;R.selectedMultiple=(R.data.t=="p")&&R.data.d&&(R.data.d.length>1)&&((R.data.g=="all")||(R.data.g=="any"));R.error=null;R.momentary=false;R.selectedDataType="string";R.selectedOptions=[];switch(R.data.t){case"p":var H=x.db.attributes[R.data.a];if(!H){if(R.data.d.length){var P=x.getDeviceById(R.data.d[0]);if(P){for(a in P.a){if(P.a[a].n==R.data.a){H=P.a[a];break}}}}}if(H){R.momentary=H.m;R.count=0;if(R.momentary&&!!H.s){var K=H.s.split(",");for(deviceIndex in R.data.d){var D=x.getDeviceById(R.data.d[deviceIndex]);var S=0;if(D){for(i in K){var L=x.getDeviceAttributeById(D,K[i]);if((L)&&(!isNaN(L.v))){S=parseInt(L.v);if(S>R.count){R.count=S}}}}else{if(R.count<32){R.count=32}}}}if(R.count){if((R.data.i==null)||(R.data.i==undefined)){R.data.i=["1"]}x.refreshSelects()}R.selectedDataType=H.t.toLowerCase();R.selectedOptions=H.o;if(R.momentary){R.allowAll=false;R.allowAggregation=false}}else{R.selectedDataType="string"}if(R.data.d&&(R.data.d.length>1)){if(!R.data.g){R.error="Invalid aggregation method"}if(!(["any","all","least","most"].indexOf(R.data.g)>=0)){R.selectedDataType="decimal"}}break;case"v":var M=x.instance.virtualDevices[R.data.v];R.selectedDataType=(!!M&&!!M.t)?M.t:"string";if(M){R.momentary=M.m;for(o in M.o){R.selectedOptions.push({v:o,n:M.o[o]})}}break;case"x":if(R.data.x instanceof Array){if(R.data.x.length){R.selectedDataType="dynamic"}else{R.error="Invalid list of variables"}}else{var O=x.getVariableByName(R.data.x);if(O){R.selectedDataType=O.t;if(R.selectedDataType=="boolean"){R.selectedOptions=["false","true"]}}else{R.error="Invalid variable"}}break;case"u":R.selectedDataType="dynamic";break;case"c":var J=x.parseString(R.data.c,R.data.vt);R.error=J.err;R.expressionVar=J.errVar;R.data.exp=J;if(!R.options){if(!R.optional&&!R.data.c&&(R.requirePositiveNumber)){R.error="Empty value";R.expressionVar=""}}else{if((R.data.c==null)||(R.data.c==undefined)){R.error="Invalid selection";R.expressionVar=""}}R.selectedDataType=R.dataType;break;case"e":var J=x.parseExpression(R.data.e,false,R.data.vt);R.error=J.err;R.expressionVar=J.errVar;if(J.err){var F=(J.loc?J.loc:"0:"+(J.str.length-1).toString()).split(":");var E=parseInt(F[0]);var C=F.length==2?parseInt(F[1]):E;R.config.autocomplete[0]={words:[new RegExp(".(?=.{"+(J.str.length-E-1)+"}$).{"+(C-E)+"}")],cssClass:"hl err",title:J.err}}else{R.config.autocomplete[0]={words:[],cssClass:"hl err"}}R.data.exp=J;R.selectedDataType="dynamic";break}if((!R.error)&&(R.dataType=="duration")&&(!R.durationUnit)){R.error="Invalid duration unit"}if((!R.error)&&R.count&&(!R.data.i||!R.data.i.length)){R.error="Invalid sub device selection"}R.valid=(!R.error)&&(((R.data.t=="")&&(R.optional))||((R.data.t=="d")&&!!R.data.d&&!!R.data.d.length)||((R.data.t=="p")&&!!R.data.d&&!!R.data.d.length&&!!R.data.a)||((R.data.t=="v")&&!!R.data.v)||((R.data.t=="x")&&!!R.data.x&&!!R.data.x.length)||((R.data.t=="s")&&!!R.data.s)||((R.data.t=="u")&&!!R.data.u)||((R.data.t=="c")&&!((R.data.c=="Invalid Date")&&(R.data.c instanceof Object))&&!((N=="duration")&&(isNaN(R.data.c)||(R.requirePositiveNumber&&(R.data.c<1)))))||((R.data.t=="e")&&!!R.data.e&&!!R.data.e.length));switch(R.dataType){case"integer":R.inputType="number";try{R.data.c=parseInt(R.data.c)}catch(B){R.data.c=0}break;case"duration":case"decimal":R.inputType="number";try{R.data.c=parseFloat(R.data.c)}catch(B){R.data.c=0}break;default:R.inputType=R.dataType}if(R.linkedOperand){R.linkedOperand.dataType=R.selectedDataType;R.linkedOperand.options=R.selectedOptions;x.validateOperand(R.linkedOperand,true);x.refreshSelects()}};x.refreshSelects=function(A){console.log("refresh!");if(A){x.$$postDigest(function(){$("select["+A+"]").selectpicker("refresh");g(function(){$("select["+A+"]").selectpicker("refresh")},0,false)})}else{x.$$postDigest(function(){$("select").selectpicker("refresh");g(function(){$("select").selectpicker("refresh")},0,false)})}};x.getOrdinalSuffix=function(C){if(isNaN(C)){return""}C=parseInt(C);var A=C%100;var B=C%10;if(((A>3)&&(A<21))||(B==0)||(B>3)){return"th"}switch(B){case 1:return"st";case 2:return"nd";case 3:return"rd"}return"th"};x.getOrdinal=function(A){if(isNaN(A)){return""}A=parseInt(A);switch(A){case -3:return"third-last";case -2:return"second-last";case -1:return"last"}return A+x.getOrdinalSuffix(A)};x.listODM=function(){var A=x.designer.odm;var B=(!x.designer.operand.data.odw||(x.designer.operand.data.odw=="d"))?31:5;if(!A||(A.length!=(B+3))){A=[];for(i=1;i<=B;i++){A.push({v:i,n:i+x.getOrdinalSuffix(i)})}A.push({v:-1,n:"last"});A.push({v:-2,n:"second-last"});A.push({v:-3,n:"third-last"});x.designer.odm=A}return A};x.listODW=function(){var A=x.designer.odw;var B=(x.designer.operand.data.odm>5)?0:7;if(!A||(A.length!=(B+1))){A=[];A.push({v:"d",n:"day"});if(B){for(i in x.weekDays){A.push({v:i.toString(),n:x.weekDays[i]})}}x.designer.odw=A}return A};x.validateComparison=function(J,B){x.validateOperand(J.left,B,true);if((J.left.selectedDataType!=J.dataType)||(J.left.selectedMultiple!=J.selectedMultiple)||(J.left.momentary!=J.momentary)||(J.left.data.t=="v")){J.dataType=J.left.selectedDataType;J.selectedMultiple=J.left.selectedMultiple;J.momentary=J.left.momentary;var H=(J.left.data.t!="p")||((J.left.data.g!="any")&&(J.left.data.g!="all"));var A=(J.type=="restriction");var G=[];var K=[];if(!J.dataType){J.dataType="dynamic"}switch(J.dataType){case"enum":dt="s";break;case"dynamic":dt="";break;case"time":case"date":case"datetime":dt="t";break;default:dt=J.dataType.substr(0,1)}dt=(J.momentary?(J.left.data.t=="v"?"v":"m"):((dt=="n"?"d":dt)));for(conditionId in x.db.comparisons.conditions){var E=x.db.comparisons.conditions[conditionId];if(((!dt&&(E.g!="m"))||(E.g.indexOf(dt)>=0))&&(!H||!E.t)){K.push({id:conditionId,d:(J.selectedMultiple?(E.dd?E.dd:E.d):E.d),c:"Conditions"})}}G=G.concat(K.sort(x.sortByDisplay));if(!A){K=[];for(triggerId in x.db.comparisons.triggers){var C=x.db.comparisons.triggers[triggerId];if(C.g.indexOf(dt)>=0){K.push({id:triggerId,d:(J.selectedMultiple?(C.dd?C.dd:C.d):C.d),c:"Triggers"})}}G=G.concat(K.sort(x.sortByDisplay))}J.options=G}var F=x.db.comparisons.conditions[J.operator]||x.db.comparisons.triggers[J.operator];J.operatorValid=!!F;J.parameterCount=F&&F.p?F.p:0;J.multiple=F&&F.m?true:false;J.valid=J.left.valid&&J.operatorValid;J.timed=F?F.t:0;if(J.parameterCount>0){J.right.multiple=J.multiple;J.right.disableAggregation=J.multiple;J.right.dataType=J.left.selectedDataType;if(angular.toJson(J.right.options)!=angular.toJson(J.left.selectedOptions)){if((J.right.data.t=="c")&&J.right.options&&J.right.options.length&&(!J.left.selectedOptions||!J.left.selectedOptions.left)){J.right.data.c=""}J.right.options=J.left.selectedOptions}x.validateOperand(J.right,B,true);J.valid=J.valid&&J.right.valid}if(J.parameterCount>1){J.right2.multiple=J.multiple;J.right2.disableAggregation=J.multiple;J.right2.dataType=J.left.selectedDataType;if(angular.toJson(J.right2.options)!=angular.toJson(J.left.selectedOptions)){J.right2.options=J.left.selectedOptions}x.validateOperand(J.right2,B,true);J.valid=J.valid&&J.right2.valid}var D=(J.timed>0);var I=false;if(J.left.selectedDataType=="time"){D=D||(J.right.data.t!="c");I=(J.right2.data.t!="c")}if(D){J.time.requirePositiveNumber=!!J.timed;x.validateOperand(J.time,B,true);J.valid=J.valid&&J.time.valid}if(I){J.time2.requirePositiveNumber=false;J.time2.dataType="duration";x.validateOperand(J.time2,B,true);J.valid=J.valid&&J.time2.valid}};x.detectDataType=function(A){switch(typeof A){case"string":if(!isNaN(parseFloat(A))){return"number"}return"string";case"number":return"number";default:return"string"}};x.renderOperand=function(F,E,H,B){var I="";if(F){switch(F.t){case"d":if(F.d){I=x.buildDeviceNameList(F.d)}break;case"p":if(F.d&&F.a){I=x.renderDeviceList(F.d,F.a,F.g,true)+" <span attr>"+F.a+"</span>"}break;case"v":var A=x.getVirtualDeviceById(F.v);I="<span vdev>"+(A?A.n:"(invalid virtual device)")+"</span>";break;case"s":if(F.s){I="<span num>"+F.s+"</span>"}break;case"x":if(F.x){I="<span var>{"+F.x+"}</span>"}break;case"c":var D="num";E=E||!isNaN(F.c);switch(F.vt){case"time":var C=x.localTimeToDate(F.c);I="<span num>"+C.toLocaleTimeString({hour:"2-digit",minute:"2-digit"})+"</span>";break;case"date":I="<span num>"+utcToDateString(F.c)+"</span>";break;case"datetime":I="<span num>"+utcToString(F.c)+"</span>";break;case"piston":I="<span lit>"+x.getPistonName(F.c)+"</span>";break;case"phone":I="<span phn>"+F.c+"</span>";break;case"uri":I="<span uri>"+F.c+"</span>";break;case"contact":I=x.renderContactNameList(F.c);break;default:if(!E){if((F.vt=="boolean")||(F.vt=="enum")){E=true}D="lit"}var G=F.c;if(B&&!isNaN(G)&&parseInt(G)<0){G=-parseInt(G)}I="<span "+D+">"+scope.buildName(G,E,H)+"</span>"}break;case"u":I=I+"<span var>{$args."+F.u+"}</span>";break;case"e":if(F.e){I="<span exp>{"+F.e+"}</span>"}break}}I=I?I:'<span nul class="nul">(empty)</span>';return(I instanceof Object)?I:r.trustAsHtml(I)};x.renderForOperands=function(B){var A;A="<span var>"+(B.x?B.x:"$index")+"</span> <span pun>=</span> <span num>"+x.renderOperand(B.lo)+" <span kwd>to</span> "+x.renderOperand(B.lo2)+" <span kwd>step</span> "+x.renderOperand(B.lo3);return r.trustAsHtml(A?A:"(invalid operands)")};x.renderForEachOperands=function(B){var A;A="<span var>"+(B.x?B.x:"$device")+"</span> <span pun>in</span> <span num>"+x.renderOperand(B.lo);return r.trustAsHtml(A?A:"(invalid operands)")};x.renderTimeOperand=function(C){if(!C){return""}var A=(C.t=="c");var B=A&&!isNaN(C.c)?parseInt(C.c):0;if(A&&(B==0)){return""}return x.renderOperand(C,false,false,true)+" <span lit>"+x.getDurationUnitName(C.vt,(B!=1))+"</span> <span pun>"+(B<0?"to":"past")+" </span> "};x.renderComparison=function(P,M,J,Q,B,R){var W=x.db.comparisons.triggers[M];var I=!!W;if(!W){W=x.db.comparisons.conditions[M]}if(!W){return"[ERROR: Invalid comparison]"}var C=P.t=="v";var L=P&&(P.t=="p")&&P.d&&(P.d.length>1)&&(P.g=="all");var S=false;var F="";switch(P.t){case"v":switch(P.v){case"locationMode":case"shmState":S=true;break}break;case"p":var V=x.getAttributeById(P.a);if(!!V&&!!V.u){F=V.u}break}var D="";if((W.g=="m")&&P.i&&P.i.length){D=" <span num>"+x.buildNameList(P.i,"or",null,null,false,true,false,"#")+"</span>"}var O="";var N="";if((P.t=="v")&&(P.v=="time")){if(J&&B&&(J.t!="c")){O=x.renderTimeOperand(B)}if(Q&&R&&(Q.t!="c")){N=x.renderTimeOperand(R)}}var E=x.renderOperand(P)+D+" <span pun>"+(L?(W.dd?W.dd:W.d):W.d)+"</span>"+(W.p>0?" "+O+x.renderOperand(J,S,C):"")+(F?"<span pun>"+F+"</span> ":"")+(W.p>1?" <span pun>"+(W.d.indexOf("between")?"and":"through")+"</span> "+N+x.renderOperand(Q,S,C)+(F?"<span pun>"+F+"</span> ":""):"");switch(W.t){case 1:E+=" <span pun>"+(I?"for":"in the last")+"</span> "+x.renderOperand(B)+" <span lit>"+x.getDurationUnitName(B.vt,!((B.t=="c")&&(!isNaN(B.c))&&(parseInt(B.c)==1)))+"</span>";break;case 2:E+=" <span pun>for "+(B.f=="g"?"at least":"less than")+"</span> "+x.renderOperand(B)+" <span lit>"+x.getDurationUnitName(B.vt,!((B.t=="c")&&(!isNaN(B.c))&&(parseInt(B.c)==1)))+"</span>";break}if((P.t=="v")&&(["time","date","datetime"].indexOf(P.v)>=0)){var T=(P.odw instanceof Array)&&P.odw.length?P.odw:null;var A=(P.odm instanceof Array)&&P.odm.length?P.odm:null;var K=!A&&(P.owm instanceof Array)&&P.owm.length?P.owm:null;var U=(P.omy instanceof Array)&&P.omy.length?P.omy:null;if(!!T||!!A||!!K||!!U){var H=0;E+="<span pun>,</span> <span pun>but only</span>";var G="";if(T){for(i in T){if((i>0)&&(T.length>2)){G+="<span pun>,</span> "}if((i>0)&&(i==T.length-1)){G+=" <span pun>or</span> "}G+="<span lit>"+x.weekDays[T[i]]+"s</span>"}H++}if(K){E+=(H?"<span pun>,</span>":"")+" <span pun>on the</span> ";for(i in K){if((i>0)&&(K.length>2)){E+="<span pun>,</span> "}if((i>0)&&(i==K.length-1)){E+=" <span pun>or</span> "}E+="<span num>"+x.getOrdinal(K[i])+"</span>"}E+=" "+(G?G:"<span pun>week"+(K.length>1?"s":"")+"</span>")+(U?"":" <span pun>of the month</span>");H++}else{if(G){E+=(H>1?"<span pun>,</span>":"")+" <span pun>on</span> "+G}}if(A){E+=(H?"<span pun>,</span>":"")+" <span pun>on the</span> ";for(i in A){if((i>0)&&(A.length>2)){E+="<span pun>,</span> "}if((i>0)&&(i==A.length-1)){E+=" <span pun>or</span> "}E+="<span num>"+x.getOrdinal(A[i])+"</span>"}E+=" day"+(A.length>1?"s":"")+(U?"":" <span pun>of the month</span>");H++}if(U){E+=" <span pun>"+(K||A?"of":"in")+"</span> ";for(i in U){if((i>0)&&(U.length>2)){E+="<span pun>,</span> "}if((i>0)&&(i==U.length-1)){E+=" <span pun>or</span> "}E+="<span lit>"+x.yearMonths[U[i]-1]+"</span>"}H++}}}return r.trustAsHtml(E)};x.getWeekDayName=function(A){if(isNaN(A)){return"day"}return x.weekDays[parseInt(A)]};x.getMonthDayName=function(A){switch(A){case -1:return"last";case -2:return"second-last";case -3:return"third-last"}return A+x.getOrdinalSuffix(A)};x.getMonthName=function(A){return x.yearMonths[A]};x.getDurationUnitName=function(B,A){var C=A?"s":"";switch(B){case"ms":return"millisecond"+C;case"s":return"second"+C;case"m":return"minute"+C;case"h":return"hour"+C;case"d":return"day"+C;case"w":return"week"+C;case"n":return"month"+C;case"y":return"year"+C}return""};x.renderTimer=function(B){var Q="";var D=B.lo;var M=x.getDurationUnitName(D.vt);var I=M;var A=0;switch(D.vt){case"ms":A=1;break;case"s":A=2;break;case"m":A=3;break;case"h":A=4;break;case"d":A=5;break;case"w":A=6;M=x.getWeekDayName(D.odw);break;case"n":A=7;M=x.getMonthDayName(D.odm)+" "+x.getWeekDayName(D.odw)+" of the month";break;case"y":A=8;M=x.getMonthDayName(D.odm)+" "+x.getWeekDayName(D.odw)+" of "+x.getMonthName(D.omy);break}switch(D.t){case"c":if(!isNaN(D.c)){var L=parseInt(D.c);switch(L){case 1:Q=M;break;case 2:Q="<span num>other</span> "+M;break;default:Q="<span num>"+L+"</span> "+I+"s";switch(D.vt){case"n":Q+=", on the "+x.getMonthDayName(D.odm)+" "+x.getWeekDayName(D.odw)+" of the month";break;case"y":Q+=", on the "+x.getMonthDayName(D.odm)+" "+x.getWeekDayName(D.odw)+" of "+x.getMonthName(D.omy);break}}break}default:Q=x.renderOperand(D)+" "+M+"s"}if(A==4){var E=("00"+B.lo.om).substr(-2);Q+=", <span pun>at <span num>:"+E+"</span> <span pun>past the hour</span>"}if(A>=5){Q+=", <span pun>at</span> ";if(B.lo2.t!="c"){switch(B.lo3.t){case"c":var G=isNaN(B.lo3.c)?0:parseInt(B.lo3.c);if(G==0){Q+=x.renderOperand(B.lo2)}else{if(G<0){Q+="<span num>"+(-G).toString()+"</span> <span lit>"+x.getDurationUnitName(B.lo3.vt,(G<-1))+"</span> <span pun>before</span> "+x.renderOperand(B.lo2)}else{Q+="<span num>"+G.toString()+"</span> <span lit>"+x.getDurationUnitName(B.lo3.vt,(G>1))+"</span> <span pun>after</span> "+x.renderOperand(B.lo2)}}break;default:Q+=x.renderOperand(B.lo2)+" <span num>±</span> "+x.renderOperand(B.lo3)}}else{Q+=x.renderOperand(B.lo2)}}var K=(A<=2)&&(D.om instanceof Array)&&D.om.length?D.om:null;var N=(A<=3)&&(D.oh instanceof Array)&&D.oh.length?D.oh:null;var C=(A<=5)&&(D.odw instanceof Array)&&D.odw.length?D.odw:null;var J=(A<=6)&&(D.odm instanceof Array)&&D.odm.length?D.odm:null;var P=(A<=6)&&!J&&(D.owm instanceof Array)&&D.owm.length?D.owm:null;var O=(A<=7)&&(D.omy instanceof Array)&&D.omy.length?D.omy:null;if(!!K||!!N||!!C||!!J||!!P||!!O){var F=0;Q+="<span pun>,</span> <span pun>but only</span>";if(K){Q+=" <span pun>at</span> ";for(i in K){if((i>0)&&(K.length>2)){Q+="<span pun>,</span> "}if((i>0)&&(i==K.length-1)){Q+=" <span pun>or</span> "}Q+="<span num>:"+("00"+K[i]).substr(-2)+"</span>"}Q+=" <span pun>minutes past the hour</span>";F++}if(N){Q+=(F?"<span pun>,</span>":"")+" <span pun>during the</span> ";for(i in N){if((i>0)&&(N.length>2)){Q+="<span pun>,</span> "}if((i>0)&&(i==N.length-1)){Q+=" <span pun>or</span> "}Q+="<span num>"+x.formatHour(N[i])+"</span>"}Q+=" <span pun>hour"+(N.length>1?"s":"")+"</span>";F++}var H="";if(C){for(i in C){if((i>0)&&(C.length>2)){H+="<span pun>,</span> "}if((i>0)&&(i==C.length-1)){H+=" <span pun>or</span> "}H+="<span lit>"+x.weekDays[C[i]]+"s</span>"}F++}if(P){Q+=(F?"<span pun>,</span>":"")+" <span pun>on the</span> ";for(i in P){if((i>0)&&(P.length>2)){Q+="<span pun>,</span> "}if((i>0)&&(i==P.length-1)){Q+=" <span pun>or</span> "}Q+="<span num>"+x.getOrdinal(P[i])+"</span>"}Q+=" "+(H?H:"<span pun>week"+(P.length>1?"s":"")+"</span>")+(O?"":" <span pun>of the month</span>");F++}else{if(H){Q+=(F>1?"<span pun>,</span>":"")+" <span pun>on</span> "+H}}if(J){Q+=(F?"<span pun>,</span>":"")+" <span pun>on the</span> ";for(i in J){if((i>0)&&(J.length>2)){Q+="<span pun>,</span> "}if((i>0)&&(i==J.length-1)){Q+=" <span pun>or</span> "}Q+="<span num>"+x.getOrdinal(J[i])+"</span>"}Q+=" day"+(J.length>1?"s":"")+(O?"":" <span pun>of the month</span>");F++}if(O){Q+=" <span pun>"+(P||J?"of":"in")+"</span> ";for(i in O){if((i>0)&&(O.length>2)){Q+="<span pun>,</span> "}if((i>0)&&(i==O.length-1)){Q+=" <span pun>or</span> "}Q+="<span lit>"+x.yearMonths[O[i]-1]+"</span>"}F++}}return r.trustAsHtml(Q)};x.renderTask=function(A){var D=x.getCommandById(A.c);var C;if(!D){C=A.c+"(";for(i in A.p){C+=(parseInt(i)?", ":"")+x.renderOperand(A.p[i])}C+=")"}else{C=!D.d?D.n:D.d.replace(/\{(\d)\}/g,function(F,I){var E=parseInt(I);if((E<0)||(!A.p)||(E>A.p.length)){return"?"}if((E<0)||(!A.p)||(E>A.p.length)){return"?"}var H="";if(D.p[E].t=="duration"){var G=x.getDurationUnitName(A.p[E].vt,true);H=x.renderOperand(A.p[E],true)+" "+G}else{if((A.p[E].t=="c")&&(!!D.p[E].d)&&(A.p[E].c=="false")){H=""}else{H=x.renderOperand(A.p[E],true)}}if(!H){H=""}if(!!H&&!!D.p[E].d){H=(!!A.p[E]&&!!A.p[E].t)?D.p[E].d.replace("{v}",H):""}return H}).replace(/(\{T\})/g,"°"+x.location.temperatureScale);var B=D.i;if(B){C='<span pun><i class="fa fa-'+B+'" aria-hidden="true"></i></span> '+C}}if(A.m){C+=" <span pun><i>(only while "+x.buildLocationModeNameList(A.m)+")</i></span>"}C+="<span pun>;</span>";return r.trustAsHtml(C)};x.renderDeviceList=function(B,E,G,H){var A="";var D=[];suffix=(G=="any"?"or":"and");var F="";if(B instanceof Array){if(B.length>1){switch(G){case"any":F="Any of ";break;case"all":F="All of ";break;case"count":F="Count of ";break;case"avg":F="Average of ";break;case"median":F="Median of ";break;case"least":F="Least occurring value of ";break;case"most":F="Most occurring value of ";break;case"stdev":F="Standard deviation of ";break;case"min":F="Minimum of ";break;case"max":F="Maximum of ";break;case"variance":F="Variance of ";break}if(!H){F=F.toLowerCase()}}for(deviceIndex in B){var C=x.getDeviceById(B[deviceIndex]);if(C){D.push({n:C.n,a:C.an,t:"dev"})}else{D.push({n:"{"+B[deviceIndex]+"}",t:"var"})}}if(D.length){A=F+x.buildNameList(D,suffix,"dev","",!!E,true)}}return r.trustAsHtml(A)};x.compilePiston=function(F,C,E){var E=E?E:{};var B=0;var A=function(G,I){if(!C){return(!!E[G]&&!!E[G].id)?E[G].id:G}if(!G){return""}var J;if(E[G]){var H=E[G];J=H.key;if(I&&I.a&&(I.a instanceof Array)&&H.value&&H.value.a&&(H.value.a instanceof Array)){for(a in I.a){if(H.value.a.indexOf(I.a[a])<0){H.value.a.push(I.a[a])}}}}else{J=":"+("xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx"+B).substr(-32)+":";B++;E[G]={key:J,value:I}}return J};var D=function(I,Q,M){if(I instanceof Array){for(i in I){I[i]=D(I[i],Q,M)}return I}if(I instanceof Object){if(I.exp){delete (I.exp)}if(C){switch(I.vt){case"phone":var H=I.c?I.c.split(/,;\*\|/):[];var R=[];for(p in H){R.push(A(H[p],{t:"phone"}))}I.c=R.join(",");I.e="";break;case"contact":case"contacts":var P=I.c?(I.c instanceof Array?I.c:I.c.split(/,;\*|/)):[];var O=[];for(c in P){O.push(A(P[c],{t:"contact"}))}I.c=(I.c instanceof Array)?O:O[0];I.e="";break;case"uri":I.c=A(I.c,{t:"uri"});I.e="";break}}for(property in I){I[property]=D(I[property],I,I.vt?I.vt:I.t)}if(!C&&!!I&&!!I.t&&!!I.vt&&((I.t=="c")||(I.t=="e"))){switch(I.t){case"c":I.exp=x.parseString(I.c,I.vt);break;case"e":I.exp=x.parseExpression(I.e,false,I.vt);break}}return I}var N=I?I.toString():"";if(N.startsWith(":")&&N.endsWith(":")){if(C){var G=x.getDeviceById(I);if(G){I=A(I,{t:"device",n:G.an,a:!!Q&&!!Q.a&&(Q.a.length>1)?[Q.a]:[]});return I}var K=x.getLocationModeById(I);if(K){switch(K){case"Home":case"Night":case"Sleep":case"Away":case"Vacation":break;default:K="Custom Mode"}I=A(I,{t:"mode",n:K});return I}var L=x.getRoutineById(I);if(L){I=A(I,{t:"routine"});return I}var J=x.getContactById(I);if(J){I=A(I,{t:"contact"});return I}}I=A(I,{t:"unknown"});return I}return I};F=D(x.copy(F),"piston");F.l={};for(l in E){F.l[E[l].key]=E[l].value}return F};x.determineDeviceType=function(A){return v.determineDeviceType(A)};x.anonymizeDevices=function(C){var B={};for(i in C){var E=C[i];var D=v.determineDeviceType(E).replace(/([A-Z])/g," $1").replace(/^./,function(F){return F.toUpperCase()}).replace("Rgb ","RGB ");var A=B[D]?B[D]+1:1;B[D]=A;C[i].an=D+" "+A}return C};x.anonymizeContacts=function(E){var C={};for(i in E){var B=E[i];var D="John Doe";var A=C[D]?C[D]+1:1;C[D]=A;E[i].an=D+" "+A}return E};x.breakList=function(A){return A.replace(/,/g,"<br/>")};var z=function(B){var C=B.getFullYear();var D=(1+B.getMonth()).toString();D=D.length>1?D:"0"+D;var A=B.getDate().toString();A=A.length>1?A:"0"+A;return D+"/"+A+"/"+C};x.getMonth=function(A){if(A){return["JAN","FEB","MAR","APR","MAY","JUN","JUL","AUG","SEP","OCT","NOV","DEC"][A.getMonth()]}};x.getDay=function(A){if(A){return("0"+A.getDate()).substr(-2)}};x.timeSince=timeSince;x.timeCounter=timeCounter;x.timeLeft=timeLeft;x.currentTime=currentTime;x.tap=function(A){v.tap(A).then(function(B){})};x.togglePiston=function(C,B){if((!C)&&(!x.viewerPiston||!x.viewerPiston.app)){return}var D=C?C.i:x.pistonId;if(D){g.cancel(tmrRefresh);var A=!(C?C.e:x.viewerPiston.app.enabled);if(C){C.e=A}else{x.viewerPiston.app.enabled=A}if(A){v.resumePiston(D).then(function(E){x.onRefresh(E)})}else{v.pausePiston(D).then(function(E){x.onRefresh(E)})}}if(B&&e.preventDefault){B.preventDefault()}if(B&&B.stopPropagation){B.stopPropagation()}};x.configurePiston=function(A){x.configuredPistonId=x.configuredPistonId==A.i?null:A.i};x.showPiston=function(A){document.body.scrollTop=0;x.viewerPiston=null;x.pistonId=A.i;x.refresh();window.onSwipeRight=x.hidePiston};x.hidePiston=function(){document.body.scrollTop=0;x.pistonId=null;window.onSwipeRight=null};x.prepareActions=function(C){var E=[];var A=[];var H=[];var I=(C.id<=0);var D=x.viewerPiston.tasks;var G=x.viewerPiston.app.actions;for(action in G){if(G[action].pid==C.id){if(G[action].t){var F=G[action].t;for(t in F){var B=0;for(task in D){if((D[task].type=="cmd")&&(D[task].ownerId==G[action].id)&&(D[task].taskId==F[t].i)){if((B==0)||(B>D[task].time)){B=D[task].time}}}F[t].time=B}}if(I){E.push(G[action])}else{if(G[action].rs==false){H.push(G[action])}else{A.push(G[action])}}}}var B=0;for(task in D){if((D[task].type=="evt")&&(D[task].ownerId==C.id)){if((B==0)||(B>D[task].time)){B=D[task].time}}}C.time=B;C.actions=E;C.trueActions=A;C.falseActions=H;C.$scope=x;if(C.children){for(child in C.children){x.prepareActions(C.children[child])}}};x.hadRecentActivity=function(A){return A&&A.le&&A.le.event&&A.le.event.date&&(timeLeft((new Date(A.le.event.date)).getTime())>-120)};x.toggleViewerOptions=function(){x.viewerPiston.showOptions=!x.viewerPiston.showOptions};x.getSecondaryStatementName=function(){var A=x.viewerPiston.app.mode;switch(A){case"Latching":return"BUT IF";case"Then-If":return"THEN IF";case"Else-If":return"ELSE IF";case"Or-If":return"OR IF";case"And-If":return"AND IF"}return"IF"};x.serializeObject=function(A){return angular.toJson(A)};x.anonymizeObject=function(A,D){var C=x.serializeObject(A);var B=C.match(/(:[a-f0-9]{32}:)/g);if(B){B=B.unique()}for(i in B){C=C.replace(new RegExp(B[i],"g"),("xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx"+i).substr(-32))}return(D?C:angular.fromJson(C))};x.objectToBlob=function(E,L){L=L||"";var B=1024;var I=btoa(x.serializeObject(E));I+="|"+I.length.toString();var K=I.length;var H=Math.ceil(K/B);var J=new Array(H);for(var C=0;C<H;++C){var A=C*B;var D=Math.min(A+B,K);var M=new Array(D-A);for(var F=A,G=0;F<D;++G,++F){M[G]=I[F].charCodeAt(0)}J[C]=new Uint8Array(M)}return new Blob(J,{type:L})};x.dataURItoBlob=function(B){var G=atob(B.split(",")[1]);var A=B.split(",")[0].split(":")[1].split(";")[0];var F=new ArrayBuffer(G.length);var D=new Uint8Array(F);for(var E=0;E<G.length;E++){D[E]=G.charCodeAt(E)}var C=new Blob([F],{type:A});return C};x.snapshot=function(A){var C=0;var B=function(){C++;return C};var D=x.compilePiston(x.piston,A);x.loading=true;v.generateBackupBin(D,A).then(function(E){m.enabled(false);var F=E.data;x.view.exportBin=F;var G=document.getElementById("piston");G.setAttribute("printing","");if(A){G.setAttribute("anonymized","")}g(function(){var I=G.clientWidth+10;var H=G.clientHeight+(A?0:64)+10;html2canvas(G,{width:I,height:H,counter:B}).then(function(K){x.loading=false;var J=new window.FileReader();console.log("Embedding data into PNG: "+D);J.readAsDataURL(new Blob([x.dataURItoBlob(K.toDataURL("image/png")),x.objectToBlob(D,"image/png")],{type:"image/png"}));J.onloadend=function(){x.capturedImage=J.result;x.dialogCapture=u.open({template:"dialog-captured-image",className:"ngdialog-theme-default ngdialog-auto-size",disableAnimation:true,closeByDocument:false,scope:x,showClose:true})}});G.removeAttribute("printing");G.removeAttribute("anonymized");delete (x.view.exportBin);m.enabled(true)},1,false)},function(){piston.removeAttribute("printing");piston.removeAttribute("anonymized");delete (x.view.exportBin)})};x.textSnapshot=function(){copyToClipboard("piston")};x.parseString=function(B,A){return x.parseExpression(B,true,A)};x.parseExpression=function(L,D,M){L=(L!=null)?L.toString():"";var I=0;var J=!!D?0:1;var H=J;var C=false;var F=false;var B=false;var E=0;var A=0;function N(Q,P){return Q==P?Q.toString():Q.toString()+":"+P.toString()}function G(){var P=[];var V=I;function S(){if(I-1>V){var Y=L.slice(V,I-1);var X=parseFloat(Y.trim());if(!isNaN(X)){P.push({t:(Y.indexOf(".")>0?"decimal":"integer"),v:X,l:N(V,I-2)});return true}if(typeof Y=="string"){if(["true","false"].indexOf(Y)>=0){P.push({t:"boolean",v:Y,l:N(V,I-2)})}else{P.push({t:"variable",x:Y,l:N(V,I-2)})}return true}P.push({t:"operand",v:L.slice(V,I-1),l:N(V,I-2)});return true}return false}function Q(){if(I-1>V){var Y=L.slice(V,I-1);var X=parseFloat(Y.trim());if((M!="phone")&&!isNaN(X)){P.push({t:(Y.indexOf(".")>0?"decimal":"integer"),v:parseInt(X),l:N(V,I-2)});return true}P.push({t:(["true","false"].indexOf(Y)>=0?"boolean":"string"),v:Y,l:N(V,I-2)})}}function T(){if(I-1>V){var ac=L.slice(V,I-1);var ad=ac.lastIndexOf(":");var Z=ac;var ab="";if(ad>0){var Z=ac.substr(0,ad).trim();ab=ac.substr(ad+1).trim()}var aa=x.getDeviceByName(Z);if(aa&&aa.id){var Y=ab.toLowerCase();ab="";for(attributeIndex in aa.a){var X=aa.a[attributeIndex];if(Y==X.n.toLowerCase()){ab=X.n}}if(!!Y&&!ab){ab="?"}P.push({t:"device",id:aa.id,a:ab,l:N(V-1,I-1)})}else{P.push({t:"device",x:Z,a:ab,l:N(V-1,I-1)})}}}function U(){var Z=L.slice(V,I-1).toLowerCase();if(x.db.functions[Z]){E++;var aa=G();var X=[];var Y=null;for(p in aa){if(!Y){Y={t:"expression",i:[]}}if((aa[p].t=="operator")&&(aa[p].o==",")){X.push(Y);Y={t:"expression",i:[]}}else{Y.i.push(aa[p])}}if(Y){X.push(Y)}P.push({t:"function",n:Z,i:X,l:N(V,I-1)});E--}else{S();P.push({t:"expression",i:G(),l:N(V,I-1)});V=I}}while(I<L.length){var W=L[I++];switch(W){case" ":case"\t":case"\r":case"\n":if(H&&!B&&!F&&!C){S();V=I}continue;case"+":case"-":case"/":case"*":case"^":case"\\":case"%":case"&":case"|":case",":case"!":case"=":case"<":case">":case"?":case":":if(H&&!B&&!C&&!F){var R=(I<L.length)?L[I]:"";S();if(["&&","||","==","!=","!!",">=","<=","<>"].indexOf(W+R)>=0){I++;W+=R}P.push({t:"operator",o:W,l:N(I-1,I-1)});V=I}continue;case'"':if(H&&!B&&!C){F=!F;(F?S():Q());V=I}continue;case"'":if(H&&!F&&!B){C=!C;(C?S():Q());V=I}continue;case"(":if(H&&!B&&!F&&!C){A++;U();V=I}continue;case")":if(H&&!B&&!F&&!C){A--;S();V=I;return P}continue;case"[":if(H&&!F&&!C&&!B){B=true;S();V=I}continue;case"]":if(H&&B&&!F&&!C){T();B=false;V=I}continue;case"{":if(H==J){H++;Q();V=I;P.push({t:"expression",i:G(),l:N(V-1,I-1)});V=I}else{H++;V=I;P.push({t:"expression",i:G(),l:N(V-1,I-1)});V=I}continue;case"}":S();H--;return P;continue}}I++;H?S():Q();return P}var K=G();var O={t:"expression",i:K,str:L};if(H!=J){O.err="Invalid expression closure termination"}else{if(C){O.err="Invalid single quote termination"}else{if(F){O.err="Invalid double quote termination"}else{if(A){O.err="Invalid parenthesis closure termination"}}}}O.ok=!O.err;if(O.ok){O.ok=x.validateExpression(O)}return O};x.validateExpression=function(F){var C="";var A="";var E="";function B(H,K,J){if(!H){return""}H=H.toString().split(":");var L=parseInt(H[0]);var G=(H.length==2)?parseInt(H[1]):L;var I=F.str.substr(L,G-L+1);if((I.substr(0,1)=="[")&&(I.substr(-1,1)=="]")){I=I.substr(1,I.length-2)}if(K){I=I.split(K);if(J>=I.length){return""}return I[J].trim()}return I.trim()}function D(I){var G=true;var H="";var J="";if(I.i){for(subitem in I.i){G=G&&D(I.i[subitem])}}else{switch(I.t){case"device":if(!I.x&&!I.id){G=false;H="Invalid device "+B(I.l,":",0);J=I.l;break}if(!I.id&&I.x&&!((x.systemVars&&scope.systemVars[I.x])||(x.globalVars&&x.systemVars[I.x])||x.getVariableByName(I.x))){G=false;H="Invalid device variable "+B(I.l,":",0);J=I.l;break}if(I.a=="?"){G=false;H="Invalid attribute "+B(I.l,":",1);J=I.l;break}break;case"variable":if(I.x.startsWith("$args.")&&(I.x.length>6)){break}if(x.systemVars&&x.systemVars[I.x]){break}if(x.globalVars&&x.globalVars[I.x]){break}if(!x.getVariableByName(I.x)){G=false;A=B(I.l);H="Variable "+A+" not found";J=I.l;break}break}}I.ok=G;if(H){I.err=H;if(!C){C=H;E=J}}return G}D(F);if(C){F.err=C;F.errVar=A;F.loc=E}return F.ok};x.hexToHsl=function(B){var H=/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(B);if(!H){return{h:0,s:0,l:0}}var A=0+parseInt(H[1],16)/255;var F=0+parseInt(H[2],16)/255;var I=0+parseInt(H[3],16)/255;var J=Math.max(A,F,I),D=Math.min(A,F,I);var E,K,C=(J+D)/2;if(J==D){E=K=0}else{var G=J-D;K=(C>0.5)?G/(2-J-D):G/(J+D);switch(J){case A:E=(F-I)/G+(F<I?6:0);break;case F:E=(I-A)/G+2;break;case I:E=(A-F)/G+4;break}E=E/6}return{h:Math.round(360*E),s:Math.round(100*K),l:Math.round(100*C)}};x.evaluateExpression=function(B,A){v.evaluateExpression(x.pistonId,B,A).then(function(C){console.log(C)})};x.init();var y=navigator.userAgent||navigator.vendor||window.opera;if(y.match(/Android/i)){x.android=true}x.url=window.location.href;x.mobile=window.mobileCheck();x.tablet=(!x.mobile)&&(window.mobileOrTabletCheck());x.formatTime=window.formatTime;x.utcToString=utcToString;x.utcToTimeString=utcToTimeString;x.utcToDateString=utcToDateString;x.formatLogTime=function(A,B){return utcToString(A)+"+"+B};x.md5=window.md5}]);function test(g,b,f){scope.evaluateExpression(scope.parseExpression(g,b,f))}var MAX_STACK_SIZE=10;