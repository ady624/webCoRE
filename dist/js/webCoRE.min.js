...
var app=angular.module("CoRE",["ng","ngRoute","ngSanitize","ngResource","ngDialog","ngAnimate","angular-svg-round-progressbar","angular-bootstrap-select","swipe","dndLists","ui.toggle","chart.js","smartArea","ui.bootstrap.contextMenu"]);var cdn="";var theme="";app.directive("head",["$rootScope","$compile",function(a,b){return{restrict:"E",link:function(e,f){var c='<link rel="stylesheet" ng-repeat="(routeCtrl, cssUrl) in routeStyles" ng-href="{{cssUrl}}" />';f.append(b(c)(e));e.routeStyles={};a.$on("$routeChangeStart",function(j,g,h){if(h&&h.$$route&&h.$$route.css){if(!angular.isArray(h.$$route.css)){h.$$route.css=[h.$$route.css]}angular.forEach(h.$$route.css,function(k){delete e.routeStyles[k]})}if(g&&g.$$route&&g.$$route.css){if(!angular.isArray(g.$$route.css)){g.$$route.css=[g.$$route.css]}angular.forEach(g.$$route.css,function(k){e.routeStyles[k]=k})}})}}}]);app.directive("ngWheel",["$parse",function(a){return function(f,c,b){var e=a(b.ngWheel);c.bind("wheel",function(g){f.$apply(function(){e(f,{$event:g})})})}}]);app.directive("textcomplete",["Textcomplete",function(a){return{restrict:"EA",scope:{members:"=",message:"=",callback:"&"},template:'<textarea ng-model="message" type="text"></textarea>',link:function(f,g,e){var b=f.members;var c=g.find("textarea");var h=new a(c,[{match:/(\b)(\w{2,})$/,search:function(j,k){k($.map(b,function(l){return l.toLowerCase().indexOf(j.toLowerCase())===0?l:null}))},index:2,replace:function(j){return"$1"+j+" "}}]);if(f.callback){f.$watch("message",function(k,j){f.callback()})}$(h).on({"textComplete:select":function(k,j){f.$apply(function(){f.message=j})},"textComplete:show":function(j){$(this).data("autocompleting",true)},"textComplete:hide":function(j){$(this).data("autocompleting",false)}})}}}]);app.directive("masonry",["$parse",function(a){return{restrict:"AC",link:function(g,h,e){g.items=[];var b=h[0];var c=angular.extend({itemSelector:"tile"},JSON.parse(e.masonry));var f=g.masonry=new Masonry(b,c);var j=0;g.update=function(){if(j){window.clearTimeout(j)}j=window.setTimeout(function(){j=0;f.reloadItems();f.layout();h.children(c.itemSelector).css("visibility","visible")},120)};g.update()}}}]).directive("masonryTile",function(){return{restrict:"AC",link:function(a,c){c.css("visibility","hidden");var b=c.parent("*[masonry]:first").scope(),e=b.update;imagesLoaded(c.get(0),e);c.ready(e)}}});app.directive("tileHeight",function(){var a={restrict:"A",link:function(g,h,b,c,e){var f=1;if(b.tileHeight){f=b.tileHeight}var j=function(){var k=h[0].parentElement.offsetWidth/Math.round(h[0].parentElement.offsetWidth/h[0].offsetWidth)*f;h.outerHeight(k)};g.$watch(b.tileHeight,function(k){f=1*k;j()});$(window).resize(j);j();g.$on("$destroy",function(){$(window).unbind("resize",j)})}};return a});app.directive("help",function(a){return function(f,c,b){var g=b.help?b.help:c.text();var e=angular.element("<wiki ng-click=\"wiki('"+g+'\')" class="fa fa-info-circle"></wiki>');c.append(a(e)(f))}});app.directive("script",function(){return{restrict:"E",scope:false,link:function(b,e,a){if(a.type==="text/javascript"){var c=e.text();var g=new Function(c);g()}}}});app.directive("devData",function(a){return function(e,c,b){var f=function(j,h,g){var k=a(g.devData)(j);if(k){for(attr in k){h.attr("data-"+attr,k[attr])}}};e.$watch(b.devData,function(){f(e,c,b)})}});app.filter("orderObjectBy",function(){return function(a,e,c){var b=[];angular.forEach(a,function(g,f){b.push(Object.assign({id:f},g))});b.sort(function(g,f){return(g[e]>f[e]?1:-1)});if(c){b.reverse()}return b}});var config=app.config(["$routeProvider","$locationProvider","$sceDelegateProvider","$rootScopeProvider",function(b,a,f,e){e.digestTtl(10000);var c=".module.css";f.resourceUrlWhitelist(["self",cdn+"**"]);b.when("/",{templateUrl:cdn+theme+"html/modules/dashboard.module.html",controller:"dashboard",css:cdn+theme+"css/modules/dashboard"+c}).when("/register",{templateUrl:cdn+theme+"html/modules/register.module.html",controller:"register",css:cdn+theme+"css/modules/register"+c}).when("/init/:init",{redirectTo:function(g){app.initialInstanceUri=atou(g.init);return"/"}}).when("/piston/:pistonId",{templateUrl:cdn+theme+"html/modules/piston.module.html",controller:"piston",css:cdn+theme+"css/modules/piston"+c,reloadOnSearch:false}).when("/init/:instId1/:instId2",{redirectTo:function(g){app.initialInstanceUri=g.instId1+g.instId2;return"/"}}).otherwise({redirectTo:"/"});a.html5Mode(true)}]);config.factory("dataService",["$http","$location","$rootScope","$window","$q",function(H,n,p,s,C){var y={};var r="";var b=null;var G={};var E=null;var g={};var l={};var m="N7zqL6a8Texs4wY5y&y2YPLzus+_dZ%s";var v=m;var A=null;var e=null;var k=null;var B={};var I=1;var j=false;if(localforage){localforage.config({name:"webCoRE"});localforage.keys().then(function(J){I=J.length;if(I){localforage.iterate(function(M,L,K){B[L]=F(M);I--;if(!I&&!j){c()}})}else{c()}})}var o=function(J){return JSON.parse(J)};var z=function(J,L,K){return Array(L-String(J).length+1).join(K||"0")+J};var q=function(J){return z(J.getFullYear(),4)+"-"+z(1+J.getMonth(),2)+"-"+z(J.getDate(),2)+" "+z(J.getHours(),2)+":"+z(J.getMinutes(),2)+":"+z(J.getSeconds(),2)};var u=function(J){return JSON.stringify(J)};var t=function(L,J){try{return utoa(s.sjcl.encrypt(J?J:v,angular.toJson(L),{ks:256}))}catch(K){return null}};var F=function(K,J){try{return angular.fromJson(s.sjcl.decrypt(J?J:v,atou(K)))}catch(L){return null}};var x=function(J,L,K){localforage.setItem("core:"+J,t(L,K));B["core:"+J]=L;return};var f=function(J,K){return B["core:"+J]};var h=function(J){b=J;G[b.id]=b;x("locations",G);return b};var a=function(L){var K=(!E);if(!E||(E.id!=L.id)){E=L}var J=l[E.id];if(!J){J={}}J.token=L.token?L.token:J.token;J.uri=L.uri?L.uri.replace(":443",""):J.uri;l[E.id]=J;delete (E.token);delete (E.uri);if(L.contacts){E.contacts=L.contacts}E.contacts=E.contacts?E.contacts:(g[E.id]&&g[E.id].contacts?g[E.id].contacts:[]);if(L.devices){E.devices=L.devices;K=true}E.devices=E.devices?E.devices:(g[E.id]&&g[E.id].devices?g[E.id].devices:[]);E.pistons=L.pistons;E.globalVars=L.globalVars;E.coreVersion=L.coreVersion;E.name=L.name;if(K&&E.devices){for(d in E.devices){E.devices[d].t=y.determineDeviceType(E.devices[d])}}E.virtualDevices=E.virtualDevices||{};g[E.id]=E;x("instances",g);x("store",l);x("instance",E.id,m);if((E.coreVersion)&&(version()!=E.coreVersion)){if(version()>E.coreVersion){w("A newer SmartApp version ("+version()+") is available, please update and publish the all the webCoRE SmartApps in the SmartThings IDE.")}else{w("A newer UI version ("+E.coreVersion+") is available, please hard reload this web page to get the newest version.")}}return E};var w=function(J){if(A){A(J)}};y.openWebSocket=function(K){if(K&&E){k=K;if(e){return e}var J=E.id;e=new WebSocket("wss://api-us-"+J[32]+".webcore.co:9297");e.onopen=function(L){e.send(E.id)};e.onclose=function(L){e=null;if(k){setTimeout(function(){y.openWebSocket(k)},5000)}};e.onmessage=function(L){if(k){try{k(L)}catch(M){}}};e.onerror=function(L){e=null;if(k){setTimeout(function(){y.openWebSocket(k)},5000)}};return e}else{k=null;e.close();e=null}};y.closeWebSocket=function(){y.openWebSocket(null)};y.ready=function(){return !!j};y.logout=function(){return localforage.clear()};y.setStatusCallback=function(J){A=J};y.saveToStore=function(J,K){return x(J,K)};y.loadFromStore=function(J){return f(J)};y.deleteFromStore=function(J){return localforage.removeItem("core:"+J)};y.loadFromStore=function(J){return f(J)};y.deleteInstance=function(J){if(J){if(J==E){E=null;x("instance",null,m)}delete (l[J.id]);delete (g[J.id]);x("instances",g);x("store",l)}};y.listLocations=function(){var J=[];for(lid in G){J.push(JSON.parse(JSON.stringify(G[lid])))}return J};y.getLocation=function(J){if(J){for(lid in G){if(lid==J){return JSON.parse(JSON.stringify(G[lid]))}}}else{return JSON.parse(JSON.stringify(b))}return null};y.listInstances=function(K){var J=[];for(iid in g){if(!K||(g[iid].locationId==K)){J.push(JSON.parse(JSON.stringify(g[iid])))}}return J};y.getInstanceCount=function(K){var J=0;for(iid in g){if(!K||(g[iid].locationId==K)){J++}}return J};y.getInstance=function(J){if(E&&!J){return E}if(E&&(E.id==J)){return E}if(J){for(iid in g){if(iid==J){return JSON.parse(JSON.stringify(g[iid]))}}}else{try{return JSON.parse(JSON.stringify(E?E:(g?g[f("instance")]:null)))}catch(K){}}return null};y.getPistonInstance=function(J){for(iid in g){for(i in g[iid].pistons){if(g[iid].pistons[i].id==J){return JSON.parse(JSON.stringify(g[iid]))}}}return null};y.loadInstance=function(P,N,M,J){var L=P?l[P.id]:null;var O=!P||!(P.devices instanceof Object)||!(Object.keys(P.devices).length)?0:(P.deviceVersion?P.deviceVersion:0);if(!L){if((app.initialInstanceUri&&app.initialInstanceUri.length)||(N&&N.length)){N=app.initialInstanceUri?app.initialInstanceUri:N;if(N&&!(N instanceof Object)&&(N.length>=69)){N=N.substr(0,8)=="https://"?N:"https://"+N.substr(0,N.length-64)+".api.smartthings.com/api/token/"+N.substr(-64,8)+"-"+N.substr(-56,4)+"-"+N.substr(-52,4)+"-"+N.substr(-48,4)+"-"+N.substr(-44,12)+"/smartapps/installations/"+N.substr(-32,8)+"-"+N.substr(-24,4)+"-"+N.substr(-20,4)+"-"+N.substr(-16,4)+"-"+N.substr(-12)+"/"}L={uri:N};for(id in l){if(l[id].uri==N){L=l[id];if(g&&g[id]&&g[id].devices instanceof Object&&Object.keys(g[id].devices).length&&g[id].deviceVersion){O=g[id].deviceVersion}break}}}}delete (app.initialInstanceUri);if(!L){var Q=f("instance");if(Q){L=l[Q];if(g&&g[Q]&&g[Q].devices instanceof Object&&Object.keys(g[Q].devices).length&&g[Q].deviceVersion){O=g[Q].deviceVersion}}}if(!L){localStorage.clear();n.path("/register")}else{var K=document.getElementById("error");if(K){K.parentNode.removeChild(K)}}return H.jsonp((L?L.uri:"about:blank/")+"intf/dashboard/load?token="+(L&&L.token?L.token:"")+(M?"&pin="+M:"")+"&dashboard="+(J?1:0)+"&dev="+O,{jsonpCallbackParam:"callback"}).then(function(R){var S=R.data;if(S.now){adjustTimeOffset(S.now)}if(S.error&&L){S.uri=L.uri}if(S.location){h(S.location)}if(S.instance){S.instance=a(S.instance)}return S},function(R){})};y.tap=function(J){return H({method:"GET",url:"tap/"+J})};y.getApiUri=function(){var J=y.getInstance();si=l?l[J.id]:null;return si?si.uri:null};y.refreshDashboard=function(){var K=y.getInstance();si=l&&K?l[K.id]:null;var J=!K||!(K.devices instanceof Object)||!(Object.keys(K.devices).length)?0:(K.deviceVersion?K.deviceVersion:0);w("Loading dashboard...");return H.jsonp((si?si.uri:"about:blank/")+"intf/dashboard/refresh?token="+(si&&si.token?si.token:""),{jsonpCallbackParam:"callback"}).then(function(L){data=L.data;return data},function(L){return null})};y.getPiston=function(M){var L=y.getPistonInstance(M);if(!L){L=y.getInstance()}si=l&&L?l[L.id]:null;var K=!L||!(L.devices instanceof Object)||!(Object.keys(L.devices).length)?0:(L.deviceVersion?L.deviceVersion:0);var J=f("db.version",m);w("Loading piston...");return H.jsonp((si?si.uri:"about:blank/")+"intf/dashboard/piston/get?id="+M+"&db="+J+"&token="+(si&&si.token?si.token:"")+"&dev="+K,{jsonpCallbackParam:"callback"}).then(function(N){data=N.data;if(data.now){adjustTimeOffset(data.now)}if(data.dbVersion){x("db.version",data.dbVersion,m);x("db",data.db);w("Database updated to version "+data.dbVersion)}else{data.db=f("db");w()}if(data.location){h(data.location)}if(data.instance){data.instance=a(data.instance)}return data},function(N){return null})};y.getActivity=function(L,J){var K=y.getPistonInstance(L);if(!K){K=y.getInstance()}si=l?l[K.id]:null;return H.jsonp((si?si.uri:"about:blank/")+"intf/dashboard/piston/activity?id="+L+"&log="+(J?J:0)+"&token="+(si&&si.token?si.token:""),{jsonpCallbackParam:"callback"}).then(function(M){return M.data})};y.generateBackupBin=function(K,L){var J=y.getInstance();return H({method:"POST",url:"https://api.webcore.co/bins/"+(L?"":md5(J.account.id)),data:K?(L?{d:t(K,m)}:{e:t(K,m+J.account.id)}):{},transformResponse:function(M){try{M=JSON.parse(M);if(M&&M.bin){return M.bin}if(M&&M.uri){M=M.uri.split("/");if(M&&M.length){return M[M.length-1]}}}catch(N){}return null}})};y.saveToBin=function(L,K){w("Saving piston to backup bin...");var J=y.getInstance();if(J&&J.account&&J.account.id){K={e:t(K,m+J.account.id)}}else{K={};L=null}return H({method:"PUT",url:"https://api.webcore.co/bins/"+md5(J.account.id)+"/"+L,data:K,transformResponse:function(M){w("Backup bin updated");return true}})};y.loadFromBin=function(L,J){w("Loading piston from backup bin...");var K=y.getInstance();if(!(K&&K.account&&K.account.id)){L=null}return H({method:"GET",url:"https://api.webcore.co/bins/"+(J?md5(K.account.id)+"/":"")+L,transformResponse:function(M){if(L){try{M=JSON.parse(M);if(M&&M.e){return F(M.e,m+K.account.id)}if(M&&M.d){return F(M.d,m)}w()}catch(N){w("Sorry, an error occurred while importing the backup bin")}}return null}})};y.generateNewPistonName=function(){var J=y.getInstance();si=l?l[J.id]:null;return H.jsonp((si?si.uri:"about:blank/")+"intf/dashboard/piston/new?token="+(si&&si.token?si.token:""),{jsonpCallbackParam:"callback"}).then(function(K){return K.data})};y.createPiston=function(J,K,M){var L=y.getInstance();si=l?l[L.id]:null;return H.jsonp((si?si.uri:"about:blank/")+"intf/dashboard/piston/create?author="+encodeURIComponent(K)+"&name="+encodeURIComponent(J)+"&bin="+encodeURIComponent(M?M:"")+"&token="+(si&&si.token?si.token:""),{jsonpCallbackParam:"callback"}).then(function(N){return N.data})};var D=function(K,M,J,L){if(J<M.length){w("Saving piston chunk "+(J+1).toString()+" of "+M.length.toString()+"...");return H.jsonp((K?K.uri:"about:blank/")+"intf/dashboard/piston/set.chunk?chunk="+J.toString()+"&data="+encodeURIComponent(M[J])+"&token="+(K&&K.token?K.token:""),{jsonpCallbackParam:"callback"}).then(function(N){return D(K,M,J+1,L)})}else{w("Finishing up...");return H.jsonp((K?K.uri:"about:blank/")+"intf/dashboard/piston/set.end?bin="+encodeURIComponent(L)+"&token="+(K&&K.token?K.token:""),{jsonpCallbackParam:"callback"}).then(function(N){w();return N})}};y.setPiston=function(M,O){var L=y.getPistonInstance(M.id);if(!L){L=y.getInstance()}si=l?l[L.id]:null;var K=utoa(angular.toJson(M));var J=3076;if(M&&O){y.saveToBin(O,M)}if(K.length>J){var N=[].concat.apply([],K.split("").map(function(P,Q){return Q%J?[]:K.slice(Q,Q+J)},K));w("Preparing to save chunked piston...");return H.jsonp((si?si.uri:"about:blank/")+"intf/dashboard/piston/set.start?id="+M.id+"&chunks="+N.length.toString()+"&token="+(si&&si.token?si.token:""),{jsonpCallbackParam:"callback"}).then(function(P){if(P&&(P.status==200)&&P.data&&(P.data.status=="ST_READY")){return D(si,N,0,O)}})}else{w("Saving piston...");return H.jsonp((si?si.uri:"about:blank/")+"intf/dashboard/piston/set?id="+M.id+"&data="+K+"&bin="+encodeURIComponent(O)+"&token="+(si&&si.token?si.token:""),{jsonpCallbackParam:"callback"}).then(function(P){w();return P})}};y.setPistonLogging=function(J,L){var K=y.getPistonInstance(J);if(!K){K=y.getInstance()}si=l?l[K.id]:null;w("Setting piston logging level to "+L+"...");return H.jsonp((si?si.uri:"about:blank/")+"intf/dashboard/piston/logging?id="+J+"&level="+L+"&token="+(si&&si.token?si.token:""),{jsonpCallbackParam:"callback"}).then(function(M){w();return M.data})};y.pausePiston=function(J){var K=y.getPistonInstance(J);if(!K){K=y.getInstance()}si=l?l[K.id]:null;w("Pausing piston...");return H.jsonp((si?si.uri:"about:blank/")+"intf/dashboard/piston/pause?id="+J+"&token="+(si&&si.token?si.token:""),{jsonpCallbackParam:"callback"}).then(function(L){w();return L.data})};y.resumePiston=function(J){var K=y.getPistonInstance(J);if(!K){K=y.getInstance()}si=l?l[K.id]:null;w("Resuming piston...");return H.jsonp((si?si.uri:"about:blank/")+"intf/dashboard/piston/resume?id="+J+"&token="+(si&&si.token?si.token:""),{jsonpCallbackParam:"callback"}).then(function(L){w();return L.data})};y.deletePiston=function(J){var K=y.getPistonInstance(J);if(!K){K=y.getInstance()}si=l?l[K.id]:null;return H.jsonp((si?si.uri:"about:blank/")+"intf/dashboard/piston/delete?id="+J+"&token="+(si&&si.token?si.token:""),{jsonpCallbackParam:"callback"}).then(function(L){return L.data})};y.setVariable=function(J,M){var L=y.getInstance();si=l?l[L.id]:null;var K=M?utoa(angular.toJson(M)):"";return H.jsonp((si?si.uri:"about:blank/")+"intf/dashboard/variable/set?name="+J+"&value="+K+"&token="+(si&&si.token?si.token:""),{jsonpCallbackParam:"callback"}).then(function(N){return N.data})};y.evaluateExpression=function(K,N,J){var M=y.getPistonInstance(K);if(!M){M=y.getInstance()}si=l?l[M.id]:null;var L=utoa(angular.toJson(N));return H.jsonp((si?si.uri:"about:blank/")+"intf/dashboard/piston/evaluate?id="+K+"&expression="+L+"&dataType="+(J?encodeURIComponent(J):"")+"&token="+(si&&si.token?si.token:""),{jsonpCallbackParam:"callback"}).then(function(O){return O.data})};y.registerDashboard=function(J){return H.post("https://api.webcore.co/dashboard/register/"+J).then(function(K){return K.data})};y.registerHandler=function(){navigator.registerProtocolHandler("web+core","https://"+window.location.hostname+"/handler/%s","webCoRE")};y.determineDeviceType=function(J){if(J&&J.cn){if(J.cn.indexOf("Water Sensor")>=0){return"waterSensor"}if(J.cn.indexOf("Contact Sensor")>=0){return"contactSensor"}if(J.cn.indexOf("Thermostat")>=0){return"thermostat"}if(J.cn.indexOf("Garage Door Control")>=0){return"garageDoor"}if(J.cn.indexOf("Music Player")>=0){return"musicPlayer"}if(J.cn.indexOf("Door Control")>=0){return"door"}if(J.cn.indexOf("Presence Sensor")>=0){return"presenceSensor"}if(J.cn.indexOf("Motion Sensor")>=0){return"motionSensor"}if(J.cn.indexOf("Color Control")>=0){return"rgbBulb"}if(J.cn.indexOf("Color Temperature")>=0){return"whiteBulb"}if(J.cn.indexOf("Switch Level")>=0){var K=J.n.toLowerCase();if(K.indexOf("light")>=0){return"whiteBulb"}if(K.indexOf("keen")>=0){return"vent"}if(K.indexOf("vent")>=0){return"vent"}return"dimmer"}if(J.cn.indexOf("Lock")>=0){return"lock"}if((J.cn.indexOf("Button")>=0)&&(J.cn.indexOf("Button")>=0)){return"keypad"}if(J.cn.indexOf("Button")>=0){return"button"}if(J.cn.indexOf("Temperature Measurement")>0){return"temperatureSensor"}if((J.cn.indexOf("Switch")>=0)&&(J.cn.indexOf("Power Meter")>=0)){return"outlet"}if(J.cn.indexOf("Switch")>=0){return"switch"}if(J.cn.indexOf("Power Meter")>=0){return"powerMeter"}}return"unknownDevice"};var c=function(){l=f("store");if(!l){l={}}G=f("locations");if(!G){G={}}g=f("instances");if(!g){g={}}j=true;window.ds=y};return y}]);app.run(["$rootScope","$window","$location",function(a,b,c){a.getTime=function(e){if(e){return e.format("h:mmtt")}};a.$on("$viewContentLoaded",function(f){var g=c.path();if(g.startsWith("/init/")){g="/init"}if(g.startsWith("/piston/")){g="/piston"}b.ga("send","pageview",{page:g});var e=null;if(!mobileCheck()){switch(g){case"/":e=[{calltype:"async[2]",publisher:"ady624",width:160,height:600,sid:"Chitika Default"}];break;case"/register":e=[{calltype:"async[2]",publisher:"ady624",width:728,height:90,sid:"Chitika Default"}];break}}if(e){b.CHITIKA={units:e};if(b.CHITIKA_ADS){b.CHITIKA_ADS.make_it_so()}}else{delete (window.CHITIKA)}});a.bytesToSize=function(e){var g=["bytes","kB","MB","GB","TB"];if(e==0){return"0 Byte"}var f=parseInt(Math.floor(Math.log(e)/Math.log(1024)));return(e/Math.pow(1024,f)).toFixed(f==0?0:2)+" "+g[f]}}]);Date.prototype.format=function(x,a){var r=["\x00","January","February","March","April","May","June","July","August","September","October","November","December"];var c=["\x01","Jan.","Feb.","Mar.","Apr.","May","June","July","Aug.","Sept.","Oct.","Nov.","Dec."];var b=["\x02","Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"];var g=["\x03","Sun","Mon","Tue","Wed","Thu","Fri","Sat"];function o(h,f){var m=h+"";f=f||2;while(m.length<f){m="0"+m}return m}var l=a?this.getUTCFullYear():this.getFullYear();x=x.replace(/(^|[^\\])yyyy+/g,"$1"+l);x=x.replace(/(^|[^\\])yy/g,"$1"+l.toString().substr(2,2));x=x.replace(/(^|[^\\])y/g,"$1"+l);var j=(a?this.getUTCMonth():this.getMonth())+1;x=x.replace(/(^|[^\\])MMMM+/g,"$1"+r[0]);x=x.replace(/(^|[^\\])MMM/g,"$1"+c[0]);x=x.replace(/(^|[^\\])MM/g,"$1"+o(j));x=x.replace(/(^|[^\\])M/g,"$1"+j);var B=a?this.getUTCDate():this.getDate();x=x.replace(/(^|[^\\])dddd+/g,"$1"+b[0]);x=x.replace(/(^|[^\\])ddd/g,"$1"+g[0]);x=x.replace(/(^|[^\\])dd/g,"$1"+o(B));x=x.replace(/(^|[^\\])d/g,"$1"+B);var n=a?this.getUTCHours():this.getHours();x=x.replace(/(^|[^\\])HH+/g,"$1"+o(n));x=x.replace(/(^|[^\\])H/g,"$1"+n);var z=n>12?n-12:n==0?12:n;x=x.replace(/(^|[^\\])hh+/g,"$1"+o(z));x=x.replace(/(^|[^\\])h/g,"$1"+z);var u=a?this.getUTCMinutes():this.getMinutes();x=x.replace(/(^|[^\\])mm+/g,"$1"+o(u));x=x.replace(/(^|[^\\])m/g,"$1"+u);var q=a?this.getUTCSeconds():this.getSeconds();x=x.replace(/(^|[^\\])ss+/g,"$1"+o(q));x=x.replace(/(^|[^\\])s/g,"$1"+q);var A=a?this.getUTCMilliseconds():this.getMilliseconds();x=x.replace(/(^|[^\\])fff+/g,"$1"+o(A,3));A=Math.round(A/10);x=x.replace(/(^|[^\\])ff/g,"$1"+o(A));A=Math.round(A/10);x=x.replace(/(^|[^\\])f/g,"$1"+A);var e=n<12?"AM":"PM";x=x.replace(/(^|[^\\])TT+/g,"$1"+e);x=x.replace(/(^|[^\\])T/g,"$1"+e.charAt(0));var p=e.toLowerCase();x=x.replace(/(^|[^\\])tt+/g,"$1"+p);x=x.replace(/(^|[^\\])t/g,"$1"+p.charAt(0));var C=-this.getTimezoneOffset();var k=a||!C?"Z":C>0?"+":"-";if(!a){C=Math.abs(C);var D=Math.floor(C/60);var v=C%60;k+=o(D)+":"+o(v)}x=x.replace(/(^|[^\\])K/g,"$1"+k);var w=(a?this.getUTCDay():this.getDay())+1;x=x.replace(new RegExp(b[0],"g"),b[w]);x=x.replace(new RegExp(g[0],"g"),g[w]);x=x.replace(new RegExp(r[0],"g"),r[j]);x=x.replace(new RegExp(c[0],"g"),c[j]);x=x.replace(/\\(.)/g,"$1");return x};function formatTime(c){try{var a=(new Date(c)).getTime()+(window.timeOffset?window.timeOffset:0);var f=new Date(a);return f.format("h:mm TT")}catch(b){}}function currentTime(){return(new Date()).getTime()+(window.timeOffset?window.timeOffset:0)}function utcToString(a){return(new Date(a)).toLocaleString()}function utcToTimeString(a){return(new Date(a)).toLocaleTimeString()}function utcToDateString(a){return(new Date(a)).toLocaleDateString()}function timeSince(f){if(!f){return"never"}switch(typeof f){case"number":break;case"string":f=+new Date(f);break;case"object":if(f.constructor===Date){f=f.getTime()}break;default:f=+new Date()}var e=[[60,"seconds",1],[120,"1 minute ago","1 minute from now"],[3600,"minutes",60],[7200,"1 hour ago","1 hour from now"],[86400,"hours",3600],[172800,"yesterday","tomorrow"],[604800,"days",86400],[1209600,"last week","next week"],[2419200,"weeks",604800],[4838400,"last month","next month"],[29030400,"months",2419200],[58060800,"last year","next year"],[2903040000,"years",29030400],[5806080000,"last century","next century"],[58060800000,"centuries",2903040000]];var h=(+new Date()+(window.timeOffset?window.timeOffset:0)-f)/1000,b="ago",g=1;if(h==0){return"Just now"}if(h<0){h=Math.abs(h);b="from now";g=2}var a=0,c;while(c=e[a++]){if(h<c[0]){if(typeof c[2]=="string"){return c[g]}else{return Math.floor(h/c[2])+" "+c[1]+" "+b}}}return f}function timeCounter(j){j+=window.timeOffset?window.timeOffset:0;var g=Math.ceil((0+j-(new Date().getTime()))/1000);var f=false;if(g<=0){if(g>-20){return"pending"}f=true;g=-g}var b="";if(g>86400){b=Math.floor(g/86400).toString()+"d ";g=g%86400}var e=Math.floor(g/3600);var a=Math.floor((g-e*3600)/60);var c=g%60;b+=(e>0?(e<10?"0":"")+e.toString()+":":"")+(a<10?"0":"")+a.toString()+":"+(c<10?"0":"")+c.toString();return b}function timeLeft(c,a){if(!c){return 0}c+=window.timeOffset?window.timeOffset:0;var b=Math.round((c-(new Date().getTime()))/1000);switch(a){case"h":return Math.floor(b/3600);break;case"m":return b>=3600?60:Math.floor(b/60);break;case"s":return b>=60?60:Math.floor(b%60);break}return b}function adjustTimeOffset(a){var b=a-(new Date()).getTime();if(isNaN(window.timeOffset)||(Math.abs(b)<Math.abs(window.timeOffset))){window.timeOffset=b}}Object.defineProperty(Array.prototype,"unique",{enumerable:false,value:function(){if(!this){return[]}var e={},c=[];for(var f=0,b=this.length;f<b;++f){if(e.hasOwnProperty(this[f])){continue}c.push(this[f]);e[this[f]]=1}return c}});function mobileCheck(){var a=false;(function(b){if(/(android|bb\d+|meego).+mobile|avantgo|bada\/|blackberry|blazer|compal|elaine|fennec|hiptop|iemobile|ip(hone|od)|iris|kindle|lge |maemo|midp|mmp|mobile.+firefox|netfront|opera m(ob|in)i|palm( os)?|phone|p(ixi|re)\/|plucker|pocket|psp|series(4|6)0|symbian|treo|up\.(browser|link)|vodafone|wap|windows ce|xda|xiino/i.test(b)||/1207|6310|6590|3gso|4thp|50[1-6]i|770s|802s|a wa|abac|ac(er|oo|s\-)|ai(ko|rn)|al(av|ca|co)|amoi|an(ex|ny|yw)|aptu|ar(ch|go)|as(te|us)|attw|au(di|\-m|r |s )|avan|be(ck|ll|nq)|bi(lb|rd)|bl(ac|az)|br(e|v)w|bumb|bw\-(n|u)|c55\/|capi|ccwa|cdm\-|cell|chtm|cldc|cmd\-|co(mp|nd)|craw|da(it|ll|ng)|dbte|dc\-s|devi|dica|dmob|do(c|p)o|ds(12|\-d)|el(49|ai)|em(l2|ul)|er(ic|k0)|esl8|ez([4-7]0|os|wa|ze)|fetc|fly(\-|_)|g1 u|g560|gene|gf\-5|g\-mo|go(\.w|od)|gr(ad|un)|haie|hcit|hd\-(m|p|t)|hei\-|hi(pt|ta)|hp( i|ip)|hs\-c|ht(c(\-| |_|a|g|p|s|t)|tp)|hu(aw|tc)|i\-(20|go|ma)|i230|iac( |\-|\/)|ibro|idea|ig01|ikom|im1k|inno|ipaq|iris|ja(t|v)a|jbro|jemu|jigs|kddi|keji|kgt( |\/)|klon|kpt |kwc\-|kyo(c|k)|le(no|xi)|lg( g|\/(k|l|u)|50|54|\-[a-w])|libw|lynx|m1\-w|m3ga|m50\/|ma(te|ui|xo)|mc(01|21|ca)|m\-cr|me(rc|ri)|mi(o8|oa|ts)|mmef|mo(01|02|bi|de|do|t(\-| |o|v)|zz)|mt(50|p1|v )|mwbp|mywa|n10[0-2]|n20[2-3]|n30(0|2)|n50(0|2|5)|n7(0(0|1)|10)|ne((c|m)\-|on|tf|wf|wg|wt)|nok(6|i)|nzph|o2im|op(ti|wv)|oran|owg1|p800|pan(a|d|t)|pdxg|pg(13|\-([1-8]|c))|phil|pire|pl(ay|uc)|pn\-2|po(ck|rt|se)|prox|psio|pt\-g|qa\-a|qc(07|12|21|32|60|\-[2-7]|i\-)|qtek|r380|r600|raks|rim9|ro(ve|zo)|s55\/|sa(ge|ma|mm|ms|ny|va)|sc(01|h\-|oo|p\-)|sdk\/|se(c(\-|0|1)|47|mc|nd|ri)|sgh\-|shar|sie(\-|m)|sk\-0|sl(45|id)|sm(al|ar|b3|it|t5)|so(ft|ny)|sp(01|h\-|v\-|v )|sy(01|mb)|t2(18|50)|t6(00|10|18)|ta(gt|lk)|tcl\-|tdg\-|tel(i|m)|tim\-|t\-mo|to(pl|sh)|ts(70|m\-|m3|m5)|tx\-9|up(\.b|g1|si)|utst|v400|v750|veri|vi(rg|te)|vk(40|5[0-3]|\-v)|vm40|voda|vulc|vx(52|53|60|61|70|80|81|83|85|98)|w3c(\-| )|webc|whit|wi(g |nc|nw)|wmlb|wonu|x700|yas\-|your|zeto|zte\-/i.test(b.substr(0,4))){a=true}})(navigator.userAgent||navigator.vendor||window.opera);return a}function mobileOrTabletCheck(){var a=false;(function(b){if(/(android|bb\d+|meego).+mobile|avantgo|bada\/|blackberry|blazer|compal|elaine|fennec|hiptop|iemobile|ip(hone|od)|iris|kindle|lge |maemo|midp|mmp|mobile.+firefox|netfront|opera m(ob|in)i|palm( os)?|phone|p(ixi|re)\/|plucker|pocket|psp|series(4|6)0|symbian|treo|up\.(browser|link)|vodafone|wap|windows ce|xda|xiino|android|ipad|playbook|silk/i.test(b)||/1207|6310|6590|3gso|4thp|50[1-6]i|770s|802s|a wa|abac|ac(er|oo|s\-)|ai(ko|rn)|al(av|ca|co)|amoi|an(ex|ny|yw)|aptu|ar(ch|go)|as(te|us)|attw|au(di|\-m|r |s )|avan|be(ck|ll|nq)|bi(lb|rd)|bl(ac|az)|br(e|v)w|bumb|bw\-(n|u)|c55\/|capi|ccwa|cdm\-|cell|chtm|cldc|cmd\-|co(mp|nd)|craw|da(it|ll|ng)|dbte|dc\-s|devi|dica|dmob|do(c|p)o|ds(12|\-d)|el(49|ai)|em(l2|ul)|er(ic|k0)|esl8|ez([4-7]0|os|wa|ze)|fetc|fly(\-|_)|g1 u|g560|gene|gf\-5|g\-mo|go(\.w|od)|gr(ad|un)|haie|hcit|hd\-(m|p|t)|hei\-|hi(pt|ta)|hp( i|ip)|hs\-c|ht(c(\-| |_|a|g|p|s|t)|tp)|hu(aw|tc)|i\-(20|go|ma)|i230|iac( |\-|\/)|ibro|idea|ig01|ikom|im1k|inno|ipaq|iris|ja(t|v)a|jbro|jemu|jigs|kddi|keji|kgt( |\/)|klon|kpt |kwc\-|kyo(c|k)|le(no|xi)|lg( g|\/(k|l|u)|50|54|\-[a-w])|libw|lynx|m1\-w|m3ga|m50\/|ma(te|ui|xo)|mc(01|21|ca)|m\-cr|me(rc|ri)|mi(o8|oa|ts)|mmef|mo(01|02|bi|de|do|t(\-| |o|v)|zz)|mt(50|p1|v )|mwbp|mywa|n10[0-2]|n20[2-3]|n30(0|2)|n50(0|2|5)|n7(0(0|1)|10)|ne((c|m)\-|on|tf|wf|wg|wt)|nok(6|i)|nzph|o2im|op(ti|wv)|oran|owg1|p800|pan(a|d|t)|pdxg|pg(13|\-([1-8]|c))|phil|pire|pl(ay|uc)|pn\-2|po(ck|rt|se)|prox|psio|pt\-g|qa\-a|qc(07|12|21|32|60|\-[2-7]|i\-)|qtek|r380|r600|raks|rim9|ro(ve|zo)|s55\/|sa(ge|ma|mm|ms|ny|va)|sc(01|h\-|oo|p\-)|sdk\/|se(c(\-|0|1)|47|mc|nd|ri)|sgh\-|shar|sie(\-|m)|sk\-0|sl(45|id)|sm(al|ar|b3|it|t5)|so(ft|ny)|sp(01|h\-|v\-|v )|sy(01|mb)|t2(18|50)|t6(00|10|18)|ta(gt|lk)|tcl\-|tdg\-|tel(i|m)|tim\-|t\-mo|to(pl|sh)|ts(70|m\-|m3|m5)|tx\-9|up(\.b|g1|si)|utst|v400|v750|veri|vi(rg|te)|vk(40|5[0-3]|\-v)|vm40|voda|vulc|vx(52|53|60|61|70|80|81|83|85|98)|w3c(\-| )|webc|whit|wi(g |nc|nw)|wmlb|wonu|x700|yas\-|your|zeto|zte\-/i.test(b.substr(0,4))){a=true}})(navigator.userAgent||navigator.vendor||window.opera);return a}function initBootstrapSelect(){$("select").selectpicker()}window.onerror=function myErrorHandler(c,b,a){return false};function mergeObjects(e,c){if(Object.assign){return Object.assign(e,c)}var a={};if(e instanceof Object){for(var b in e){a[b]=e[b]}}if(c instanceof Object){for(var b in c){a[b]=c[b]}}return a}function utoa(a){return window.btoa(unescape(encodeURIComponent(a)))}function atou(a){return decodeURIComponent(escape(window.atob(a)))}function copyToClipboard(a){if(document.selection){var b=document.body.createTextRange();b.moveToElementText(document.getElementById(a));b.select().createTextRange();document.execCommand("Copy")}else{if(window.getSelection){var b=document.createRange();b.selectNode(document.getElementById(a));window.getSelection().addRange(b);document.execCommand("Copy")}}}version=function(){return"v0.1.0a6.20170512"};config.controller("dashboard",["$scope","$rootScope","dataService","$timeout","$interval","$location","$sce","$routeParams","ngDialog","$window",function(r,n,p,d,h,g,m,q,o,c){var b=null;var f=null;var j=null;r.initialized=false;r.loading=true;r.data=null;r.error="";r.designer={};r.locations=null;r.instances=null;r.requestId=0;r.activePistons=0;r.pausedPistons=0;r.dropDownMenu=false;r.view="piston";r.init=function(v,x,w){if(r.$$destroyed){return}if(j){d.cancel(j)}j=null;r.requestId++;var y=0+r.requestId;r.loading=!r.initialized||!r.instance;p.setStatusCallback(r.setStatus);p.loadInstance(v,x,w,(r.view=="dashboard")).then(function(z){if(r.$$destroyed){return}if(y!=r.requestId){return}if(z){if(z.error){switch(z.error){case"ERR_INVALID_TOKEN":r.dialogLogIn(z.name,z.uri);break}}else{r.initialized=true;r.location=p.getLocation();r.instance=p.getInstance();r.currentInstanceId=r.instance.id;r.instanceCount=p.getInstanceCount();if(!r.devices){r.devices=r.listAvailableDevices()}if(!r.virtualDevices){r.virtualDevices=r.listAvailableVirtualDevices()}window.scope=r;r.loading=false;r.activePistons=0;r.pausedPistons=0;for(pistonIndex in r.instance.pistons){var A=r.instance.pistons[pistonIndex];if(A.meta&&A.meta.a){r.activePistons++}else{r.pausedPistons++}}r.clock();r.render()}}else{r.dialogDeleteInstance(v)}})};r.closeNavBar=function(){if(!$("#navbar-btn").hasClass("collapsed")){$("#navbar-btn").click()}};r.render=function(){if(r.$$destroyed){return}if(!r.initialized){return}if(!f){f=h(r.clock,1000)}if(!j){j=d(r.init,5000)}};r.clock=function(){if(r.instance){for(pistonIndex in r.instance.pistons){var v=r.instance.pistons[pistonIndex];v.opacity=v.meta?r.getOpacity(v.meta.t):0}}};r.setStatus=function(v){if(b){d.cancel(b)}b=null;r.status=v;if(r.status){b=d(function(){r.setStatus()},10000)}};r.showDashboard=function(){r.view="dashboard";p.openWebSocket(r.onWSUpdate);r.dropDownMenu=false;r.refreshing=true;p.refreshDashboard().then(function(x){for(deviceId in x){if(deviceId.startsWith(":")){var w=r.instance.devices[deviceId];if(w){var v=x[deviceId];for(attr in v){for(i in w.a){if(w.a[i].n==attr){w.a[i].v=v[attr];break}}}w.data=r.getDeviceData(w)}}}r.refreshing=false;r.setStatus()})};r.hideDashboard=function(){p.closeWebSocket();r.view="piston";r.dropDownMenu=false};r.onWheel=function(v){r.dropDownMenu=v&&v.originalEvent&&(v.currentTarget.scrollTop==0)&&(v.originalEvent.deltaY<0);return true};r.onSwipe=function(v,w){r.dropDownMenu=(v.currentTarget.scrollTop==0)&&(w=="down");return true};r.listLocations=function(){return p.listLocations()};r.listInstances=function(v){return p.listInstances(v)};r.listAllInstances=function(){var w=[];var v=r.listLocations();for(l in v){var x=p.listInstances(v[l].id);for(i in x){w.push({id:x[i].id,name:v[l].name+" \\ "+x[i].name,pistons:x[i].pistons})}}return w};r.listAvailableDevices=function(){var v=[];for(deviceIndex in r.instance.devices){r.instance.devices[deviceIndex].id=deviceIndex;v.push(r.instance.devices[deviceIndex])}return v.sort(r.sortByName)};r.listAvailableVirtualDevices=function(){var v=[];for(deviceIndex in r.instance.virtualDevices){var w=r.instance.virtualDevices[deviceIndex];v.push(mergeObjects({id:deviceIndex},w))}return v.sort(r.sortByName)};r.sortByDisplay=function(w,v){return(w.d>v.d)?1:((v.d>w.d)?-1:0)};r.sortByName=function(w,v){return(w.n>v.n)?1:((v.n>w.n)?-1:0)};r.switchInstance=function(w){if(w!=r.instance.id){var v=p.getInstance(w);if(v){r.instance=null;if(j){d.cancel(j)}j=null;r.devices=null;r.init(v);r.closeNavBar()}}};r.$on("$destroy",function(){if(b){d.cancel(b)}if(f){h.cancel(f)}if(j){d.cancel(j)}});r.getDeviceData=function(v){var w={};for(a in v.a){w[v.a[a].n]=v.a[a].v}return w};r.getBatteryLevel=function(v){if(isNaN(v)){return 0}v=Math.floor(v/20);if(v<=0){return 0}if(v>=4){return 4}return v};r.onWSUpdate=function(v){if(v.isTrusted&&v.data){try{var x=JSON.parse(v.data);if(x.d&&x.n){var w=r.instance.devices[x.d];if(w){for(a in w.a){if(w.a[a].n==x.n){w.a[a].v=x.v;w.data=r.getDeviceData(w);break}}}}r.$apply()}catch(y){}}};r.getDeviceAttribute=function(x,w){for(a in x.a){var v=x.a[a];if(w==v.n){return v.v}}return""};r.openPiston=function(v){r.loading=true;r.initialized=false;g.path("piston/"+v)};r.newPiston=function(){r.loading=true;p.generateNewPistonName().then(function(v){r.loading=false;r.designer={};r.designer.author=p.loadFromStore("author.handle");r.designer.name=v.name;r.designer.page=0;r.designer.backup=!!p.loadFromStore("backup.auto");r.designer.disclaimer=!r.designer.backup;r.designer.items=[{type:"blank",name:"Create a blank piston",icon:"code",cssClass:"wide btn-default"},{type:"duplicate",name:"Create a duplicate piston",icon:"code",cssClass:"wide btn-info"},{type:"template",name:"Create a piston from a template",icon:"code",cssClass:"wide btn-success"},{type:"restore",name:"Restore a piston using a backup code",icon:"code",cssClass:"wide btn-warning"},{type:"import",name:"Import a piston from an external source",icon:"code",cssClass:"wide btn-danger"}];r.designer.dialog=o.open({template:"dialog-add-piston",className:"ngdialog-theme-default ngdialog-large",closeByDocument:false,disableAnimation:true,scope:r})})};r.movePiston=function(){r.designer={pistons:[],instance:""};r.designer.dialog=o.open({template:"dialog-move-piston",className:"ngdialog-theme-default ngdialog-large",closeByDocument:false,disableAnimation:true,scope:r})};r.movePistons=function(){alert("Sorry, not ready yet")};r.createPiston=function(){var v=function(w){r.closeDialog();r.initialized=false;g.path("piston/"+w.id).search({description:r.designer.description,type:r.designer.type,piston:r.designer.piston,bin:r.designer.bin})};r.loading=true;p.saveToStore("backup.auto",!!r.designer.backup);p.saveToStore("author.handle",r.designer.author);if(r.designer.backup){p.generateBackupBin().then(function(w){var x=w.data;p.createPiston(r.designer.name,r.designer.author,x).then(v)})}else{p.createPiston(r.designer.name,r.designer.author).then(v)}};r.dialogLogIn=function(v,w){if(j){d.cancel(j)}j=null;r.loading=false;r.initialized=false;r.designer={};r.designer.sender=v;r.designer.uri=w;r.designer.dialog=o.open({template:"dialog-auth",className:"ngdialog-theme-default ngdialog-large",closeByDocument:false,disableAnimation:true,scope:r})};r.logOut=function(){p.logout().then(function(){r.loading=true;r.initialized=false;g.path("register")})};r.initAds=function(){d(function(){if(CHITIKA_ADS){CHITIKA_ADS.make_it_so()}},1,false)};r.authenticate=function(){r.closeDialog();r.init(null,r.designer.uri,window.md5("pin:"+r.designer.password));r.designer=null};r.dialogDeleteInstance=function(v){if(v){r.loading=false;r.initialized=false;r.designer={};r.designer.sender=v.locationName+" \\ "+v.name;r.designer.instance=v;r.designer.dialog=o.open({template:"dialog-del-instance",className:"ngdialog-theme-default ngdialog-large",closeByDocument:false,disableAnimation:true,scope:r})}};r.deleteInstance=function(){r.closeDialog();p.deleteInstance(r.designer.instance);r.designer=null;r.init()};r.setDesignerType=function(v){r.designer.type=v;r.nextPage()};r.closeDialog=function(){if(r.designer.dialog){r.designer.dialog.close();r.designer.dialog=null}};r.nextPage=function(){r.designer.page++};r.prevPage=function(){if(r.designer.page){r.designer.page--}};r.getOpacity=function(v){if(!v){return 0}v=currentTime()-v;if((v<0)||(v>60000)){return 0}return 1-v/60000};r.breakList=function(v){return v.replace(/,/g,"<br/>")};var u=function(w){var x=w.getFullYear();var y=(1+w.getMonth()).toString();y=y.length>1?y:"0"+y;var v=w.getDate().toString();v=v.length>1?v:"0"+v;return y+"/"+v+"/"+x};r.getMonth=function(v){if(v){return["JAN","FEB","MAR","APR","MAY","JUN","JUL","AUG","SEP","OCT","NOV","DEC"][v.getMonth()]}};r.getDay=function(v){if(v){return("0"+v.getDate()).substr(-2)}};r.timeSince=timeSince;r.timeCounter=timeCounter;r.timeLeft=timeLeft;r.tap=function(v){p.tap(v).then(function(w){})};r.togglePiston=function(x,w){if((!x)&&(!r.viewerPiston||!r.viewerPiston.app)){return}var y=x?x.i:r.pistonId;if(y){d.cancel(tmrRefresh);var v=!(x?x.e:r.viewerPiston.app.enabled);if(x){x.e=v}else{r.viewerPiston.app.enabled=v}if(v){p.resumePiston(y).then(function(z){r.onRefresh(z)})}else{p.pausePiston(y).then(function(z){r.onRefresh(z)})}}if(w&&e.preventDefault){w.preventDefault()}if(w&&w.stopPropagation){w.stopPropagation()}};r.configurePiston=function(v){r.configuredPistonId=r.configuredPistonId==v.i?null:v.i};r.showPiston=function(v){document.body.scrollTop=0;r.viewerPiston=null;r.pistonId=v.i;r.refresh();window.onSwipeRight=r.hidePiston};r.hidePiston=function(){document.body.scrollTop=0;r.pistonId=null;window.onSwipeRight=null};r.prepareActions=function(x){var z=[];var v=[];var C=[];var D=(x.id<=0);var y=r.viewerPiston.tasks;var B=r.viewerPiston.app.actions;for(action in B){if(B[action].pid==x.id){if(B[action].t){var A=B[action].t;for(t in A){var w=0;for(task in y){if((y[task].type=="cmd")&&(y[task].ownerId==B[action].id)&&(y[task].taskId==A[t].i)){if((w==0)||(w>y[task].time)){w=y[task].time}}}A[t].time=w}}if(D){z.push(B[action])}else{if(B[action].rs==false){C.push(B[action])}else{v.push(B[action])}}}}var w=0;for(task in y){if((y[task].type=="evt")&&(y[task].ownerId==x.id)){if((w==0)||(w>y[task].time)){w=y[task].time}}}x.time=w;x.actions=z;x.trueActions=v;x.falseActions=C;x.$scope=r;if(x.children){for(child in x.children){r.prepareActions(x.children[child])}}};r.hadRecentActivity=function(v){return v&&v.le&&v.le.event&&v.le.event.date&&(timeLeft((new Date(v.le.event.date)).getTime())>-120)};r.toggleViewerOptions=function(){r.viewerPiston.showOptions=!r.viewerPiston.showOptions;r.closeNavBar()};r.getSecondaryStatementName=function(){var v=r.viewerPiston.app.mode;switch(v){case"Latching":return"BUT IF";case"Then-If":return"THEN IF";case"Else-If":return"ELSE IF";case"Or-If":return"OR IF";case"And-If":return"AND IF"}return"IF"};r.capturePiston=function(){var v=document.getElementById("viewerPanel");document.body.scrollTop=0;html2canvas(v).then(function(w){r.capturedImage=w.toDataURL("image/png");r.dialogCapture=o.open({template:"dialog-captured-image",className:"ngdialog-theme-default ngdialog-large",disableAnimation:true,scope:r,showClose:true})})};r.determineDeviceType=function(v){return p.determineDeviceType(v)};r.initSocialMedia=function(){c.FB.XFBML.parse()};var s=navigator.userAgent||navigator.vendor||window.opera;if(s.match(/Android/i)){r.android=true}r.url=window.location.href;r.mobile=window.mobileCheck();r.tablet=(!r.mobile)&&(window.mobileOrTabletCheck());r.formatTime=formatTime;r.utcToString=utcToString;r.$$postDigest(function(){c.FB.XFBML.parse()});var k=setInterval(function(){if(p.ready()){clearInterval(k);r.init()}},1)}]);config.controller("register",["$scope","$rootScope","dataService","$timeout","$interval","$location","$sce","$routeParams","ngDialog","$window",function(k,g,i,c,e,d,f,j,h,b){var a=null;k.loading=false;k.code="";k.init=function(){};k.setStatus=function(m){if(a){c.cancel(a)}a=null;k.status=m;if(k.status){a=c(function(){k.setStatus()},10000)}};k.$on("$destroy",function(){if(a){c.cancel(a)}});k.register=function(){k.loading=true;i.registerDashboard(k.code).then(function(m){if(m&&(m.length>=80)&&(m.length<=128)){d.path("/init/"+m)}else{k.setStatus("Sorry, the registration code you provided did not work...")}k.loading=false})};k.init();var l=navigator.userAgent||navigator.vendor||window.opera;if(l.match(/Android/i)){k.android=true}k.url=window.location.href;k.mobile=window.mobileCheck();k.tablet=(!k.mobile)&&(window.mobileOrTabletCheck());k.formatTime=formatTime;k.utcToString=utcToString}]);config.controller("piston",["$scope","$rootScope","dataService","$timeout","$interval","$location","$sce","$routeParams","ngDialog","$window","$animate",function(s,j,u,y,v,h,n,f,m,q,w){var x;var A;var g;var r;s.lastLogEntry=0;s.error="";s.loading=true;s.initialized=false;s.mode="view";s.logging="0";s.data=null;s.error="";s.pistonId=f.pistonId;s.piston=null;s.designer={};s.showAdvancedOptions=false;s.dk="N7zqL6a8Texs4wY5y&y2YPLzus+_dZ%s";s.params=h.search();s.insertIndexes={};if(s.params){h.search({})}s.stack={undo:[],redo:[]};s.weekDays=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"];s.yearMonths=["January","February","March","April","May","June","July","August","September","October","November","December"];s.render=function(B){if((s.mode=="view")&&(s.view.trace)){if(!r){r=v(s.render,1000)}if(s.trace){}}else{if(r){y.cancel(r)}r=null}};s.setStatus=function(B){if(B){console.log(B)}if(A){y.cancel(A)}A=null;s.status=B;if(s.status){A=y(function(){s.setStatus()},10000)}};s.listAllPistons=function(){var C=[];var B=u.listLocations();for(l in B){var D=u.listInstances(B[l].id);for(i in D){for(p in D[i].pistons){C.push({v:D[i].pistons[p].id,n:B[l].name+" \\ "+D[i].name+" \\ "+D[i].pistons[p].name})}}}return C};s.listAvailableContacts=function(){var C=[];for(i in s.instance.contacts){var B=s.instance.contacts[i];C.push({v:i,n:(B.f+" "+B.l).trim()+(B.p?" (PUSH)":(B.t?" ("+B.t+")":"")),an:B.an})}if(!C.length){C.push({v:"no one",n:"No available contacts"})}return C};s.getPistonName=function(D){var B=u.listLocations();for(l in B){var C=u.listInstances(B[l].id);for(i in C){for(p in C[i].pistons){if(C[i].pistons[p].id==D){return B[l].name+" \\ "+C[i].name+" \\ "+C[i].pistons[p].name}}}}return D};s.getModeName=function(B){for(modeIndex in s.location.modes){if(s.location.modes[modeIndex].id==B){return s.location.modes[modeIndex].name}}return B};s.updateActivity=function(B){if(s.$$destroyed){return}if(s.mode!="view"){return}if(g){y.cancel(g)}if(B){g=y(s.updateActivity,10000);return}u.getActivity(s.pistonId,s.lastLogEntry).then(function(C){if(s.$$destroyed){return}if(C.error=="ERR_INVALID_ID"){s.home();return}if(C&&C.activity){if(C.activity.state){s.state=C.activity.state}if(C.activity.logs&&C.activity.logs.length){s.logs=C.activity.logs.concat(s.logs)}if(C.activity.trace){s.trace=C.activity.trace}if(C.activity.localVars){s.localVars=C.activity.localVars}if(C.activity.memory){s.memory=C.activity.memory}if(C.activity.lastExecuted){s.lastExecuted=C.activity.lastExecuted}if(C.activity.nextSchedule){s.nextSchedule=C.activity.nextSchedule}if(C.activity.schedules){s.schedules=C.activity.schedules}if(C.activity.name){s.meta.name=C.activity.name}if(s.logs&&s.logs.length){s.lastLogEntry=s.logs[0].t}if(C.activity.globalVars){s.updateGlobalVars(C.activity.globalVars)}}g=y(s.updateActivity,3000)})};s.updateGlobalVars=function(B){s.globalVars=s.globalVars instanceof Object?s.globalVars:{};for(varName in B){var C=B[varName].t;var E=B[varName].v;var D=s.globalVars[varName];if(!D){s.globalVars[varName]={t:C,v:E}}else{if(D.t!=C){D.t=C}if(D.v!=E){D.v=E}}}for(varName in s.globalVars){if(!B[varName]){delete (s.globalVars[varName])}}};s.init=function(){if(s.$$destroyed){return}u.setStatusCallback(s.setStatus);s.loading=true;if(s.piston){s.loading=true}u.getPiston(s.pistonId).then(function(B){if(s.$$destroyed){return}try{var C=s.piston?!!s.showOptions:false;if(!B||!B.data||!B.data.piston){s.error=n.trustAsHtml("Sorry, an error occurred while retrieving the piston data.");s.loading=false;return}s.piston=B.data.piston;s.meta=B.data.meta?B.data.meta:{};s.db=B.db;s.location=u.getLocation();s.instance=u.getInstance();s.view=u.loadFromStore("view")||{variables:false,elseIfs:false,restrictions:false,whens:false,advancedStatements:false};s.subscriptions=B.data.subscriptions?B.data.subscriptions:{};s.logs=B.data.logs?B.data.logs:[];s.lastLogEntry=(s.logs&&s.logs.length)?s.logs[0].t:0;s.stats=B.data.stats?B.data.stats:{};s.state=B.data.state?B.data.state:"";s.trace=B.data.trace?B.data.trace:{};s.logging=""+(B.data.logging?B.data.logging:0);s.memory=B.data.memory?B.data.memory:0;s.lastExecuted=B.data.lastExecuted;s.nextSchedule=B.data.nextSchedule;s.schedules=B.data.schedules;s.initChart();if(s.instance&&s.instance.devices){s.anonymizeDevices(s.instance.devices)}if(s.instance&&s.instance.contacts){s.anonymizeContacts(s.instance.contacts)}s.devices=s.listAvailableDevices();s.contacts=s.listAvailableContacts();s.virtualDevices=s.listAvailableVirtualDevices();window.scope=s;s.localVars=B.data.localVars;s.globalVars=s.instance.globalVars;s.systemVars=B.data.systemVars;s.systemVarNames=[];for(name in s.systemVars){s.systemVarNames.push(name)}s.meta.build=s.meta.build?1*s.meta.build:0;if(s.piston&&(s.meta.build==0)){s.piston.z=s.params&&s.params.description?s.params.description:"";s.mode="edit";if(s.params&&s.params.type!="blank"){switch(s.params.type){case"duplicate":if(s.params.piston){s.loading=true;u.getPiston(s.params.piston).then(function(E){s.loading=false;if(E&&E.data&&E.data.piston){s.piston.o=E.data.piston.o?E.data.piston.o:{};s.piston.r=E.data.piston.r?E.data.piston.r:[];s.piston.rn=!!E.data.piston.rn;s.piston.rop=E.data.piston.rop?E.data.piston.rop:"and";s.piston.s=E.data.piston.s?E.data.piston.s:[];s.piston.v=E.data.piston.v?E.data.piston.v:[]}s.initialized=true;s.loading=false});return}break;case"restore":if(s.params.bin){s.loading=true;u.loadFromBin(s.params.bin).then(function(E){var F=E.data;s.loading=false;if(F){s.piston.o=F.o?F.o:{};s.piston.r=F.r?F.r:[];s.piston.rn=!!F.rn;s.piston.rop=F.rop?F.rop:"and";s.piston.s=F.s?F.s:[];s.piston.v=F.v?F.v:[];s.piston.z=F.z?F.z:""}s.initialized=true;s.loading=false;if(!!F&&!!F.l){s.rebuildPiston(F.l)}});return}break}}}if(s.mode=="edit"){s.loadStack()}else{s.updateActivity(true)}s.piston.o=s.piston.o?s.piston.o:{cto:0,ced:0};s.piston.r=s.piston.r?s.piston.r:[];s.piston.s=s.piston.s?s.piston.s:[];s.piston.rop=s.piston.rop?s.piston.rop:"and";s.piston.rn=!!s.piston.rn;s.piston.v=s.piston.v?s.piston.v:[];s.piston.z=s.piston.z||"";s.initialized=true;s.loading=false;s.render()}catch(D){alert(D)}})};s.initChart=function(){s.chart={type:"bar",labels:[],series:["Event delay","Load time","Execution time","Update time"],data:[[],[],[],[]],onClick:function(D,C){},datasetOverride:[{cubicInterpolationMode:"monotone",lineTension:0,yAxisID:"y-axis-1",fill:true,pointRadius:0,borderColor:"#88bbee",borderWidth:0,backgroundColor:"#99ccff"},{cubicInterpolationMode:"monotone",lineTension:0,yAxisID:"y-axis-1",fill:true,pointRadius:0,borderColor:"#eebb88",borderWidth:"0px",backgroundColor:"#ffcc99"},{cubicInterpolationMode:"monotone",lineTension:0,yAxisID:"y-axis-1",fill:true,pointRadius:0,borderColor:"#ee88bb",borderWidth:"0px",backgroundColor:"#ff99cc"},{cubicInterpolationMode:"monotone",lineTension:0,yAxisID:"y-axis-1",fill:true,pointRadius:0,borderColor:"#999",borderWidth:1,backgroundColor:"#ccff99"}],options:{legend:{display:true},multiTooltipTemplate:"<%=datasetLabel%> : <%= value %>ms",showLines:true,fill:true,scales:{xAxes:[{type:"time"}],yAxes:[{id:"y-axis-1",stacked:true,type:"linear",display:true,position:"left"}]},pan:{enabled:true,mode:"x"},zoom:{enabled:true,mode:"x"}}};if(s.stats&&s.stats.timing){for(var B=0;B<s.stats.timing.length;B++){s.chart.labels.push(new Date(s.stats.timing[B].t));s.chart.data[0].push(s.stats.timing[B].d);s.chart.data[1].push(s.stats.timing[B].l);s.chart.data[2].push(s.stats.timing[B].e);s.chart.data[3].push(s.stats.timing[B].u)}}};s.$on("$destroy",function(){if(A){y.cancel(A)}if(x){y.cancel(x)}if(g){y.cancel(g)}if(r){y.cancel(r)}});s.copy=function(B){return angular.fromJson(angular.toJson(B))};s.home=function(){s.initialized=false;h.path("/")};s.toggleView=function(B){if(B){s.view[B]=!s.view[B]}u.saveToStore("view",s.view)};s.revealBin=function(){s.revealing=!s.revealing;if(x){y.cancel(x)}if(s.revealing){x=y(function(){s.revealing=false;x=null},10000)}};s.edit=function(){s.mode="edit";s.init();$("viewer")[0].scrollTop=0};s.cancel=function(){s.mode="view";s.init()};s.save=function(){s.loading=true;var B=s.compilePiston({id:s.pistonId,o:s.piston.o,s:s.piston.s,v:s.piston.v,r:s.piston.r,rop:s.piston.rop,rn:s.piston.rn,z:s.piston.z,n:s.meta.name});u.setPiston(B,s.meta.bin).then(function(C){s.loading=false;if(C&&C.data&&C.data.build){s.meta.active=C.data.active;s.meta.modified=C.data.modified;s.meta.build=C.data.build;s.saveStack(true);s.mode="view";s.init()}})};s.pause=function(){s.loading=true;u.pausePiston(s.pistonId).then(function(B){s.loading=false;if(B&&B.status&&(B.status=="ST_SUCCESS")){s.meta.active=B.active;s.subscriptions={};s.updateActivity()}})};s.setLoggingLevel=function(B){s.loading=true;u.setPistonLogging(s.pistonId,s.logging).then(function(C){s.loading=false})};s.resume=function(){s.loading=true;u.resumePiston(s.pistonId).then(function(B){s.loading=false;if(B&&B.status&&(B.status=="ST_SUCCESS")){s.meta.active=B.active;if(B.subscriptions){s.subscriptions=B.subscriptions}s.updateActivity()}})};s.del=function(){s.loading=true;u.deleteFromStore("stack"+s.pistonId);u.deletePiston(s.pistonId).then(function(B){s.closeDialog();h.path("/")})};s.padComment=function(C,B){if(!C){C=""}B=B-6-C.length;while(B>0){C+=" ";B--}return"/* "+C+" */"};s.range=function(B){return new Array(B)};s.wiki=function(B){s.wikiUrl=n.trustAsUrl("https://wiki.webcore.co/"+B+"?content-only");q.mydialog=m.open({template:"dialog-wiki",className:"ngdialog-theme-default ngdialog-large ngdialog-wiki",closeByDocument:true,disableAnimation:true,scope:s})};s.formatVariableValue=function(C,B){if((C.v==null)&&!!B&&s.localVars){C=s.copy(C);C.v=s.localVars[B]}if((C.v==="")||(C.v===null)||((C.v instanceof Array)&&!C.v.length)){return"(not set)"}switch(C.t){case"time":return utcToTimeString(C.v);case"datetime":return utcToString(C.v);case"date":return utcToDateString(C.v);case"contact":return s.renderContactNameList(C.v);case"device":return s.renderDeviceNameList(C.v);default:return C.v}};s.deleteDialog=function(){s.designer.dialog=m.open({template:"dialog-del-piston",className:"ngdialog-theme-default ngdialog-large",closeByDocument:false,disableAnimation:true,scope:s})};s.listDevicesWithAttributes=function(C){if(!C||!(C instanceof Array)||!C.length){return s.instance.devices}var B={};for(d in s.instance.devices){var D=s.instance.devices[d];var E=0;for(a in D.a){if(C.indexOf(D.a[a].n)>=0){E++;if(E==C.length){break}}}if(E==C.length){B[d]=D}}return B};s.rebuildPiston=function(B){if(!B){return}for(key in B){var C=B[key];C.id="";switch(C.t){case"device":C.i=s.listDevicesWithAttributes(C.a);break;case"contact":C.i=s.instance.contacts;break;case"mode":C.i=s.instance.virtualDevices.mode.o;for(i in C.i){if(C.i[i]==C.n){C.id=i;break}}break;case"routine":C.i=s.instance.virtualDevices.routine.o;break}}s.designer={legend:B};s.designer.dialog=m.open({template:"dialog-rebuild-piston",className:"ngdialog-theme-default ngdialog-large",closeByDocument:false,disableAnimation:true,scope:s})};s.doRebuildPiston=function(){s.piston=s.compilePiston(s.piston,false,s.designer.legend);s.closeDialog()};s.getExpressionConfig=function(){var B=[];for(attribute in s.db.attributes){B.push(": "+attribute+"]")}return{autocomplete:[{words:[]},{words:s.listAutoCompleteFunctions(),cssClass:"hl kwd"},{words:s.listAutoCompleteVariables(),cssClass:"hl var"},{words:s.listAutoCompleteDevices(),cssClass:"hl dev"},{words:B,cssClass:"hl dev"},{words:[/([0-9]+)(\.[0-9]+)?/g],cssClass:"hl num"}]}};s.removeFromArray=function(D,C){if(!(D instanceof Array)){return}var B=D.indexOf(C);if(B!==-1){D.splice(B,1)}return D};s.deleteObject=function(D,C){var B=!D;if(B){D=s.designer.$obj;C=s.designer.parent}if(!D){return}if((C instanceof Array)&&(D)){s.autoSave();C=s.removeFromArray(C,D);if(B){s.closeDialog()}}if(C&&(C.t=="action")&&(C.k instanceof Array)&&(D)){s.autoSave();C.k=s.removeFromArray(C.k,D);if(B){s.closeDialog()}}};s.getIFTTTUri=function(B){var C=u.getApiUri();if(!C){return"An error has occurred retrieving the IFTTT Maker URL"}return C+"ifttt/"+B};s.toggleAdvancedOptions=function(){s.designer.showAdvancedOptions=!s.designer.showAdvancedOptions};s.getClipboard=function(){var B=u.loadFromStore("clipboard");if(!B){B=[]}return B};s.getClipboardItems=function(D){var C=s.getClipboard();var B=[];for(i in C){if(C[i].t.startsWith(D)){B.push(C[i])}}return B};s.saveToClipboard=function(C,B){var D=s.getClipboard();D.push({s:(new Date()).getTime(),t:B,o:s.copy(C)});if(D.length>MAX_STACK_SIZE){D=D.slice(-MAX_STACK_SIZE)}u.saveToStore("clipboard",D)};s.deleteClipboardItem=function(B){var C=s.getClipboard();s.removeFromArray(s.designer.clipboard,B);for(i=0;i<C.length;i++){if((C[i].s==B.s)&&(C[i].t==B.t)){break}}if(i<C.length){C.splice(i,1);u.saveToStore("clipboard",[])}};s.clearClipboard=function(){u.saveToStore("clipboard",[])};s.copySelection=function(){if(!s.selection){return}s.saveToClipboard(s.selection,s.selectionType)};s.cutSelection=function(){if(!s.selection){return}s.saveToClipboard(s.selection,s.selectionType);s.deleteObject(s.selection,s.selectionParent)};s.duplicateSelection=function(){if(!s.selection){return}if(!s.selectionParent){return}if(s.selectionParent instanceof Array){s.selectionParent.push(s.copy(s.selection))}};s.deleteSelection=function(){if(!s.selection){return}s.deleteObject(s.selection,s.selectionParent)};s.pasteItem=function(C){if(!C||!C.o||!s.designer||!s.designer.parent){return}var B=(s.designer.parent instanceof Array)?s.designer.parent:(C.t.startsWith("condition")&&s.designer.parent.c?s.designer.parent.c:(C.t.startsWith("restriction")&&s.designer.parent.r?s.designer.parent.r:(C.t.startsWith("task")&&s.designer.parent.k?s.designer.parent.k:null)));if(!B){return}B.push(s.copy(C.o));s.closeDialog()};s.contextMenu=function(C){var B=[];if(s.selection){B.push(["Copy selected "+s.selectionType,s.copySelection]);if(s.mode=="edit"){B.push(["Duplicate selected "+s.selectionType,s.duplicateSelection]);if(s.selectionParent){B.push(null);B.push(["Cut selected "+s.selectionType,s.cutSelection]);B.push(["Delete selected "+s.selectionType,s.deleteSelection])}}B.push(null)}B.push(["Clear clipboard",s.clearClipboard]);return B};s.select=function(C,D,B){if(!B){B="statement"}s.selection=C;s.selectionParent=D;s.selectionType=B};s.editSettings=function(){if(s.mode!="edit"){return}s.designer={name:s.meta.name,description:s.piston.z,automaticState:s.piston.o.mps?1:0,conditionOptimizations:s.piston.o.cto?1:0,executionParallelism:s.piston.o.pep?1:0,eventSubscriptions:s.piston.o.des?1:0,commandDelay:s.piston.o.ced?s.piston.o.ced:0};window.designer=s.designer;s.designer.dialog=m.open({template:"dialog-edit-settings",className:"ngdialog-theme-default ngdialog-large",closeByDocument:false,disableAnimation:true,scope:s})};s.updateSettings=function(){s.meta.name=s.designer.name;s.piston.z=s.designer.description;s.piston.o.mps=s.designer.automaticState?1:0;s.piston.o.pep=s.designer.executionParallelism?1:0;s.piston.o.cto=s.designer.conditionOptimizations?1:0;s.piston.o.des=s.designer.eventSubscriptions?1:0;s.piston.o.ced=isNaN(s.designer.commandDelay)?0:parseInt(s.designer.commandDelay);s.closeDialog()};s.addStatement=function(B){return s.editStatement(null,B)};s.editStatement=function(C,B){if(s.mode!="edit"){return}if(!C){C={};C.t=null;C.d=[];C.o="and";C.n=false;C.rop="and";C.rn=false;C.a="0";C.di=false;C.tcp="c";C.tep="";C.tsp="";C.ctp="i";C.s="local";C.z=""}s.designer={config:s.getExpressionConfig(),clipboard:C.t?[]:s.getClipboardItems("statement")};s.designer.$obj=C;s.designer.$statement=C;s.designer.$new=C.t?false:true;s.designer.type=C.t;s.designer.page=C.t?1:0;s.designer.operator=C.o;s.designer.not=C.n?"1":"0";s.designer.disabled=C.di?"1":"0";s.designer.roperator=C.rop;s.designer.rnot=C.rn?"1":"0";s.designer.description=C.z;s.designer.parent=B;s.designer.devices=C.d;s.designer.operand={data:s.copy(C.lo),multiple:false};s.designer.operand2={data:s.copy(C.lo2),multiple:false};s.designer.operand3={data:s.copy(C.lo3),multiple:false};s.designer.x=C.x;s.designer.autoDialogs=true;s.designer.tcp=C.tcp;s.designer.tep=C.tep;s.designer.tsp=C.tsp;s.designer.ctp=C.ctp||"i";s.designer.async=C.a;s.designer.ontypechanged=function(D,E){D.operand.requirePositiveNumber=false;D.operand2.requirePositiveNumber=false;D.operand3.requirePositiveNumber=false;switch(E){case"for":D.operand.dataType="decimal";D.operand2.dataType="decimal";D.operand3.dataType="decimal";D.operand.onlyAllowConstants=false;D.operand.hideMilliseconds=true;if(D.$new){D.operand.data={t:"c"}}if(D.$new){D.operand2.data={t:"c"}}if(D.$new){D.operand3.data={t:"c"}}s.validateOperand(D.operand,true);s.validateOperand(D.operand2,true);s.validateOperand(D.operand3,true);break;case"each":D.operand.dataType="devices";D.operand.onlyAllowConstants=false;D.operand.hideMilliseconds=true;if(D.$new){D.operand.data={t:"d"}}s.validateOperand(D.operand,true);break;case"switch":D.operand.dataType="";D.operand.onlyAllowConstants=false;D.operand.hideMilliseconds=true;if(D.$new){D.operand.data={t:"p"}}s.validateOperand(D.operand,true);break;case"every":D.operand.dataType="duration";if(D.$new){D.operand.data={t:"c",c:1,vt:"d"}}D.operand.onlyAllowConstants=true;D.operand.hideMilliseconds=true;D.operand2.dataType="time";var F=new Date();F.setSeconds(0,0);if(D.$new){D.operand2.data={t:"c",c:F}}D.operand3.dataType="duration";if(D.$new){D.operand3.data={t:"c",c:0,vt:"m"}}D.operand3.onlyAllowConstants=true;s.validateOperand(D.operand,true);s.validateOperand(D.operand2,true);s.validateOperand(D.operand3,true);break}s.refreshSelects()};window.designer=s.designer;s.designer.items={simple:[{type:"if",name:"If Block",icon:"code-fork",cssClass:"info",description:"An if block allows the piston to execute different actions depending on the truth result of a comparison or set of comparisons",button:"an if"},{type:"action",name:"Action",icon:"code",cssClass:"success",description:"An action allows the piston to control devices and execute tasks",button:"an action"},{type:"every",name:"Timer",icon:"clock-o",cssClass:"warning",description:"A timer will trigger execution of the piston at set time intervals",button:"a timer"}],advanced:[{type:"switch",name:"Switch",icon:"code-fork",cssClass:"info",description:"A switch statement compares an operand against a set of values and executes statements corresponding to those matches",button:"a switch"},{type:"do",name:"Do Block",icon:"code",cssClass:"success",description:"A do block can help organize several statements into a single block",button:"a do block"},{type:"on",name:"On event",icon:"code-fork",cssClass:"warning",description:"An on event executes its statements only when certain events happen",button:"an on event"},{type:"for",name:"For Loop",icon:"circle-o-notch",cssClass:"warning",description:"A for loop executes the same statements for a set number of iteration cycles",button:"a for loop"},{type:"each",name:"For Each Loop",icon:"circle-o-notch",cssClass:"warning",description:"An each loop executes the same statements for each device in a device list",button:"a for each loop"},{type:"while",name:"While Loop",icon:"circle-o-notch",cssClass:"warning",description:"A while loop executes the same statements for as long as a condition is met",button:"a while loop"},{type:"repeat",name:"Repeat Loop",icon:"circle-o-notch",cssClass:"warning",description:"A repeat loop executes the same statements until a condition is met",button:"a repeat loop"},{type:"break",name:"Break",icon:"ban",cssClass:"danger",description:"A break allows the interruption of the inner most switch, for loop, for each loop, while loop, or repeat loop",button:"a break"},{type:"exit",name:"Exit",icon:"ban",cssClass:"danger",description:"An exit interrupts the piston execution and exits immediately",button:"an exit"}]};s.designer.ontypechanged(s.designer,s.designer.type);s.designer.dialog=m.open({template:"dialog-edit-statement",className:"ngdialog-theme-default ngdialog-large",closeByDocument:false,disableAnimation:true,scope:s})};s.updateStatement=function(C,D){s.autoSave();var B=s.designer.$new?{t:s.designer.type}:s.designer.$statement;B.a=(s.designer.async=="1")||(["every","on"].indexOf(s.designer.type)>=0)?"1":"0";B.tcp=s.designer.tcp;B.tep=s.designer.tep;B.tsp=s.designer.tsp;B.z=s.designer.description;B.r=B.r?B.r:[];B.rop=s.designer.roperator;B.rn=s.designer.rnot=="1";B.di=s.designer.disabled=="1";switch(B.t){case"action":B.d=s.designer.devices;B.k=B.k?B.k:[];break;case"do":B.s=B.s?B.s:[];break;case"on":B.c=B.c?B.c:[];B.o="or";B.n=false;B.s=B.s?B.s:[];break;case"if":B.o=s.designer.operator;B.n=s.designer.not=="1";B.c=B.c?B.c:[];B.s=B.s?B.s:[];B.ei=B.ei?B.ei:[];B.e=B.e?B.e:[];break;case"switch":B.lo=s.designer.operand.data;B.cs=B.cs||[];B.e=B.e?B.e:[];B.ctp=s.designer.ctp;break;case"for":B.x=s.designer.x;B.lo=s.designer.operand.data;B.lo2=s.designer.operand2.data;B.lo3=s.designer.operand3.data;B.s=B.s?B.s:[];break;case"each":B.x=s.designer.x;B.lo=s.designer.operand.data;B.s=B.s?B.s:[];break;case"while":B.o=s.designer.operator;B.n=s.designer.not=="1";B.c=B.c?B.c:[];B.s=B.s?B.s:[];break;case"every":B.lo=s.designer.operand.data;B.lo2=s.designer.operand2.data;if(B.lo2.c instanceof Date){B.lo2.c=B.lo2.c.getHours()*60+B.lo2.c.getMinutes()}B.lo3=s.designer.operand3.data;B.s=B.s?B.s:[];break;case"repeat":B.o=s.designer.operator;B.n=s.designer.not=="1";B.c=B.c?B.c:[];B.s=B.s?B.s:[];break;case"break":break;case"exit":B.lo=s.designer.operand.data;break;default:B.t=null}if(B.t){B.$$html=null;if(s.designer.$new){if(s.designer.parent instanceof Array){s.designer.parent.push(B)}else{if((s.designer.parent.s)&&(s.designer.parent.s instanceof Array)){s.designer.parent.s.push(B)}else{s.designer.parent.s=[B]}}}else{s.designer.$statement=B}}s.closeDialog();if(C){switch(B.t){case"action":s.addTask(B);break;case"if":s.addCondition(B.c,false,D);break;case"on":s.addEvent(B.c);break;case"while":s.addCondition(B.c);break;case"do":case"for":case"each":case"repeat":s.addStatement(B.s);break;case"switch":s.addCase(B.cs);break}}};s.upgradeStatement=function(){s.updateStatement();var B=s.designer.$statement;if(B&&B.c&&(B.c instanceof Array)){B.c=[{t:"group",n:false,o:"and",c:B.c}]}};s.addCase=function(B){return s.editCase(null,B)};s.editCase=function(B,C){if(s.mode!="edit"){return}var D=B?false:true;if(!B){B={};B.t="s";B.s=[];B.ro={};B.ro2={};B.z=""}s.designer={config:s.getExpressionConfig()};s.designer.$obj=B;s.designer.$case=B;s.designer.$new=D;s.designer.parent=C;s.designer.type=B.t;s.designer.operand={data:B.ro,multiple:false};s.designer.operand2={data:B.ro2,multiple:false};s.designer.autoDialogs=true;s.designer.description=B.z;window.designer=s.designer;s.validateOperand(s.designer.operand);s.validateOperand(s.designer.operand2);s.designer.dialog=m.open({template:"dialog-edit-case",className:"ngdialog-theme-default ngdialog-large",closeByDocument:false,disableAnimation:true,scope:s})};s.updateCase=function(C){s.autoSave();var B=s.designer.$case;B.t=s.designer.type;B.s=B.s||[];B.ro=s.designer.operand.data;B.ro2=s.designer.operand2.data;B.z=s.designer.description;if(B.t){B.$$html=null;B.$$html2=null;if(s.designer.$new){if(s.designer.parent instanceof Array){s.designer.parent.push(B)}else{if((s.designer.parent.cs)&&(s.designer.parent.cs instanceof Array)){s.designer.parent.cs.push(B)}else{s.designer.parent.cs=[B]}}}else{s.designer.$case=B}}s.closeDialog();if(C){s.addStatement(B.s)}};s.addEvent=function(B){return s.editEvent(null,B)};s.editEvent=function(D,B){if(s.mode!="edit"){return}var C=!D;if(!D){D={};D.t="event";D.lo={t:"p",d:[],a:null,g:"any",v:null,c:"",x:null,e:""};D.z="";D.sm="auto"}s.designer={config:s.getExpressionConfig(),clipboard:C?s.getClipboardItems("event"):[]};s.designer.$event=D;s.designer.$obj=D;s.designer.type=D.t;s.designer.$new=C;s.designer.parent=B;s.designer.comparison={event:true,type:"event",left:{data:D.lo?s.copy(D.lo):{},event:true}};s.validateComparison(s.designer.comparison,true);s.designer.smode=D.sm;s.designer.description=D.z;window.designer=s.designer;s.designer.dialog=m.open({template:"dialog-edit-event",className:"ngdialog-theme-default ngdialog-large",closeByDocument:false,disableAnimation:true,scope:s})};s.updateEvent=function(C){s.autoSave();var B=s.designer.$new?{t:s.designer.type}:s.designer.$event;B.lo=s.fixOperand(s.designer.comparison.left.data);B.sm=s.designer.smode;B.z=s.designer.description;if(B.t){B.$$html=null;if(s.designer.$new){if(s.designer.parent instanceof Array){s.designer.parent.push(B)}else{if((s.designer.parent.c)&&(s.designer.parent.c instanceof Array)){s.designer.parent.c.push(B)}else{s.designer.parent.c=[B]}}}else{s.designer.$event=B}}s.closeDialog();if(B.t&&C){s.addEvent(s.designer.parent)}};s.addCondition=function(B,C,D){return s.editCondition(null,B,C,D)};s.editCondition=function(F,B,D,E){if(s.mode!="edit"){return}var C=!F;if(!F){F={};F.t=E;F.d=[];F.n=false;F.o="and";F.lo={t:"p",d:[],a:null,g:"any",v:null,c:"",x:null,e:""};F.co=null;F.ro={t:"c",d:[],a:null,g:"any",v:null,c:"",x:null,e:""};F.ro2={t:"c",d:[],a:null,g:"any",v:null,c:"",x:null,e:""};F.to={t:"c",d:[],a:null,g:"any",v:null,c:"",x:null,e:""};F.to2={t:"c",d:[],a:null,g:"any",v:null,c:"",x:null,e:""};F.z="";F.sm="auto";F.ts=[];F.fs=[]}s.designer={config:s.getExpressionConfig(),clipboard:C?s.getClipboardItems("condition"):[]};s.designer.$condition=F;s.designer.$obj=F;s.designer.type=F.t;s.designer.$new=!E&&!!F.t?false:true;s.designer.newElseIf=D;s.designer.page=s.designer.$new&&!E?0:1;s.designer.parent=B;s.designer.devices=F.d;s.designer.not=F.n?"1":"0";s.designer.operator=F.o;s.designer.comparison={type:"condition",left:{data:F.lo?s.copy(F.lo):{},showSubDevices:true},operator:F.co,right:{data:F.ro?s.copy(F.ro):{}},right2:{data:F.ro2?s.copy(F.ro2):{}},time:{data:F.to?s.copy(F.to):{t:"c",c:0},dataType:"duration"},time2:{data:F.to2?s.copy(F.to2):{t:"c",c:0},dataType:"duration"}};s.validateComparison(s.designer.comparison,true);s.designer.smode=F.sm;s.designer.description=F.z;window.designer=s.designer;s.designer.items=[{type:"condition",name:"Condition",icon:"code",cssClass:"btn-info"},{type:"group",name:"Group",icon:"code-fork",cssClass:"btn-warning"}];s.designer.dialog=m.open({template:"dialog-edit-condition",className:"ngdialog-theme-default ngdialog-large",closeByDocument:false,disableAnimation:true,scope:s})};s.fixOperand=function(B){switch(B.vt){case"time":B.c=B.c instanceof Date?B.c.getHours()*60+B.c.getMinutes():B.c;break;case"date":case"datetime":B.c=B.c instanceof Date?B.c.getTime():(new Date(B.c)).getTime();break}return B};s.updateCondition=function(C){s.autoSave();var D=s.designer.$new?{t:s.designer.type}:s.designer.$condition;switch(D.t){case"condition":D.lo=s.fixOperand(s.designer.comparison.left.data);D.co=s.designer.comparison.operator;D.ro=s.fixOperand(s.designer.comparison.right.data);D.ro2=s.fixOperand(s.designer.comparison.right2.data);D.to=s.designer.comparison.time.data;D.to2=s.designer.comparison.time2.data;break;case"group":D.c=D.c?D.c:[];D.o=s.designer.operator;D.n=s.designer.not=="1";break}D.sm=s.designer.smode;D.ts=D.ts?D.ts:[];D.fs=D.fs?D.fs:[];D.z=s.designer.description;if(D.t){D.$$html=null;if(s.designer.$new){if(s.designer.newElseIf){var B={o:"and",n:false,c:[],s:[]};B.c.push(D);s.designer.parent.push(B)}else{if(s.designer.parent instanceof Array){s.designer.parent.push(D)}else{if((s.designer.parent.c)&&(s.designer.parent.c instanceof Array)){s.designer.parent.c.push(D)}else{s.designer.parent.c=[D]}}}}else{s.designer.$condition=D}}s.closeDialog();if(D.t&&C){s.addCondition(D.t=="group"?D:s.designer.parent)}};s.upgradeCondition=function(){s.updateCondition();var C=s.designer.parent;if(s.designer.$condition&&C&&(C instanceof Array)){var B=C.indexOf(s.designer.$condition);if(B>=0){var D={};D.t=s.designer.$condition.t;D.n=s.designer.$condition.n;D.o=s.designer.$condition.o;D.c=s.designer.$condition.c;s.designer.$condition={};s.designer.$condition.t="group";s.designer.$condition.n=false;s.designer.$condition.o="and";s.designer.$condition.c=[D];C[B]=s.designer.$condition}}};s.editConditionGroup=function(C,B){if(s.mode!="edit"){return}s.designer={operator:C.o||"and",not:C.n?"1":"0",description:C.z};s.designer.group=C;s.designer.$obj=C;s.designer.parent=B;window.designer=s.designer;s.designer.dialog=m.open({template:"dialog-edit-condition-group",className:"ngdialog-theme-default ngdialog-large",closeByDocument:false,disableAnimation:true,scope:s})};s.updateConditionGroup=function(){s.autoSave();var B=s.designer.group;B.n=s.designer.not=="1";B.o=s.designer.operator;B.z=s.designer.description;s.closeDialog()};s.addRestriction=function(B){return s.editRestriction(null,B)};s.editRestriction=function(B,C){if(s.mode!="edit"){return}var D=!B;if(!B){B={};B.t=null;B.d=[];B.rn=false;B.rop="and";B.lo={t:"p",d:[],a:null,g:"any",v:null,c:"",x:null,e:""};B.co=null;B.ro={t:"c",d:[],a:null,g:"any",v:null,c:"",x:null,e:""};B.ro2={t:"c",d:[],a:null,g:"any",v:null,c:"",x:null,e:""};B.to={t:"c",d:[],a:null,g:"any",v:null,c:"",x:null,e:""};B.to2={t:"c",d:[],a:null,g:"any",v:null,c:"",x:null,e:""};B.z=""}s.designer={config:s.getExpressionConfig(),clipboard:D?s.getClipboardItems("restriction"):[]};s.designer.$restriction=B;s.designer.$obj=B;s.designer.type=B.t;s.designer.$new=B.t?false:true;s.designer.page=s.designer.$new?0:1;s.designer.parent=C;s.designer.devices=B.d;s.designer.not=B.rn?"1":"0";s.designer.operator=B.rop;s.designer.comparison={type:"restriction",left:{data:B.lo?s.copy(B.lo):{}},operator:B.co,right:{data:B.ro?s.copy(B.ro):{}},right2:{data:B.ro2?s.copy(B.ro2):{}},time:{data:B.to?s.copy(B.to):{t:"c",c:0},dataType:"duration"},time2:{data:B.to2?s.copy(B.to2):{t:"c",c:0},dataType:"duration"}};s.validateComparison(s.designer.comparison,true);s.designer.smode=B.sm;s.designer.description=B.z;window.designer=s.designer;s.designer.items=[{type:"restriction",name:"Restriction",icon:"code",cssClass:"btn-info"},{type:"group",name:"Group",icon:"code-fork",cssClass:"btn-warning"}];s.designer.dialog=m.open({template:"dialog-edit-restriction",className:"ngdialog-theme-default ngdialog-large",closeByDocument:false,disableAnimation:true,scope:s})};s.updateRestriction=function(C){s.autoSave();var B=s.designer.$new?{t:s.designer.type}:s.designer.$restriction;switch(B.t){case"restriction":B.lo=s.fixOperand(s.designer.comparison.left.data);B.co=s.designer.comparison.operator;B.ro=s.fixOperand(s.designer.comparison.right.data);B.ro2=s.fixOperand(s.designer.comparison.right2.data);B.to=s.designer.comparison.time.data;B.to2=s.designer.comparison.time2.data;break;case"group":B.r=B.r?B.r:[];B.rop=s.designer.operator;B.rn=s.designer.not=="1";break}B.z=s.designer.description;if(B.t){B.$$html=null;if(s.designer.$new){if(s.designer.parent instanceof Array){s.designer.parent.push(B)}else{if((s.designer.parent.r)&&(s.designer.parent.r instanceof Array)){s.designer.parent.r.push(B)}else{s.designer.parent.r=[B]}}}else{s.designer.$restriction=B}}s.closeDialog();if(B.t&&C){s.addRestriction(B.t=="group"?B:s.designer.parent)}};s.upgradeRestriction=function(){s.updateRestriction();var D=s.designer.parent;if(s.designer.$restriction&&D&&(D instanceof Array)){var C=D.indexOf(s.designer.$restriction);if(C>=0){var B={};B.t=s.designer.$restriction.t;B.rn=s.designer.$restriction.rn;B.rop=s.designer.$restriction.rop;B.c=s.designer.$restriction.c;s.designer.$restriction={};s.designer.$restriction.t="group";s.designer.$restriction.rn=false;s.designer.$restriction.rop="and";s.designer.$restriction.c=[B];D[C]=s.designer.$restriction}}};s.editRestrictionGroup=function(C,B){if(s.mode!="edit"){return}s.designer={operator:C.rop||"and",not:C.rn?"1":"0",description:C.z};s.designer.group=C;s.designer.$obj=C;s.designer.parent=B;window.designer=s.designer;s.designer.dialog=m.open({template:"dialog-edit-restriction-group",className:"ngdialog-theme-default ngdialog-large",closeByDocument:false,disableAnimation:true,scope:s})};s.updateRestrictionGroup=function(){s.autoSave();var B=s.designer.group;B.rn=s.designer.not=="1";B.rop=s.designer.operator;B.z=s.designer.description;s.closeDialog()};s.addTask=function(B){return s.editTask(null,B)};s.editTask=function(C,D){if(s.mode!="edit"){return}if(!C){C={};C.c="";C.a="0";C.m="";C.z=""}var E=C.c?false:true;s.designer={clipboard:E?s.getClipboardItems("task"):[]};var B=E?s.insertIndexes[D.$$hashkey]:D.k.indexOf(C);if(isNaN(B)){B=D.k.length}s.designer.insertIndex=B;s.designer.$task=C;s.designer.$obj=C;s.designer.$new=E;s.designer.page=0;s.designer.parent=D;s.designer.command=C.c;s.designer.mode=C.m;s.designer.description=C.z;s.prepareParameters(C);window.designer=s.designer;window.scope=s;s.designer.commands=s.listAvailableCommands(D.d);$("a-ckolor-wheel").remove();s.designer.dialog=m.open({template:"dialog-edit-task",className:"ngdialog-theme-default ngdialog-large",closeByDocument:false,disableAnimation:true,scope:s})};s.updateTask=function(F){s.autoSave();var D=s.designer.$new?{}:s.designer.$task;D.c=s.designer.command;D.a=s.designer.async;D.z=s.designer.description;D.m=s.designer.mode;if(D.c){D.$$html=null;D.p=[];for(parameterIndex in s.designer.parameters){var E=s.designer.parameters[parameterIndex].data;if(E.t=="c"){switch(E.vt){case"time":E.c=E.c instanceof Date?E.c.getHours()*60+E.c.getMinutes():E.c;break;case"date":case"datetime":E.c=E.c instanceof Date?E.c.getTime():(new Date(E.c)).getTime();break}}D.p.push(E)}if(s.designer.$new){if((s.designer.parent)&&(s.designer.parent.k instanceof Array)){s.designer.parent.k.push(D);s.insertIndexes[parent.$$hashkey]=s.designer.insertIndex+1}}else{s.designer.$task=D}}var G=s.designer.parent.k;if(G&&G.length){var C=G.indexOf(D);var B=s.designer.insertIndex;if(B>C){B--}if(B>=G.length){B=G.length-1}if(s.designer.insertIndex!=C){G.splice(B,0,G.splice(C,1)[0])}}s.closeDialog();if(F){s.addTask(s.designer.parent)}};s.addVariable=function(){return s.editVariable(null)};s.editVariable=function(B){if(s.mode!="edit"){return}if(!B){B={};B.t="dynamic";B.n="";B.v={data:{}};B.a="d";B.z=""}if(B.v instanceof Array){B.v={data:{}}}s.designer={};s.designer.$variable=B;s.designer.$obj=B;s.designer.$new=B.n?false:true;s.designer.page=0;s.designer.parent=s.piston.v;s.designer.type=B.t;s.designer.assignment=B.a||"d";s.designer.name=B.n;s.designer.operand={data:B.v,multiple:false,dataType:B.t,optional:true};s.designer.description=B.z;window.designer=s.designer;window.scope=s;s.validateOperand(s.designer.operand);s.designer.dialog=m.open({template:"dialog-edit-variable",className:"ngdialog-theme-default ngdialog-large",closeByDocument:false,disableAnimation:true,scope:s});s.refreshSelects()};s.updateVariable=function(D){s.autoSave();var B=s.designer.$new?{}:s.designer.$variable;B.t=s.designer.operand.dataType;B.n=s.designer.name.trim().replace(/[^a-z0-9]|\s+|\r?\n|\r/gmi,"_");B.z=s.designer.description;B.a=s.designer.assignment;var C=s.fixOperand(s.designer.operand.data);switch(C.t){case"":B.v=null;break;default:B.v=C;break}B.$$html=null;if(s.designer.$new){s.piston.v.push(B)}else{s.designer.variable=B}s.closeDialog();if(D){s.addVariable()}};s.addGlobalVariable=function(){return s.editGlobalVariable(null)};s.editGlobalVariable=function(C){if(s.mode!="edit"){return}var B=s.globalVars[C];if(!B){B={t:"dynamic",v:""}}s.designer={};s.designer.$variableName=C;s.designer.$variable=B;s.designer.$obj=B;s.designer.$new=C?false:true;s.designer.name=C?""+C:"@";s.designer.type=B.t;s.designer.operand={data:{t:!B.v?"":(B.t=="device"?"d":"c"),c:B.v,d:B.v},multiple:false,dataType:B.t,optional:true,onlyAllowConstants:true};window.designer=s.designer;window.scope=s;s.validateOperand(s.designer.operand);s.designer.dialog=m.open({template:"dialog-edit-global-variable",className:"ngdialog-theme-default ngdialog-large",closeByDocument:false,disableAnimation:true,scope:s})};s.updateGlobalVariable=function(D){s.autoSave();var B=s.designer.$new?{}:s.designer.$variable;B.t=s.designer.operand.dataType;B.n=s.designer.name.trim().replace(/[^@a-z0-9]|\s+|\r?\n|\r/gmi,"_");var C=s.designer.operand.data;switch(C.t){case"":B.v=B.t=="device"?[]:null;break;case"c":B.v=C.c?C.c:"";break;case"d":B.v=C.d?C.d:[];break;default:B.v=null;break}delete (B.$$html);u.setVariable(s.designer.$variableName,B).then(function(E){if(E&&E.globalVars){s.updateGlobalVars(E.globalVars)}});s.closeDialog();if(D){s.addGlobalVariable()}};s.deleteGlobalVariable=function(){if((!s.designer)||(!s.designer.$variableName)){return}u.setVariable(s.designer.$variableName,null).then(function(B){if(B&&B.globalVars){s.updateGlobalVars(B.globalVars)}});s.closeDialog()};s.validateGlobalVariableName=function(){if(!s.designer){return false}var B=s.designer.name;if(!B){return false}if(!B.startsWith("@")){B="@"+B}while(B.startsWith("@@@")){B=B.substr(1)}if(s.designer.name!=B){s.designer.name=B}return B&&(B!="@")&&(B!="@@")&&((s.designer.$variableName==B)||!(s.globalVars[B]))};s.getDeviceAttributeValue=function(D,C){for(i in D.a){if(D.a[i].n==C){var B={v:D.a[i].v,t:D.a[i].v};if(B.v==undefined){B.v=""}if((C=="battery")&&(!isNaN(B.v))){B.t=B.t+"%";B.v=Math.floor(parseInt(B.v)/20);if(B.v>4){B.v=4}}if((C=="temperature")&&(!isNaN(B.v))){B.v=Math.round(parseFloat(B.v)).toString()+"°";B.t=B.v}return B}}return{v:"",t:""}};s.renderDevice=function(D){var F=s.getDeviceAttributeValue(D,"switch");var F=F?'class="fa fa-toggle-off" switch="'+F+'"':"";var C=["temperature","battery","switch","motion","presence"];var B="<div col>"+D.n+"</div>";for(a in C){var E=s.getDeviceAttributeValue(D,C[a]);B+="<div col "+C[a]+'="'+E.v+'" title="'+E.t+'"></div>'}return n.trustAsHtml(B)};s.drag=function(C,B){C.splice(B,1)};s.setDesignerType=function(B){s.designer.type=B;s.nextPage();if(s.designer.ontypechanged){s.designer.ontypechanged(s.designer,B)}};s.closeDialog=function(){s.saveStack();if(s.designer.dialog){s.designer.dialog.close();s.designer.dialog=null}};s.nextPage=function(){s.designer.page++;s.refreshSelects()};s.prevPage=function(){if(s.designer.page){s.designer.page--}};s.selectTaskIndex=function(B){if(s.designer){s.designer.insertIndex=B}};s.initLineNumbers=function(){j.lineNumber=0};s.getLineNumber=function(){return j.lineNumber};s.mergeObjects=function(E,D){if(Object.assign){return Object.assign(E,D)}var B={};for(var C in E){B[C]=E[C]}for(var C in D){B[C]=D[C]}return B};s.clearLogs=function(){s.logs=[]};s.prepareParameters=function(B){s.designer.parameters=[];var F=s.db.commands.physical[s.designer.command]||s.db.commands.virtual[s.designer.command];s.designer.parameters=[];s.designer.custom=false;if(F){for(parameterIndex in F.p){var G=s.copy(F.p[parameterIndex]);var D={data:{},name:G.n,dataType:G.t.toLowerCase(),multiple:false,optional:((G.t!="bool")&&(G.t!="boolean"))&&!!G.d,options:G.o,strict:!!G.s};var C=s.getAttributeById(G.t);if(C){D.attribute=C;D.dataType=C.t;D.allowMuliple=false;D.options=C.o}if(B&&B.p&&(B.p.length>parameterIndex)){D.data=s.copy(B.p[parameterIndex])}s.validateOperand(D);s.designer.parameters.push(D)}}else{s.designer.custom=!!s.designer.command;for(i in B.p){var E={dataType:B.p[i].vt,data:s.copy(B.p[i])};s.validateOperand(E);s.designer.parameters.push(E)}}if(s.designer.command=="setVariable"){s.designer.parameters[0].linkedOperand=s.designer.parameters[1];s.validateOperand(s.designer.parameters[0])}s.refreshSelects()};s.renameParameters=function(){if(!s.designer.custom){return}for(i in s.designer.parameters){s.designer.parameters[i].name="Parameter #"+(parseInt(i)+1).toString()+" ("+s.designer.parameters[i].dataType+")"}s.refreshSelects()};s.addParameter=function(B){if(!s.designer.custom){return}var C={dataType:B,name:"",data:{t:"c"}};s.validateOperand(C);s.designer.parameters.push(C);s.renameParameters()};s.deleteParameter=function(C){if(!s.designer.custom){return}var B=s.designer.parameters.indexOf(C);if(B>-1){s.designer.parameters.splice(B,1)}s.renameParameters()};s.getParameterInputType=function(B){switch(B.t){case"color":case"duration":case"enum":case"boolean":return B.t;case"number":return Math.abs(B.M-B.m)>360?"number":"range"}return"text"};s.getParameterMin=function(B){switch(B.t){case"level":case"saturation":case"hue":return 0;case"colorTemperature":return 1500}return null};s.getParameterMax=function(B){switch(B.t){case"level":case"saturation":return 100;case"hue":return 360;case"colorTemperature":return 10000}return null};s.getContactById=function(B){return s.instance.contacts[B]};s.getRoutineById=function(B){if(s.instance.virtualDevices.routine&&s.instance.virtualDevices.routine.o){return s.instance.virtualDevices.routine.o[B]}return null};s.getLocationModeById=function(B){if(s.instance.virtualDevices.mode&&s.instance.virtualDevices.mode.o){return s.instance.virtualDevices.mode.o[B]}return null};s.getDeviceById=function(B){if(B==s.location.id){return{id:B,n:s.location.name,an:"Location"}}return s.instance.devices[B]};s.getDeviceByName=function(B){for(deviceIndex in s.instance.devices){if(s.instance.devices[deviceIndex].n==B){return mergeObjects({id:deviceIndex},s.instance.devices[deviceIndex])}}return null};s.getVirtualDeviceById=function(B){if(B==s.location.id){return{id:B,name:s.location.name}}return s.instance.virtualDevices[B]};s.getCapabilityById=function(B){return s.db.capabilities[B]};s.getCapabilityByName=function(B){for(capabilityIndex in s.db.capabilities){if(s.db.capabilities[capabilityIndex].n==B){return mergeObjects({id:capabilityIndex},s.db.capabilities[capabilityIndex])}}return null};s.getCommandById=function(B){return s.db.commands.physical[B]||s.db.commands.virtual[B]};s.getCommandByName=function(B){for(commandIndex in s.db.commands.physical){if(s.db.commands.physical[commandIndex].n==B){return mergeObjects({id:commandIndex},s.db.commands.physical[commandIndex])}}for(commandIndex in s.db.commands.virtual){if(s.db.commands.virtual[commandIndex].n==B){return mergeObjects({id:commandIndex},s.db.commands.virtual[commandIndex])}}return null};s.getAttributeById=function(B){return s.db.attributes[B]};s.getAttributeByName=function(B){for(attributeIndex in s.db.attributes){if(s.db.attributes[attributeIndex].n==B){return s.db.attributes[attributeIndex]}}return null};s.getDeviceAttributeById=function(C,B){if(!C){return null}for(i in C.a){if(C.a[i].n==B){return C.a[i]}}return null};s.buildName=function(C,F,B,E){if((C==null)||(C==undefined)){return""}if(C instanceof Array){return s.buildNameList(C,"or","","",false,F,B,E)}if(B||(C.length==34)){for(deviceId in s.instance.virtualDevices){var D=s.instance.virtualDevices[deviceId];if(D.o){for(id in D.o){F=F||!B;if(C==id){return(!F?"'":"")+D.o[id]+(!F?"'":"")}}}}}return(!F?"'":"")+(E?E:"")+C+(!F?"'":"")};s.buildNameList=function(G,J,N,H,B,D,I,K){var C=1;var M="";for(i in G){var F="";var E=G[i];if(E instanceof Object){N=E.t?E.t:N;F=E.a?E.a:"[unknown]";E=E.n}var L=s.buildName(E,D,I,K);M+="<span "+(N?N:"")+(F?' an="'+F+'"':"")+(H?' class="'+H+'"':"")+">"+L+"</span>"+(B?"'"+(L.substr(-1)=="s"?"":"s"):"")+(C<G.length?"<span pun>"+(C==G.length-1?(G.length>2?", ":" ")+J+" ":", ")+"</span>":"");C++}return M.trim()};s.buildLocationModeNameList=function(C){var B=[];if(C instanceof Array){for(modeIndex in C){B.push(s.getModeName(C[modeIndex]))}if(B.length){return s.buildNameList(B,"or","lit","",false,true)}}return""};s.buildDeviceNameList=function(B){var D=[];if(B instanceof Array){for(deviceIndex in B){var C=s.getDeviceById(B[deviceIndex]);if(C){D.push({n:C.n,a:C.an,t:"dev"})}else{D.push({n:"{"+B[deviceIndex]+"}",t:"var"})}}if(D.length){return s.buildNameList(D,"and","dev","",false,true)}}return"Location"};s.buildContactNameList=function(D){var C=[];if(D instanceof Array){for(contactIndex in D){var B=s.getContactById(D[contactIndex]);if(B){C.push({n:(B.f+" "+B.l).trim()+" ("+B.t+"/"+(B.p?"PUSH":"SMS")+")",a:B.an,t:"cnt"})}else{C.push({n:"{"+D[contactIndex]+"}",a:"Unknown Contact",t:"var"})}}if(C.length){return s.buildNameList(C,"and","cnt","",false,true)}}return"(empty)"};s.formatHour=function(B){return(!location.timeZone||location.timeZone.id.startsWith("America"))?((B%12?B%12:"12")+(B<12?"am":"pm")):("00"+B).substr(-2)};s.renderDeviceNameList=function(B){return n.trustAsHtml(s.buildDeviceNameList(B))};s.renderContactNameList=function(B){return n.trustAsHtml(s.buildContactNameList(B))};s.hasCommand=function(C,B){if(!C||!C.c){return false}return s.hasName(C.c,B)};s.hasName=function(C,B){if(!C||!C.length){return false}for(obj in C){if(C[obj]&&(C[obj].n===B)){return true}}return false};s.hasId=function(B,C){if(!B||!B.length){return false}for(obj in B){if(B[obj]&&(B[obj].id===C)){return true}}return false};s.listAvailableCommands=function(L){var D={};var I=L?L.length:0;for(deviceIndex in L){var E=L[deviceIndex]||"";var B=[];var K=false;if(E.startsWith(":")){var C=s.getDeviceById(L[deviceIndex]);B=C.c}else{K=true;B=s.db.commands.physical}for(commandIndex in B){var G=K?commandIndex:B[commandIndex].n;if(D[G]){D[G]+=1}else{D[G]=1}}}var M={common:[],partial:[],virtual:[]};for(G in D){var F=s.db.commands.physical[G];if(!F){F={n:G+"(..)",cm:true}}if(D[G]==I){M.common.push(mergeObjects({id:G},F))}else{M.partial.push(mergeObjects({id:G},F))}}for(G in s.db.commands.virtual){var F=s.db.commands.virtual[G];if(F.r){var H=0;for(deviceIndex in L){var E=L[deviceIndex]||"";var J=false;if(E.startsWith(":")){var C=s.getDeviceById(L[deviceIndex]);J=!!C;if(J){for(req in F.r){if(!s.hasCommand(C,F.r[req])){J=false;break}}}}else{J=true}if(J){H++}}if(H>0){if(H==I){if(!s.hasId(M.common,G)){M.common.push(mergeObjects({id:G,em:true},F))}}else{if(!s.hasId(M.partial,G)){M.partial.push(mergeObjects({id:G,em:true},F))}}}}else{M.virtual.push(mergeObjects({id:G},F))}}M.common.sort(s.sortByName);M.partial.sort(s.sortByName);M.virtual.sort(s.sortByName);return M};s.listAvailableDevices=function(){var B=[];for(deviceIndex in s.instance.devices){var C=s.instance.devices[deviceIndex];var D="";for(i in C.a){D+=":"+C.a[i].n+" "}B.push(mergeObjects({id:deviceIndex,tokens:D+C.n},C))}return B.sort(s.sortByName)};s.listAvailableVirtualDevices=function(){var B=[];for(deviceIndex in s.instance.virtualDevices){var C=s.instance.virtualDevices[deviceIndex];B.push(mergeObjects({id:deviceIndex},C))}return B.sort(s.sortByName)};s.escapeRegExp=function(B){return B};s.listAutoCompleteFunctions=function(){var B=[];for(functionIndex in s.db.functions){B.push((s.db.functions[functionIndex].d?s.db.functions[functionIndex].d:functionIndex)+"(")}return B.sort()};s.listAutoCompleteDevices=function(){var B=[];for(deviceIndex in s.instance.devices){var C=s.instance.devices[deviceIndex];B.push(s.escapeRegExp("["+C.n+" :"))}return B.sort()};s.listAutoCompleteVariables=function(){var B=[];for(varIndex in s.piston.v){var C=s.piston.v[varIndex];B.push(s.escapeRegExp(C.n))}if(s.systemVars){for(varName in s.systemVars){B.push(s.escapeRegExp(varName))}}if(s.globalVars){for(varName in s.globalVars){B.push(s.escapeRegExp(varName))}}return B.sort()};s.getVariableByName=function(B){if(s.systemVars&&s.systemVars[B]){return s.systemVars[B]}if(s.globalVars&&s.globalVars[B]){return s.globalVars[B]}for(varIndex in s.piston.v){if(s.piston.v[varIndex].n==B){return s.piston.v[varIndex]}}return null};s.getVariableValue=function(C,D){if(s.localVars){var B=s.localVars[C];if(B!=undefined){if(D=="datetime"){return utcToString(B)}return""+B}}return"(not set)"};s.autoAddVariable=function(C){if(!C){return false}C=C?C.trim():"";var B=s.getVariableByName(C);s.piston.v.push({t:"dynamic",n:C})};s.hasAttribute=function(C,B){for(a in C.a){if(C.a[a].n==B){return true}}return false};s.listAvailableAttributes=function(D,I){var B=[];var G=null;if(D&&D.length){var C={};var E=D.length;for(deviceIndex in D){G=s.getDeviceById(D[deviceIndex]);if(G){for(attributeIndex in G.a){var F=G.a[attributeIndex];if(!I||(F.n==I)){if(C[F.n]){C[F.n]+=1}else{C[F.n]=1}}}}else{for(attributeName in s.db.attributes){if(!I||(attributeName==I)){if(C[attributeName]){C[attributeName]+=1}else{C[attributeName]=1}}}}}for(attributeId in C){if(C[attributeId]==E){var F=s.getAttributeById(attributeId);if(F){B.push(mergeObjects({id:attributeId},F))}else{for(a in G.a){if(G.a[a].n==attributeId){F=G.a[a];break}}if(F){var H=mergeObjects({id:attributeId,c:true},F);H.n="⌂ "+H.n;H.t=(H.t||"string").toLowerCase().replace("number","decimal");B.push(H)}}}}B.sort(s.sortByName)}return B};s.sortByDisplay=function(C,B){return(C.d>B.d)?1:((B.d>C.d)?-1:0)};s.sortByName=function(C,B){C=C.n.toLowerCase();B=B.n.toLowerCase();return(C>B)?1:((B>C)?-1:0)};s.getStackData=function(){var B=angular.toJson(s.compilePiston(s.piston));return{hash:s.md5(B),timestamp:(new Date()).getTime(),data:angular.fromJson(B)}};s.autoSave=function(B){var C=B?false:true;B=B?B:s.stack.undo;pushToStack=true;var D=s.getStackData();if(B&&B.length){if(D.hash==B[B.length-1].hash){pushToStack=false}}if(pushToStack){B.push(D);if(B.length>MAX_STACK_SIZE){B=B.slice(-MAX_STACK_SIZE)}}if(C){s.stack.redo=[]}};s.objectToArray=function(C){var B=[];for(property in C){B.push({v:property,n:C[property]})}return B};s.saveStack=function(B){s.stack.current=s.getStackData();if(B){s.stack.current.timestamp=0}s.stack.build=s.meta.build;u.saveToStore("stack"+s.pistonId,s.stack)};s.loadStack=function(){s.stack=u.loadFromStore("stack"+s.pistonId);s.stack=s.stack instanceof Object?s.stack:{};s.stack.undo=(s.stack.undo instanceof Array?s.stack.undo:[]);s.stack.redo=(s.stack.redo instanceof Array?s.stack.redo:[]);if(s.stack.current instanceof Object&&s.stack.current.data&&(s.stack.build==s.meta.build)&&(s.meta.modified<s.stack.current.timestamp)){s.setStatus();s.dialogChooseVersion()}else{}};s.dialogChooseVersion=function(){s.designer.dialog=m.open({template:"dialog-choose-version",className:"ngdialog-theme-default ngdialog-large",closeByDocument:false,disableAnimation:true,scope:s})};s.chooseVersion=function(B){if(B){s.piston=s.stack.current.data}else{s.autoSave()}s.closeDialog()};s.undo=function(){if(s.stack&&s.stack.undo&&s.stack.undo.length){s.autoSave(s.stack.redo);s.stack.current=s.stack.undo.pop();s.piston=s.stack.current.data;s.saveStack()}};s.redo=function(){if(s.stack&&s.stack.redo&&s.stack.redo.length){s.autoSave(s.stack.undo);s.stack.current=s.stack.redo.pop();s.piston=s.stack.current.data;s.saveStack()}};s.localTimeToDate=function(C){C=C?C:0;var B=new Date();B.setHours(Math.floor(C/60));B.setMinutes(C%60);B.setSeconds(0);B.setMilliseconds(0);return B};s.validateOperand=function(S,B,R){if(!!s.designer.comparison&&!R){s.validateComparison(s.designer.comparison,B);return}S=S||{};if(!S.initialized||B){S.data=S.data||{};S.data.a=S.data.a||"";S.data.c=(S.data.c==undefined)||(S.data.c==null)?"":S.data.c;S.data.v=S.data.v||"";S.data.e=S.data.e||"";S.data.x=S.data.x||"";S.data.d=S.data.d||[];S.data.g=S.data.g||(S.multiple?"any":"avg");S.data.f=S.data.f||"l";S.options=S.options||[]}if(true||!S.initialized||B){var O=(S.dataType||"string").toLowerCase();if(O=="variables"){S.multiple=true;O="variable"}if(O=="devices"){S.multiple=true;O="device"}if(O=="pistons"){S.multiple=true;O="piston"}if(O=="routines"){S.multiple=true;O="routine"}if(O=="modes"){S.multiple=true;O="mode"}if(O=="alarmsystemstatus"){O="alarmSystemStatus"}if(O=="alarmsystemstatuses"){S.multiple=true;O="alarmSystemStatus"}if(O=="modes"){S.multiple=true;O="mode"}if(O=="enums"){S.multiple=true;O="enum"}if(O=="contacts"){S.multiple=true;O="contact"}if(O=="number"){O="decimal"}if(O=="bool"){O="boolean"}if((O=="enum")&&!S.options&&!S.options.length){O="string"}if(S.data.t==null){var J="";if(!S.optional){J=O=="variable"?"x":"c";if((s.designer.$condition)||(s.designer.$restriction)){J="p"}}S.data.t=J}switch(S.data.vt){case"time":if(!(S.data.c instanceof Date)){if(S.data.c!=undefined){S.data.c=s.localTimeToDate(S.data.c)}}break;case"date":case"datetime":if(!(S.data.c instanceof Date)){S.data.c=new Date(S.data.c);if(S.data.c=="Invalid Date"){S.data.c=new Date()}}break}S.onlyAllowConstants=S.onlyAllowConstants||(O=="piston")||(O=="routine")||(O=="askAlexaMacro");var U=!!S.strict;if(S.onlyAllowConstants||(O=="contact")){S.allowArgument=false;S.allowDevices=(O=="device");S.allowPhysical=false;S.allowVirtual=false;S.allowConstant=(O!="device");S.allowVariable=false;S.allowExpression=false}else{S.allowDevices=O=="device";S.allowPhysical=(O!="datetime")&&(O!="date")&&(O!="time")&&(O!="device")&&(O!="variable")&&(!U||(O!="boolean"))&&(O!="duration");S.allowPreset=(!S.event)&&(O=="datetime")||(O=="time")||(O=="color");S.allowVirtual=(!S.event)&&(O!="datetime")&&(O!="date")&&(O!="time")&&(O!="device")&&(O!="variable")&&(O!="decimal")&&(O!="integer")&&(O!="number")&&(O!="boolean")&&(O!="enum")&&(O!="color")&&(O!="duration");S.allowVariable=(O!="device"||((O=="device")&&S.multiple))&&(!U||(O!="boolean"));S.allowConstant=(!S.event)&&(O!="device")&&(O!="variable");S.allowArgument=(!S.event)&&(O!="device")&&(O!="variable");S.allowExpression=(!S.event)&&(O!="variable")&&(O!="enum")&&(!U||(O!="boolean"))}if(((S.data.t=="p")&&(!S.allowPhysical))||((S.data.t=="v")&&(!S.allowVirtual))){S.data.t="c"}if(!S.config){S.config=s.copy(s.getExpressionConfig());S.config.autocomplete[5].words=[/([0-9]+)(\.[0-9]+)?/g]}S.restrictAttribute=null;S.restrictType=null;switch(O){case"color":S.restrictAttribute="color";break;case"device":S.restrictType="device";break;case"integer":S.restrictType="integer";break;case"decimal":S.restrictType="integer,decimal";break;case"time":S.restrictType="datetime,time";break;case"date":case"datetime":S.restrictType="datetime,date";break}S.dataType=O;S.durationUnit=S.durationUnit||S.data.vt||"s";S.data.vt=O=="duration"?S.durationUnit:O}switch(O){case"enum":break;case"bool":case"boolean":S.options=["false","true"];break;case"mode":case"powerSource":case"alarmSystemStatus":case"routine":S.options=s.objectToArray(s.instance.virtualDevices[O].o);break;case"piston":S.options=s.listAllPistons();break;case"contact":S.options=s.contacts;break;case"integer":case"decimal":case"duration":if((S.data.t=="c")&&(isNaN(S.data.c)||(S.data.c==""))){S.data.c=0}default:S.options=null}if((!S.multiple)&&(S.options)&&(S.options.length)&&(S.data.t=="c")){if(S.options[0] instanceof Object){var H=false;for(i in S.options){if(S.options[i].v==S.data.c){H=true;break}}if(!H){S.data.c=S.options[0].v}}else{if(S.options.indexOf(S.data.c)<0){S.data.c=S.options[0]}}}S.initialized=true;S.allowAggregation=true;S.allowAll=true;S.attributes=(S.data.t=="p")?s.listAvailableAttributes(S.data.d,S.restrictAttribute):[];S.valid=false;S.selectedMultiple=(S.data.t=="p")&&S.data.d&&(S.data.d.length>1)&&((S.data.g=="all")||(S.data.g=="any"));S.error=null;S.momentary=false;S.selectedDataType="string";S.selectedOptions=[];switch(S.data.t){case"p":var I=s.db.attributes[S.data.a];if(!I){if(S.data.d.length){var Q=s.getDeviceById(S.data.d[0]);if(Q){for(a in Q.a){if(Q.a[a].n==S.data.a){I=Q.a[a];break}}}}}if(I){S.momentary=I.m;S.count=0;if(S.momentary&&!!I.s){var L=I.s.split(",");for(deviceIndex in S.data.d){var E=s.getDeviceById(S.data.d[deviceIndex]);var T=0;if(E){for(i in L){var M=s.getDeviceAttributeById(E,L[i]);if((M)&&(!isNaN(M.v))){T=parseInt(M.v);if(T>S.count){S.count=T}}}}else{if(S.count<32){S.count=32}}}}if(S.count){if((S.data.i==null)||(S.data.i==undefined)){S.data.i=["1"]}s.refreshSelects()}S.selectedDataType=I.t.toLowerCase();S.selectedOptions=I.o;if(S.momentary){S.allowAll=false;S.allowAggregation=false}}else{S.selectedDataType="string"}if(S.data.d&&(S.data.d.length>1)){if(!S.data.g){S.error="Invalid aggregation method"}if(!(["any","all","least","most"].indexOf(S.data.g)>=0)){S.selectedDataType="decimal"}}break;case"v":var N=s.instance.virtualDevices[S.data.v];S.selectedDataType=(!!N&&!!N.t)?N.t:"string";if(N){S.momentary=N.m;for(o in N.o){S.selectedOptions.push({v:o,n:N.o[o]})}}break;case"x":if(S.data.x instanceof Array){if(S.data.x.length){S.selectedDataType="dynamic"}else{S.error="Invalid list of variables"}}else{var P=s.getVariableByName(S.data.x);if(P){S.selectedDataType=P.t;if(S.selectedDataType=="boolean"){S.selectedOptions=["false","true"]}}else{S.error="Invalid variable"}}break;case"u":S.selectedDataType="dynamic";break;case"c":var K=s.parseString(S.data.c,S.data.vt);S.error=K.err;S.expressionVar=K.errVar;S.data.exp=K;if(!S.options){if(!S.optional&&!S.data.c&&(S.requirePositiveNumber)){S.error="Empty value";S.expressionVar=""}}else{if((S.data.c==null)||(S.data.c==undefined)){S.error="Invalid selection";S.expressionVar=""}}S.selectedDataType=S.dataType;break;case"e":var K=s.parseExpression(S.data.e,false,S.data.vt);S.error=K.err;S.expressionVar=K.errVar;if(K.err){var G=(K.loc?K.loc:"0:"+(K.str.length-1).toString()).split(":");var F=parseInt(G[0]);var D=G.length==2?parseInt(G[1]):F;S.config.autocomplete[0]={words:[new RegExp(".(?=.{"+(K.str.length-F-1)+"}$).{"+(D-F)+"}")],cssClass:"hl err",title:K.err}}else{S.config.autocomplete[0]={words:[],cssClass:"hl err"}}S.data.exp=K;S.selectedDataType="dynamic";break}if((!S.error)&&(S.dataType=="duration")&&(!S.durationUnit)){S.error="Invalid duration unit"}if((!S.error)&&S.count&&(!S.data.i||!S.data.i.length)){S.error="Invalid sub device selection"}S.valid=(!S.error)&&(((S.data.t=="")&&(S.optional))||((S.data.t=="d")&&!!S.data.d&&!!S.data.d.length)||((S.data.t=="p")&&!!S.data.d&&!!S.data.d.length&&!!S.data.a)||((S.data.t=="v")&&!!S.data.v)||((S.data.t=="x")&&!!S.data.x&&!!S.data.x.length)||((S.data.t=="s")&&!!S.data.s)||((S.data.t=="u")&&!!S.data.u)||((S.data.t=="c")&&!((S.data.c=="Invalid Date")&&(S.data.c instanceof Object))&&!((O=="duration")&&(isNaN(S.data.c)||(S.requirePositiveNumber&&(S.data.c<1)))))||((S.data.t=="e")&&!!S.data.e&&!!S.data.e.length));switch(S.dataType){case"integer":S.inputType="number";try{S.data.c=parseInt(S.data.c)}catch(C){S.data.c=0}break;case"duration":case"decimal":S.inputType="number";try{S.data.c=parseFloat(S.data.c)}catch(C){S.data.c=0}break;default:S.inputType=S.dataType}if(S.linkedOperand){S.linkedOperand.dataType=S.selectedDataType;S.linkedOperand.options=S.selectedOptions;s.validateOperand(S.linkedOperand,true);s.refreshSelects()}};s.refreshSelects=function(B){if(B){s.$$postDigest(function(){$("select["+B+"]").selectpicker("refresh");y(function(){$("select["+B+"]").selectpicker("refresh")},0,false)})}else{s.$$postDigest(function(){$("select").selectpicker("refresh");y(function(){$("select").selectpicker("refresh")},0,false)})}};s.getOrdinalSuffix=function(D){if(isNaN(D)){return""}D=parseInt(D);var B=D%100;var C=D%10;if(((B>3)&&(B<21))||(C==0)||(C>3)){return"th"}switch(C){case 1:return"st";case 2:return"nd";case 3:return"rd"}return"th"};s.getOrdinal=function(B){if(isNaN(B)){return""}B=parseInt(B);switch(B){case -3:return"third-last";case -2:return"second-last";case -1:return"last"}return B+s.getOrdinalSuffix(B)};s.listODM=function(){var B=s.designer.odm;var C=(!s.designer.operand.data.odw||(s.designer.operand.data.odw=="d"))?31:5;if(!B||(B.length!=(C+3))){B=[];for(i=1;i<=C;i++){B.push({v:i,n:i+s.getOrdinalSuffix(i)})}B.push({v:-1,n:"last"});B.push({v:-2,n:"second-last"});B.push({v:-3,n:"third-last"});s.designer.odm=B}return B};s.listODW=function(){var B=s.designer.odw;var C=(s.designer.operand.data.odm>5)?0:7;if(!B||(B.length!=(C+1))){B=[];B.push({v:"d",n:"day"});if(C){for(i in s.weekDays){B.push({v:i.toString(),n:s.weekDays[i]})}}s.designer.odw=B}return B};s.validateComparison=function(K,C){s.validateOperand(K.left,C,true);if((K.left.selectedDataType!=K.dataType)||(K.left.selectedMultiple!=K.selectedMultiple)||(K.left.momentary!=K.momentary)||(K.left.data.t=="v")){K.dataType=K.left.selectedDataType;K.selectedMultiple=K.left.selectedMultiple;K.momentary=K.left.momentary;var I=(K.left.data.t!="p")||((K.left.data.g!="any")&&(K.left.data.g!="all"));var B=(K.type=="restriction");var H=[];var L=[];if(!K.dataType){K.dataType="dynamic"}switch(K.dataType){case"enum":dt="s";break;case"dynamic":dt="";break;case"time":case"date":case"datetime":dt="t";break;default:dt=K.dataType.substr(0,1)}dt=(K.momentary?(K.left.data.t=="v"?"v":"m"):((dt=="n"?"d":dt)));for(conditionId in s.db.comparisons.conditions){var F=s.db.comparisons.conditions[conditionId];if(((!dt&&(F.g!="m"))||(F.g.indexOf(dt)>=0))&&(!I||!F.t)){L.push({id:conditionId,d:(K.selectedMultiple?(F.dd?F.dd:F.d):F.d),c:"Conditions"})}}H=H.concat(L.sort(s.sortByDisplay));if(!B){L=[];for(triggerId in s.db.comparisons.triggers){var D=s.db.comparisons.triggers[triggerId];if(D.g.indexOf(dt)>=0){L.push({id:triggerId,d:(K.selectedMultiple?(D.dd?D.dd:D.d):D.d),c:"Triggers"})}}H=H.concat(L.sort(s.sortByDisplay))}K.options=H}var G=s.db.comparisons.conditions[K.operator]||s.db.comparisons.triggers[K.operator];K.operatorValid=!!G;K.parameterCount=G&&G.p?G.p:0;K.multiple=G&&G.m?true:false;K.valid=K.left.valid&&K.operatorValid;K.timed=G?G.t:0;if(K.parameterCount>0){K.right.multiple=K.multiple;K.right.disableAggregation=K.multiple;K.right.dataType=K.left.selectedDataType;if(angular.toJson(K.right.options)!=angular.toJson(K.left.selectedOptions)){if((K.right.data.t=="c")&&K.right.options&&K.right.options.length&&(!K.left.selectedOptions||!K.left.selectedOptions.left)){K.right.data.c=""}K.right.options=K.left.selectedOptions}s.validateOperand(K.right,C,true);K.valid=K.valid&&K.right.valid}if(K.parameterCount>1){K.right2.multiple=K.multiple;K.right2.disableAggregation=K.multiple;K.right2.dataType=K.left.selectedDataType;if(angular.toJson(K.right2.options)!=angular.toJson(K.left.selectedOptions)){K.right2.options=K.left.selectedOptions}s.validateOperand(K.right2,C,true);K.valid=K.valid&&K.right2.valid}var E=(K.timed>0);var J=false;if(K.left.selectedDataType=="time"){E=E||(K.right.data.t!="c");J=(K.right2.data.t!="c")}if(E){K.time.requirePositiveNumber=!!K.timed;s.validateOperand(K.time,C,true);K.valid=K.valid&&K.time.valid}if(J){K.time2.requirePositiveNumber=false;K.time2.dataType="duration";s.validateOperand(K.time2,C,true);K.valid=K.valid&&K.time2.valid}};s.detectDataType=function(B){switch(typeof B){case"string":if(!isNaN(parseFloat(B))){return"number"}return"string";case"number":return"number";default:return"string"}};s.renderOperand=function(G,F,I,C){var J="";if(G){switch(G.t){case"d":if(G.d){J=s.buildDeviceNameList(G.d)}break;case"p":if(G.d&&G.a){J=s.renderDeviceList(G.d,G.a,G.g,true)+" <span attr>"+G.a+"</span>"}break;case"v":var B=s.getVirtualDeviceById(G.v);J="<span vdev>"+(B?B.n:"(invalid virtual device)")+"</span>";break;case"s":if(G.s){J="<span num>"+G.s+"</span>"}break;case"x":if(G.x){J="<span var>{"+G.x+"}</span>"}break;case"c":var E="num";F=F||!isNaN(G.c);switch(G.vt){case"time":var D=s.localTimeToDate(G.c);J="<span num>"+D.toLocaleTimeString({hour:"2-digit",minute:"2-digit"})+"</span>";break;case"date":J="<span num>"+utcToDateString(G.c)+"</span>";break;case"datetime":J="<span num>"+utcToString(G.c)+"</span>";break;case"piston":J="<span lit>"+s.getPistonName(G.c)+"</span>";break;case"phone":J="<span phn>"+G.c+"</span>";break;case"uri":J="<span uri>"+G.c+"</span>";break;case"contact":J=s.renderContactNameList(G.c);break;default:if(!F){if((G.vt=="boolean")||(G.vt=="enum")){F=true}E="lit"}var H=G.c;if(C&&!isNaN(H)&&parseInt(H)<0){H=-parseInt(H)}J="<span "+E+">"+scope.buildName(H,F,I)+"</span>"}break;case"u":J=J+"<span var>{$args."+G.u+"}</span>";break;case"e":if(G.e){J="<span exp>{"+G.e+"}</span>"}break}}J=J?J:'<span nul class="nul">(empty)</span>';return(J instanceof Object)?J:n.trustAsHtml(J)};s.renderForOperands=function(C){var B;B="<span var>"+(C.x?C.x:"$index")+"</span> <span pun>=</span> <span num>"+s.renderOperand(C.lo)+" <span kwd>to</span> "+s.renderOperand(C.lo2)+" <span kwd>step</span> "+s.renderOperand(C.lo3);return n.trustAsHtml(B?B:"(invalid operands)")};s.renderForEachOperands=function(C){var B;B="<span var>"+(C.x?C.x:"$device")+"</span> <span pun>in</span> <span num>"+s.renderOperand(C.lo);return n.trustAsHtml(B?B:"(invalid operands)")};s.renderTimeOperand=function(D){if(!D){return""}var B=(D.t=="c");var C=B&&!isNaN(D.c)?parseInt(D.c):0;if(B&&(C==0)){return""}return s.renderOperand(D,false,false,true)+" <span lit>"+s.getDurationUnitName(D.vt,(C!=1))+"</span> <span pun>"+(C<0?"to":"past")+" </span> "};s.renderComparison=function(Q,N,K,R,C,S){var X=s.db.comparisons.triggers[N];var J=!!X;if(!X){X=s.db.comparisons.conditions[N]}if(!X){return"[ERROR: Invalid comparison]"}var D=Q.t=="v";var M=Q&&(Q.t=="p")&&Q.d&&(Q.d.length>1)&&(Q.g=="all");var T=false;var G="";switch(Q.t){case"v":switch(Q.v){case"locationMode":case"shmState":T=true;break}break;case"p":var W=s.getAttributeById(Q.a);if(!!W&&!!W.u){G=W.u}break}var E="";if((X.g=="m")&&Q.i&&Q.i.length){E=" <span num>"+s.buildNameList(Q.i,"or",null,null,false,true,false,"#")+"</span>"}var P="";var O="";if((Q.t=="v")&&(Q.v=="time")){if(K&&C&&(K.t!="c")){P=s.renderTimeOperand(C)}if(R&&S&&(R.t!="c")){O=s.renderTimeOperand(S)}}var F=s.renderOperand(Q)+E+" <span pun>"+(M?(X.dd?X.dd:X.d):X.d)+"</span>"+(X.p>0?" "+P+s.renderOperand(K,T,D):"")+(G?"<span pun>"+G+"</span> ":"")+(X.p>1?" <span pun>"+(X.d.indexOf("between")?"and":"through")+"</span> "+O+s.renderOperand(R,T,D)+(G?"<span pun>"+G+"</span> ":""):"");switch(X.t){case 1:F+=" <span pun>"+(J?"for":"in the last")+"</span> "+s.renderOperand(C)+" <span lit>"+s.getDurationUnitName(C.vt,!((C.t=="c")&&(!isNaN(C.c))&&(parseInt(C.c)==1)))+"</span>";break;case 2:F+=" <span pun>for "+(C.f=="g"?"at least":"less than")+"</span> "+s.renderOperand(C)+" <span lit>"+s.getDurationUnitName(C.vt,!((C.t=="c")&&(!isNaN(C.c))&&(parseInt(C.c)==1)))+"</span>";break}if((Q.t=="v")&&(["time","date","datetime"].indexOf(Q.v)>=0)){var U=(Q.odw instanceof Array)&&Q.odw.length?Q.odw:null;var B=(Q.odm instanceof Array)&&Q.odm.length?Q.odm:null;var L=!B&&(Q.owm instanceof Array)&&Q.owm.length?Q.owm:null;var V=(Q.omy instanceof Array)&&Q.omy.length?Q.omy:null;if(!!U||!!B||!!L||!!V){var I=0;F+="<span pun>,</span> <span pun>but only</span>";var H="";if(U){for(i in U){if((i>0)&&(U.length>2)){H+="<span pun>,</span> "}if((i>0)&&(i==U.length-1)){H+=" <span pun>or</span> "}H+="<span lit>"+s.weekDays[U[i]]+"s</span>"}I++}if(L){F+=(I?"<span pun>,</span>":"")+" <span pun>on the</span> ";for(i in L){if((i>0)&&(L.length>2)){F+="<span pun>,</span> "}if((i>0)&&(i==L.length-1)){F+=" <span pun>or</span> "}F+="<span num>"+s.getOrdinal(L[i])+"</span>"}F+=" "+(H?H:"<span pun>week"+(L.length>1?"s":"")+"</span>")+(V?"":" <span pun>of the month</span>");I++}else{if(H){F+=(I>1?"<span pun>,</span>":"")+" <span pun>on</span> "+H}}if(B){F+=(I?"<span pun>,</span>":"")+" <span pun>on the</span> ";for(i in B){if((i>0)&&(B.length>2)){F+="<span pun>,</span> "}if((i>0)&&(i==B.length-1)){F+=" <span pun>or</span> "}F+="<span num>"+s.getOrdinal(B[i])+"</span>"}F+=" day"+(B.length>1?"s":"")+(V?"":" <span pun>of the month</span>");I++}if(V){F+=" <span pun>"+(L||B?"of":"in")+"</span> ";for(i in V){if((i>0)&&(V.length>2)){F+="<span pun>,</span> "}if((i>0)&&(i==V.length-1)){F+=" <span pun>or</span> "}F+="<span lit>"+s.yearMonths[V[i]-1]+"</span>"}I++}}}return n.trustAsHtml(F)};s.getWeekDayName=function(B){if(isNaN(B)){return"day"}return s.weekDays[parseInt(B)]};s.getMonthDayName=function(B){switch(B){case -1:return"last";case -2:return"second-last";case -3:return"third-last"}return B+s.getOrdinalSuffix(B)};s.getMonthName=function(B){return s.yearMonths[B]};s.getDurationUnitName=function(C,B){var D=B?"s":"";switch(C){case"ms":return"millisecond"+D;case"s":return"second"+D;case"m":return"minute"+D;case"h":return"hour"+D;case"d":return"day"+D;case"w":return"week"+D;case"n":return"month"+D;case"y":return"year"+D}return""};s.renderTimer=function(C){var R="";var E=C.lo;var N=s.getDurationUnitName(E.vt);var J=N;var B=0;switch(E.vt){case"ms":B=1;break;case"s":B=2;break;case"m":B=3;break;case"h":B=4;break;case"d":B=5;break;case"w":B=6;N=s.getWeekDayName(E.odw);break;case"n":B=7;N=s.getMonthDayName(E.odm)+" "+s.getWeekDayName(E.odw)+" of the month";break;case"y":B=8;N=s.getMonthDayName(E.odm)+" "+s.getWeekDayName(E.odw)+" of "+s.getMonthName(E.omy);break}switch(E.t){case"c":if(!isNaN(E.c)){var M=parseInt(E.c);switch(M){case 1:R=N;break;case 2:R="<span num>other</span> "+N;break;default:R="<span num>"+M+"</span> "+J+"s";switch(E.vt){case"n":R+=", on the "+s.getMonthDayName(E.odm)+" "+s.getWeekDayName(E.odw)+" of the month";break;case"y":R+=", on the "+s.getMonthDayName(E.odm)+" "+s.getWeekDayName(E.odw)+" of "+s.getMonthName(E.omy);break}}break}default:R=s.renderOperand(E)+" "+N+"s"}if(B==4){var F=("00"+C.lo.om).substr(-2);R+=", <span pun>at <span num>:"+F+"</span> <span pun>past the hour</span>"}if(B>=5){R+=", <span pun>at</span> ";if(C.lo2.t!="c"){switch(C.lo3.t){case"c":var H=isNaN(C.lo3.c)?0:parseInt(C.lo3.c);if(H==0){R+=s.renderOperand(C.lo2)}else{if(H<0){R+="<span num>"+(-H).toString()+"</span> <span lit>"+s.getDurationUnitName(C.lo3.vt,(H<-1))+"</span> <span pun>before</span> "+s.renderOperand(C.lo2)}else{R+="<span num>"+H.toString()+"</span> <span lit>"+s.getDurationUnitName(C.lo3.vt,(H>1))+"</span> <span pun>after</span> "+s.renderOperand(C.lo2)}}break;default:R+=s.renderOperand(C.lo2)+" <span num>±</span> "+s.renderOperand(C.lo3)}}else{R+=s.renderOperand(C.lo2)}}var L=(B<=2)&&(E.om instanceof Array)&&E.om.length?E.om:null;var O=(B<=3)&&(E.oh instanceof Array)&&E.oh.length?E.oh:null;var D=(B<=5)&&(E.odw instanceof Array)&&E.odw.length?E.odw:null;var K=(B<=6)&&(E.odm instanceof Array)&&E.odm.length?E.odm:null;var Q=(B<=6)&&!K&&(E.owm instanceof Array)&&E.owm.length?E.owm:null;var P=(B<=7)&&(E.omy instanceof Array)&&E.omy.length?E.omy:null;if(!!L||!!O||!!D||!!K||!!Q||!!P){var G=0;R+="<span pun>,</span> <span pun>but only</span>";if(L){R+=" <span pun>at</span> ";for(i in L){if((i>0)&&(L.length>2)){R+="<span pun>,</span> "}if((i>0)&&(i==L.length-1)){R+=" <span pun>or</span> "}R+="<span num>:"+("00"+L[i]).substr(-2)+"</span>"}R+=" <span pun>minutes past the hour</span>";G++}if(O){R+=(G?"<span pun>,</span>":"")+" <span pun>during the</span> ";for(i in O){if((i>0)&&(O.length>2)){R+="<span pun>,</span> "}if((i>0)&&(i==O.length-1)){R+=" <span pun>or</span> "}R+="<span num>"+s.formatHour(O[i])+"</span>"}R+=" <span pun>hour"+(O.length>1?"s":"")+"</span>";G++}var I="";if(D){for(i in D){if((i>0)&&(D.length>2)){I+="<span pun>,</span> "}if((i>0)&&(i==D.length-1)){I+=" <span pun>or</span> "}I+="<span lit>"+s.weekDays[D[i]]+"s</span>"}G++}if(Q){R+=(G?"<span pun>,</span>":"")+" <span pun>on the</span> ";for(i in Q){if((i>0)&&(Q.length>2)){R+="<span pun>,</span> "}if((i>0)&&(i==Q.length-1)){R+=" <span pun>or</span> "}R+="<span num>"+s.getOrdinal(Q[i])+"</span>"}R+=" "+(I?I:"<span pun>week"+(Q.length>1?"s":"")+"</span>")+(P?"":" <span pun>of the month</span>");G++}else{if(I){R+=(G>1?"<span pun>,</span>":"")+" <span pun>on</span> "+I}}if(K){R+=(G?"<span pun>,</span>":"")+" <span pun>on the</span> ";for(i in K){if((i>0)&&(K.length>2)){R+="<span pun>,</span> "}if((i>0)&&(i==K.length-1)){R+=" <span pun>or</span> "}R+="<span num>"+s.getOrdinal(K[i])+"</span>"}R+=" day"+(K.length>1?"s":"")+(P?"":" <span pun>of the month</span>");G++}if(P){R+=" <span pun>"+(Q||K?"of":"in")+"</span> ";for(i in P){if((i>0)&&(P.length>2)){R+="<span pun>,</span> "}if((i>0)&&(i==P.length-1)){R+=" <span pun>or</span> "}R+="<span lit>"+s.yearMonths[P[i]-1]+"</span>"}G++}}return n.trustAsHtml(R)};s.renderTask=function(B){var E=s.getCommandById(B.c);var D;if(!E){D=B.c+"(";for(i in B.p){D+=(parseInt(i)?", ":"")+s.renderOperand(B.p[i])}D+=")"}else{D=!E.d?E.n:E.d.replace(/\{(\d)\}/g,function(G,J){var F=parseInt(J);if((F<0)||(!B.p)||(F>B.p.length)){return"?"}if((F<0)||(!B.p)||(F>B.p.length)){return"?"}var I="";if(E.p[F].t=="duration"){var H=s.getDurationUnitName(B.p[F].vt,true);I=s.renderOperand(B.p[F],true)+" "+H}else{if((B.p[F].t=="c")&&(!!E.p[F].d)&&(B.p[F].c=="false")){I=""}else{I=s.renderOperand(B.p[F],true)}}if(!I){I=""}if(!!I&&!!E.p[F].d){I=(!!B.p[F]&&!!B.p[F].t)?E.p[F].d.replace("{v}",I):""}return I}).replace(/(\{T\})/g,"°"+s.location.temperatureScale);var C=E.i;if(C){D='<span pun><i class="fa fa-'+C+'" aria-hidden="true"></i></span> '+D}}if(B.m){D+=" <span pun><i>(only while "+s.buildLocationModeNameList(B.m)+")</i></span>"}D+="<span pun>;</span>";return n.trustAsHtml(D)};s.renderDeviceList=function(C,F,H,I){var B="";var E=[];suffix=(H=="any"?"or":"and");var G="";if(C instanceof Array){if(C.length>1){switch(H){case"any":G="Any of ";break;case"all":G="All of ";break;case"count":G="Count of ";break;case"avg":G="Average of ";break;case"median":G="Median of ";break;case"least":G="Least occurring value of ";break;case"most":G="Most occurring value of ";break;case"stdev":G="Standard deviation of ";break;case"min":G="Minimum of ";break;case"max":G="Maximum of ";break;case"variance":G="Variance of ";break}if(!I){G=G.toLowerCase()}}for(deviceIndex in C){var D=s.getDeviceById(C[deviceIndex]);if(D){E.push({n:D.n,a:D.an,t:"dev"})}else{E.push({n:"{"+C[deviceIndex]+"}",t:"var"})}}if(E.length){B=G+s.buildNameList(E,suffix,"dev","",!!F,true)}}return n.trustAsHtml(B)};s.compilePiston=function(G,D,F){var F=F?F:{};var C=0;var B=function(H,J){if(!D){return(!!F[H]&&!!F[H].id)?F[H].id:H}if(!H){return""}var K;if(F[H]){var I=F[H];K=I.key;if(J&&J.a&&(J.a instanceof Array)&&I.value&&I.value.a&&(I.value.a instanceof Array)){for(a in J.a){if(I.value.a.indexOf(J.a[a])<0){I.value.a.push(J.a[a])}}}}else{K=":"+("xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx"+C).substr(-32)+":";C++;F[H]={key:K,value:J}}return K};var E=function(J,S,N){if(J instanceof Array){for(i in J){J[i]=E(J[i],S,N)}return J}if(J instanceof Object){if(J.exp){delete (J.exp)}if(D){switch(J.vt){case"phone":var I=J.c?J.c.split(/,;\*\|/):[];var T=[];for(p in I){T.push(B(I[p],{t:"phone"}))}J.c=T.join(",");J.e="";break;case"contact":case"contacts":var R=J.c?(J.c instanceof Array?J.c:J.c.split(/,;\*|/)):[];var P=[];for(c in R){P.push(B(R[c],{t:"contact"}))}J.c=(J.c instanceof Array)?P:P[0];J.e="";break;case"uri":J.c=B(J.c,{t:"uri"});J.e="";break}}for(property in J){var Q=J[property];if((Q===false)||(Q===null)||(Q==="")){delete (J[property])}else{J[property]=E(J[property],J,J.vt?J.vt:J.t)}}if(!D&&!!J&&!!J.t&&!!J.vt&&((J.t=="c")||(J.t=="e"))){switch(J.t){case"c":J.exp=s.parseString(J.c,J.vt);break;case"e":J.exp=s.parseExpression(J.e,false,J.vt);break}}return J}var O=J?J.toString():"";if(O.startsWith(":")&&O.endsWith(":")){if(D){var H=s.getDeviceById(J);if(H){J=B(J,{t:"device",n:H.an,a:!!S&&!!S.a&&(S.a.length>1)?[S.a]:[]});return J}var L=s.getLocationModeById(J);if(L){switch(L){case"Home":case"Night":case"Sleep":case"Away":case"Vacation":break;default:L="Custom Mode"}J=B(J,{t:"mode",n:L});return J}var M=s.getRoutineById(J);if(M){J=B(J,{t:"routine"});return J}var K=s.getContactById(J);if(K){J=B(J,{t:"contact"});return J}}J=B(J,{t:"unknown"});return J}return J};G=E(s.copy(G),"piston");G.l={};for(l in F){G.l[F[l].key]=F[l].value}return G};s.determineDeviceType=function(B){return u.determineDeviceType(B)};s.anonymizeDevices=function(D){var C={};for(i in D){var F=D[i];var E=u.determineDeviceType(F).replace(/([A-Z])/g," $1").replace(/^./,function(G){return G.toUpperCase()}).replace("Rgb ","RGB ");var B=C[E]?C[E]+1:1;C[E]=B;D[i].an=E+" "+B}return D};s.anonymizeContacts=function(F){var D={};for(i in F){var C=F[i];var E="John Doe";var B=D[E]?D[E]+1:1;D[E]=B;F[i].an=E+" "+B}return F};s.breakList=function(B){return B.replace(/,/g,"<br/>")};var k=function(C){var D=C.getFullYear();var E=(1+C.getMonth()).toString();E=E.length>1?E:"0"+E;var B=C.getDate().toString();B=B.length>1?B:"0"+B;return E+"/"+B+"/"+D};s.getMonth=function(B){if(B){return["JAN","FEB","MAR","APR","MAY","JUN","JUL","AUG","SEP","OCT","NOV","DEC"][B.getMonth()]}};s.getDay=function(B){if(B){return("0"+B.getDate()).substr(-2)}};s.timeSince=timeSince;s.timeCounter=timeCounter;s.timeLeft=timeLeft;s.currentTime=currentTime;s.tap=function(B){u.tap(B).then(function(C){})};s.togglePiston=function(D,C){if((!D)&&(!s.viewerPiston||!s.viewerPiston.app)){return}var E=D?D.i:s.pistonId;if(E){y.cancel(tmrRefresh);var B=!(D?D.e:s.viewerPiston.app.enabled);if(D){D.e=B}else{s.viewerPiston.app.enabled=B}if(B){u.resumePiston(E).then(function(F){s.onRefresh(F)})}else{u.pausePiston(E).then(function(F){s.onRefresh(F)})}}if(C&&e.preventDefault){C.preventDefault()}if(C&&C.stopPropagation){C.stopPropagation()}};s.configurePiston=function(B){s.configuredPistonId=s.configuredPistonId==B.i?null:B.i};s.showPiston=function(B){document.body.scrollTop=0;s.viewerPiston=null;s.pistonId=B.i;s.refresh();window.onSwipeRight=s.hidePiston};s.hidePiston=function(){document.body.scrollTop=0;s.pistonId=null;window.onSwipeRight=null};s.prepareActions=function(D){var F=[];var B=[];var I=[];var J=(D.id<=0);var E=s.viewerPiston.tasks;var H=s.viewerPiston.app.actions;for(action in H){if(H[action].pid==D.id){if(H[action].t){var G=H[action].t;for(t in G){var C=0;for(task in E){if((E[task].type=="cmd")&&(E[task].ownerId==H[action].id)&&(E[task].taskId==G[t].i)){if((C==0)||(C>E[task].time)){C=E[task].time}}}G[t].time=C}}if(J){F.push(H[action])}else{if(H[action].rs==false){I.push(H[action])}else{B.push(H[action])}}}}var C=0;for(task in E){if((E[task].type=="evt")&&(E[task].ownerId==D.id)){if((C==0)||(C>E[task].time)){C=E[task].time}}}D.time=C;D.actions=F;D.trueActions=B;D.falseActions=I;D.$scope=s;if(D.children){for(child in D.children){s.prepareActions(D.children[child])}}};s.hadRecentActivity=function(B){return B&&B.le&&B.le.event&&B.le.event.date&&(timeLeft((new Date(B.le.event.date)).getTime())>-120)};s.toggleViewerOptions=function(){s.viewerPiston.showOptions=!s.viewerPiston.showOptions};s.getSecondaryStatementName=function(){var B=s.viewerPiston.app.mode;switch(B){case"Latching":return"BUT IF";case"Then-If":return"THEN IF";case"Else-If":return"ELSE IF";case"Or-If":return"OR IF";case"And-If":return"AND IF"}return"IF"};s.serializeObject=function(B){return angular.toJson(B)};s.anonymizeObject=function(B,E){var D=s.serializeObject(B);var C=D.match(/(:[a-f0-9]{32}:)/g);if(C){C=C.unique()}for(i in C){D=D.replace(new RegExp(C[i],"g"),("xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx"+i).substr(-32))}return(E?D:angular.fromJson(D))};s.objectToBlob=function(F,M){M=M||"";var C=1024;var J=btoa(s.serializeObject(F));J+="|"+J.length.toString();var L=J.length;var I=Math.ceil(L/C);var K=new Array(I);for(var D=0;D<I;++D){var B=D*C;var E=Math.min(B+C,L);var N=new Array(E-B);for(var G=B,H=0;G<E;++H,++G){N[H]=J[G].charCodeAt(0)}K[D]=new Uint8Array(N)}return new Blob(K,{type:M})};s.dataURItoBlob=function(C){var H=atob(C.split(",")[1]);var B=C.split(",")[0].split(":")[1].split(";")[0];var G=new ArrayBuffer(H.length);var E=new Uint8Array(G);for(var F=0;F<H.length;F++){E[F]=H.charCodeAt(F)}var D=new Blob([G],{type:B});return D};s.snapshot=function(B){var D=0;var C=function(){D++;return D};var E=s.compilePiston(s.piston,B);s.loading=true;u.generateBackupBin(E,B).then(function(F){w.enabled(false);var G=F.data;s.view.exportBin=G;var H=document.getElementById("piston");H.setAttribute("printing","");if(B){H.setAttribute("anonymized","")}y(function(){var J=H.clientWidth+10;var I=H.clientHeight+(B?0:64)+10;html2canvas(H,{width:J,height:I,counter:C}).then(function(L){s.loading=false;var K=new window.FileReader();console.log("Embedding data into PNG: "+E);K.readAsDataURL(new Blob([s.dataURItoBlob(L.toDataURL("image/png")),s.objectToBlob(E,"image/png")],{type:"image/png"}));K.onloadend=function(){s.capturedImage=K.result;s.dialogCapture=m.open({template:"dialog-captured-image",className:"ngdialog-theme-default ngdialog-auto-size",disableAnimation:true,closeByDocument:false,scope:s,showClose:true})}});H.removeAttribute("printing");H.removeAttribute("anonymized");delete (s.view.exportBin);w.enabled(true)},1,false)},function(){piston.removeAttribute("printing");piston.removeAttribute("anonymized");delete (s.view.exportBin)})};s.textSnapshot=function(){copyToClipboard("piston")};s.parseString=function(C,B){return s.parseExpression(C,true,B)};s.parseExpression=function(N,E,O){N=(N!=null)?N.toString():"";var J=0;var L=!!E?0:1;var I=L;var D=false;var G=false;var C=false;var F=0;var K=/^-?(0(\.\d*)?|([1-9]\d*\.?\d*)|(\.\d+))([Ee][+-]?\d+)?$/;var B=0;function P(S,R){return S==R?S.toString():S.toString()+":"+R.toString()}function H(){var R=[];var X=J;function U(){if(J-1>X){var aa=N.slice(X,J-1);var Z=parseFloat(aa.trim());if(!isNaN(Z)&&(K.test(aa.trim()))){R.push({t:(aa.indexOf(".")>0?"decimal":"integer"),v:Z,l:P(X,J-2)});return true}if(typeof aa=="string"){if(["true","false"].indexOf(aa)>=0){R.push({t:"boolean",v:aa,l:P(X,J-2)})}else{R.push({t:"variable",x:aa,l:P(X,J-2)})}return true}R.push({t:"operand",v:N.slice(X,J-1),l:P(X,J-2)});return true}return false}function S(){if(J-1>X){var aa=N.slice(X,J-1);var Z=parseFloat(aa.trim());if((O!="phone")&&!isNaN(Z)&&(K.test(aa.trim()))){R.push({t:(aa.indexOf(".")>0?"decimal":"integer"),v:parseInt(Z),l:P(X,J-2)});return true}R.push({t:(["true","false"].indexOf(aa)>=0?"boolean":"string"),v:aa,l:P(X,J-2)})}}function V(){if(J-1>X){var ae=N.slice(X,J-1);var af=ae.lastIndexOf(":");var ab=ae;var ad="";if(af>0){var ab=ae.substr(0,af).trim();ad=ae.substr(af+1).trim()}var ac=s.getDeviceByName(ab);if(ac&&ac.id){var aa=ad.toLowerCase();ad="";for(attributeIndex in ac.a){var Z=ac.a[attributeIndex];if(aa==Z.n.toLowerCase()){ad=Z.n}}if(!!aa&&!ad){ad="?"}R.push({t:"device",id:ac.id,a:ad,l:P(X-1,J-1)})}else{R.push({t:"device",x:ab,a:ad,l:P(X-1,J-1)})}}}function W(){var ab=N.slice(X,J-1).toLowerCase();if(s.db.functions[ab]){F++;var ac=H();var Z=[];var aa=null;for(p in ac){if(!aa){aa={t:"expression",i:[]}}if((ac[p].t=="operator")&&(ac[p].o==",")){Z.push(aa);aa={t:"expression",i:[]}}else{aa.i.push(ac[p])}}if(aa){Z.push(aa)}R.push({t:"function",n:ab,i:Z,l:P(X,J-1)});F--}else{U();R.push({t:"expression",i:H(),l:P(X,J-1)});X=J}}while(J<N.length){var Y=N[J++];switch(Y){case" ":case"\t":case"\r":case"\n":if(I&&!C&&!G&&!D){U();X=J}continue;case"+":case"-":case"/":case"*":case"~":case"^":case"\\":case"%":case"&":case"|":case",":case"!":case"=":case"<":case">":case"?":case":":if(I&&!C&&!D&&!G){var T=(J<N.length)?N[J]:"";U();if(["**","&&","||","^^","!&","!|","!^","==","!=","!!",">=","<=","<>","<<",">>"].indexOf(Y+T)>=0){J++;Y+=T}R.push({t:"operator",o:Y,l:P(J-1,J-1)});X=J}continue;case'"':if(I&&!C&&!D){G=!G;(G?U():S());X=J}continue;case"'":if(I&&!G&&!C){D=!D;(D?U():S());X=J}continue;case"(":if(I&&!C&&!G&&!D){B++;W();X=J}continue;case")":if(I&&!C&&!G&&!D){B--;U();X=J;return R}continue;case"[":if(I&&!G&&!D&&!C){C=true;U();X=J}continue;case"]":if(I&&C&&!G&&!D){V();C=false;X=J}continue;case"{":if(I==L){I++;S();X=J;R.push({t:"expression",i:H(),l:P(X-1,J-1)});X=J}else{I++;X=J;R.push({t:"expression",i:H(),l:P(X-1,J-1)});X=J}continue;case"}":U();I--;return R;continue}}J++;I?U():S();return R}var M=H();var Q={t:"expression",i:M,str:N};if(I!=L){Q.err="Invalid expression closure termination"}else{if(D){Q.err="Invalid single quote termination"}else{if(G){Q.err="Invalid double quote termination"}else{if(B){Q.err="Invalid parenthesis closure termination"}}}}Q.ok=!Q.err;if(Q.ok){Q.ok=s.validateExpression(Q)}return Q};s.validateExpression=function(G){var D="";var B="";var F="";function C(I,L,K){if(!I){return""}I=I.toString().split(":");var M=parseInt(I[0]);var H=(I.length==2)?parseInt(I[1]):M;var J=G.str.substr(M,H-M+1);if((J.substr(0,1)=="[")&&(J.substr(-1,1)=="]")){J=J.substr(1,J.length-2)}if(L){J=J.split(L);if(K>=J.length){return""}return J[K].trim()}return J.trim()}function E(J){var H=true;var I="";var K="";if(J.i){for(subitem in J.i){H=H&&E(J.i[subitem])}}else{switch(J.t){case"device":if(!J.x&&!J.id){H=false;I="Invalid device "+C(J.l,":",0);K=J.l;break}if(!J.id&&J.x&&!((s.systemVars&&scope.systemVars[J.x])||(s.globalVars&&s.systemVars[J.x])||s.getVariableByName(J.x))){H=false;I="Invalid device variable "+C(J.l,":",0);K=J.l;break}if(J.a=="?"){H=false;I="Invalid attribute "+C(J.l,":",1);K=J.l;break}break;case"variable":if(J.x.startsWith("$args.")&&(J.x.length>6)){break}if(s.systemVars&&s.systemVars[J.x]){break}if(s.globalVars&&s.globalVars[J.x]){break}if(!s.getVariableByName(J.x)){H=false;B=C(J.l);I="Variable "+B+" not found";K=J.l;break}break}}J.ok=H;if(I){J.err=I;if(!D){D=I;F=K}}return H}E(G);if(D){G.err=D;G.errVar=B;G.loc=F}return G.ok};s.hexToHsl=function(C){var I=/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(C);if(!I){return{h:0,s:0,l:0}}var B=0+parseInt(I[1],16)/255;var G=0+parseInt(I[2],16)/255;var J=0+parseInt(I[3],16)/255;var K=Math.max(B,G,J),E=Math.min(B,G,J);var F,L,D=(K+E)/2;if(K==E){F=L=0}else{var H=K-E;L=(D>0.5)?H/(2-K-E):H/(K+E);switch(K){case B:F=(G-J)/H+(G<J?6:0);break;case G:F=(J-B)/H+2;break;case J:F=(B-G)/H+4;break}F=F/6}return{h:Math.round(360*F),s:Math.round(100*L),l:Math.round(100*D)}};s.evaluateExpression=function(C,B){u.evaluateExpression(s.pistonId,C,B).then(function(D){console.log(D)})};var z=navigator.userAgent||navigator.vendor||window.opera;if(z.match(/Android/i)){s.android=true}s.url=window.location.href;s.mobile=window.mobileCheck();s.tablet=(!s.mobile)&&(window.mobileOrTabletCheck());s.formatTime=window.formatTime;s.utcToString=utcToString;s.utcToTimeString=utcToTimeString;s.utcToDateString=utcToDateString;s.formatLogTime=function(B,C){return utcToString(B)+"+"+C};s.md5=window.md5;var b=setInterval(function(){if(u.ready()){clearInterval(b);s.init()}},1)}]);function test(g,b,f){scope.evaluateExpression(scope.parseExpression(g,b,f))}var MAX_STACK_SIZE=10;