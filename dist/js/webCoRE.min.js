...
var app=angular.module("CoRE",["ng","ngRoute","ngSanitize","ngResource","ngDialog","ngAnimate","angular-svg-round-progressbar","angular-bootstrap-select","swipe","dndLists","ui.toggle","chart.js","smartArea","ui.bootstrap.contextMenu"]);var cdn="";var theme="";app.directive("head",["$rootScope","$compile",function(a,b){return{restrict:"E",link:function(e,f){var c='<link rel="stylesheet" ng-repeat="(routeCtrl, cssUrl) in routeStyles" ng-href="{{cssUrl}}" />';f.append(b(c)(e));e.routeStyles={};a.$on("$routeChangeStart",function(j,g,h){if(h&&h.$$route&&h.$$route.css){if(!angular.isArray(h.$$route.css)){h.$$route.css=[h.$$route.css]}angular.forEach(h.$$route.css,function(k){delete e.routeStyles[k]})}if(g&&g.$$route&&g.$$route.css){if(!angular.isArray(g.$$route.css)){g.$$route.css=[g.$$route.css]}angular.forEach(g.$$route.css,function(k){e.routeStyles[k]=k})}})}}}]);app.directive("ngWheel",["$parse",function(a){return function(f,c,b){var e=a(b.ngWheel);c.bind("wheel",function(g){f.$apply(function(){e(f,{$event:g})})})}}]);app.directive("textcomplete",["Textcomplete",function(a){return{restrict:"EA",scope:{members:"=",message:"=",callback:"&"},template:'<textarea ng-model="message" type="text"></textarea>',link:function(f,g,e){var b=f.members;var c=g.find("textarea");var h=new a(c,[{match:/(\b)(\w{2,})$/,search:function(j,k){k($.map(b,function(l){return l.toLowerCase().indexOf(j.toLowerCase())===0?l:null}))},index:2,replace:function(j){return"$1"+j+" "}}]);if(f.callback){f.$watch("message",function(k,j){f.callback()})}$(h).on({"textComplete:select":function(k,j){f.$apply(function(){f.message=j})},"textComplete:show":function(j){$(this).data("autocompleting",true)},"textComplete:hide":function(j){$(this).data("autocompleting",false)}})}}}]);app.directive("masonry",["$parse",function(a){return{restrict:"AC",link:function(g,h,e){g.items=[];var b=h[0];var c=angular.extend({itemSelector:"tile"},JSON.parse(e.masonry));var f=g.masonry=new Masonry(b,c);var j=0;g.update=function(){if(j){window.clearTimeout(j)}j=window.setTimeout(function(){j=0;f.reloadItems();f.layout();h.children(c.itemSelector).css("visibility","visible")},120)};g.update()}}}]).directive("masonryTile",function(){return{restrict:"AC",link:function(a,c){c.css("visibility","hidden");var b=c.parent("*[masonry]:first").scope(),e=b.update;imagesLoaded(c.get(0),e);c.ready(e)}}});app.directive("tileHeight",function(){var a={restrict:"A",link:function(g,h,b,c,e){var f=1;if(b.tileHeight){f=b.tileHeight}var j=function(){var k=h[0].parentElement.offsetWidth/Math.round(h[0].parentElement.offsetWidth/h[0].offsetWidth)*f;h.outerHeight(k)};g.$watch(b.tileHeight,function(k){f=1*k;j()});$(window).resize(j);j();g.$on("$destroy",function(){$(window).unbind("resize",j)})}};return a});app.directive("help",["$compile",function(a){var b={restrict:"A",link:function(g,e,c){var h=c.help?c.help:e.text();var f=angular.element("<wiki ng-click=\"wiki('"+h+'\')" class="fa fa-info-circle"></wiki>');e.append(a(f)(g))}};return b}]);app.directive("script",function(){return{restrict:"E",scope:false,link:function(b,e,a){if(a.type==="text/javascript"){var c=e.text();var g=new Function(c);g()}}}});app.directive("devData",function(a){return function(e,c,b){var f=function(j,h,g){var k=a(g.devData)(j);if(k){for(attr in k){h.attr("data-"+attr,k[attr])}}};e.$watch(b.devData,function(){f(e,c,b)})}});app.filter("orderObjectBy",function(){return function(a,e,c){var b=[];angular.forEach(a,function(g,f){b.push(Object.assign({id:f},g))});b.sort(function(g,f){return(g[e]>f[e]?1:-1)});if(c){b.reverse()}return b}});var config=app.config(["$routeProvider","$locationProvider","$sceDelegateProvider","$rootScopeProvider",function(b,a,f,e){e.digestTtl(10000);var c=".module.css";f.resourceUrlWhitelist(["self",cdn+"**"]);b.when("/",{templateUrl:cdn+theme+"html/modules/dashboard.module.html",controller:"dashboard",css:cdn+theme+"css/modules/dashboard"+c}).when("/register",{templateUrl:cdn+theme+"html/modules/register.module.html",controller:"register",css:cdn+theme+"css/modules/register"+c}).when("/init/:init",{redirectTo:function(g){app.initialInstanceUri=atou(g.init);return"/"}}).when("/piston/:pistonId",{templateUrl:cdn+theme+"html/modules/piston.module.html",controller:"piston",css:cdn+theme+"css/modules/piston"+c,reloadOnSearch:false}).when("/fuel",{templateUrl:cdn+theme+"html/modules/fuel.module.html",controller:"fuel",css:cdn+theme+"css/modules/fuel"+c}).when("/init/:instId1/:instId2",{redirectTo:function(g){app.initialInstanceUri=g.instId1+g.instId2;return"/"}}).otherwise({redirectTo:"/"});a.html5Mode(true)}]);config.factory("dataService",["$http","$location","$rootScope","$window","$q",function(p,x,n,E,b){var F={};var m="";var o=null;var q={};var C=null;var t={};var a={};var j="N7zqL6a8Texs4wY5y&y2YPLzus+_dZ%s";var G=j;var f=null;var K=null;var J=null;var u=false;var w={};var y=1;var k=false;if(localforage){localforage.config({name:"webCoRE"});localforage.keys().then(function(M){y=M.length;if(y){localforage.iterate(function(P,O,N){w[O]=l(P);y--;if(!y&&!k){c()}})}else{c()}})}var g=function(M){return JSON.parse(M)};var L=function(M,O,N){return Array(O-String(M).length+1).join(N||"0")+M};var z=function(M){return L(M.getFullYear(),4)+"-"+L(1+M.getMonth(),2)+"-"+L(M.getDate(),2)+" "+L(M.getHours(),2)+":"+L(M.getMinutes(),2)+":"+L(M.getSeconds(),2)};var e=function(M){return JSON.stringify(M)};var B=function(O,M){try{return utoa(E.sjcl.encrypt(M?M:G,angular.toJson(O),{ks:256}))}catch(N){return null}};var l=function(N,M){try{return angular.fromJson(E.sjcl.decrypt(M?M:G,atou(N)))}catch(O){return null}};var I=function(M,O,N){localforage.setItem("core:"+M,B(O,N));w["core:"+M]=O;return};var A=function(M,N){return w["core:"+M]};var r=function(M){o=M;q[o.id]=o;I("locations",q);return o};var H=function(O){var N=(!C);if(!C||(C.id!=O.id)){C=O}var M=a[C.id];if(!M){M={}}M.token=O.token?O.token:M.token;M.uri=O.uri?O.uri.replace(":443",""):M.uri;a[C.id]=M;delete (C.token);delete (C.uri);if(O.contacts){C.contacts=O.contacts}C.contacts=C.contacts?C.contacts:(t[C.id]&&t[C.id].contacts?t[C.id].contacts:[]);if(O.devices){C.devices=O.devices;N=true}C.devices=C.devices?C.devices:(t[C.id]&&t[C.id].devices?t[C.id].devices:[]);C.pistons=O.pistons;C.globalVars=O.globalVars;C.coreVersion=O.coreVersion;C.name=O.name;C.settings=O.settings;if(N&&C.devices){for(d in C.devices){C.devices[d].t=F.determineDeviceType(C.devices[d])}}C.virtualDevices=C.virtualDevices||{};t[C.id]=C;I("instances",t);I("store",a);I("instance",C.id,j);if((C.coreVersion)&&(version()!=C.coreVersion)&&!u){u=true;if(version()>C.coreVersion){v("A newer SmartApp version ("+version()+") is available, please update and publish all the webCoRE SmartApps in the SmartThings IDE.")}else{v("A newer UI version ("+C.coreVersion+") is available, please hard reload this web page to get the newest version.")}}return C};var v=function(M){if(f){f(M)}};var s=function(M){if(!M){return""}return M.replace(/([\uD83C-\uDBFF][\uDC00-\uDFFF])/g,function(N){return":"+encodeURIComponent(N)+":"})};var h=function(M){if(!M){return""}return M.replace(/(\:%[0-9A-F]{2}%[0-9A-F]{2}%[0-9A-F]{2}%[0-9A-F]{2}\:)/g,function(N){return decodeURIComponent(N.substr(1,12))})};F.openWebSocket=function(P){if(P&&C){J=P;if(K){return K}var O=C.id;var M=a[C.id];if(!M){M={}}var N=(M&&M.uri&&M.uri.startsWith("https://graph-eu"))?"eu":"us";K=new WebSocket("wss://api-"+N+"-"+O[32]+".webcore.co:9297");K.onopen=function(Q){K.send(C.id)};K.onclose=function(Q){K=null;if(J){setTimeout(function(){F.openWebSocket(J)},5000)}};K.onmessage=function(Q){if(J){try{J(Q)}catch(R){}}};K.onerror=function(Q){K=null;if(J){setTimeout(function(){F.openWebSocket(J)},5000)}};return K}else{J=null;K.close();K=null}};F.closeWebSocket=function(){F.openWebSocket(null)};F.ready=function(){return !!k};F.logout=function(){return localforage.clear()};F.setStatusCallback=function(M){f=M};F.saveToStore=function(M,N){return I(M,N)};F.loadFromStore=function(M){return A(M)};F.deleteFromStore=function(M){return localforage.removeItem("core:"+M)};F.loadFromStore=function(M){return A(M)};F.deleteInstance=function(M){if(M){if(M==C){C=null;I("instance",null,j)}delete (a[M.id]);delete (t[M.id]);I("instances",t);I("store",a)}};F.listLocations=function(){var M=[];for(lid in q){M.push(JSON.parse(JSON.stringify(q[lid])))}return M};F.getLocation=function(M){if(M){for(lid in q){if(lid==M){return JSON.parse(JSON.stringify(q[lid]))}}}else{return JSON.parse(JSON.stringify(o))}return null};F.listInstances=function(N){var M=[];for(iid in t){if(!N||(t[iid].locationId==N)){M.push(JSON.parse(JSON.stringify(t[iid])))}}return M};F.getInstanceCount=function(N){var M=0;for(iid in t){if(!N||(t[iid].locationId==N)){M++}}return M};F.getInstance=function(M){if(C&&!M){return C}if(C&&(C.id==M)){return C}if(M){for(iid in t){if(iid==M){return JSON.parse(JSON.stringify(t[iid]))}}}else{try{return JSON.parse(JSON.stringify(C?C:(t?t[A("instance")]:null)))}catch(N){}}return null};F.getPistonInstance=function(M){for(iid in t){for(i in t[iid].pistons){if(t[iid].pistons[i].id==M){return JSON.parse(JSON.stringify(t[iid]))}}}return null};F.loadInstance=function(P,N,M,S){var O=P?a[P.id]:null;var R=!P||!(P.devices instanceof Object)||!(Object.keys(P.devices).length)?0:(P.deviceVersion?P.deviceVersion:0);if(!O){if((app.initialInstanceUri&&app.initialInstanceUri.length)||(N&&N.length)){N=app.initialInstanceUri?app.initialInstanceUri:N;if(N&&!(N instanceof Object)&&(N.length>=69)){var U=N.substr(0,N.length-64);if(!U.endsWith(".com")){U+=".api.smartthings.com"}N=N.substr(0,8)=="https://"?N:"https://"+U+"/api/token/"+N.substr(-64,8)+"-"+N.substr(-56,4)+"-"+N.substr(-52,4)+"-"+N.substr(-48,4)+"-"+N.substr(-44,12)+"/smartapps/installations/"+N.substr(-32,8)+"-"+N.substr(-24,4)+"-"+N.substr(-20,4)+"-"+N.substr(-16,4)+"-"+N.substr(-12)+"/"}O={uri:N};for(id in a){if(a[id].uri==N){O=a[id];if(t&&t[id]&&t[id].devices instanceof Object&&Object.keys(t[id].devices).length&&t[id].deviceVersion){R=t[id].deviceVersion}break}}}}delete (app.initialInstanceUri);if(!O){var T=A("instance");if(T){O=a[T];if(t&&t[T]&&t[T].devices instanceof Object&&Object.keys(t[T].devices).length&&t[T].deviceVersion){R=t[T].deviceVersion}}}if(!O){x.path("/register")}else{var Q=document.getElementById("error");if(Q){Q.parentNode.removeChild(Q)}}return p.jsonp((O?O.uri:"about:blank/")+"intf/dashboard/load?token="+(O&&O.token?O.token:"")+(M?"&pin="+M:"")+"&dashboard="+(S?1:0)+"&dev="+R,{jsonpCallbackParam:"callback"}).then(function(V){var W=V.data;if(W.now){adjustTimeOffset(W.now)}if(W.error&&O){W.uri=O.uri}if(W.location){r(W.location)}if(W.instance){W.instance=H(W.instance)}W.endpoint=O.uri;return W},function(V){})};F.tap=function(M){return p({method:"GET",url:"tap/"+M})};F.getApiUri=function(){var M=F.getInstance();si=a?a[M.id]:null;return si?si.uri:null};F.refreshDashboard=function(){var N=F.getInstance();si=a&&N?a[N.id]:null;var M=!N||!(N.devices instanceof Object)||!(Object.keys(N.devices).length)?0:(N.deviceVersion?N.deviceVersion:0);v("Loading dashboard...");return p.jsonp((si?si.uri:"about:blank/")+"intf/dashboard/refresh?token="+(si&&si.token?si.token:""),{jsonpCallbackParam:"callback"}).then(function(O){data=O.data;return data},function(O){return null})};F.getPiston=function(P){var O=F.getPistonInstance(P);if(!O){O=F.getInstance()}si=a&&O?a[O.id]:null;var N=!O||!(O.devices instanceof Object)||!(Object.keys(O.devices).length)?0:(O.deviceVersion?O.deviceVersion:0);var M=A("db.version",j);v("Loading piston...");return p.jsonp((si?si.uri:"about:blank/")+"intf/dashboard/piston/get?id="+P+"&db="+M+"&token="+(si&&si.token?si.token:"")+"&dev="+N,{jsonpCallbackParam:"callback"}).then(function(Q){data=Q.data;if(data.now){adjustTimeOffset(data.now)}if(data.dbVersion){I("db.version",data.dbVersion,j);I("db",data.db);v("Database updated to version "+data.dbVersion)}else{data.db=A("db");v()}if(data.location){r(data.location)}if(data.instance){data.instance=H(data.instance)}return data},function(Q){return null})};F.getActivity=function(O,M){var N=F.getPistonInstance(O);if(!N){N=F.getInstance()}si=a?a[N.id]:null;return p.jsonp((si?si.uri:"about:blank/")+"intf/dashboard/piston/activity?id="+O+"&log="+(M?M:0)+"&token="+(si&&si.token?si.token:""),{jsonpCallbackParam:"callback"}).then(function(P){return P.data})};F.generateBackupBin=function(N,O){var M=F.getInstance();return p({method:"POST",url:"https://api.webcore.co/bins/"+(O?"":md5(M.account.id)),data:N?(O?{d:B(N,j)}:{e:B(N,j+M.account.id)}):{},transformResponse:function(P){try{P=JSON.parse(P);if(P&&P.bin){return P.bin}if(P&&P.uri){P=P.uri.split("/");if(P&&P.length){return P[P.length-1]}}}catch(Q){}return null}})};F.saveToBin=function(O,N){v("Saving piston to backup bin...");var M=F.getInstance();if(M&&M.account&&M.account.id){N={e:B(N,j+M.account.id)}}else{N={};O=null}return p({method:"PUT",url:"https://api.webcore.co/bins/"+md5(M.account.id)+"/"+O,data:N,transformResponse:function(P){v("Backup bin updated");return true}})};F.loadFromBin=function(O,M){v("Loading piston from backup bin...");var N=F.getInstance();if(!(N&&N.account&&N.account.id)){O=null}return p({method:"GET",url:"https://api.webcore.co/bins/"+md5(N.account.id)+"/"+O,transformResponse:function(P){if(O){try{P=JSON.parse(P);if(P&&P.e){return l(P.e,j+N.account.id)}if(P&&P.d){return l(P.d,j)}v()}catch(Q){v("Sorry, an error occurred while importing the backup bin")}}return null}})};F.generateNewPistonName=function(){var M=F.getInstance();si=a?a[M.id]:null;return p.jsonp((si?si.uri:"about:blank/")+"intf/dashboard/piston/new?token="+(si&&si.token?si.token:""),{jsonpCallbackParam:"callback"}).then(function(N){return N.data})};F.createPiston=function(M,N,P){var O=F.getInstance();si=a?a[O.id]:null;return p.jsonp((si?si.uri:"about:blank/")+"intf/dashboard/piston/create?author="+encodeURIComponent(N)+"&name="+encodeURIComponent(M)+"&bin="+encodeURIComponent(P?P:"")+"&token="+(si&&si.token?si.token:""),{jsonpCallbackParam:"callback"}).then(function(Q){return Q.data})};var D=function(N,P,M,O){if(M<P.length){v("Saving piston chunk "+(M+1).toString()+" of "+P.length.toString()+"...");return p.jsonp((N?N.uri:"about:blank/")+"intf/dashboard/piston/set.chunk?chunk="+M.toString()+"&data="+encodeURIComponent(P[M])+"&token="+(N&&N.token?N.token:""),{jsonpCallbackParam:"callback"}).then(function(Q){return D(N,P,M+1,O)})}else{v("Finishing up...");return p.jsonp((N?N.uri:"about:blank/")+"intf/dashboard/piston/set.end?bin="+encodeURIComponent(O)+"&token="+(N&&N.token?N.token:""),{jsonpCallbackParam:"callback"}).then(function(Q){v();return Q})}};F.setPiston=function(P,R){var O=F.getPistonInstance(P.id);if(!O){O=F.getInstance()}si=a?a[O.id]:null;var N=utoa(s(angular.toJson(P)));var M=3076;if(P&&R){F.saveToBin(R,P)}if(N.length>M){var Q=[].concat.apply([],N.split("").map(function(S,T){return T%M?[]:N.slice(T,T+M)},N));v("Preparing to save chunked piston...");return p.jsonp((si?si.uri:"about:blank/")+"intf/dashboard/piston/set.start?id="+P.id+"&chunks="+Q.length.toString()+"&token="+(si&&si.token?si.token:""),{jsonpCallbackParam:"callback"}).then(function(S){if(S&&(S.status==200)&&S.data&&(S.data.status=="ST_READY")){return D(si,Q,0,R)}})}else{v("Saving piston...");return p.jsonp((si?si.uri:"about:blank/")+"intf/dashboard/piston/set?id="+P.id+"&data="+N+"&bin="+encodeURIComponent(R)+"&token="+(si&&si.token?si.token:""),{jsonpCallbackParam:"callback"}).then(function(S){v();return S})}};F.setPistonLogging=function(M,O){var N=F.getPistonInstance(M);if(!N){N=F.getInstance()}si=a?a[N.id]:null;v("Setting piston logging level to "+O+"...");return p.jsonp((si?si.uri:"about:blank/")+"intf/dashboard/piston/logging?id="+M+"&level="+O+"&token="+(si&&si.token?si.token:""),{jsonpCallbackParam:"callback"}).then(function(P){v();return P.data})};F.pausePiston=function(M){var N=F.getPistonInstance(M);if(!N){N=F.getInstance()}si=a?a[N.id]:null;v("Pausing piston...");return p.jsonp((si?si.uri:"about:blank/")+"intf/dashboard/piston/pause?id="+M+"&token="+(si&&si.token?si.token:""),{jsonpCallbackParam:"callback"}).then(function(O){v();return O.data})};F.resumePiston=function(M){var N=F.getPistonInstance(M);if(!N){N=F.getInstance()}si=a?a[N.id]:null;v("Resuming piston...");return p.jsonp((si?si.uri:"about:blank/")+"intf/dashboard/piston/resume?id="+M+"&token="+(si&&si.token?si.token:""),{jsonpCallbackParam:"callback"}).then(function(O){v();return O.data})};F.testPiston=function(M){var N=F.getPistonInstance(M);if(!N){N=F.getInstance()}si=a?a[N.id]:null;v("Testing piston...");return p.jsonp((si?si.uri:"about:blank/")+"intf/dashboard/piston/test?id="+M+"&token="+(si&&si.token?si.token:""),{jsonpCallbackParam:"callback"}).then(function(O){v();return O.data})};F.deletePiston=function(M){var N=F.getPistonInstance(M);if(!N){N=F.getInstance()}si=a?a[N.id]:null;return p.jsonp((si?si.uri:"about:blank/")+"intf/dashboard/piston/delete?id="+M+"&token="+(si&&si.token?si.token:""),{jsonpCallbackParam:"callback"}).then(function(O){return O.data})};F.setVariable=function(M,P){var O=F.getInstance();si=a?a[O.id]:null;var N=P?utoa(angular.toJson(P)):"";return p.jsonp((si?si.uri:"about:blank/")+"intf/dashboard/variable/set?name="+M+"&value="+N+"&token="+(si&&si.token?si.token:""),{jsonpCallbackParam:"callback"}).then(function(Q){return Q.data})};F.setSettings=function(M){var O=F.getInstance();si=a?a[O.id]:null;var N=M?utoa(angular.toJson(M)):"";return p.jsonp((si?si.uri:"about:blank/")+"intf/dashboard/settings/set?settings="+N+"&token="+(si&&si.token?si.token:""),{jsonpCallbackParam:"callback"}).then(function(P){return P.data})};F.evaluateExpression=function(N,Q,M){var P=F.getPistonInstance(N);if(!P){P=F.getInstance()}si=a?a[P.id]:null;var O=utoa(angular.toJson(Q));return p.jsonp((si?si.uri:"about:blank/")+"intf/dashboard/piston/evaluate?id="+N+"&expression="+O+"&dataType="+(M?encodeURIComponent(M):"")+"&token="+(si&&si.token?si.token:""),{jsonpCallbackParam:"callback"}).then(function(R){return R.data})};F.registerDashboard=function(M){return p.post("https://api.webcore.co/dashboard/register/"+M).then(function(N){return N.data})};F.listFuelStreams=function(){var M=F.getInstance();if(M){var Q=M.id;var N=a[M.id];if(!N){N={}}var P=(N&&N.uri&&N.uri.startsWith("https://graph-eu"))?"eu":"us";var O={method:"POST",url:"https://api-"+P+"-"+Q[32]+".webcore.co/fuelStreams/list",headers:{"Auth-Token":Q},data:{i:Q}};return p(O).then(function(R){return R.data})}};F.listFuelStreamData=function(N){var M=F.getInstance();if(M){var R=M.id;var O=a[M.id];if(!O){O={}}var Q=(O&&O.uri&&O.uri.startsWith("https://graph-eu"))?"eu":"us";var P={method:"POST",url:"https://api-"+Q+"-"+R[32]+".webcore.co/fuelStreams/get",headers:{"Auth-Token":R},data:{i:R,f:N}};return p(P).then(function(S){return S.data})}};F.registerHandler=function(){navigator.registerProtocolHandler("web+core","https://"+window.location.hostname+"/handler/%s","webCoRE")};F.determineDeviceType=function(M){if(M&&M.cn){if(M.cn.indexOf("Water Sensor")>=0){return"waterSensor"}if(M.cn.indexOf("Contact Sensor")>=0){return"contactSensor"}if(M.cn.indexOf("Thermostat")>=0){return"thermostat"}if(M.cn.indexOf("Garage Door Control")>=0){return"garageDoor"}if(M.cn.indexOf("Music Player")>=0){return"musicPlayer"}if(M.cn.indexOf("Door Control")>=0){return"door"}if(M.cn.indexOf("Presence Sensor")>=0){return"presenceSensor"}if(M.cn.indexOf("Motion Sensor")>=0){return"motionSensor"}if(M.cn.indexOf("Color Control")>=0){return"rgbBulb"}if(M.cn.indexOf("Color Temperature")>=0){return"whiteBulb"}if(M.cn.indexOf("Switch Level")>=0){var N=M.n.toLowerCase();if(N.indexOf("light")>=0){return"whiteBulb"}if(N.indexOf("keen")>=0){return"vent"}if(N.indexOf("vent")>=0){return"vent"}return"dimmer"}if(M.cn.indexOf("Lock")>=0){return"lock"}if((M.cn.indexOf("Button")>=0)&&(M.cn.indexOf("Button")>=0)){return"keypad"}if(M.cn.indexOf("Button")>=0){return"button"}if(M.cn.indexOf("Temperature Measurement")>0){return"temperatureSensor"}if((M.cn.indexOf("Switch")>=0)&&(M.cn.indexOf("Power Meter")>=0)){return"outlet"}if(M.cn.indexOf("Switch")>=0){return"switch"}if(M.cn.indexOf("Power Meter")>=0){return"powerMeter"}}return"unknownDevice"};var c=function(){a=A("store");if(!a){a={}}q=A("locations");if(!q){q={}}t=A("instances");if(!t){t={}}k=true;window.ds=F};return F}]);app.run(["$rootScope","$window","$location",function(a,b,c){a.getTime=function(e){if(e){return e.format("h:mmtt")}};a.$on("$viewContentLoaded",function(f){var g=c.path();if(g.startsWith("/init/")){g="/init"}if(g.startsWith("/piston/")){g="/piston"}b.ga("send","pageview",{page:g});var e=null;if(!mobileCheck()){switch(g){case"/":e=[{calltype:"async[2]",publisher:"ady624",width:160,height:600,sid:"Chitika Default"}];break;case"/register":e=[{calltype:"async[2]",publisher:"ady624",width:728,height:90,sid:"Chitika Default"}];break}}if(e){b.CHITIKA={units:e};if(b.CHITIKA_ADS){b.CHITIKA_ADS.make_it_so()}}else{delete (window.CHITIKA)}});a.bytesToSize=function(e){var g=["bytes","kB","MB","GB","TB"];if(e==0){return"0 Byte"}var f=parseInt(Math.floor(Math.log(e)/Math.log(1024)));return(e/Math.pow(1024,f)).toFixed(f==0?0:2)+" "+g[f]}}]);Date.prototype.format=function(x,a){var r=["\x00","January","February","March","April","May","June","July","August","September","October","November","December"];var c=["\x01","Jan.","Feb.","Mar.","Apr.","May","June","July","Aug.","Sept.","Oct.","Nov.","Dec."];var b=["\x02","Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"];var g=["\x03","Sun","Mon","Tue","Wed","Thu","Fri","Sat"];function o(h,f){var m=h+"";f=f||2;while(m.length<f){m="0"+m}return m}var l=a?this.getUTCFullYear():this.getFullYear();x=x.replace(/(^|[^\\])yyyy+/g,"$1"+l);x=x.replace(/(^|[^\\])yy/g,"$1"+l.toString().substr(2,2));x=x.replace(/(^|[^\\])y/g,"$1"+l);var j=(a?this.getUTCMonth():this.getMonth())+1;x=x.replace(/(^|[^\\])MMMM+/g,"$1"+r[0]);x=x.replace(/(^|[^\\])MMM/g,"$1"+c[0]);x=x.replace(/(^|[^\\])MM/g,"$1"+o(j));x=x.replace(/(^|[^\\])M/g,"$1"+j);var B=a?this.getUTCDate():this.getDate();x=x.replace(/(^|[^\\])dddd+/g,"$1"+b[0]);x=x.replace(/(^|[^\\])ddd/g,"$1"+g[0]);x=x.replace(/(^|[^\\])dd/g,"$1"+o(B));x=x.replace(/(^|[^\\])d/g,"$1"+B);var n=a?this.getUTCHours():this.getHours();x=x.replace(/(^|[^\\])HH+/g,"$1"+o(n));x=x.replace(/(^|[^\\])H/g,"$1"+n);var z=n>12?n-12:n==0?12:n;x=x.replace(/(^|[^\\])hh+/g,"$1"+o(z));x=x.replace(/(^|[^\\])h/g,"$1"+z);var u=a?this.getUTCMinutes():this.getMinutes();x=x.replace(/(^|[^\\])mm+/g,"$1"+o(u));x=x.replace(/(^|[^\\])m/g,"$1"+u);var q=a?this.getUTCSeconds():this.getSeconds();x=x.replace(/(^|[^\\])ss+/g,"$1"+o(q));x=x.replace(/(^|[^\\])s/g,"$1"+q);var A=a?this.getUTCMilliseconds():this.getMilliseconds();x=x.replace(/(^|[^\\])fff+/g,"$1"+o(A,3));A=Math.round(A/10);x=x.replace(/(^|[^\\])ff/g,"$1"+o(A));A=Math.round(A/10);x=x.replace(/(^|[^\\])f/g,"$1"+A);var e=n<12?"AM":"PM";x=x.replace(/(^|[^\\])TT+/g,"$1"+e);x=x.replace(/(^|[^\\])T/g,"$1"+e.charAt(0));var p=e.toLowerCase();x=x.replace(/(^|[^\\])tt+/g,"$1"+p);x=x.replace(/(^|[^\\])t/g,"$1"+p.charAt(0));var C=-this.getTimezoneOffset();var k=a||!C?"Z":C>0?"+":"-";if(!a){C=Math.abs(C);var D=Math.floor(C/60);var v=C%60;k+=o(D)+":"+o(v)}x=x.replace(/(^|[^\\])K/g,"$1"+k);var w=(a?this.getUTCDay():this.getDay())+1;x=x.replace(new RegExp(b[0],"g"),b[w]);x=x.replace(new RegExp(g[0],"g"),g[w]);x=x.replace(new RegExp(r[0],"g"),r[j]);x=x.replace(new RegExp(c[0],"g"),c[j]);x=x.replace(/\\(.)/g,"$1");return x};function formatTime(c){try{var a=(new Date(c)).getTime()+(window.timeOffset?window.timeOffset:0);var f=new Date(a);return f.format("h:mm TT")}catch(b){}}function currentTime(){return(new Date()).getTime()+(window.timeOffset?window.timeOffset:0)}function utcToString(a){return(new Date(a)).toLocaleString()}function utcToTimeString(a){return(new Date(a)).toLocaleTimeString()}function utcToDateString(a){return(new Date(a)).toLocaleDateString()}function timeSince(f){if(!f){return"never"}switch(typeof f){case"number":break;case"string":f=+new Date(f);break;case"object":if(f.constructor===Date){f=f.getTime()}break;default:f=+new Date()}var e=[[60,"seconds",1],[120,"1 minute ago","1 minute from now"],[3600,"minutes",60],[7200,"1 hour ago","1 hour from now"],[86400,"hours",3600],[172800,"yesterday","tomorrow"],[604800,"days",86400],[1209600,"last week","next week"],[2419200,"weeks",604800],[4838400,"last month","next month"],[29030400,"months",2419200],[58060800,"last year","next year"],[2903040000,"years",29030400],[5806080000,"last century","next century"],[58060800000,"centuries",2903040000]];var h=(+new Date()+(window.timeOffset?window.timeOffset:0)-f)/1000,b="ago",g=1;if(h==0){return"Just now"}if(h<0){h=Math.abs(h);b="from now";g=2}var a=0,c;while(c=e[a++]){if(h<c[0]){if(typeof c[2]=="string"){return c[g]}else{return Math.floor(h/c[2])+" "+c[1]+" "+b}}}return f}function timeCounter(j){j+=window.timeOffset?window.timeOffset:0;var g=Math.ceil((0+j-(new Date().getTime()))/1000);var f=false;if(g<=0){if(g>-20){return"pending"}f=true;g=-g}var b="";if(g>86400){b=Math.floor(g/86400).toString()+"d ";g=g%86400}var e=Math.floor(g/3600);var a=Math.floor((g-e*3600)/60);var c=g%60;b+=(e>0?(e<10?"0":"")+e.toString()+":":"")+(a<10?"0":"")+a.toString()+":"+(c<10?"0":"")+c.toString();return b}function timeLeft(c,a){if(!c){return 0}c+=window.timeOffset?window.timeOffset:0;var b=Math.round((c-(new Date().getTime()))/1000);switch(a){case"h":return Math.floor(b/3600);break;case"m":return b>=3600?60:Math.floor(b/60);break;case"s":return b>=60?60:Math.floor(b%60);break}return b}function adjustTimeOffset(a){var b=a-(new Date()).getTime();if(isNaN(window.timeOffset)||(Math.abs(b)<Math.abs(window.timeOffset))){window.timeOffset=b}}Object.defineProperty(Array.prototype,"unique",{enumerable:false,value:function(){if(!this){return[]}var e={},c=[];for(var f=0,b=this.length;f<b;++f){if(e.hasOwnProperty(this[f])){continue}c.push(this[f]);e[this[f]]=1}return c}});function mobileCheck(){var a=false;(function(b){if(/(android|bb\d+|meego).+mobile|avantgo|bada\/|blackberry|blazer|compal|elaine|fennec|hiptop|iemobile|ip(hone|od)|iris|kindle|lge |maemo|midp|mmp|mobile.+firefox|netfront|opera m(ob|in)i|palm( os)?|phone|p(ixi|re)\/|plucker|pocket|psp|series(4|6)0|symbian|treo|up\.(browser|link)|vodafone|wap|windows ce|xda|xiino/i.test(b)||/1207|6310|6590|3gso|4thp|50[1-6]i|770s|802s|a wa|abac|ac(er|oo|s\-)|ai(ko|rn)|al(av|ca|co)|amoi|an(ex|ny|yw)|aptu|ar(ch|go)|as(te|us)|attw|au(di|\-m|r |s )|avan|be(ck|ll|nq)|bi(lb|rd)|bl(ac|az)|br(e|v)w|bumb|bw\-(n|u)|c55\/|capi|ccwa|cdm\-|cell|chtm|cldc|cmd\-|co(mp|nd)|craw|da(it|ll|ng)|dbte|dc\-s|devi|dica|dmob|do(c|p)o|ds(12|\-d)|el(49|ai)|em(l2|ul)|er(ic|k0)|esl8|ez([4-7]0|os|wa|ze)|fetc|fly(\-|_)|g1 u|g560|gene|gf\-5|g\-mo|go(\.w|od)|gr(ad|un)|haie|hcit|hd\-(m|p|t)|hei\-|hi(pt|ta)|hp( i|ip)|hs\-c|ht(c(\-| |_|a|g|p|s|t)|tp)|hu(aw|tc)|i\-(20|go|ma)|i230|iac( |\-|\/)|ibro|idea|ig01|ikom|im1k|inno|ipaq|iris|ja(t|v)a|jbro|jemu|jigs|kddi|keji|kgt( |\/)|klon|kpt |kwc\-|kyo(c|k)|le(no|xi)|lg( g|\/(k|l|u)|50|54|\-[a-w])|libw|lynx|m1\-w|m3ga|m50\/|ma(te|ui|xo)|mc(01|21|ca)|m\-cr|me(rc|ri)|mi(o8|oa|ts)|mmef|mo(01|02|bi|de|do|t(\-| |o|v)|zz)|mt(50|p1|v )|mwbp|mywa|n10[0-2]|n20[2-3]|n30(0|2)|n50(0|2|5)|n7(0(0|1)|10)|ne((c|m)\-|on|tf|wf|wg|wt)|nok(6|i)|nzph|o2im|op(ti|wv)|oran|owg1|p800|pan(a|d|t)|pdxg|pg(13|\-([1-8]|c))|phil|pire|pl(ay|uc)|pn\-2|po(ck|rt|se)|prox|psio|pt\-g|qa\-a|qc(07|12|21|32|60|\-[2-7]|i\-)|qtek|r380|r600|raks|rim9|ro(ve|zo)|s55\/|sa(ge|ma|mm|ms|ny|va)|sc(01|h\-|oo|p\-)|sdk\/|se(c(\-|0|1)|47|mc|nd|ri)|sgh\-|shar|sie(\-|m)|sk\-0|sl(45|id)|sm(al|ar|b3|it|t5)|so(ft|ny)|sp(01|h\-|v\-|v )|sy(01|mb)|t2(18|50)|t6(00|10|18)|ta(gt|lk)|tcl\-|tdg\-|tel(i|m)|tim\-|t\-mo|to(pl|sh)|ts(70|m\-|m3|m5)|tx\-9|up(\.b|g1|si)|utst|v400|v750|veri|vi(rg|te)|vk(40|5[0-3]|\-v)|vm40|voda|vulc|vx(52|53|60|61|70|80|81|83|85|98)|w3c(\-| )|webc|whit|wi(g |nc|nw)|wmlb|wonu|x700|yas\-|your|zeto|zte\-/i.test(b.substr(0,4))){a=true}})(navigator.userAgent||navigator.vendor||window.opera);return a}function mobileOrTabletCheck(){var a=false;(function(b){if(/(android|bb\d+|meego).+mobile|avantgo|bada\/|blackberry|blazer|compal|elaine|fennec|hiptop|iemobile|ip(hone|od)|iris|kindle|lge |maemo|midp|mmp|mobile.+firefox|netfront|opera m(ob|in)i|palm( os)?|phone|p(ixi|re)\/|plucker|pocket|psp|series(4|6)0|symbian|treo|up\.(browser|link)|vodafone|wap|windows ce|xda|xiino|android|ipad|playbook|silk/i.test(b)||/1207|6310|6590|3gso|4thp|50[1-6]i|770s|802s|a wa|abac|ac(er|oo|s\-)|ai(ko|rn)|al(av|ca|co)|amoi|an(ex|ny|yw)|aptu|ar(ch|go)|as(te|us)|attw|au(di|\-m|r |s )|avan|be(ck|ll|nq)|bi(lb|rd)|bl(ac|az)|br(e|v)w|bumb|bw\-(n|u)|c55\/|capi|ccwa|cdm\-|cell|chtm|cldc|cmd\-|co(mp|nd)|craw|da(it|ll|ng)|dbte|dc\-s|devi|dica|dmob|do(c|p)o|ds(12|\-d)|el(49|ai)|em(l2|ul)|er(ic|k0)|esl8|ez([4-7]0|os|wa|ze)|fetc|fly(\-|_)|g1 u|g560|gene|gf\-5|g\-mo|go(\.w|od)|gr(ad|un)|haie|hcit|hd\-(m|p|t)|hei\-|hi(pt|ta)|hp( i|ip)|hs\-c|ht(c(\-| |_|a|g|p|s|t)|tp)|hu(aw|tc)|i\-(20|go|ma)|i230|iac( |\-|\/)|ibro|idea|ig01|ikom|im1k|inno|ipaq|iris|ja(t|v)a|jbro|jemu|jigs|kddi|keji|kgt( |\/)|klon|kpt |kwc\-|kyo(c|k)|le(no|xi)|lg( g|\/(k|l|u)|50|54|\-[a-w])|libw|lynx|m1\-w|m3ga|m50\/|ma(te|ui|xo)|mc(01|21|ca)|m\-cr|me(rc|ri)|mi(o8|oa|ts)|mmef|mo(01|02|bi|de|do|t(\-| |o|v)|zz)|mt(50|p1|v )|mwbp|mywa|n10[0-2]|n20[2-3]|n30(0|2)|n50(0|2|5)|n7(0(0|1)|10)|ne((c|m)\-|on|tf|wf|wg|wt)|nok(6|i)|nzph|o2im|op(ti|wv)|oran|owg1|p800|pan(a|d|t)|pdxg|pg(13|\-([1-8]|c))|phil|pire|pl(ay|uc)|pn\-2|po(ck|rt|se)|prox|psio|pt\-g|qa\-a|qc(07|12|21|32|60|\-[2-7]|i\-)|qtek|r380|r600|raks|rim9|ro(ve|zo)|s55\/|sa(ge|ma|mm|ms|ny|va)|sc(01|h\-|oo|p\-)|sdk\/|se(c(\-|0|1)|47|mc|nd|ri)|sgh\-|shar|sie(\-|m)|sk\-0|sl(45|id)|sm(al|ar|b3|it|t5)|so(ft|ny)|sp(01|h\-|v\-|v )|sy(01|mb)|t2(18|50)|t6(00|10|18)|ta(gt|lk)|tcl\-|tdg\-|tel(i|m)|tim\-|t\-mo|to(pl|sh)|ts(70|m\-|m3|m5)|tx\-9|up(\.b|g1|si)|utst|v400|v750|veri|vi(rg|te)|vk(40|5[0-3]|\-v)|vm40|voda|vulc|vx(52|53|60|61|70|80|81|83|85|98)|w3c(\-| )|webc|whit|wi(g |nc|nw)|wmlb|wonu|x700|yas\-|your|zeto|zte\-/i.test(b.substr(0,4))){a=true}})(navigator.userAgent||navigator.vendor||window.opera);return a}function initBootstrapSelect(){$("select").selectpicker()}window.onerror=function myErrorHandler(c,b,a){return false};function mergeObjects(e,c){if(Object.assign){return Object.assign(e,c)}var a={};if(e instanceof Object){for(var b in e){a[b]=e[b]}}if(c instanceof Object){for(var b in c){a[b]=c[b]}}return a}function utoa(a){return window.btoa(unescape(encodeURIComponent(a)))}function atou(a){return decodeURIComponent(escape(window.atob(a)))}function copyToClipboard(a){if(document.selection){var b=document.body.createTextRange();b.moveToElementText(document.getElementById(a));b.select().createTextRange();document.execCommand("Copy")}else{if(window.getSelection){var b=document.createRange();b.selectNode(document.getElementById(a));window.getSelection().addRange(b);document.execCommand("Copy")}}}version=function(){return"v0.2.0c2.20170616"};config.controller("dashboard",["$scope","$rootScope","dataService","$timeout","$interval","$location","$sce","$routeParams","ngDialog","$window",function(r,n,p,d,h,g,m,q,o,c){var b=null;var f=null;var j=null;r.initialized=false;r.loading=true;r.data=null;r.error="";r.designer={};r.locations=null;r.instances=null;r.requestId=0;r.activePistons=0;r.pausedPistons=0;r.dropDownMenu=false;r.endpoint="";r.view="piston";r.init=function(v,y,w){if(r.$$destroyed){return}if(j){d.cancel(j)}j=null;r.requestId++;var z=0+r.requestId;r.loading=!r.initialized||!r.instance;p.setStatusCallback(r.setStatus);p.loadInstance(v,y,w,(r.view=="dashboard")).then(function(A){if(r.$$destroyed){return}if(z!=r.requestId){return}if(A){r.endpoint=A.endpoint+"execute/:pistonId:";if(A.error){switch(A.error){case"ERR_INVALID_TOKEN":r.dialogLogIn(A.name,A.uri);break}}else{r.initialized=true;r.location=p.getLocation();r.instance=p.getInstance();r.currentInstanceId=r.instance.id;r.instanceCount=p.getInstanceCount();if(!r.devices){r.devices=r.listAvailableDevices()}if(!r.virtualDevices){r.virtualDevices=r.listAvailableVirtualDevices()}window.scope=r;r.loading=false;r.activePistons=0;r.pausedPistons=0;for(pistonIndex in r.instance.pistons){var B=r.instance.pistons[pistonIndex];if(B.meta&&B.meta.a){r.activePistons++}else{r.pausedPistons++}}r.clock();r.render()}}else{r.dialogDeleteInstance(v)}})};r.closeNavBar=function(){if(!$("#navbar-btn").hasClass("collapsed")){$("#navbar-btn").click()}};r.render=function(){if(r.$$destroyed){return}if(!r.initialized){return}if(!f){f=h(r.clock,1000)}if(!j){j=d(r.init,10000)}};r.clock=function(){if(r.instance){for(pistonIndex in r.instance.pistons){var v=r.instance.pistons[pistonIndex];v.opacity=v.meta?r.getOpacity(v.meta.t):0}}};r.setStatus=function(v){if(b){d.cancel(b)}b=null;r.status=v;if(r.status){b=d(function(){r.setStatus()},10000)}};r.showSettings=function(){ga("send","event","settings","show");r.closeNavBar();r.settings=r.instance.settings;r.view="settings"};r.hideSettings=function(){ga("send","event","settings","hide");r.view="piston"};r.saveSettings=function(){ga("send","event","settings","save");p.setSettings(r.settings).then(function(v){r.instance.settings=r.settings;r.hideSettings()})};r.showFuelStreams=function(){ga("send","event","fuel","show");r.initialized=false;r.loading=true;g.path("fuel")};r.showDashboard=function(){r.view="dashboard";ga("send","event","dashboard","show");p.openWebSocket(r.onWSUpdate);r.dropDownMenu=false;r.refreshing=true;p.refreshDashboard().then(function(y){for(deviceId in y){if(deviceId.startsWith(":")){var w=r.instance.devices[deviceId];if(w){var v=y[deviceId];for(attr in v){for(i in w.a){if(w.a[i].n==attr){w.a[i].v=v[attr];break}}}w.data=r.getDeviceData(w)}}}r.refreshing=false;r.setStatus()})};r.hideDashboard=function(){ga("send","event","dashboard","hide");p.closeWebSocket();r.view="piston";r.dropDownMenu=false};r.onWheel=function(v){r.dropDownMenu=v&&v.originalEvent&&(v.currentTarget.scrollTop==0)&&(v.originalEvent.deltaY<0);return true};r.onSwipe=function(v,w){r.dropDownMenu=(v.currentTarget.scrollTop==0)&&(w=="down");return true};r.listLocations=function(){return p.listLocations()};r.listInstances=function(v){return p.listInstances(v)};r.listAllInstances=function(){var w=[];var v=r.listLocations();for(l in v){var y=p.listInstances(v[l].id);for(i in y){w.push({id:y[i].id,name:v[l].name+" \\ "+y[i].name,pistons:y[i].pistons})}}return w};r.listAvailableDevices=function(){var v=[];for(deviceIndex in r.instance.devices){r.instance.devices[deviceIndex].id=deviceIndex;v.push(r.instance.devices[deviceIndex])}return v.sort(r.sortByName)};r.listAvailableVirtualDevices=function(){var v=[];for(deviceIndex in r.instance.virtualDevices){var w=r.instance.virtualDevices[deviceIndex];v.push(mergeObjects({id:deviceIndex},w))}return v.sort(r.sortByName)};r.sortByDisplay=function(w,v){return(w.d>v.d)?1:((v.d>w.d)?-1:0)};r.sortByName=function(w,v){return(w.n>v.n)?1:((v.n>w.n)?-1:0)};r.switchInstance=function(w){if(w!=r.instance.id){var v=p.getInstance(w);if(v){r.instance=null;if(j){d.cancel(j)}j=null;r.devices=null;r.init(v);r.closeNavBar()}}};r.$on("$destroy",function(){if(b){d.cancel(b)}if(f){h.cancel(f)}if(j){d.cancel(j)}});r.getDeviceData=function(v){var w={};for(a in v.a){w[v.a[a].n]=v.a[a].v}return w};r.getBatteryLevel=function(v){if(isNaN(v)){return 0}v=Math.floor(v/20);if(v<=0){return 0}if(v>=4){return 4}return v};r.renderString=function(w){var v=0;if(!w){return""}var y=function(F){var z="";while(v<w.length){var G=w[v];switch(G){case"<":z+="&lt;";break;case">":z+="&gt;";break;case"[":var E=w.indexOf("|",v);if(E>v){var B=w.substring(v+1,E);v=E+1;z+=y(B)}else{v++;z+=y()}break;case"]":if(F==undefined){return"["+z+"]"}var A=F.trim().replace(/\s/g,",").split(",");var D="";var C="";for(x in A){switch(A[x]){case"b":D+="s-b ";break;case"u":D+="s-u ";break;case"i":D+="s-i ";break;case"s":D+="s-s ";break;case"pre":D+="s-pre ";break;case"flash":D+="s-flash ";break;default:C=A[x].replace(/[^#0-9a-z]/gi,"")}}return"<span "+(D?'class="'+D+'" ':"")+(C?'style="color: '+C+' !important"':"")+">"+z+"</span>";default:z+=G}v++}return z};return m.trustAsHtml(y(w).replace(/\:fa-([a-z0-9\-\s]*)\:/gi,function(z){return'<i class="fa '+z.replace(/\:/g,"").toLowerCase()+'"></i>'}).replace(/\\[rn]/gi,"<br/>"))};r.onWSUpdate=function(v){if(v.isTrusted&&v.data){try{var y=JSON.parse(v.data);if(y.d&&y.n){var w=r.instance.devices[y.d];if(w){for(a in w.a){if(w.a[a].n==y.n){w.a[a].v=y.v;w.data=r.getDeviceData(w);break}}}}r.$apply()}catch(z){}}};r.getDeviceAttribute=function(y,w){for(a in y.a){var v=y.a[a];if(w==v.n){return v.v}}return""};r.openPiston=function(v){ga("send","event","piston","view",v);r.loading=true;r.initialized=false;g.path("piston/"+v)};r.newPiston=function(){r.loading=true;p.generateNewPistonName().then(function(v){r.loading=false;r.designer={};r.designer.author=p.loadFromStore("author.handle");r.designer.name=v.name;r.designer.page=0;r.designer.backup=!!p.loadFromStore("backup.auto");r.designer.disclaimer=!r.designer.backup;r.designer.items=[{type:"blank",name:"Create a blank piston",icon:"code",cssClass:"wide btn-default"},{type:"duplicate",name:"Create a duplicate piston",icon:"code",cssClass:"wide btn-info"},{type:"template",name:"Create a piston from a template",icon:"code",cssClass:"wide btn-success"},{type:"restore",name:"Restore a piston using a backup code",icon:"code",cssClass:"wide btn-warning"},{type:"import",name:"Import a piston from an external source",icon:"code",cssClass:"wide btn-danger"}];r.designer.dialog=o.open({template:"dialog-add-piston",className:"ngdialog-theme-default ngdialog-large",closeByDocument:false,disableAnimation:true,scope:r})})};r.movePiston=function(){r.designer={pistons:[],instance:""};r.designer.dialog=o.open({template:"dialog-move-piston",className:"ngdialog-theme-default ngdialog-large",closeByDocument:false,disableAnimation:true,scope:r})};r.movePistons=function(){alert("Sorry, not ready yet")};r.createPiston=function(){var v=function(w){r.closeDialog();r.initialized=false;g.path("piston/"+w.id).search({description:r.designer.description,type:r.designer.type,piston:r.designer.piston,bin:r.designer.bin})};r.loading=true;p.saveToStore("backup.auto",!!r.designer.backup);p.saveToStore("author.handle",r.designer.author);if(r.designer.backup){p.generateBackupBin().then(function(w){var y=w.data;p.createPiston(r.designer.name,r.designer.author,y).then(v)})}else{p.createPiston(r.designer.name,r.designer.author).then(v)}};r.dialogLogIn=function(v,w){if(j){d.cancel(j)}j=null;r.loading=false;r.initialized=false;r.designer={};r.designer.sender=v;r.designer.uri=w;r.designer.dialog=o.open({template:"dialog-auth",className:"ngdialog-theme-default ngdialog-large",closeByDocument:false,disableAnimation:true,scope:r})};r.logOut=function(){p.logout().then(function(){r.loading=true;r.initialized=false;g.path("register")})};r.initAds=function(){d(function(){if(CHITIKA_ADS){CHITIKA_ADS.make_it_so()}},1,false)};r.authenticate=function(){r.closeDialog();r.init(null,r.designer.uri,window.md5("pin:"+r.designer.password));r.designer=null};r.dialogDeleteInstance=function(v){if(v){r.loading=false;r.initialized=false;r.designer={};r.designer.sender=v.locationName+" \\ "+v.name;r.designer.instance=v;r.designer.dialog=o.open({template:"dialog-del-instance",className:"ngdialog-theme-default ngdialog-large",closeByDocument:false,disableAnimation:true,scope:r})}};r.deleteInstance=function(){r.closeDialog();p.deleteInstance(r.designer.instance);r.designer=null;r.init()};r.setDesignerType=function(v){r.designer.type=v;r.nextPage()};r.closeDialog=function(){if(r.designer.dialog){r.designer.dialog.close();r.designer.dialog=null}};r.nextPage=function(){r.designer.page++};r.prevPage=function(){if(r.designer.page){r.designer.page--}};r.getOpacity=function(v){if(!v){return 0}v=currentTime()-v;if((v<0)||(v>60000)){return 0}return 1-v/60000};r.getLocationMode=function(){var w=r.location.mode;for(var v=0;v<r.location.modes.length;v++){if(r.location.modes[v].id==w){return r.location.modes[v].name}}return"(unknown)"};r.getSHMModeName=function(){switch(r.location.shm){case"away":return"ARMED (AWAY)";case"stay":return"ARMED (HOME)";case"off":return"DISARMED"}return"(unknown)"};r.renderIncident=function(v){result="<span date>"+r.utcToString(v.date)+"</span> - <span title>";result+=v.message.replace(/\{\{(.*)\}\}/gi,function(w){return v.args[w.substr(2,w.length-4).trim()]});result+="</span>";return m.trustAsHtml(result)};r.breakList=function(v){return v.replace(/,/g,"<br/>")};var u=function(w){var y=w.getFullYear();var z=(1+w.getMonth()).toString();z=z.length>1?z:"0"+z;var v=w.getDate().toString();v=v.length>1?v:"0"+v;return z+"/"+v+"/"+y};r.getMonth=function(v){if(v){return["JAN","FEB","MAR","APR","MAY","JUN","JUL","AUG","SEP","OCT","NOV","DEC"][v.getMonth()]}};r.getDay=function(v){if(v){return("0"+v.getDate()).substr(-2)}};r.timeSince=timeSince;r.timeCounter=timeCounter;r.timeLeft=timeLeft;r.tap=function(v){p.tap(v).then(function(w){})};r.togglePiston=function(y,w){if((!y)&&(!r.viewerPiston||!r.viewerPiston.app)){return}var z=y?y.i:r.pistonId;if(z){d.cancel(tmrRefresh);var v=!(y?y.e:r.viewerPiston.app.enabled);if(y){y.e=v}else{r.viewerPiston.app.enabled=v}if(v){p.resumePiston(z).then(function(A){r.onRefresh(A)})}else{p.pausePiston(z).then(function(A){r.onRefresh(A)})}}if(w&&e.preventDefault){w.preventDefault()}if(w&&w.stopPropagation){w.stopPropagation()}};r.configurePiston=function(v){r.configuredPistonId=r.configuredPistonId==v.i?null:v.i};r.showPiston=function(v){document.body.scrollTop=0;r.viewerPiston=null;r.pistonId=v.i;r.refresh();window.onSwipeRight=r.hidePiston};r.hidePiston=function(){document.body.scrollTop=0;r.pistonId=null;window.onSwipeRight=null};r.prepareActions=function(y){var A=[];var v=[];var D=[];var E=(y.id<=0);var z=r.viewerPiston.tasks;var C=r.viewerPiston.app.actions;for(action in C){if(C[action].pid==y.id){if(C[action].t){var B=C[action].t;for(t in B){var w=0;for(task in z){if((z[task].type=="cmd")&&(z[task].ownerId==C[action].id)&&(z[task].taskId==B[t].i)){if((w==0)||(w>z[task].time)){w=z[task].time}}}B[t].time=w}}if(E){A.push(C[action])}else{if(C[action].rs==false){D.push(C[action])}else{v.push(C[action])}}}}var w=0;for(task in z){if((z[task].type=="evt")&&(z[task].ownerId==y.id)){if((w==0)||(w>z[task].time)){w=z[task].time}}}y.time=w;y.actions=A;y.trueActions=v;y.falseActions=D;y.$scope=r;if(y.children){for(child in y.children){r.prepareActions(y.children[child])}}};r.hadRecentActivity=function(v){return v&&v.le&&v.le.event&&v.le.event.date&&(timeLeft((new Date(v.le.event.date)).getTime())>-120)};r.toggleViewerOptions=function(){r.viewerPiston.showOptions=!r.viewerPiston.showOptions;r.closeNavBar()};r.getSecondaryStatementName=function(){var v=r.viewerPiston.app.mode;switch(v){case"Latching":return"BUT IF";case"Then-If":return"THEN IF";case"Else-If":return"ELSE IF";case"Or-If":return"OR IF";case"And-If":return"AND IF"}return"IF"};r.capturePiston=function(){var v=document.getElementById("viewerPanel");document.body.scrollTop=0;html2canvas(v).then(function(w){r.capturedImage=w.toDataURL("image/png");r.dialogCapture=o.open({template:"dialog-captured-image",className:"ngdialog-theme-default ngdialog-large",disableAnimation:true,scope:r,showClose:true})})};r.pausePiston=function(v){r.loading=true;p.pausePiston(v).then(function(w){r.init()})};r.resumePiston=function(v){r.loading=true;p.resumePiston(v).then(function(w){r.init()})};r.testPiston=function(v){p.testPiston(v)};r.determineDeviceType=function(v){return p.determineDeviceType(v)};r.initSocialMedia=function(){c.FB.XFBML.parse()};var s=navigator.userAgent||navigator.vendor||window.opera;if(s.match(/Android/i)){r.android=true}r.url=window.location.href;r.mobile=window.mobileCheck();r.tablet=(!r.mobile)&&(window.mobileOrTabletCheck());r.formatTime=formatTime;r.utcToString=utcToString;r.$$postDigest(function(){c.FB.XFBML.parse()});var k=setInterval(function(){if(p.ready()){clearInterval(k);r.init()}},1)}]);config.controller("register",["$scope","$rootScope","dataService","$timeout","$interval","$location","$sce","$routeParams","ngDialog","$window",function(k,g,i,c,e,d,f,j,h,b){var a=null;k.loading=false;k.code="";k.init=function(){};k.setStatus=function(m){if(a){c.cancel(a)}a=null;k.status=m;if(k.status){a=c(function(){k.setStatus()},10000)}};k.$on("$destroy",function(){if(a){c.cancel(a)}});k.register=function(){k.loading=true;i.registerDashboard(k.code).then(function(m){if(m&&(m.length>=80)&&(m.length<=140)){d.path("/init/"+m)}else{k.setStatus("Sorry, the registration code you provided did not work...")}k.loading=false})};k.init();var l=navigator.userAgent||navigator.vendor||window.opera;if(l.match(/Android/i)){k.android=true}k.url=window.location.href;k.mobile=window.mobileCheck();k.tablet=(!k.mobile)&&(window.mobileOrTabletCheck());k.formatTime=formatTime;k.utcToString=utcToString}]);config.controller("piston",["$scope","$rootScope","dataService","$timeout","$interval","$location","$sce","$routeParams","ngDialog","$window","$animate",function(u,j,v,A,w,h,n,f,m,q,y){var z;var C;var g;var s;var r="$status";u.lastLogEntry=0;u.error="";u.loading=true;u.initialized=false;u.mode="view";u.logging="0";u.data=null;u.error="";u.pistonId=f.pistonId;u.piston=null;u.designer={};u.showAdvancedOptions=false;u.dk="N7zqL6a8Texs4wY5y&y2YPLzus+_dZ%s";u.params=h.search();u.insertIndexes={};u.warnings={};if(u.params){h.search({})}u.stack={undo:[],redo:[]};u.weekDays=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"];u.yearMonths=["January","February","March","April","May","June","July","August","September","October","November","December"];u.render=function(D){if((u.mode=="view")&&(u.view.trace)){if(!s){s=w(u.render,1000)}if(u.trace){}}else{if(s){A.cancel(s)}s=null}};u.setStatus=function(D){if(D){console.log(D)}if(C){A.cancel(C)}C=null;u.status=D;if(u.status){C=A(function(){u.setStatus()},10000)}};u.version=function(){return q.version()};u.encodeEmoji=function(D){if(!D){return""}return D.replace(/([\uD83C-\uDBFF][\uDC00-\uDFFF])/g,function(E){return encodeURIComponent(E)})};u.listAllPistons=function(){var E=[];var D=v.listLocations();for(l in D){var F=v.listInstances(D[l].id);for(i in F){for(p in F[i].pistons){E.push({v:F[i].pistons[p].id,n:D[l].name+" \\ "+F[i].name+" \\ "+F[i].pistons[p].name})}}}return E};u.listAvailableContacts=function(){var E=[];for(i in u.instance.contacts){var D=u.instance.contacts[i];E.push({v:i,n:(D.f+" "+D.l).trim()+(D.p?" (PUSH)":(D.t?" ("+D.t+")":"")),an:D.an})}if(!E.length){E.push({v:"no one",n:"No available contacts"})}return E};u.getPistonName=function(F){var D=v.listLocations();for(l in D){var E=v.listInstances(D[l].id);for(i in E){for(p in E[i].pistons){if(E[i].pistons[p].id==F){return D[l].name+" \\ "+E[i].name+" \\ "+E[i].pistons[p].name}}}}return F};u.getLifxSceneName=function(D){if(!u.instance.settings.lifx_scenes){return D}var E=u.instance.settings.lifx_scenes[D];if(!E){return D}return E};u.getModeName=function(D){for(modeIndex in u.location.modes){if(u.location.modes[modeIndex].id==D){return u.location.modes[modeIndex].name}}return D};u.updateActivity=function(D){if(u.$$destroyed){return}if(u.mode!="view"){return}if(g){A.cancel(g)}if(D){g=A(u.updateActivity,10000);return}v.getActivity(u.pistonId,u.lastLogEntry).then(function(E){if(u.$$destroyed){return}if(E.error=="ERR_INVALID_ID"){u.home();return}if(E&&E.activity){if(E.activity.state){u.state=E.activity.state}if(E.activity.logs&&E.activity.logs.length){u.logs=E.activity.logs.concat(u.logs)}if(E.activity.trace){u.trace=E.activity.trace}if(E.activity.localVars){u.localVars=E.activity.localVars}if(E.activity.memory){u.memory=E.activity.memory}if(E.activity.lastExecuted){u.lastExecuted=E.activity.lastExecuted}if(E.activity.nextSchedule){u.nextSchedule=E.activity.nextSchedule}if(E.activity.schedules){u.schedules=E.activity.schedules}if(E.activity.name){u.meta.name=E.activity.name}if(u.logs&&u.logs.length){u.lastLogEntry=u.logs[0].t}if(E.activity.globalVars){u.updateGlobalVars(E.activity.globalVars)}}g=A(u.updateActivity,3000)})};u.updateGlobalVars=function(D){u.globalVars=u.globalVars instanceof Object?u.globalVars:{};for(varName in D){var E=D[varName].t;var G=D[varName].v;var F=u.globalVars[varName];if(!F){u.globalVars[varName]={t:E,v:G}}else{if(F.t!=E){F.t=E}if(F.v!=G){F.v=G}}}for(varName in u.globalVars){if(!D[varName]){delete (u.globalVars[varName])}}};u.init=function(){if(u.$$destroyed){return}v.setStatusCallback(u.setStatus);u.loading=true;if(u.piston){u.loading=true}v.getPiston(u.pistonId).then(function(D){if(u.$$destroyed){return}try{var E=u.piston?!!u.showOptions:false;if(!D||!D.data||!D.data.piston){u.error=n.trustAsHtml("Sorry, an error occurred while retrieving the piston data.");u.loading=false;return}u.piston=D.data.piston;u.validatePiston(u.piston);u.meta=D.data.meta?D.data.meta:{};u.db=D.db;u.location=v.getLocation();u.instance=v.getInstance();u.view=v.loadFromStore("view")||{variables:false,elseIfs:false,restrictions:false,whens:false,advancedStatements:false};u.subscriptions=D.data.subscriptions?D.data.subscriptions:{};u.logs=D.data.logs?D.data.logs:[];u.lastLogEntry=(u.logs&&u.logs.length)?u.logs[0].t:0;u.stats=D.data.stats?D.data.stats:{};u.state=D.data.state?D.data.state:"";u.trace=D.data.trace?D.data.trace:{};u.logging=""+(D.data.logging?D.data.logging:0);u.memory=D.data.memory?D.data.memory:0;u.lastExecuted=D.data.lastExecuted;u.nextSchedule=D.data.nextSchedule;u.schedules=D.data.schedules;u.initChart();if(u.instance&&u.instance.devices){u.anonymizeDevices(u.instance.devices)}if(u.instance&&u.instance.contacts){u.anonymizeContacts(u.instance.contacts)}u.devices=u.listAvailableDevices();u.contacts=u.listAvailableContacts();u.virtualDevices=u.listAvailableVirtualDevices();window.scope=u;u.localVars=D.data.localVars;u.globalVars=u.instance.globalVars;u.systemVars=D.data.systemVars;u.systemVarNames=[];for(name in u.systemVars){u.systemVarNames.push(name)}u.meta.build=u.meta.build?1*u.meta.build:0;if(u.piston&&(u.meta.build==0)){u.piston.z=u.params&&u.params.description?u.params.description:"";u.mode="edit";if(u.params&&u.params.type!="blank"){switch(u.params.type){case"duplicate":if(u.params.piston){u.loading=true;v.getPiston(u.params.piston).then(function(G){u.loading=false;if(G&&G.data&&G.data.piston){u.piston.o=G.data.piston.o?G.data.piston.o:{};u.piston.r=G.data.piston.r?G.data.piston.r:[];u.piston.rn=!!G.data.piston.rn;u.piston.rop=G.data.piston.rop?G.data.piston.rop:"and";u.piston.s=G.data.piston.s?G.data.piston.s:[];u.piston.v=G.data.piston.v?G.data.piston.v:[]}u.initialized=true;u.loading=false});return}break;case"restore":if(u.params.bin){u.loading=true;v.loadFromBin(u.params.bin).then(function(G){var H=G.data;u.loading=false;if(H){u.piston.o=H.o?H.o:{};u.piston.r=H.r?H.r:[];u.piston.rn=!!H.rn;u.piston.rop=H.rop?H.rop:"and";u.piston.s=H.s?H.s:[];u.piston.v=H.v?H.v:[];u.piston.z=H.z?H.z:""}u.initialized=true;u.loading=false;if(!!H&&!!H.l){u.rebuildPiston(H.l)}});return}break}}}if(u.mode=="edit"){u.loadStack()}else{u.updateActivity(true)}u.piston.o=u.piston.o?u.piston.o:{cto:0,ced:0};u.piston.r=u.piston.r?u.piston.r:[];u.piston.s=u.piston.s?u.piston.s:[];u.piston.rop=u.piston.rop?u.piston.rop:"and";u.piston.rn=!!u.piston.rn;u.piston.v=u.piston.v?u.piston.v:[];u.piston.z=u.piston.z||"";u.initialized=true;u.loading=false;u.render()}catch(F){alert(F)}})};u.initChart=function(){u.chart={type:"bar",labels:[],series:["Event delay","Load time","Execution time","Update time"],data:[[],[],[],[]],onClick:function(F,E){},datasetOverride:[{cubicInterpolationMode:"monotone",lineTension:0,yAxisID:"y-axis-1",fill:true,pointRadius:0,borderColor:"#88bbee",borderWidth:0,backgroundColor:"#99ccff"},{cubicInterpolationMode:"monotone",lineTension:0,yAxisID:"y-axis-1",fill:true,pointRadius:0,borderColor:"#eebb88",borderWidth:"0px",backgroundColor:"#ffcc99"},{cubicInterpolationMode:"monotone",lineTension:0,yAxisID:"y-axis-1",fill:true,pointRadius:0,borderColor:"#ee88bb",borderWidth:"0px",backgroundColor:"#ff99cc"},{cubicInterpolationMode:"monotone",lineTension:0,yAxisID:"y-axis-1",fill:true,pointRadius:0,borderColor:"#999",borderWidth:1,backgroundColor:"#ccff99"}],options:{legend:{display:true},multiTooltipTemplate:"<%=datasetLabel%> : <%= value %>ms",showLines:true,fill:true,scales:{xAxes:[{type:"time"}],yAxes:[{id:"y-axis-1",stacked:true,type:"linear",display:true,position:"left"}]},pan:{enabled:true,mode:"x"},zoom:{enabled:true,mode:"x"}}};if(u.stats&&u.stats.timing){for(var D=0;D<u.stats.timing.length;D++){u.chart.labels.push(new Date(u.stats.timing[D].t));u.chart.data[0].push(u.stats.timing[D].d);u.chart.data[1].push(u.stats.timing[D].l);u.chart.data[2].push(u.stats.timing[D].e);u.chart.data[3].push(u.stats.timing[D].u)}}};u.$on("$destroy",function(){if(C){A.cancel(C)}if(z){A.cancel(z)}if(g){A.cancel(g)}if(s){A.cancel(s)}});u.copy=function(D){return angular.fromJson(angular.toJson(D))};u.home=function(){u.initialized=false;h.path("/")};u.toggleView=function(D){if(D){u.view[D]=!u.view[D]}v.saveToStore("view",u.view)};u.revealBin=function(){u.revealing=!u.revealing;if(z){A.cancel(z)}if(u.revealing){z=A(function(){u.revealing=false;z=null},10000)}};u.edit=function(){u.mode="edit";u.init();$("viewer")[0].scrollTop=0};u.cancel=function(){u.mode="view";u.init()};u.save=function(){u.loading=true;var D=u.compilePiston({id:u.pistonId,o:u.piston.o,s:u.piston.s,v:u.piston.v,r:u.piston.r,rop:u.piston.rop,rn:u.piston.rn,z:u.piston.z,n:u.meta.name});v.setPiston(D,u.meta.bin).then(function(E){u.loading=false;if(E&&E.data&&E.data.build){u.meta.active=E.data.active;u.meta.modified=E.data.modified;u.meta.build=E.data.build;u.saveStack(true);u.mode="view";u.init()}})};u.pause=function(){u.loading=true;v.pausePiston(u.pistonId).then(function(D){u.loading=false;if(D&&D.status&&(D.status=="ST_SUCCESS")){u.meta.active=D.active;u.subscriptions={};u.updateActivity()}})};u.setLoggingLevel=function(D){u.loading=true;v.setPistonLogging(u.pistonId,u.logging).then(function(E){u.loading=false})};u.resume=function(){u.loading=true;v.resumePiston(u.pistonId).then(function(D){u.loading=false;if(D&&D.status&&(D.status=="ST_SUCCESS")){u.meta.active=D.active;if(D.subscriptions){u.subscriptions=D.subscriptions}u.updateActivity()}})};u.del=function(){u.loading=true;v.deleteFromStore("stack"+u.pistonId);v.deletePiston(u.pistonId).then(function(D){u.closeDialog();h.path("/")})};u.padComment=function(E,D){if(!E){E=""}D=D-6-E.replace(/\u200E/g,"").trim().length;while(D>0){E+=" ";D--}return"/* "+E+" */"};u.range=function(D){return new Array(D)};u.wiki=function(D){u.wikiUrl=n.trustAsUrl("https://wiki.webcore.co/"+D+"?content-only");q.mydialog=m.open({template:"dialog-wiki",className:"ngdialog-theme-default ngdialog-large ngdialog-wiki",closeByDocument:true,disableAnimation:true,scope:u})};u.formatVariableValue=function(E,D){if((E.v==null)&&!!D&&u.localVars){E=u.copy(E);E.v=u.localVars[D]}var F=(D=="$localNow")||(D=="$utc")?"long":E.t;if((E.v==="")||(E.v===null)||((E.v instanceof Array)&&!E.v.length)){return"(not set)"}switch(F){case"time":return utcToTimeString(E.v);case"datetime":return utcToString(E.v);case"date":return utcToDateString(E.v);case"contact":return u.renderContactNameList(E.v);case"device":return u.renderDeviceNameList(E.v);default:return E.v}};u.deleteDialog=function(){u.designer.dialog=m.open({template:"dialog-del-piston",className:"ngdialog-theme-default ngdialog-large",closeByDocument:false,disableAnimation:true,scope:u})};u.listDevicesWithAttributes=function(E){if(!E||!(E instanceof Array)||!E.length){return u.instance.devices}var D={};for(d in u.instance.devices){var F=u.instance.devices[d];var G=0;for(a in F.a){if(E.indexOf(F.a[a].n)>=0){G++;if(G==E.length){break}}}if(G==E.length){D[d]=F}}return D};u.rebuildPiston=function(D){if(!D){return}for(key in D){var E=D[key];E.id="";switch(E.t){case"device":E.i=u.listDevicesWithAttributes(E.a);break;case"contact":E.i=u.instance.contacts;break;case"mode":E.i=u.instance.virtualDevices.mode.o;for(i in E.i){if(E.i[i]==E.n){E.id=i;break}}break;case"routine":E.i=u.instance.virtualDevices.routine.o;break}}u.designer={legend:D};u.designer.dialog=m.open({template:"dialog-rebuild-piston",className:"ngdialog-theme-default ngdialog-large",closeByDocument:false,disableAnimation:true,scope:u})};u.doRebuildPiston=function(){u.piston=u.compilePiston(u.piston,false,u.designer.legend);u.closeDialog()};u.doValidatePiston=function(){u.validatePiston(u.piston)};u.getExpressionConfig=function(){var D=[];for(attribute in u.db.attributes){D.push(": "+attribute+"]")}return{autocomplete:[{words:[]},{words:u.listAutoCompleteFunctions(),cssClass:"hl kwd"},{words:u.listAutoCompleteVariables(),cssClass:"hl var"},{words:u.listAutoCompleteDevices(),cssClass:"hl dev"},{words:D,cssClass:"hl dev"},{words:[/([0-9]+)(\.[0-9]+)?/g],cssClass:"hl num"}]}};u.removeFromArray=function(F,E){if(!(F instanceof Array)){return}var D=F.indexOf(E);if(D!==-1){F.splice(D,1)}return F};u.deleteObject=function(F,E){var D=!F;if(D){F=u.designer.$obj;E=u.designer.parent}if(!F){return}if((E instanceof Array)&&(F)){u.autoSave();E=u.removeFromArray(E,F);if(D){u.closeDialog()}}if(E&&(E.t=="action")&&(E.k instanceof Array)&&(F)){u.autoSave();E.k=u.removeFromArray(E.k,F);if(D){u.closeDialog()}}};u.getIFTTTUri=function(D){var E=v.getApiUri();if(!E){return"An error has occurred retrieving the IFTTT Maker URL"}return E+"ifttt/"+D};u.toggleAdvancedOptions=function(){u.designer.showAdvancedOptions=!u.designer.showAdvancedOptions};u.getClipboard=function(){var D=v.loadFromStore("clipboard");if(!D){D=[]}return D};u.getClipboardItems=function(F){var E=u.getClipboard();var D=[];for(i in E){if(E[i].t.startsWith(F)){D.push(E[i])}}return D};u.saveToClipboard=function(E,D){var F=u.getClipboard();F.push({s:(new Date()).getTime(),t:D,o:u.copy(E)});if(F.length>MAX_STACK_SIZE){F=F.slice(-MAX_STACK_SIZE)}v.saveToStore("clipboard",F)};u.deleteClipboardItem=function(D){var E=u.getClipboard();u.removeFromArray(u.designer.clipboard,D);for(i=0;i<E.length;i++){if((E[i].s==D.s)&&(E[i].t==D.t)){break}}if(i<E.length){E.splice(i,1);v.saveToStore("clipboard",[])}};u.clearClipboard=function(){v.saveToStore("clipboard",[])};u.copySelection=function(){if(!u.selection){return}u.saveToClipboard(u.selection,u.selectionType)};u.cutSelection=function(){if(!u.selection){return}u.saveToClipboard(u.selection,u.selectionType);u.deleteObject(u.selection,u.selectionParent)};u.duplicateSelection=function(){if(!u.selection){return}if(!u.selectionParent){return}if(u.selectionParent instanceof Array){u.selectionParent.push(u.copy(u.selection))}};u.deleteSelection=function(){if(!u.selection){return}u.deleteObject(u.selection,u.selectionParent)};u.pasteItem=function(E){if(!E||!E.o||!u.designer||!u.designer.parent){return}var D=(u.designer.parent instanceof Array)?u.designer.parent:(E.t.startsWith("condition")&&u.designer.parent.c?u.designer.parent.c:(E.t.startsWith("restriction")&&u.designer.parent.r?u.designer.parent.r:(E.t.startsWith("task")&&u.designer.parent.k?u.designer.parent.k:null)));if(!D){return}D.push(u.copy(E.o));u.closeDialog()};u.contextMenu=function(E){var D=[];if(u.selection){D.push(["Copy selected "+u.selectionType,u.copySelection]);if(u.mode=="edit"){D.push(["Duplicate selected "+u.selectionType,u.duplicateSelection]);if(u.selectionParent){D.push(null);D.push(["Cut selected "+u.selectionType,u.cutSelection]);D.push(["Delete selected "+u.selectionType,u.deleteSelection])}}D.push(null)}D.push(["Clear clipboard",u.clearClipboard]);return D};u.select=function(E,F,D){if(!D){D="statement"}u.selection=E;u.selectionParent=F;u.selectionType=D};u.editSettings=function(){if(u.mode!="edit"){return}u.designer={name:u.meta.name,description:u.piston.z,automaticState:u.piston.o.mps?1:0,commandOptimizations:u.piston.o.dco?1:0,conditionOptimizations:u.piston.o.cto?1:0,executionParallelism:u.piston.o.pep?1:0,eventSubscriptions:u.piston.o.des?1:0,allowPreSchedules:u.piston.o.aps?1:0,commandDelay:u.piston.o.ced?u.piston.o.ced:0};window.designer=u.designer;u.designer.dialog=m.open({template:"dialog-edit-settings",className:"ngdialog-theme-default ngdialog-large",closeByDocument:false,disableAnimation:true,scope:u})};u.updateSettings=function(){u.meta.name=u.designer.name;u.piston.z=u.designer.description;u.piston.o.mps=u.designer.automaticState?1:0;u.piston.o.pep=u.designer.executionParallelism?1:0;u.piston.o.dco=u.designer.commandOptimizations?1:0;u.piston.o.cto=u.designer.conditionOptimizations?1:0;u.piston.o.des=u.designer.eventSubscriptions?1:0;u.piston.o.aps=u.designer.allowPreSchedules?1:0;u.piston.o.ced=isNaN(u.designer.commandDelay)?0:parseInt(u.designer.commandDelay);u.closeDialog()};u.addStatement=function(D){return u.editStatement(null,D)};u.editStatement=function(E,D){if(u.mode!="edit"){return}if(!E){E={};E.t=null;E.d=[];E.o="and";E.n=false;E.rop="and";E.rn=false;E.a="0";E.di=false;E.tcp="c";E.tep="";E.tsp="";E.ctp="i";E.s="local";E.z=""}u.designer={config:u.getExpressionConfig(),clipboard:E.t?[]:u.getClipboardItems("statement")};u.designer.$obj=E;u.designer.$statement=E;u.designer.$new=E.t?false:true;u.designer.type=E.t;u.designer.page=E.t?1:0;u.designer.operator=E.o;u.designer.not=E.n?"1":"0";u.designer.disabled=E.di?"1":"0";u.designer.roperator=E.rop;u.designer.rnot=E.rn?"1":"0";u.designer.description=E.z;u.designer.parent=D;u.designer.devices=E.d;u.designer.operand={data:u.copy(E.lo),multiple:false};u.designer.operand2={data:u.copy(E.lo2),multiple:false};u.designer.operand3={data:u.copy(E.lo3),multiple:false};u.designer.x=E.x;u.designer.autoDialogs=true;u.designer.tcp=E.tcp;u.designer.tep=E.tep;u.designer.tsp=E.tsp;u.designer.ctp=E.ctp||"i";u.designer.async=E.a;u.designer.ontypechanged=function(F,G){F.operand.requirePositiveNumber=false;F.operand2.requirePositiveNumber=false;F.operand3.requirePositiveNumber=false;switch(G){case"for":F.operand.dataType="decimal";F.operand2.dataType="decimal";F.operand3.dataType="decimal";F.operand.onlyAllowConstants=false;F.operand.hideMilliseconds=true;if(F.$new){F.operand.data={t:"c"}}if(F.$new){F.operand2.data={t:"c"}}if(F.$new){F.operand3.data={t:"c"}}u.validateOperand(F.operand,true);u.validateOperand(F.operand2,true);u.validateOperand(F.operand3,true);break;case"each":F.operand.dataType="devices";F.operand.onlyAllowConstants=false;F.operand.hideMilliseconds=true;if(F.$new){F.operand.data={t:"d"}}u.validateOperand(F.operand,true);break;case"exit":F.operand.dataType="string";if(F.$new){F.operand.data={t:"c"}}u.validateOperand(F.operand,true);break;case"switch":F.operand.dataType="";F.operand.onlyAllowConstants=false;F.operand.hideMilliseconds=true;if(F.$new){F.operand.data={t:"p"}}u.validateOperand(F.operand,true);break;case"every":F.operand.dataType="duration";if(F.$new){F.operand.data={t:"c",c:1,vt:"d"}}F.operand.onlyAllowConstants=true;F.operand.hideMilliseconds=true;F.operand2.dataType="time";var H=new Date();H.setSeconds(0,0);if(F.$new){F.operand2.data={t:"c",c:H}}F.operand3.dataType="duration";if(F.$new){F.operand3.data={t:"c",c:0,vt:"m"}}F.operand3.onlyAllowConstants=true;u.validateOperand(F.operand,true);u.validateOperand(F.operand2,true);u.validateOperand(F.operand3,true);break}u.refreshSelects()};window.designer=u.designer;u.designer.items={simple:[{type:"if",name:"If Block",icon:"code-fork",cssClass:"info",description:"An if block allows the piston to execute different actions depending on the truth result of a comparison or set of comparisons",button:"an if"},{type:"action",name:"Action",icon:"code",cssClass:"success",description:"An action allows the piston to control devices and execute tasks",button:"an action"},{type:"every",name:"Timer",icon:"clock-o",cssClass:"warning",description:"A timer will trigger execution of the piston at set time intervals",button:"a timer"}],advanced:[{type:"switch",name:"Switch",icon:"code-fork",cssClass:"info",description:"A switch statement compares an operand against a set of values and executes statements corresponding to those matches",button:"a switch"},{type:"do",name:"Do Block",icon:"code",cssClass:"success",description:"A do block can help organize several statements into a single block",button:"a do block"},{type:"on",name:"On event",icon:"code-fork",cssClass:"warning",description:"An on event executes its statements only when certain events happen",button:"an on event"},{type:"for",name:"For Loop",icon:"circle-o-notch",cssClass:"warning",description:"A for loop executes the same statements for a set number of iteration cycles",button:"a for loop"},{type:"each",name:"For Each Loop",icon:"circle-o-notch",cssClass:"warning",description:"An each loop executes the same statements for each device in a device list",button:"a for each loop"},{type:"while",name:"While Loop",icon:"circle-o-notch",cssClass:"warning",description:"A while loop executes the same statements for as long as a condition is met",button:"a while loop"},{type:"repeat",name:"Repeat Loop",icon:"circle-o-notch",cssClass:"warning",description:"A repeat loop executes the same statements until a condition is met",button:"a repeat loop"},{type:"break",name:"Break",icon:"ban",cssClass:"danger",description:"A break allows the interruption of the inner most switch, for loop, for each loop, while loop, or repeat loop",button:"a break"},{type:"exit",name:"Exit",icon:"ban",cssClass:"danger",description:"An exit interrupts the piston execution and exits immediately",button:"an exit"}]};u.designer.ontypechanged(u.designer,u.designer.type);u.designer.dialog=m.open({template:"dialog-edit-statement",className:"ngdialog-theme-default ngdialog-large",closeByDocument:false,disableAnimation:true,scope:u})};u.updateStatement=function(E,F){u.autoSave();var D=u.designer.$new?{t:u.designer.type}:u.designer.$statement;D.a=(u.designer.async=="1")||(["every","on"].indexOf(u.designer.type)>=0)?"1":"0";D.tcp=u.designer.tcp;D.tep=u.designer.tep;D.tsp=u.designer.tsp;D.z=u.designer.description;D.r=D.r?D.r:[];D.rop=u.designer.roperator;D.rn=u.designer.rnot=="1";D.di=u.designer.disabled=="1";switch(D.t){case"action":D.d=u.designer.devices;D.k=D.k?D.k:[];break;case"do":D.s=D.s?D.s:[];break;case"on":D.c=D.c?D.c:[];D.o="or";D.n=false;D.s=D.s?D.s:[];break;case"if":D.o=u.designer.operator;D.n=u.designer.not=="1";D.c=D.c?D.c:[];D.s=D.s?D.s:[];D.ei=D.ei?D.ei:[];D.e=D.e?D.e:[];break;case"switch":D.lo=u.designer.operand.data;D.cs=D.cs||[];D.e=D.e?D.e:[];D.ctp=u.designer.ctp;break;case"for":D.x=u.designer.x;D.lo=u.designer.operand.data;D.lo2=u.designer.operand2.data;D.lo3=u.designer.operand3.data;D.s=D.s?D.s:[];break;case"each":D.x=u.designer.x;D.lo=u.designer.operand.data;D.s=D.s?D.s:[];break;case"while":D.o=u.designer.operator;D.n=u.designer.not=="1";D.c=D.c?D.c:[];D.s=D.s?D.s:[];break;case"every":D.lo=u.designer.operand.data;D.lo2=u.designer.operand2.data;if(D.lo2.c instanceof Date){D.lo2.c=D.lo2.c.getHours()*60+D.lo2.c.getMinutes()}D.lo3=u.designer.operand3.data;D.s=D.s?D.s:[];break;case"repeat":D.o=u.designer.operator;D.n=u.designer.not=="1";D.c=D.c?D.c:[];D.s=D.s?D.s:[];break;case"break":break;case"exit":D.lo=u.designer.operand.data;break;default:D.t=null}if(D.t){D.$$html=null;if(u.designer.$new){if(u.designer.parent instanceof Array){u.designer.parent.push(D)}else{if((u.designer.parent.s)&&(u.designer.parent.s instanceof Array)){u.designer.parent.s.push(D)}else{u.designer.parent.s=[D]}}}else{u.designer.$statement=D}}u.doValidatePiston();u.closeDialog();if(E){switch(D.t){case"action":u.addTask(D);return;case"if":u.addCondition(D.c,false,F);return;case"on":u.addEvent(D.c);return;case"while":u.addCondition(D.c);return;case"do":case"for":case"each":case"repeat":case"every":u.addStatement(D.s);return;case"switch":u.addCase(D.cs);return}}};u.upgradeStatement=function(){u.updateStatement();var D=u.designer.$statement;if(D&&D.c&&(D.c instanceof Array)){D.c=[{t:"group",n:false,o:"and",c:D.c}]}};u.addCase=function(D){return u.editCase(null,D)};u.editCase=function(D,E){if(u.mode!="edit"){return}var F=D?false:true;if(!D){D={};D.t="s";D.s=[];D.ro={};D.ro2={};D.z=""}u.designer={config:u.getExpressionConfig()};u.designer.$obj=D;u.designer.$case=D;u.designer.$new=F;u.designer.parent=E;u.designer.type=D.t;u.designer.operand={data:D.ro,multiple:false};u.designer.operand2={data:D.ro2,multiple:false};u.designer.autoDialogs=true;u.designer.description=D.z;window.designer=u.designer;u.validateOperand(u.designer.operand);u.validateOperand(u.designer.operand2);u.designer.dialog=m.open({template:"dialog-edit-case",className:"ngdialog-theme-default ngdialog-large",closeByDocument:false,disableAnimation:true,scope:u})};u.updateCase=function(E){u.autoSave();var D=u.designer.$case;D.t=u.designer.type;D.s=D.s||[];D.ro=u.designer.operand.data;D.ro2=u.designer.operand2.data;D.z=u.designer.description;if(D.t){D.$$html=null;D.$$html2=null;if(u.designer.$new){if(u.designer.parent instanceof Array){u.designer.parent.push(D)}else{if((u.designer.parent.cs)&&(u.designer.parent.cs instanceof Array)){u.designer.parent.cs.push(D)}else{u.designer.parent.cs=[D]}}}else{u.designer.$case=D}}u.doValidatePiston();u.closeDialog();if(E){u.addStatement(D.s);return}};u.addEvent=function(D){return u.editEvent(null,D)};u.editEvent=function(F,D){if(u.mode!="edit"){return}var E=!F;if(!F){F={};F.t="event";F.lo={t:"p",d:[],a:null,g:"any",v:null,c:"",x:null,e:""};F.z="";F.sm="auto"}u.designer={config:u.getExpressionConfig(),clipboard:E?u.getClipboardItems("event"):[]};u.designer.$event=F;u.designer.$obj=F;u.designer.type=F.t;u.designer.$new=E;u.designer.parent=D;u.designer.comparison={event:true,type:"event",left:{data:F.lo?u.copy(F.lo):{},event:true}};u.validateComparison(u.designer.comparison,true);u.designer.smode=F.sm;u.designer.description=F.z;window.designer=u.designer;u.designer.dialog=m.open({template:"dialog-edit-event",className:"ngdialog-theme-default ngdialog-large",closeByDocument:false,disableAnimation:true,scope:u})};u.updateEvent=function(E){u.autoSave();var D=u.designer.$new?{t:u.designer.type}:u.designer.$event;D.lo=u.fixOperand(u.designer.comparison.left.data);D.sm=u.designer.smode;D.z=u.designer.description;if(D.t){D.$$html=null;if(u.designer.$new){if(u.designer.parent instanceof Array){u.designer.parent.push(D)}else{if((u.designer.parent.c)&&(u.designer.parent.c instanceof Array)){u.designer.parent.c.push(D)}else{u.designer.parent.c=[D]}}}else{u.designer.$event=D}}u.doValidatePiston();u.closeDialog();if(D.t&&E){u.addEvent(u.designer.parent);return}};u.addCondition=function(D,E,F){return u.editCondition(null,D,E,F)};u.editCondition=function(H,D,F,G){if(u.mode!="edit"){return}var E=!H;if(!H){H={};H.t=G;H.d=[];H.n=false;H.o="and";H.lo={t:"p",d:[],a:null,g:"any",v:null,c:"",x:null,e:""};H.co=null;H.ro={t:"c",d:[],a:null,g:"any",v:null,c:"",x:null,e:""};H.ro2={t:"c",d:[],a:null,g:"any",v:null,c:"",x:null,e:""};H.to={t:"c",d:[],a:null,g:"any",v:null,c:"",x:null,e:""};H.to2={t:"c",d:[],a:null,g:"any",v:null,c:"",x:null,e:""};H.z="";H.sm="auto";H.ts=[];H.fs=[]}u.designer={config:u.getExpressionConfig(),clipboard:E?u.getClipboardItems("condition"):[]};u.designer.$condition=H;u.designer.$obj=H;u.designer.type=H.t;u.designer.$new=!G&&!!H.t?false:true;u.designer.newElseIf=F;u.designer.page=u.designer.$new&&!G?0:1;u.designer.parent=D;u.designer.devices=H.d;u.designer.not=H.n?"1":"0";u.designer.operator=H.o;u.designer.comparison={type:"condition",left:{data:H.lo?u.copy(H.lo):{},showSubDevices:true,showInteraction:true},operator:H.co,right:{data:H.ro?u.copy(H.ro):{}},right2:{data:H.ro2?u.copy(H.ro2):{}},time:{data:H.to?u.copy(H.to):{t:"c",c:0},dataType:"duration"},time2:{data:H.to2?u.copy(H.to2):{t:"c",c:0},dataType:"duration"}};u.validateComparison(u.designer.comparison,true);u.designer.smode=H.sm;u.designer.description=H.z;window.designer=u.designer;u.designer.items=[{type:"condition",name:"Condition",icon:"code",cssClass:"btn-info"},{type:"group",name:"Group",icon:"code-fork",cssClass:"btn-warning"}];u.designer.dialog=m.open({template:"dialog-edit-condition",className:"ngdialog-theme-default ngdialog-large",closeByDocument:false,disableAnimation:true,scope:u})};u.fixOperand=function(D){switch(D.vt){case"time":D.c=D.c instanceof Date?D.c.getHours()*60+D.c.getMinutes():D.c;break;case"date":case"datetime":D.c=D.c instanceof Date?D.c.getTime():(new Date(D.c)).getTime();break}return D};u.updateCondition=function(E){u.autoSave();var F=u.designer.$new?{t:u.designer.type}:u.designer.$condition;switch(F.t){case"condition":F.lo=u.fixOperand(u.designer.comparison.left.data);F.co=u.designer.comparison.operator;F.ro=u.fixOperand(u.designer.comparison.right.data);F.ro2=u.fixOperand(u.designer.comparison.right2.data);F.to=u.designer.comparison.time.data;F.to2=u.designer.comparison.time2.data;break;case"group":F.c=F.c?F.c:[];F.o=u.designer.operator;F.n=u.designer.not=="1";break}F.sm=u.designer.smode;F.ts=F.ts?F.ts:[];F.fs=F.fs?F.fs:[];F.z=u.designer.description;if(F.t){F.$$html=null;if(u.designer.$new){if(u.designer.newElseIf){var D={o:"and",n:false,c:[],s:[]};D.c.push(F);u.designer.parent.push(D)}else{if(u.designer.parent instanceof Array){u.designer.parent.push(F)}else{if((u.designer.parent.c)&&(u.designer.parent.c instanceof Array)){u.designer.parent.c.push(F)}else{u.designer.parent.c=[F]}}}}else{u.designer.$condition=F}}u.doValidatePiston();u.closeDialog();if(F.t&&E){u.addCondition(F.t=="group"?F:u.designer.parent);return}};u.upgradeCondition=function(){u.updateCondition();var E=u.designer.parent;if(u.designer.$condition&&E&&(E instanceof Array)){var D=E.indexOf(u.designer.$condition);if(D>=0){var F={};F.t=u.designer.$condition.t;F.n=u.designer.$condition.n;F.o=u.designer.$condition.o;F.c=u.designer.$condition.c;u.designer.$condition={};u.designer.$condition.t="group";u.designer.$condition.n=false;u.designer.$condition.o="and";u.designer.$condition.c=[F];E[D]=u.designer.$condition}}};u.editConditionGroup=function(E,D){if(u.mode!="edit"){return}u.designer={operator:E.o||"and",not:E.n?"1":"0",description:E.z};u.designer.group=E;u.designer.$obj=E;u.designer.parent=D;window.designer=u.designer;u.designer.dialog=m.open({template:"dialog-edit-condition-group",className:"ngdialog-theme-default ngdialog-large",closeByDocument:false,disableAnimation:true,scope:u})};u.updateConditionGroup=function(){u.autoSave();var D=u.designer.group;D.n=u.designer.not=="1";D.o=u.designer.operator;D.z=u.designer.description;u.closeDialog()};u.addRestriction=function(D){return u.editRestriction(null,D)};u.editRestriction=function(D,E){if(u.mode!="edit"){return}var F=!D;if(!D){D={};D.t=null;D.d=[];D.rn=false;D.rop="and";D.lo={t:"p",d:[],a:null,g:"any",v:null,c:"",x:null,e:""};D.co=null;D.ro={t:"c",d:[],a:null,g:"any",v:null,c:"",x:null,e:""};D.ro2={t:"c",d:[],a:null,g:"any",v:null,c:"",x:null,e:""};D.to={t:"c",d:[],a:null,g:"any",v:null,c:"",x:null,e:""};D.to2={t:"c",d:[],a:null,g:"any",v:null,c:"",x:null,e:""};D.z=""}u.designer={config:u.getExpressionConfig(),clipboard:F?u.getClipboardItems("restriction"):[]};u.designer.$restriction=D;u.designer.$obj=D;u.designer.type=D.t;u.designer.$new=D.t?false:true;u.designer.page=u.designer.$new?0:1;u.designer.parent=E;u.designer.devices=D.d;u.designer.not=D.rn?"1":"0";u.designer.operator=D.rop;u.designer.comparison={type:"restriction",left:{data:D.lo?u.copy(D.lo):{}},operator:D.co,right:{data:D.ro?u.copy(D.ro):{}},right2:{data:D.ro2?u.copy(D.ro2):{}},time:{data:D.to?u.copy(D.to):{t:"c",c:0},dataType:"duration"},time2:{data:D.to2?u.copy(D.to2):{t:"c",c:0},dataType:"duration"}};u.validateComparison(u.designer.comparison,true);u.designer.smode=D.sm;u.designer.description=D.z;window.designer=u.designer;u.designer.items=[{type:"restriction",name:"Restriction",icon:"code",cssClass:"btn-info"},{type:"group",name:"Group",icon:"code-fork",cssClass:"btn-warning"}];u.designer.dialog=m.open({template:"dialog-edit-restriction",className:"ngdialog-theme-default ngdialog-large",closeByDocument:false,disableAnimation:true,scope:u})};u.updateRestriction=function(E){u.autoSave();var D=u.designer.$new?{t:u.designer.type}:u.designer.$restriction;switch(D.t){case"restriction":D.lo=u.fixOperand(u.designer.comparison.left.data);D.co=u.designer.comparison.operator;D.ro=u.fixOperand(u.designer.comparison.right.data);D.ro2=u.fixOperand(u.designer.comparison.right2.data);D.to=u.designer.comparison.time.data;D.to2=u.designer.comparison.time2.data;break;case"group":D.r=D.r?D.r:[];D.rop=u.designer.operator;D.rn=u.designer.not=="1";break}D.z=u.designer.description;if(D.t){D.$$html=null;if(u.designer.$new){if(u.designer.parent instanceof Array){u.designer.parent.push(D)}else{if((u.designer.parent.r)&&(u.designer.parent.r instanceof Array)){u.designer.parent.r.push(D)}else{u.designer.parent.r=[D]}}}else{u.designer.$restriction=D}}u.doValidatePiston();u.closeDialog();if(D.t&&E){u.addRestriction(D.t=="group"?D:u.designer.parent);return}};u.upgradeRestriction=function(){u.updateRestriction();var F=u.designer.parent;if(u.designer.$restriction&&F&&(F instanceof Array)){var E=F.indexOf(u.designer.$restriction);if(E>=0){var D={};D.t=u.designer.$restriction.t;D.rn=u.designer.$restriction.rn;D.rop=u.designer.$restriction.rop;D.c=u.designer.$restriction.c;u.designer.$restriction={};u.designer.$restriction.t="group";u.designer.$restriction.rn=false;u.designer.$restriction.rop="and";u.designer.$restriction.c=[D];F[E]=u.designer.$restriction}}};u.editRestrictionGroup=function(E,D){if(u.mode!="edit"){return}u.designer={operator:E.rop||"and",not:E.rn?"1":"0",description:E.z};u.designer.group=E;u.designer.$obj=E;u.designer.parent=D;window.designer=u.designer;u.designer.dialog=m.open({template:"dialog-edit-restriction-group",className:"ngdialog-theme-default ngdialog-large",closeByDocument:false,disableAnimation:true,scope:u})};u.updateRestrictionGroup=function(){u.autoSave();var D=u.designer.group;D.rn=u.designer.not=="1";D.rop=u.designer.operator;D.z=u.designer.description;u.closeDialog()};u.addTask=function(D){return u.editTask(null,D)};u.editTask=function(E,F){if(u.mode!="edit"){return}if(!E){E={};E.c="";E.a="0";E.m="";E.z=""}var G=E.c?false:true;u.designer={clipboard:G?u.getClipboardItems("task"):[]};var D=G?u.insertIndexes[F.$$hashkey]:F.k.indexOf(E);if(isNaN(D)){D=F.k.length}u.designer.insertIndex=D;u.designer.$task=E;u.designer.$obj=E;u.designer.$new=G;u.designer.page=0;u.designer.parent=F;u.designer.command=E.c;u.designer.mode=E.m;u.designer.description=E.z;u.prepareParameters(E);window.designer=u.designer;window.scope=u;u.designer.commands=u.listAvailableCommands(F.d);$("a-ckolor-wheel").remove();u.designer.dialog=m.open({template:"dialog-edit-task",className:"ngdialog-theme-default ngdialog-large",closeByDocument:false,disableAnimation:true,scope:u})};u.updateTask=function(H){u.autoSave();var F=u.designer.$new?{}:u.designer.$task;F.c=u.designer.command;F.a=u.designer.async;F.z=u.designer.description;F.m=u.designer.mode;if(F.c){F.$$html=null;F.p=[];for(parameterIndex in u.designer.parameters){var G=u.designer.parameters[parameterIndex].data;if(G.t=="c"){switch(G.vt){case"time":G.c=G.c instanceof Date?G.c.getHours()*60+G.c.getMinutes():G.c;break;case"date":case"datetime":G.c=G.c instanceof Date?G.c.getTime():(new Date(G.c)).getTime();break}}F.p.push(G)}if(u.designer.$new){if((u.designer.parent)&&(u.designer.parent.k instanceof Array)){u.designer.parent.k.push(F);u.insertIndexes[parent.$$hashkey]=u.designer.insertIndex+1}}else{u.designer.$task=F}}var I=u.designer.parent.k;if(I&&I.length){var E=I.indexOf(F);var D=u.designer.insertIndex;if(D>E){D--}if(D>=I.length){D=I.length-1}if(u.designer.insertIndex!=E){I.splice(D,0,I.splice(E,1)[0])}}u.doValidatePiston();u.closeDialog();if(H){u.addTask(u.designer.parent);return}};u.addVariable=function(){return u.editVariable(null)};u.editVariable=function(D){if(u.mode!="edit"){return}if(!D){D={};D.t="dynamic";D.n="";D.v={data:{}};D.a="d";D.z=""}if(D.v instanceof Array){D.v={data:{}}}u.designer={};u.designer.$variable=D;u.designer.$obj=D;u.designer.$new=D.n?false:true;u.designer.page=0;u.designer.parent=u.piston.v;u.designer.type=D.t;u.designer.assignment=D.a||"d";u.designer.name=D.n;u.designer.operand={data:D.v,multiple:false,dataType:D.t,optional:true};u.designer.description=D.z;window.designer=u.designer;window.scope=u;u.validateOperand(u.designer.operand);u.designer.dialog=m.open({template:"dialog-edit-variable",className:"ngdialog-theme-default ngdialog-large",closeByDocument:false,disableAnimation:true,scope:u});u.refreshSelects()};u.updateVariable=function(F){u.autoSave();var D=u.designer.$new?{}:u.designer.$variable;D.t=u.designer.operand.dataType;D.n=u.designer.name.trim().replace(/[^a-z0-9]|\s+|\r?\n|\r/gmi,"_");D.z=u.designer.description;D.a=u.designer.assignment;var E=u.fixOperand(u.designer.operand.data);switch(E.t){case"":D.v=null;break;default:D.v=E;break}D.$$html=null;if(u.designer.$new){u.piston.v.push(D)}else{u.designer.variable=D}u.doValidatePiston();u.closeDialog();if(F){u.addVariable();return}};u.addGlobalVariable=function(){return u.editGlobalVariable(null)};u.editGlobalVariable=function(E){if(u.mode!="edit"){return}var D=u.globalVars[E];if(!D){D={t:"dynamic",v:""}}u.designer={};u.designer.$variableName=E;u.designer.$variable=D;u.designer.$obj=D;u.designer.$new=E?false:true;u.designer.name=E?""+E:"@";u.designer.type=D.t;u.designer.operand={data:{t:!D.v?"":(D.t=="device"?"d":"c"),c:D.v,d:D.v},multiple:false,dataType:D.t,optional:true,onlyAllowConstants:true};window.designer=u.designer;window.scope=u;u.validateOperand(u.designer.operand);u.designer.dialog=m.open({template:"dialog-edit-global-variable",className:"ngdialog-theme-default ngdialog-large",closeByDocument:false,disableAnimation:true,scope:u})};u.updateGlobalVariable=function(F){u.autoSave();var D=u.designer.$new?{}:u.designer.$variable;D.t=u.designer.operand.dataType;D.n=u.designer.name.trim().replace(/[^@a-z0-9]|\s+|\r?\n|\r/gmi,"_");var E=u.designer.operand.data;switch(E.t){case"":D.v=D.t=="device"?[]:null;break;case"c":D.v=E.c?E.c:"";break;case"d":D.v=E.d?E.d:[];break;default:D.v=null;break}delete (D.$$html);v.setVariable(u.designer.$variableName,D).then(function(G){if(G&&G.globalVars){u.updateGlobalVars(G.globalVars)}});u.doValidatePiston();u.closeDialog();if(F){u.addGlobalVariable();return}};u.deleteGlobalVariable=function(){if((!u.designer)||(!u.designer.$variableName)){return}v.setVariable(u.designer.$variableName,null).then(function(D){if(D&&D.globalVars){u.updateGlobalVars(D.globalVars)}});u.closeDialog()};u.validateGlobalVariableName=function(){if(!u.designer){return false}var D=u.designer.name;if(!D){return false}if(!D.startsWith("@")){D="@"+D}while(D.startsWith("@@@")){D=D.substr(1)}if(u.designer.name!=D){u.designer.name=D}return D&&(D!="@")&&(D!="@@")&&((u.designer.$variableName==D)||!(u.globalVars[D]))};u.getDeviceAttributeValue=function(F,E){for(i in F.a){if(F.a[i].n==E){var D={v:F.a[i].v,t:F.a[i].v};if(D.v==undefined){D.v=""}if((E=="battery")&&(!isNaN(D.v))){D.t=D.t+"%";D.v=Math.floor(parseInt(D.v)/20);if(D.v>4){D.v=4}}if((E=="temperature")&&(!isNaN(D.v))){D.v=Math.round(parseFloat(D.v)).toString()+"°";D.t=D.v}return D}}return{v:"",t:""}};u.renderDevice=function(F){var H=u.getDeviceAttributeValue(F,"switch");var H=H?'class="fa fa-toggle-off" switch="'+H+'"':"";var E=["temperature","battery","switch","motion","presence"];var D="<div col>"+F.n+"</div>";for(a in E){var G=u.getDeviceAttributeValue(F,E[a]);D+="<div col "+E[a]+'="'+G.v+'" title="'+G.t+'"></div>'}return n.trustAsHtml(D)};u.drag=function(E,D){E.splice(D,1);u.autoSave();u.doValidatePiston()};u.setDesignerType=function(D){u.designer.type=D;u.nextPage();if(u.designer.ontypechanged){u.designer.ontypechanged(u.designer,D)}};u.closeDialog=function(){u.saveStack();if(u.designer.dialog){u.designer.dialog.close();u.designer.dialog=null}};u.nextPage=function(){u.designer.page++;u.refreshSelects()};u.prevPage=function(){if(u.designer.page){u.designer.page--}};u.selectTaskIndex=function(D){if(u.designer){u.designer.insertIndex=D}};u.initLineNumbers=function(){j.lineNumber=0};u.getLineNumber=function(){return j.lineNumber};u.mergeObjects=function(G,F){if(Object.assign){return Object.assign(G,F)}var D={};for(var E in G){D[E]=G[E]}for(var E in F){D[E]=F[E]}return D};u.clearLogs=function(){u.logs=[]};u.prepareParameters=function(D){u.designer.parameters=[];var H=u.db.commands.physical[u.designer.command]||u.db.commands.virtual[u.designer.command];u.designer.parameters=[];u.designer.custom=false;if(H){for(parameterIndex in H.p){var I=u.copy(H.p[parameterIndex]);var F={data:{},name:I.n,dataType:I.t.toLowerCase(),multiple:false,optional:((I.t!="bool")&&(I.t!="boolean"))&&!!I.d,options:I.o,strict:!!I.s};var E=u.getAttributeById(I.t);if(E){F.attribute=E;F.dataType=E.t;F.allowMuliple=false;F.options=E.o}if(D&&D.p&&(D.p.length>parameterIndex)){F.data=u.copy(D.p[parameterIndex])}u.validateOperand(F);u.designer.parameters.push(F)}}else{u.designer.custom=!!u.designer.command;for(i in D.p){var G={dataType:D.p[i].vt,data:u.copy(D.p[i])};u.validateOperand(G);u.designer.parameters.push(G)}}if(u.designer.command=="setVariable"){u.designer.parameters[0].linkedOperand=u.designer.parameters[1];u.validateOperand(u.designer.parameters[0])}u.refreshSelects()};u.renameParameters=function(){if(!u.designer.custom){return}for(i in u.designer.parameters){u.designer.parameters[i].name="Parameter #"+(parseInt(i)+1).toString()+" ("+u.designer.parameters[i].dataType+")"}u.refreshSelects()};u.addParameter=function(D){if(!u.designer.custom){return}var E={dataType:D,name:"",data:{t:"c"}};u.validateOperand(E);u.designer.parameters.push(E);u.renameParameters()};u.deleteParameter=function(E){if(!u.designer.custom){return}var D=u.designer.parameters.indexOf(E);if(D>-1){u.designer.parameters.splice(D,1)}u.renameParameters()};u.getParameterInputType=function(D){switch(D.t){case"color":case"duration":case"enum":case"boolean":return D.t;case"number":return Math.abs(D.M-D.m)>360?"number":"range"}return"text"};u.getParameterMin=function(D){switch(D.t){case"level":case"saturation":case"hue":return 0;case"colorTemperature":return 1500}return null};u.getParameterMax=function(D){switch(D.t){case"level":case"saturation":return 100;case"hue":return 360;case"colorTemperature":return 10000}return null};u.getContactById=function(D){return u.instance.contacts[D]};u.getRoutineById=function(D){if(u.instance.virtualDevices.routine&&u.instance.virtualDevices.routine.o){return u.instance.virtualDevices.routine.o[D]}return null};u.getLocationModeById=function(D){if(u.instance.virtualDevices.mode&&u.instance.virtualDevices.mode.o){return u.instance.virtualDevices.mode.o[D]}return null};u.getDeviceById=function(D){if(D==u.location.id){return{id:D,n:u.location.name,an:"Location"}}return u.instance.devices[D]};u.getDeviceByName=function(D){for(deviceIndex in u.instance.devices){if(u.instance.devices[deviceIndex].n==D){return mergeObjects({id:deviceIndex},u.instance.devices[deviceIndex])}}return null};u.getVirtualDeviceById=function(D){if(D==u.location.id){return{id:D,name:u.location.name}}return u.instance.virtualDevices[D]};u.getCapabilityById=function(D){return u.db.capabilities[D]};u.getCapabilityByName=function(D){for(capabilityIndex in u.db.capabilities){if(u.db.capabilities[capabilityIndex].n==D){return mergeObjects({id:capabilityIndex},u.db.capabilities[capabilityIndex])}}return null};u.getCommandById=function(D){return u.db.commands.physical[D]||u.db.commands.virtual[D]};u.getCommandByName=function(D){for(commandIndex in u.db.commands.physical){if(u.db.commands.physical[commandIndex].n==D){return mergeObjects({id:commandIndex},u.db.commands.physical[commandIndex])}}for(commandIndex in u.db.commands.virtual){if(u.db.commands.virtual[commandIndex].n==D){return mergeObjects({id:commandIndex},u.db.commands.virtual[commandIndex])}}return null};u.getAttributeById=function(D){return u.db.attributes[D]};u.getAttributeByName=function(D){for(attributeIndex in u.db.attributes){if(u.db.attributes[attributeIndex].n==D){return u.db.attributes[attributeIndex]}}return null};u.getDeviceAttributeById=function(E,D){if(!E){return null}for(i in E.a){if(E.a[i].n==D){return E.a[i]}}return null};u.buildName=function(E,I,D,H,G){if((E==null)||(E==undefined)){return""}if(E instanceof Array){return u.buildNameList(E,G?G:"or","","",false,I,D,H)}if(D||(E.length==34)){for(deviceId in u.instance.virtualDevices){var F=u.instance.virtualDevices[deviceId];if(F.o){for(id in F.o){I=I||!D;if(E==id){return(!I?"'":"")+F.o[id]+(!I?"'":"")}}}}}return(!I?"'":"")+(H?H:"")+E+(!I?"'":"")};u.buildNameList=function(I,L,P,J,D,F,K,M){var E=1;var O="";for(i in I){var H="";var G=I[i];if(G instanceof Object){P=G.t?G.t:P;H=G.a?G.a:"[unknown]";G=G.n}var N=u.buildName(G,F,K,M);O+="<span "+(P?P:"")+(H?' an="'+H+'"':"")+(J?' class="'+J+'"':"")+">"+N+"</span>"+(D?"'"+(N.substr(-1)=="s"?"":"s"):"")+(E<I.length?"<span pun>"+(E==I.length-1?(I.length>2?", ":" ")+L+" ":", ")+"</span>":"");E++}return O.trim()};u.buildLocationModeNameList=function(E){var D=[];if(E instanceof Array){for(modeIndex in E){D.push(u.getModeName(E[modeIndex]))}if(D.length){return u.buildNameList(D,"or","lit","",false,true)}}return""};u.buildDeviceNameList=function(D){var F=[];if(D instanceof Array){for(deviceIndex in D){var E=u.getDeviceById(D[deviceIndex]);if(E){F.push({n:E.n,a:E.an,t:"dev"})}else{F.push({n:"{"+D[deviceIndex]+"}",t:"var"})}}if(F.length){return u.buildNameList(F,"and","dev","",false,true)}}return"Location"};u.buildContactNameList=function(F){var E=[];if(F instanceof Array){for(contactIndex in F){var D=u.getContactById(F[contactIndex]);if(D){E.push({n:(D.f+" "+D.l).trim()+" ("+D.t+"/"+(D.p?"PUSH":"SMS")+")",a:D.an,t:"cnt"})}else{E.push({n:"{"+F[contactIndex]+"}",a:"Unknown Contact",t:"var"})}}if(E.length){return u.buildNameList(E,"and","cnt","",false,true)}}return"(empty)"};u.formatHour=function(D){return(!location.timeZone||location.timeZone.id.startsWith("America"))?((D%12?D%12:"12")+(D<12?"am":"pm")):("00"+D).substr(-2)};u.renderDeviceNameList=function(D){return n.trustAsHtml(u.buildDeviceNameList(D))};u.renderContactNameList=function(D){return n.trustAsHtml(u.buildContactNameList(D))};u.hasCommand=function(E,D){if(!E||!E.c){return false}return u.hasName(E.c,D)};u.hasName=function(E,D){if(!E||!E.length){return false}for(obj in E){if(E[obj]&&(E[obj].n===D)){return true}}return false};u.hasId=function(D,E){if(!D||!D.length){return false}for(obj in D){if(D[obj]&&(D[obj].id===E)){return true}}return false};u.listAvailableCommands=function(N){var F={};var K=N?N.length:0;for(deviceIndex in N){var G=N[deviceIndex]||"";var D=[];var M=false;if(G.startsWith(":")){var E=u.getDeviceById(N[deviceIndex]);if(E){D=E.c}}else{M=true;D=u.db.commands.physical}for(commandIndex in D){var I=M?commandIndex:D[commandIndex].n;if(F[I]){F[I]+=1}else{F[I]=1}}}var O={common:[],partial:[],virtual:[]};for(I in F){var H=u.db.commands.physical[I];if(!H){H={n:I+"(..)",cm:true}}if(F[I]==K){O.common.push(mergeObjects({id:I},H))}else{O.partial.push(mergeObjects({id:I},H))}}for(I in u.db.commands.virtual){var H=u.db.commands.virtual[I];if(H.r){var J=0;for(deviceIndex in N){var G=N[deviceIndex]||"";var L=false;if(G.startsWith(":")){var E=u.getDeviceById(N[deviceIndex]);L=!!E;if(L){for(req in H.r){if(!u.hasCommand(E,H.r[req])){L=false;break}}}}else{L=true}if(L){J++}}if(J>0){if(J==K){if(!u.hasId(O.common,I)){O.common.push(mergeObjects({id:I,em:true},H))}}else{if(!u.hasId(O.partial,I)){O.partial.push(mergeObjects({id:I,em:true},H))}}}}else{O.virtual.push(mergeObjects({id:I},H))}}O.common.sort(u.sortByName);O.partial.sort(u.sortByName);O.virtual.sort(u.sortByName);return O};u.listAvailableDevices=function(){var D=[];for(deviceIndex in u.instance.devices){var E=u.instance.devices[deviceIndex];var F="";for(i in E.a){F+=":"+E.a[i].n+" "}D.push(mergeObjects({id:deviceIndex,tokens:F+E.n},E))}return D.sort(u.sortByName)};u.listAvailableVirtualDevices=function(){var D=[];for(deviceIndex in u.instance.virtualDevices){var E=u.instance.virtualDevices[deviceIndex];D.push(mergeObjects({id:deviceIndex},E))}return D.sort(u.sortByName)};u.escapeRegExp=function(D){return D};u.listAutoCompleteFunctions=function(){var D=[];for(functionIndex in u.db.functions){D.push((u.db.functions[functionIndex].d?u.db.functions[functionIndex].d:functionIndex)+"(")}return D.sort()};u.listAutoCompleteDevices=function(){var D=[];for(deviceIndex in u.instance.devices){var E=u.instance.devices[deviceIndex];D.push(u.escapeRegExp("["+E.n+" :"))}return D.sort()};u.listAutoCompleteVariables=function(){var D=[];for(varIndex in u.piston.v){var E=u.piston.v[varIndex];D.push(u.escapeRegExp(E.n))}if(u.systemVars){for(varName in u.systemVars){D.push(u.escapeRegExp(varName))}}if(u.globalVars){for(varName in u.globalVars){D.push(u.escapeRegExp(varName))}}return D.sort()};u.getVariableByName=function(D){if(u.systemVars&&u.systemVars[D]){return u.systemVars[D]}if(u.globalVars&&u.globalVars[D]){return u.globalVars[D]}for(varIndex in u.piston.v){if(u.piston.v[varIndex].n==D){return u.piston.v[varIndex]}}return null};u.getVariableValue=function(E,F){if(u.localVars){var D=u.localVars[E];if(D!=undefined){if(F=="datetime"){return utcToString(D)}return""+D}}return"(not set)"};u.autoAddVariable=function(E){if(!E){return false}E=E?E.trim():"";var D=u.getVariableByName(E);u.piston.v.push({t:"dynamic",n:E})};u.hasAttribute=function(E,D){for(a in E.a){if(E.a[a].n==D){return true}}return false};u.listAvailableAttributeNames=function(E,G){var D=[];var F=u.listAvailableAttributes(E,G);for(i in F){if(F[i].n!=r){D.push({n:F[i].n,v:F[i].id})}}return D};u.listAvailableAttributes=function(F,K){var D=[];var I=null;if(F&&F.length){var E={};var G=F.length;for(deviceIndex in F){I=u.getDeviceById(F[deviceIndex]);if(I){for(attributeIndex in I.a){var H=I.a[attributeIndex];if(!K||(H.n==K)){if(E[H.n]){E[H.n]+=1}else{E[H.n]=1}}}}else{for(attributeName in u.db.attributes){if(!K||(attributeName==K)){if(E[attributeName]){E[attributeName]+=1}else{E[attributeName]=1}}}}}for(attributeId in E){if(E[attributeId]==G){var H=u.getAttributeById(attributeId);if(H){D.push(mergeObjects({id:attributeId},H))}else{for(a in I.a){if(I.a[a].n==attributeId){H=I.a[a];break}}if(H){var J=mergeObjects({id:attributeId,c:true},H);J.n="⌂ "+J.n;J.t=(J.t||"string").toLowerCase().replace("number","decimal");D.push(J)}}}}D.push({id:r,n:"⌂ "+r,t:"string"});D.sort(u.sortByName)}return D};u.sortByDisplay=function(E,D){return(E.d>D.d)?1:((D.d>E.d)?-1:0)};u.sortByName=function(E,D){E=E.n.toLowerCase();D=D.n.toLowerCase();return(E>D)?1:((D>E)?-1:0)};u.getStackData=function(){var D=angular.toJson(u.compilePiston(u.piston));return{hash:u.md5(D),timestamp:(new Date()).getTime(),data:angular.fromJson(D)}};u.autoSave=function(D){var E=D?false:true;D=D?D:u.stack.undo;pushToStack=true;var F=u.getStackData();if(D&&D.length){if(F.hash==D[D.length-1].hash){pushToStack=false}}if(pushToStack){D.push(F);if(D.length>MAX_STACK_SIZE){D=D.slice(-MAX_STACK_SIZE)}}if(E){u.stack.redo=[]}};u.objectToArray=function(E){var D=[];for(property in E){D.push({v:property,n:E[property]})}return D};u.saveStack=function(D){u.stack.current=u.getStackData();if(D){u.stack.current.timestamp=0}u.stack.build=u.meta.build;v.saveToStore("stack"+u.pistonId,u.stack)};u.loadStack=function(){u.stack=v.loadFromStore("stack"+u.pistonId);u.stack=u.stack instanceof Object?u.stack:{};u.stack.undo=(u.stack.undo instanceof Array?u.stack.undo:[]);u.stack.redo=(u.stack.redo instanceof Array?u.stack.redo:[]);if(u.stack.current instanceof Object&&u.stack.current.data&&(u.stack.build==u.meta.build)&&(u.meta.modified<u.stack.current.timestamp)){u.setStatus();u.dialogChooseVersion()}else{}};u.dialogChooseVersion=function(){u.designer.dialog=m.open({template:"dialog-choose-version",className:"ngdialog-theme-default ngdialog-large",closeByDocument:false,disableAnimation:true,scope:u})};u.chooseVersion=function(D){if(D){u.piston=u.stack.current.data;u.validatePiston(u.piston)}else{u.autoSave()}u.closeDialog()};u.undo=function(){if(u.stack&&u.stack.undo&&u.stack.undo.length){u.autoSave(u.stack.redo);u.stack.current=u.stack.undo.pop();u.piston=u.stack.current.data;u.validatePiston(u.piston);u.saveStack()}};u.redo=function(){if(u.stack&&u.stack.redo&&u.stack.redo.length){u.autoSave(u.stack.undo);u.stack.current=u.stack.redo.pop();u.piston=u.stack.current.data;u.validatePiston(u.piston);u.saveStack()}};u.localTimeToDate=function(E){E=E?E:0;var D=new Date();D.setHours(Math.floor(E/60));D.setMinutes(E%60);D.setSeconds(0);D.setMilliseconds(0);return D};u.validateOperand=function(V,D,U){if(!!u.designer.comparison&&!U){u.validateComparison(u.designer.comparison,D);return}V=V||{};if(!V.initialized||D){V.data=V.data||{};V.data.a=V.data.a||"";V.data.c=(V.data.c==undefined)||(V.data.c==null)?"":V.data.c;V.data.v=V.data.v||"";V.data.e=V.data.e||"";V.data.x=V.data.x||"";V.data.d=V.data.d||[];V.data.g=V.data.g||(V.multiple?"any":"avg");V.data.f=V.data.f||"l";V.options=V.options||[]}if(true||!V.initialized||D){var R=(V.dataType||"string").toLowerCase();if(R=="variables"){V.multiple=true;R="variable"}if(R=="devices"){V.multiple=true;R="device"}if(R=="pistons"){V.multiple=true;R="piston"}if(R=="routines"){V.multiple=true;R="routine"}if(R=="attributes"){V.multiple=true;R="attribute"}if(R=="modes"){V.multiple=true;R="mode"}if(R=="alarmsystemstatus"){R="alarmSystemStatus"}if(R=="alarmsystemstatuses"){V.multiple=true;R="alarmSystemStatus"}if(R=="modes"){V.multiple=true;R="mode"}if(R=="enums"){V.multiple=true;R="enum"}if(R=="lifxScenes"){V.multiple=true;R="lifxScene"}if(R=="lifxscene"){R="lifxScene"}if(R=="contacts"){V.multiple=true;R="contact"}if(R=="number"){R="decimal"}if(R=="bool"){R="boolean"}if((R=="enum")&&!V.options&&!V.options.length){R="string"}if(V.data.t==null){var M="";if(!V.optional){M=R=="variable"?"x":"c";if((u.designer.$condition)||(u.designer.$restriction)){M="p"}}V.data.t=M}switch(V.data.vt){case"time":if(!(V.data.c instanceof Date)){if(V.data.c!=undefined){V.data.c=u.localTimeToDate(V.data.c)}}break;case"date":case"datetime":if(!(V.data.c instanceof Date)){V.data.c=new Date(V.data.c);if(V.data.c=="Invalid Date"){V.data.c=new Date()}}break}var H=(R=="piston")||(R=="routine")||(R=="askAlexaMacro")||(R=="attribute");V.onlyAllowConstants=V.onlyAllowConstants||H;var X=!!V.strict;if(V.onlyAllowConstants||(R=="contact")){V.allowArgument=false;V.allowDevices=(R=="device");V.allowPhysical=false;V.allowVirtual=false;V.allowConstant=(R!="device");V.allowVariable=false;V.allowExpression=!H}else{V.allowDevices=R=="device";V.allowPhysical=(R!="datetime")&&(R!="date")&&(R!="time")&&(R!="device")&&(R!="variable")&&(!X||(R!="boolean"))&&(R!="duration");V.allowPreset=(!V.event)&&(R=="datetime")||(R=="time")||(R=="color");V.allowVirtual=(!V.event)&&(R!="datetime")&&(R!="date")&&(R!="time")&&(R!="device")&&(R!="variable")&&(R!="decimal")&&(R!="integer")&&(R!="number")&&(R!="boolean")&&(R!="enum")&&(R!="color")&&(R!="duration");V.allowVariable=(R!="device"||((R=="device")&&V.multiple))&&(!X||(R!="boolean"));V.allowConstant=(!V.event)&&(R!="device")&&(R!="variable");V.allowArgument=(!V.event)&&(R!="device")&&(R!="variable");V.allowExpression=(!V.event)&&(R!="variable")&&(!X||(R!="boolean"))}if(((V.data.t=="p")&&(!V.allowPhysical))||((V.data.t=="v")&&(!V.allowVirtual))){V.data.t="c"}if(!V.config){V.config=u.copy(u.getExpressionConfig());V.config.autocomplete[5].words=[/([0-9]+)(\.[0-9]+)?/g]}V.restrictAttribute=null;V.restrictType=null;switch(R){case"color":V.restrictAttribute="color";break;case"device":V.restrictType="device";break;case"integer":V.restrictType="integer";break;case"decimal":V.restrictType="integer,decimal";break;case"time":V.restrictType="datetime,time";break;case"date":case"datetime":V.restrictType="datetime,date";break}V.dataType=R;V.durationUnit=V.durationUnit||V.data.vt||"s";V.data.vt=R=="duration"?V.durationUnit:R}switch(R){case"enum":break;case"bool":case"boolean":V.options=["false","true"];break;case"mode":case"powerSource":case"alarmSystemStatus":case"routine":V.options=u.objectToArray(u.instance.virtualDevices[R].o);break;case"attribute":V.attrs=V.attrs?V.attrs:u.listAvailableAttributeNames(u.designer.parent.d);V.options=V.attrs;break;case"piston":V.options=u.listAllPistons();break;case"contact":V.options=u.contacts;break;case"lifxScene":V.options=u.objectToArray(u.instance.settings.lifx_scenes).sort(u.sortByName);break;case"integer":case"decimal":case"duration":if((V.data.t=="c")&&(isNaN(V.data.c)||(V.data.c==""))){V.data.c=0}default:V.options=null}if((!V.multiple)&&(V.options)&&(V.options.length)&&(V.data.t=="c")){if(V.options[0] instanceof Object){var K=false;for(i in V.options){if(V.options[i].v==V.data.c){K=true;break}}if(!K){V.data.c=V.options[0].v}}else{if(V.options.indexOf(V.data.c)<0){V.data.c=V.options[0]}}}V.initialized=true;V.allowAggregation=true;V.allowAll=true;V.attributes=(V.data.t=="p")?u.listAvailableAttributes(V.data.d,V.restrictAttribute):[];V.valid=false;V.selectedMultiple=(V.data.t=="p")&&V.data.d&&(V.data.d.length>1)&&((V.data.g=="all")||(V.data.g=="any"));V.error=null;V.momentary=false;V.selectedDataType="string";V.selectedOptions=[];switch(V.data.t){case"p":var L=u.db.attributes[V.data.a];if(!L){if(V.data.d.length){var T=u.getDeviceById(V.data.d[0]);if(T){for(a in T.a){if(T.a[a].n==V.data.a){L=T.a[a];break}}}}}V.count=0;if(L){V.momentary=L.m||(!!L.s&&(V.data.i instanceof Array)&&V.data.i.length);V.interactive=!!L.p;if(V.interactive&&!V.data.p){V.data.p="a"}if(!!L.s){V.subDeviceName=L.sd;var O=L.s.split(",");for(deviceIndex in V.data.d){var G=u.getDeviceById(V.data.d[deviceIndex]);var W=0;if(G){for(i in O){var P=u.getDeviceAttributeById(G,O[i]);if((P)&&(!isNaN(P.v))){W=parseInt(P.v);if(W>V.count){V.count=W}}}}}if(V.count==0){V.count=32}}else{V.subDeviceName=""}if(V.count){if((V.data.i==null)||(V.data.i==undefined)){V.data.i=[]}u.refreshSelects()}V.selectedDataType=L.t.toLowerCase();V.selectedOptions=L.o;if(V.momentary){V.allowAll=false;V.allowAggregation=false}}else{V.selectedDataType="string"}if(V.data.d&&(V.data.d.length>1)){if(!V.data.g){V.error="Invalid aggregation method"}if(!(["any","all","least","most"].indexOf(V.data.g)>=0)){V.selectedDataType="decimal"}}break;case"v":var Q=u.instance.virtualDevices[V.data.v];V.selectedDataType=(!!Q&&!!Q.t)?Q.t:"string";if(Q){V.momentary=Q.m;for(o in Q.o){V.selectedOptions.push({v:o,n:Q.o[o]})}}break;case"x":if(V.data.x instanceof Array){if(V.data.x.length){V.selectedDataType="dynamic"}else{V.error="Invalid list of variables"}}else{var S=u.getVariableByName(V.data.x);if(S){V.selectedDataType=S.t;if(V.selectedDataType=="boolean"){V.selectedOptions=["false","true"]}}else{V.error="Invalid variable"}}break;case"u":V.selectedDataType="dynamic";break;case"c":var N=u.parseString(V.data.c,V.data.vt);V.error=N.err;V.expressionVar=N.errVar;V.data.exp=N;if(!V.options){if(!V.optional&&!V.data.c&&(V.requirePositiveNumber)){V.error="Empty value";V.expressionVar=""}}else{if((V.data.c==null)||(V.data.c==undefined)){V.error="Invalid selection";V.expressionVar=""}}V.selectedDataType=V.dataType;break;case"e":var N=u.parseExpression(V.data.e,false,V.data.vt);V.error=N.err;V.expressionVar=N.errVar;if(N.err){var J=(N.loc?N.loc:"0:"+(N.str.length-1).toString()).split(":");var I=parseInt(J[0]);var F=J.length==2?parseInt(J[1]):I;V.config.autocomplete[0]={words:[new RegExp(".(?=.{"+(N.str.length-I-1)+"}$).{"+(F-I)+"}")],cssClass:"hl err",title:N.err}}else{V.config.autocomplete[0]={words:[],cssClass:"hl err"}}V.data.exp=N;V.selectedDataType="dynamic";break}if((!V.error)&&(V.dataType=="duration")&&(!V.durationUnit)){V.error="Invalid duration unit"}V.valid=(!V.error)&&(((V.data.t=="")&&(V.optional))||((V.data.t=="d")&&!!V.data.d&&!!V.data.d.length)||((V.data.t=="p")&&!!V.data.d&&!!V.data.d.length&&!!V.data.a)||((V.data.t=="v")&&!!V.data.v)||((V.data.t=="x")&&!!V.data.x&&!!V.data.x.length)||((V.data.t=="s")&&!!V.data.s)||((V.data.t=="u")&&!!V.data.u)||((V.data.t=="c")&&!((V.data.c=="Invalid Date")&&(V.data.c instanceof Object))&&!((R=="duration")&&(isNaN(V.data.c)||(V.requirePositiveNumber&&(V.data.c<1)))))||((V.data.t=="e")&&!!V.data.e&&!!V.data.e.length));switch(V.dataType){case"integer":V.inputType="number";try{V.data.c=parseInt(V.data.c)}catch(E){V.data.c=0}break;case"duration":case"decimal":V.inputType="number";try{V.data.c=parseFloat(V.data.c)}catch(E){V.data.c=0}break;default:V.inputType=V.dataType}if(V.linkedOperand){V.linkedOperand.dataType=V.selectedDataType;V.linkedOperand.options=V.selectedOptions;u.validateOperand(V.linkedOperand,true);u.refreshSelects()}};u.refreshSelects=function(D){if(D){u.$$postDigest(function(){$("select["+D+"]").selectpicker("refresh");A(function(){$("select["+D+"]").selectpicker("refresh")},0,false)})}else{u.$$postDigest(function(){$("select").selectpicker("refresh");A(function(){$("select").selectpicker("refresh")},0,false)})}};u.getOrdinalSuffix=function(F){if(isNaN(F)){return""}F=parseInt(F);var D=F%100;var E=F%10;if(((D>3)&&(D<21))||(E==0)||(E>3)){return"th"}switch(E){case 1:return"st";case 2:return"nd";case 3:return"rd"}return"th"};u.getOrdinal=function(D){if(isNaN(D)){return""}D=parseInt(D);switch(D){case -3:return"third-last";case -2:return"second-last";case -1:return"last"}return D+u.getOrdinalSuffix(D)};u.listODM=function(){var D=u.designer.odm;var E=(!u.designer.operand.data.odw||(u.designer.operand.data.odw=="d"))?31:5;if(!D||(D.length!=(E+3))){D=[];for(i=1;i<=E;i++){D.push({v:i,n:i+u.getOrdinalSuffix(i)})}D.push({v:-1,n:"last"});D.push({v:-2,n:"second-last"});D.push({v:-3,n:"third-last"});u.designer.odm=D}return D};u.listODW=function(){var D=u.designer.odw;var E=(u.designer.operand.data.odm>5)?0:7;if(!D||(D.length!=(E+1))){D=[];D.push({v:"d",n:"day"});if(E){for(i in u.weekDays){D.push({v:i.toString(),n:u.weekDays[i]})}}u.designer.odw=D}return D};u.validateComparison=function(O,E){u.validateOperand(O.left,E,true);if((O.left.selectedDataType!=O.dataType)||(O.left.selectedMultiple!=O.selectedMultiple)||(O.left.momentary!=O.momentary)||(O.left.data.t=="v")||(O.selectedInteractive!=O.left.data.p)){O.dataType=O.left.selectedDataType;O.selectedMultiple=O.left.selectedMultiple;O.selectedInteractive=O.left.data.p;O.momentary=O.left.momentary;var I=(O.left.data.t!="p")||((O.left.data.g!="any")&&(O.left.data.g!="all"));var L=(O.left.interactive&&((O.left.data.p=="p")||(O.left.data.p=="s")));var J=L;var D=(O.type=="restriction");var M=[];var P=[];if(!O.dataType){O.dataType="dynamic"}switch(O.dataType){case"enum":dt="s";break;case"dynamic":dt="";break;case"time":case"date":case"datetime":dt="t";break;default:dt=O.dataType.substr(0,1)}dt=(O.momentary?(O.left.data.t=="v"?"v":"m"):((dt=="n"?"d":dt)));if(!L){for(conditionId in u.db.comparisons.conditions){var H=u.db.comparisons.conditions[conditionId];if(((!dt&&(H.g!="m"))||(H.g.indexOf(dt)>=0))&&(!I||!H.t)){P.push({id:conditionId,d:(O.selectedMultiple?(H.dd?H.dd:H.d):H.d),c:"Conditions"})}}M=M.concat(P.sort(u.sortByDisplay))}if(!D){P=[];for(triggerId in u.db.comparisons.triggers){var F=u.db.comparisons.triggers[triggerId];if((F.g.indexOf(dt)>=0)&&(!J||!F.t)){P.push({id:triggerId,d:(O.selectedMultiple?(F.dd?F.dd:F.d):F.d),c:"Triggers"})}}M=M.concat(P.sort(u.sortByDisplay))}O.options=M}var K=u.db.comparisons.conditions[O.operator]||u.db.comparisons.triggers[O.operator];O.operatorValid=!!K;O.parameterCount=K&&K.p?K.p:0;O.multiple=K&&K.m?true:false;O.valid=O.left.valid&&O.operatorValid;O.timed=K?K.t:0;if(O.parameterCount>0){O.right.multiple=O.multiple;O.right.disableAggregation=O.multiple;O.right.dataType=O.left.selectedDataType;if(angular.toJson(O.right.options)!=angular.toJson(O.left.selectedOptions)){if((O.right.data.t=="c")&&O.right.options&&O.right.options.length&&(!O.left.selectedOptions||!O.left.selectedOptions.left)){O.right.data.c=""}O.right.options=O.left.selectedOptions}u.validateOperand(O.right,E,true);O.valid=O.valid&&O.right.valid}if(O.parameterCount>1){O.right2.multiple=O.multiple;O.right2.disableAggregation=O.multiple;O.right2.dataType=O.left.selectedDataType;if(angular.toJson(O.right2.options)!=angular.toJson(O.left.selectedOptions)){O.right2.options=O.left.selectedOptions}u.validateOperand(O.right2,E,true);O.valid=O.valid&&O.right2.valid}var G=(O.timed>0);var N=false;if(O.left.selectedDataType=="time"){G=G||(O.right.data.t!="c");N=(O.right2.data.t!="c")}if(G){O.time.requirePositiveNumber=!!O.timed;u.validateOperand(O.time,E,true);O.valid=O.valid&&O.time.valid}if(N){O.time2.requirePositiveNumber=false;O.time2.dataType="duration";u.validateOperand(O.time2,E,true);O.valid=O.valid&&O.time2.valid}};u.detectDataType=function(D){switch(typeof D){case"string":if(!isNaN(parseFloat(D))){return"number"}return"string";case"number":return"number";default:return"string"}};u.renderOperand=function(J,I,L,F,E){var M="";if(J){switch(J.t){case"d":if(J.d){M=u.buildDeviceNameList(J.d)}break;case"p":if(J.d&&J.a){M=u.renderDeviceList(J.d,J.a,J.g,true)+" <span attr>"+J.a+"</span>"}break;case"v":var D=u.getVirtualDeviceById(J.v);M="<span vdev>"+(D?D.n:"(invalid virtual device)")+"</span>";break;case"s":if(J.s){M="<span num>"+J.s+"</span>"}break;case"x":if(J.x){M="<span var>{"+J.x+"}</span>"}break;case"c":var H="num";I=I||!isNaN(J.c);switch(J.vt){case"time":var G=u.localTimeToDate(J.c);M="<span num>"+G.toLocaleTimeString({hour:"2-digit",minute:"2-digit"})+"</span>";break;case"date":M="<span num>"+utcToDateString(J.c)+"</span>";break;case"datetime":M="<span num>"+utcToString(J.c)+"</span>";break;case"piston":M="<span lit>"+u.getPistonName(J.c)+"</span>";break;case"lifxScene":M="<span lit>"+u.getLifxSceneName(J.c)+"</span>";break;case"phone":M="<span phn>"+J.c+"</span>";break;case"uri":M="<span uri>"+J.c+"</span>";break;case"contact":M=u.renderContactNameList(J.c);break;default:if(!I){if((J.vt=="boolean")||(J.vt=="enum")){I=true}H="lit"}var K=J.c;if(F&&!isNaN(K)&&parseInt(K)<0){K=-parseInt(K)}M="<span "+H+">"+scope.buildName(K,I,L,null,E)+"</span>"}break;case"u":M=M+"<span var>{$args."+J.u+"}</span>";break;case"e":if(J.e){M="<span exp>{"+J.e+"}</span>"}break}}M=M?M:'<span nul class="nul">(empty)</span>';return(M instanceof Object)?M:n.trustAsHtml(M)};u.renderForOperands=function(E){var D;D="<span var>"+(E.x?E.x:"$index")+"</span> <span pun>=</span> <span num>"+u.renderOperand(E.lo)+" <span kwd>to</span> "+u.renderOperand(E.lo2)+" <span kwd>step</span> "+u.renderOperand(E.lo3);return n.trustAsHtml(D?D:"(invalid operands)")};u.renderForEachOperands=function(E){var D;D="<span var>"+(E.x?E.x:"$device")+"</span> <span pun>in</span> <span num>"+u.renderOperand(E.lo);return n.trustAsHtml(D?D:"(invalid operands)")};u.renderTimeOperand=function(F){if(!F){return""}var D=(F.t=="c");var E=D&&!isNaN(F.c)?parseInt(F.c):0;if(D&&(E==0)){return""}return u.renderOperand(F,false,false,true)+" <span lit>"+u.getDurationUnitName(F.vt,(E!=1))+"</span> <span pun>"+(E<0?"to":"past")+" </span> "};u.renderComparison=function(S,P,M,T,E,U){var Z=u.db.comparisons.triggers[P];var L=!!Z;if(!Z){Z=u.db.comparisons.conditions[P]}if(!Z){return"[ERROR: Invalid comparison]"}var F=S.t=="v";var O=S&&(S.t=="p")&&S.d&&(S.d.length>1)&&(S.g=="all");var V=false;var I="";var Y=null;switch(S.t){case"v":switch(S.v){case"locationMode":case"shmState":V=true;break}break;case"p":Y=u.getAttributeById(S.a);if(!!Y&&!!Y.u){I=Y.u}break}var G="";if(!!Y&&!!Y.s&&(S.i instanceof Array)&&S.i.length){G=" <span num>"+u.buildNameList(S.i,"or",null,null,false,true,false,"#")+"</span>"}if(!!Y&&!!Y.p){switch(S.p){case"p":G+=" <span lit>physically</span>";break;case"s":G+=" <span lit>programmatically</span>";break}}var R="";var Q="";if((S.t=="v")&&(S.v=="time")){if(M&&E&&(M.t!="c")){R=u.renderTimeOperand(E)}if(T&&U&&(T.t!="c")){Q=u.renderTimeOperand(U)}}var H=u.renderOperand(S)+G+" <span pun>"+(O?(Z.dd?Z.dd:Z.d):Z.d)+"</span>"+(Z.p>0?" "+R+u.renderOperand(M,V,F):"")+(I?"<span pun>"+I+"</span> ":"")+(Z.p>1?" <span pun>"+(Z.d.indexOf("between")?"and":"through")+"</span> "+Q+u.renderOperand(T,V,F)+(I?"<span pun>"+I+"</span> ":""):"");switch(Z.t){case 1:H+=" <span pun>"+(L?"for":"in the last")+"</span> "+u.renderOperand(E)+" <span lit>"+u.getDurationUnitName(E.vt,!((E.t=="c")&&(!isNaN(E.c))&&(parseInt(E.c)==1)))+"</span>";break;case 2:H+=" <span pun>for "+(E.f=="g"?"at least":"less than")+"</span> "+u.renderOperand(E)+" <span lit>"+u.getDurationUnitName(E.vt,!((E.t=="c")&&(!isNaN(E.c))&&(parseInt(E.c)==1)))+"</span>";break}if((S.t=="v")&&(["time","date","datetime"].indexOf(S.v)>=0)){var W=(S.odw instanceof Array)&&S.odw.length?S.odw:null;var D=(S.odm instanceof Array)&&S.odm.length?S.odm:null;var N=!D&&(S.owm instanceof Array)&&S.owm.length?S.owm:null;var X=(S.omy instanceof Array)&&S.omy.length?S.omy:null;if(!!W||!!D||!!N||!!X){var K=0;H+="<span pun>,</span> <span pun>but only</span>";var J="";if(W){for(i in W){if((i>0)&&(W.length>2)){J+="<span pun>,</span> "}if((i>0)&&(i==W.length-1)){J+=" <span pun>or</span> "}J+="<span lit>"+u.weekDays[W[i]]+"s</span>"}K++}if(N){H+=(K?"<span pun>,</span>":"")+" <span pun>on the</span> ";for(i in N){if((i>0)&&(N.length>2)){H+="<span pun>,</span> "}if((i>0)&&(i==N.length-1)){H+=" <span pun>or</span> "}H+="<span num>"+u.getOrdinal(N[i])+"</span>"}H+=" "+(J?J:"<span pun>week"+(N.length>1?"s":"")+"</span>")+(X?"":" <span pun>of the month</span>");K++}else{if(J){H+=(K>1?"<span pun>,</span>":"")+" <span pun>on</span> "+J}}if(D){H+=(K?"<span pun>,</span>":"")+" <span pun>on the</span> ";for(i in D){if((i>0)&&(D.length>2)){H+="<span pun>,</span> "}if((i>0)&&(i==D.length-1)){H+=" <span pun>or</span> "}H+="<span num>"+u.getOrdinal(D[i])+"</span>"}H+=" day"+(D.length>1?"s":"")+(X?"":" <span pun>of the month</span>");K++}if(X){H+=" <span pun>"+(N||D?"of":"in")+"</span> ";for(i in X){if((i>0)&&(X.length>2)){H+="<span pun>,</span> "}if((i>0)&&(i==X.length-1)){H+=" <span pun>or</span> "}H+="<span lit>"+u.yearMonths[X[i]-1]+"</span>"}K++}}}return n.trustAsHtml(H)};u.getWeekDayName=function(D){if(isNaN(D)){return"day"}return u.weekDays[parseInt(D)]};u.getMonthDayName=function(D){switch(D){case -1:return"last";case -2:return"second-last";case -3:return"third-last"}return D+u.getOrdinalSuffix(D)};u.getMonthName=function(D){return u.yearMonths[D]};u.getDurationUnitName=function(E,D){var F=D?"s":"";switch(E){case"ms":return"millisecond"+F;case"s":return"second"+F;case"m":return"minute"+F;case"h":return"hour"+F;case"d":return"day"+F;case"w":return"week"+F;case"n":return"month"+F;case"y":return"year"+F}return""};u.renderTimer=function(E){var T="";var G=E.lo;var P=u.getDurationUnitName(G.vt);var L=P;var D=0;switch(G.vt){case"ms":D=1;break;case"s":D=2;break;case"m":D=3;break;case"h":D=4;break;case"d":D=5;break;case"w":D=6;P=u.getWeekDayName(G.odw);break;case"n":D=7;P=u.getMonthDayName(G.odm)+" "+u.getWeekDayName(G.odw)+" of the month";break;case"y":D=8;P=u.getMonthDayName(G.odm)+" "+u.getWeekDayName(G.odw)+" of "+u.getMonthName(G.omy);break}switch(G.t){case"c":if(!isNaN(G.c)){var O=parseInt(G.c);switch(O){case 1:T=P;break;case 2:T="<span num>other</span> "+P;break;default:T="<span num>"+O+"</span> "+L+"s";switch(G.vt){case"n":T+=", on the "+u.getMonthDayName(G.odm)+" "+u.getWeekDayName(G.odw)+" of the month";break;case"y":T+=", on the "+u.getMonthDayName(G.odm)+" "+u.getWeekDayName(G.odw)+" of "+u.getMonthName(G.omy);break}}break}default:T=u.renderOperand(G)+" "+P+"s"}if(D==4){var H=("00"+E.lo.om).substr(-2);T+=", <span pun>at <span num>:"+H+"</span> <span pun>past the hour</span>"}if(D>=5){T+=", <span pun>at</span> ";if(E.lo2.t!="c"){switch(E.lo3.t){case"c":var J=isNaN(E.lo3.c)?0:parseInt(E.lo3.c);if(J==0){T+=u.renderOperand(E.lo2)}else{if(J<0){T+="<span num>"+(-J).toString()+"</span> <span lit>"+u.getDurationUnitName(E.lo3.vt,(J<-1))+"</span> <span pun>before</span> "+u.renderOperand(E.lo2)}else{T+="<span num>"+J.toString()+"</span> <span lit>"+u.getDurationUnitName(E.lo3.vt,(J>1))+"</span> <span pun>after</span> "+u.renderOperand(E.lo2)}}break;default:T+=u.renderOperand(E.lo2)+" <span num>±</span> "+u.renderOperand(E.lo3)}}else{T+=u.renderOperand(E.lo2)}}var N=(D<=2)&&(G.om instanceof Array)&&G.om.length?G.om:null;var Q=(D<=3)&&(G.oh instanceof Array)&&G.oh.length?G.oh:null;var F=(D<=5)&&(G.odw instanceof Array)&&G.odw.length?G.odw:null;var M=(D<=6)&&(G.odm instanceof Array)&&G.odm.length?G.odm:null;var S=(D<=6)&&!M&&(G.owm instanceof Array)&&G.owm.length?G.owm:null;var R=(D<=7)&&(G.omy instanceof Array)&&G.omy.length?G.omy:null;if(!!N||!!Q||!!F||!!M||!!S||!!R){var I=0;T+="<span pun>,</span> <span pun>but only</span>";if(N){T+=" <span pun>at</span> ";for(i in N){if((i>0)&&(N.length>2)){T+="<span pun>,</span> "}if((i>0)&&(i==N.length-1)){T+=" <span pun>or</span> "}T+="<span num>:"+("00"+N[i]).substr(-2)+"</span>"}T+=" <span pun>minutes past the hour</span>";I++}if(Q){T+=(I?"<span pun>,</span>":"")+" <span pun>during the</span> ";for(i in Q){if((i>0)&&(Q.length>2)){T+="<span pun>,</span> "}if((i>0)&&(i==Q.length-1)){T+=" <span pun>or</span> "}T+="<span num>"+u.formatHour(Q[i])+"</span>"}T+=" <span pun>hour"+(Q.length>1?"s":"")+"</span>";I++}var K="";if(F){for(i in F){if((i>0)&&(F.length>2)){K+="<span pun>,</span> "}if((i>0)&&(i==F.length-1)){K+=" <span pun>or</span> "}K+="<span lit>"+u.weekDays[F[i]]+"s</span>"}I++}if(S){T+=(I?"<span pun>,</span>":"")+" <span pun>on the</span> ";for(i in S){if((i>0)&&(S.length>2)){T+="<span pun>,</span> "}if((i>0)&&(i==S.length-1)){T+=" <span pun>or</span> "}T+="<span num>"+u.getOrdinal(S[i])+"</span>"}T+=" "+(K?K:"<span pun>week"+(S.length>1?"s":"")+"</span>")+(R?"":" <span pun>of the month</span>");I++}else{if(K){T+=(I>1?"<span pun>,</span>":"")+" <span pun>on</span> "+K}}if(M){T+=(I?"<span pun>,</span>":"")+" <span pun>on the</span> ";for(i in M){if((i>0)&&(M.length>2)){T+="<span pun>,</span> "}if((i>0)&&(i==M.length-1)){T+=" <span pun>or</span> "}T+="<span num>"+u.getOrdinal(M[i])+"</span>"}T+=" day"+(M.length>1?"s":"")+(R?"":" <span pun>of the month</span>");I++}if(R){T+=" <span pun>"+(S||M?"of":"in")+"</span> ";for(i in R){if((i>0)&&(R.length>2)){T+="<span pun>,</span> "}if((i>0)&&(i==R.length-1)){T+=" <span pun>or</span> "}T+="<span lit>"+u.yearMonths[R[i]-1]+"</span>"}I++}}return n.trustAsHtml(T)};u.renderString=function(E){var D=0;if(!E){return""}var F=function(M){var G="";while(D<E.length){var N=E[D];switch(N){case"<":G+="&lt;";break;case">":G+="&gt;";break;case"[":var L=E.indexOf("|",D);if(L>D){var I=E.substring(D+1,L);D=L+1;G+=F(I)}else{D++;G+=F()}break;case"]":if(M==undefined){return"["+G+"]"}var H=M.trim().replace(/\s/g,",").split(",");var K="";var J="";for(x in H){switch(H[x]){case"b":K+="s-b ";break;case"u":K+="s-u ";break;case"i":K+="s-i ";break;case"s":K+="s-s ";break;case"pre":K+="s-pre ";break;case"flash":K+="s-flash ";break;default:J=H[x].replace(/[^#0-9a-z]/gi,"")}}return"<span "+(K?'class="'+K+'" ':"")+(J?'style="color: '+J+' !important"':"")+">"+G+"</span>";default:G+=N}D++}return G};return n.trustAsHtml(F(E).replace(/\:fa-([a-z0-9\-\s]*)\:/gi,function(G){return'<i class="fa '+G.replace(/\:/g,"").toLowerCase()+'"></i>'}))};u.renderTask=function(D){var G=u.getCommandById(D.c);var F;if(!G){F=D.c+"(";for(i in D.p){F+=(parseInt(i)?", ":"")+u.renderOperand(D.p[i],null,null,null,"and")}F+=")"}else{F=!G.d?G.n:G.d.replace(/\{(\d)\}/g,function(I,L){var H=parseInt(L);if((H<0)||(!D.p)||(H>=D.p.length)){return" (?) "}var K="";if(G.p[H].t=="duration"){var J=u.getDurationUnitName(D.p[H].vt,true);K=u.renderOperand(D.p[H],true)+" "+J}else{if((D.p[H].t=="c")&&(!!G.p[H].d)&&(D.p[H].c=="false")){K=""}else{K=u.renderOperand(D.p[H],true,null,null,"and")}}if(!K){K=""}if(!!K&&!!G.p[H].d){K=(!!D.p[H]&&!!D.p[H].t)?G.p[H].d.replace("{v}",K):""}return K}).replace(/(\{T\})/g,"°"+u.location.temperatureScale);var E=G.i;if(E){F='<span pun><i class="fa fa-'+E+'" aria-hidden="true"></i></span> '+F}}if(D.m){F+=" <span pun><i>(only while "+u.buildLocationModeNameList(D.m)+")</i></span>"}F+="<span pun>;</span>";return n.trustAsHtml(F)};u.renderDeviceList=function(E,H,J,K){var D="";var G=[];suffix=(J=="any"?"or":"and");var I="";if(E instanceof Array){if(E.length>1){switch(J){case"any":I="Any of ";break;case"all":I="All of ";break;case"count":I="Count of ";break;case"avg":I="Average of ";break;case"median":I="Median of ";break;case"least":I="Least occurring value of ";break;case"most":I="Most occurring value of ";break;case"stdev":I="Standard deviation of ";break;case"min":I="Minimum of ";break;case"max":I="Maximum of ";break;case"variance":I="Variance of ";break}if(!K){I=I.toLowerCase()}}for(deviceIndex in E){var F=u.getDeviceById(E[deviceIndex]);if(F){G.push({n:F.n,a:F.an,t:"dev"})}else{G.push({n:"{"+E[deviceIndex]+"}",t:"var"})}}if(G.length){D=I+u.buildNameList(G,suffix,"dev","",!!H,true)}}return n.trustAsHtml(D)};u.validatePiston=function(H){var D=0;var I=0;var E={};var G=function(J,K){if(!J){return}J.w=J.w?J.w:[];J.w.push(K)};var F=function(K,L,J,N){var M=N+1;if(K instanceof Array){for(i in K){K[i]=F(K[i],L,J,M)}return K}if(K instanceof Object){for(property in K){K[property]=F(K[property],K,K.vt?K.vt:K.t,M)}if(!!K.t){delete (K.w);switch(K.t){case"every":if(M>3){G(K,"Timers are designed to be top-level statements and should not be used inside other statements. If you need a conditional timer, please look into using a while loop instead.")}break;case"on":if(M>3){G(K,"On event statements are designed to be top-level statements and should not be used inside other statements.")}break}}}return K};H=F(H,"piston",null,0);u.warnings=E;return H};u.compilePiston=function(K,F,I){var I=I?I:{};var E=0;var G={};var D=function(L,N){if(!F){return(!!I[L]&&!!I[L].id)?I[L].id:L}if(!L){return""}var O;if(I[L]){var M=I[L];O=M.key;if(N&&N.a&&(N.a instanceof Array)&&M.value&&M.value.a&&(M.value.a instanceof Array)){for(a in N.a){if(M.value.a.indexOf(N.a[a])<0){M.value.a.push(N.a[a])}}}}else{O=":"+("xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx"+E).substr(-32)+":";E++;I[L]={key:O,value:N}}return O};var J=function(L,M){if(!L){return}L.w=L.w?L.w:[];L.w.push(M)};var H=function(N,W,R){if(N instanceof Array){for(i in N){N[i]=H(N[i],W,R)}return N}if(N instanceof Object){if(N.exp){delete (N.exp)}if(F){switch(N.vt){case"phone":var M=N.c?N.c.split(/,;\*\|/):[];var X=[];for(p in M){X.push(D(M[p],{t:"phone"}))}N.c=X.join(",");N.e="";break;case"contact":case"contacts":var V=N.c?(N.c instanceof Array?N.c:N.c.split(/,;\*|/)):[];var T=[];for(c in V){T.push(D(V[c],{t:"contact"}))}N.c=(N.c instanceof Array)?T:T[0];N.e="";break;case"uri":N.c=D(N.c,{t:"uri"});N.e="";break}}delete (N.w);for(property in N){var U=N[property];if((U===false)||(U===null)||(U==="")){delete (N[property])}else{N[property]=H(N[property],N,N.vt?N.vt:N.t)}}if(!F&&!!N&&!!N.t&&!!N.vt&&((N.t=="c")||(N.t=="e"))){switch(N.t){case"c":N.exp=u.parseString(N.c,N.vt);break;case"e":N.exp=u.parseExpression(N.e,false,N.vt);break}}return N}var S=N?N.toString():"";if(S.startsWith(":")&&S.endsWith(":")){if(F){var L=u.getDeviceById(N);if(L){N=D(N,{t:"device",n:L.an,a:!!W&&!!W.a&&(W.a.length>1)?[W.a]:[]});return N}var P=u.getLocationModeById(N);if(P){switch(P){case"Home":case"Night":case"Sleep":case"Away":case"Vacation":break;default:P="Custom Mode"}N=D(N,{t:"mode",n:P});return N}var Q=u.getRoutineById(N);if(Q){N=D(N,{t:"routine"});return N}var O=u.getContactById(N);if(O){N=D(N,{t:"contact"});return N}}N=D(N,{t:"unknown"});return N}return N};K=H(u.copy(K),"piston");K.l={};for(l in I){K.l[I[l].key]=I[l].value}u.warnings=G;return K};u.determineDeviceType=function(D){return v.determineDeviceType(D)};u.anonymizeDevices=function(F){var E={};for(i in F){var H=F[i];var G=v.determineDeviceType(H).replace(/([A-Z])/g," $1").replace(/^./,function(I){return I.toUpperCase()}).replace("Rgb ","RGB ");var D=E[G]?E[G]+1:1;E[G]=D;F[i].an=G+" "+D}return F};u.anonymizeContacts=function(H){var F={};for(i in H){var E=H[i];var G="John Doe";var D=F[G]?F[G]+1:1;F[G]=D;H[i].an=G+" "+D}return H};u.breakList=function(D){return D.replace(/,/g,"<br/>")};var k=function(E){var F=E.getFullYear();var G=(1+E.getMonth()).toString();G=G.length>1?G:"0"+G;var D=E.getDate().toString();D=D.length>1?D:"0"+D;return G+"/"+D+"/"+F};u.getMonth=function(D){if(D){return["JAN","FEB","MAR","APR","MAY","JUN","JUL","AUG","SEP","OCT","NOV","DEC"][D.getMonth()]}};u.getDay=function(D){if(D){return("0"+D.getDate()).substr(-2)}};u.timeSince=timeSince;u.timeCounter=timeCounter;u.timeLeft=timeLeft;u.currentTime=currentTime;u.tap=function(D){v.tap(D).then(function(E){})};u.test=function(){v.testPiston(u.pistonId)};u.togglePiston=function(F,E){if((!F)&&(!u.viewerPiston||!u.viewerPiston.app)){return}var G=F?F.i:u.pistonId;if(G){A.cancel(tmrRefresh);var D=!(F?F.e:u.viewerPiston.app.enabled);if(F){F.e=D}else{u.viewerPiston.app.enabled=D}if(D){v.resumePiston(G).then(function(H){u.onRefresh(H)})}else{v.pausePiston(G).then(function(H){u.onRefresh(H)})}}if(E&&e.preventDefault){E.preventDefault()}if(E&&E.stopPropagation){E.stopPropagation()}};u.configurePiston=function(D){u.configuredPistonId=u.configuredPistonId==D.i?null:D.i};u.showPiston=function(D){document.body.scrollTop=0;u.viewerPiston=null;u.pistonId=D.i;u.refresh();window.onSwipeRight=u.hidePiston};u.hidePiston=function(){document.body.scrollTop=0;u.pistonId=null;window.onSwipeRight=null};u.prepareActions=function(F){var H=[];var D=[];var K=[];var L=(F.id<=0);var G=u.viewerPiston.tasks;var J=u.viewerPiston.app.actions;for(action in J){if(J[action].pid==F.id){if(J[action].t){var I=J[action].t;for(t in I){var E=0;for(task in G){if((G[task].type=="cmd")&&(G[task].ownerId==J[action].id)&&(G[task].taskId==I[t].i)){if((E==0)||(E>G[task].time)){E=G[task].time}}}I[t].time=E}}if(L){H.push(J[action])}else{if(J[action].rs==false){K.push(J[action])}else{D.push(J[action])}}}}var E=0;for(task in G){if((G[task].type=="evt")&&(G[task].ownerId==F.id)){if((E==0)||(E>G[task].time)){E=G[task].time}}}F.time=E;F.actions=H;F.trueActions=D;F.falseActions=K;F.$scope=u;if(F.children){for(child in F.children){u.prepareActions(F.children[child])}}};u.hadRecentActivity=function(D){return D&&D.le&&D.le.event&&D.le.event.date&&(timeLeft((new Date(D.le.event.date)).getTime())>-120)};u.toggleViewerOptions=function(){u.viewerPiston.showOptions=!u.viewerPiston.showOptions};u.getSecondaryStatementName=function(){var D=u.viewerPiston.app.mode;switch(D){case"Latching":return"BUT IF";case"Then-If":return"THEN IF";case"Else-If":return"ELSE IF";case"Or-If":return"OR IF";case"And-If":return"AND IF"}return"IF"};u.serializeObject=function(D){return angular.toJson(D)};u.anonymizeObject=function(D,G){var F=u.serializeObject(D);var E=F.match(/(:[a-f0-9]{32}:)/g);if(E){E=E.unique()}for(i in E){F=F.replace(new RegExp(E[i],"g"),("xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx"+i).substr(-32))}return(G?F:angular.fromJson(F))};u.objectToBlob=function(H,O){O=O||"";var E=1024;var L=utoa(u.serializeObject(H));L+="|"+L.length.toString();var N=L.length;var K=Math.ceil(N/E);var M=new Array(K);for(var F=0;F<K;++F){var D=F*E;var G=Math.min(D+E,N);var P=new Array(G-D);for(var I=D,J=0;I<G;++J,++I){P[J]=L[I].charCodeAt(0)}M[F]=new Uint8Array(P)}return new Blob(M,{type:O})};u.dataURItoBlob=function(E){var J=atob(E.split(",")[1]);var D=E.split(",")[0].split(":")[1].split(";")[0];var I=new ArrayBuffer(J.length);var G=new Uint8Array(I);for(var H=0;H<J.length;H++){G[H]=J.charCodeAt(H)}var F=new Blob([I],{type:D});return F};u.snapshot=function(D){var F=0;var E=function(){F++;return F};var G=u.compilePiston(u.piston,D);u.loading=true;v.generateBackupBin(G,D).then(function(H){y.enabled(false);var I=H.data;u.view.exportBin=I;var J=document.getElementById("piston");J.setAttribute("printing","");if(D){J.setAttribute("anonymized","")}A(function(){var L=J.clientWidth+10;var K=J.clientHeight+(D?0:64)+10;html2canvas(J,{width:L,height:K,counter:E}).then(function(N){u.loading=false;var M=new window.FileReader();console.log("Embedding data into PNG: "+G);M.readAsDataURL(new Blob([u.dataURItoBlob(N.toDataURL("image/png")),u.objectToBlob(G,"image/png")],{type:"image/png"}));M.onloadend=function(){u.capturedImage=M.result;u.dialogCapture=m.open({template:"dialog-captured-image",className:"ngdialog-theme-default ngdialog-auto-size",disableAnimation:true,closeByDocument:false,scope:u,showClose:true})}});J.removeAttribute("printing");J.removeAttribute("anonymized");delete (u.view.exportBin);y.enabled(true)},1,false)},function(){piston.removeAttribute("printing");piston.removeAttribute("anonymized");delete (u.view.exportBin)})};u.textSnapshot=function(){copyToClipboard("piston")};u.parseString=function(E,D){return u.parseExpression(E,true,D)};u.parseExpression=function(P,G,Q){P=(P!=null)?P.toString():"";var L=0;var N=!!G?0:1;var K=N;var F=false;var I=false;var E=false;var H=0;var M=/^-?(0(\.\d*)?|([1-9]\d*\.?\d*)|(\.\d+))([Ee][+-]?\d+)?$/;var D=0;function R(U,T){return U==T?U.toString():U.toString()+":"+T.toString()}function J(){var Z=[];var ab=L;var T=(P.substr(ab,6)=="$args.")||(P.substr(ab,6)=="$json.")||(P.substr(ab,10)=="$response.")||(P.substr(ab,9)=="$weather.");function W(){if(L-1>ab){var ad=P.slice(ab,L-1);var ac=parseFloat(ad.trim());if(!isNaN(ac)&&(M.test(ad.trim()))){Z.push({t:(ad.indexOf(".")>=0?"decimal":"integer"),v:ac,l:R(ab,L-2)});return true}if(typeof ad=="string"){if(["true","false"].indexOf(ad)>=0){Z.push({t:"boolean",v:ad,l:R(ab,L-2)})}else{Z.push({t:"variable",x:ad,l:R(ab,L-2)})}return true}Z.push({t:"operand",v:P.slice(ab,L-1),l:R(ab,L-2)});return true}return false}function Y(ae){if(L-(ae?0:1)>ab){var ad=P.slice(ab,L-1).replace(/\\[\[\]\{\}\'\"0-9abcdefghijklmopqsuvwxyz]/gi,function(af){return af[1]});var ac=parseFloat(ad.trim());if((Q!="phone")&&!isNaN(ac)&&(M.test(ad.trim()))){Z.push({t:(ad.indexOf(".")>=0?"decimal":"integer"),v:ac,l:R(ab,L-2)});return true}Z.push({t:(["true","false"].indexOf(ad)>=0?"boolean":"string"),v:(ad=="null"?null:ad),l:R(ab,L-2)})}}function X(){if(L-1>ab){var ah=P.slice(ab,L-1);var ai=ah.lastIndexOf(":");var ae=ah;var ag="";if(ai>0){var ae=ah.substr(0,ai).trim().replace(/\\[\[\]\{\}\'\"0-9abcdefghijklmopqsuvwxyz]/gi,function(aj){return aj[1]});ag=ah.substr(ai+1).trim()}var af=u.getDeviceByName(ae);if(af&&af.id){var ad=ag.toLowerCase();ag="";if(ad==r){ag=r}else{for(attributeIndex in af.a){var ac=af.a[attributeIndex];if(ad==ac.n.toLowerCase()){ag=ac.n}}}if(!!ad&&!ag){ag="?"}Z.push({t:"device",id:af.id,a:ag,l:R(ab-1,L-1)})}else{Z.push({t:"device",x:ae,a:ag,l:R(ab-1,L-1)})}}}function U(){var ae=P.slice(ab,L-1).toLowerCase();if(u.db.functions[ae]){H++;var af=J();var ac=[];var ad=null;for(p in af){if(!ad){ad={t:"expression",i:[]}}if((af[p].t=="operator")&&(af[p].o==",")){ac.push(ad);ad={t:"expression",i:[]}}else{ad.i.push(af[p])}}if(ad){ac.push(ad)}Z.push({t:"function",n:ae,i:ac,l:R(ab,L-1)});H--}else{W();Z.push({t:"expression",i:J(),l:R(ab,L-1)});ab=L}}while(L<P.length){var aa=P[L++];switch(aa){case" ":case"\t":case"\r":case"\n":if(K&&!E&&!I&&!F){W();ab=L}continue;case"+":case"-":case"/":case"*":case"~":case"^":case"\\":case"%":case"&":case"|":case",":case"!":case"=":case"<":case">":case"?":case":":var V=(L<P.length)?P[L]:"";if(K&&!E&&!F&&!I){W();if(["**","&&","||","^^","!&","!|","!^","==","!=","!!",">=","<=","<>","<<",">>"].indexOf(aa+V)>=0){L++;aa+=V}Z.push({t:"operator",o:aa,l:R(L-1,L-1)});ab=L}else{if(aa=="\\"){L++;aa=V}}continue;case'"':if(K&&!E&&!F){I=!I;(I?W():Y(true));ab=L}continue;case"'":if(K&&!I&&!E){F=!F;(F?W():Y(true));ab=L}continue;case"(":if(K&&!E&&!I&&!F){D++;U();ab=L}continue;case")":if(K&&!E&&!I&&!F){D--;W();ab=L;return Z}continue;case"[":if(!T&&K&&!I&&!F&&!E){E=true;W();ab=L}continue;case"]":if(!T&&K&&E&&!I&&!F){X();E=false;ab=L}continue;case"{":if(K==N){K++;Y();ab=L;Z.push({t:"expression",i:J(),l:R(ab-1,L-1)});ab=L}else{K++;ab=L;Z.push({t:"expression",i:J(),l:R(ab-1,L-1)});ab=L}continue;case"}":W();K--;return Z;continue}}L++;K?W():Y();return Z}var O=J();var S={t:"expression",i:O,str:P};if(K!=N){S.err="Invalid expression closure termination"}else{if(F){S.err="Invalid single quote termination"}else{if(I){S.err="Invalid double quote termination"}else{if(D){S.err="Invalid parenthesis closure termination"}}}}S.ok=!S.err;if(S.ok){S.ok=u.validateExpression(S)}return S};u.validateExpression=function(I){var F="";var D="";var H="";function E(K,N,M){if(!K){return""}K=K.toString().split(":");var O=parseInt(K[0]);var J=(K.length==2)?parseInt(K[1]):O;var L=I.str.substr(O,J-O+1);if((L.substr(0,1)=="[")&&(L.substr(-1,1)=="]")){L=L.substr(1,L.length-2)}if(N){L=L.split(N);if(M>=L.length){return""}return L[M].trim()}return L.trim()}function G(L){var J=true;var K="";var M="";if(L.i){for(subitem in L.i){J=J&&G(L.i[subitem])}}else{switch(L.t){case"device":if(!L.x&&!L.id){J=false;K="Invalid device "+E(L.l,":",0);M=L.l;break}if(!L.id&&L.x&&!((u.systemVars&&scope.systemVars[L.x])||(u.globalVars&&u.systemVars[L.x])||u.getVariableByName(L.x))){J=false;K="Invalid device variable "+E(L.l,":",0);M=L.l;break}if(L.a=="?"){J=false;K="Invalid attribute "+E(L.l,":",1);M=L.l;break}break;case"variable":if(L.x.startsWith("$args.")&&(L.x.length>6)){break}if(L.x.startsWith("$json.")&&(L.x.length>6)){break}if(L.x.startsWith("$response.")&&(L.x.length>10)){break}if(L.x.startsWith("$weather.")&&(L.x.length>9)){break}if(u.systemVars&&u.systemVars[L.x]){break}if(u.globalVars&&u.globalVars[L.x]){break}if(!u.getVariableByName(L.x)){J=false;D=E(L.l);K="Variable "+D+" not found";M=L.l;break}break}}L.ok=J;if(K){L.err=K;if(!F){F=K;H=M}}return J}G(I);if(F){I.err=F;I.errVar=D;I.loc=H}return I.ok};u.hexToHsl=function(E){var K=/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(E);if(!K){return{h:0,s:0,l:0}}var D=0+parseInt(K[1],16)/255;var I=0+parseInt(K[2],16)/255;var L=0+parseInt(K[3],16)/255;var M=Math.max(D,I,L),G=Math.min(D,I,L);var H,N,F=(M+G)/2;if(M==G){H=N=0}else{var J=M-G;N=(F>0.5)?J/(2-M-G):J/(M+G);switch(M){case D:H=(I-L)/J+(I<L?6:0);break;case I:H=(L-D)/J+2;break;case L:H=(D-I)/J+4;break}H=H/6}return{h:Math.round(360*H),s:Math.round(100*N),l:Math.round(100*F)}};u.evaluateExpression=function(E,D){v.evaluateExpression(u.pistonId,E,D).then(function(F){console.log(F)})};var B=navigator.userAgent||navigator.vendor||window.opera;if(B.match(/Android/i)){u.android=true}u.url=window.location.href;u.mobile=window.mobileCheck();u.tablet=(!u.mobile)&&(window.mobileOrTabletCheck());u.formatTime=window.formatTime;u.utcToString=utcToString;u.utcToTimeString=utcToTimeString;u.utcToDateString=utcToDateString;u.formatLogTime=function(D,E){return utcToString(D)+"+"+E};u.md5=window.md5;var b=setInterval(function(){if(v.ready()){clearInterval(b);u.init()}},1)}]);function test(g,b,f){scope.evaluateExpression(scope.parseExpression(g,b,f))}var MAX_STACK_SIZE=10;config.controller("fuel",["$scope","$rootScope","dataService","$timeout","$interval","$location","$sce","$routeParams","ngDialog","$window",function(p,l,n,c,f,e,k,o,m,b){var a=null;var d=null;var g=null;p.initialized=false;p.loading=true;p.canisters=[];p.fuelStreams=[];p.selectedCanister="";p.error="";p.designer={};p.locations=null;p.instances=null;p.requestId=0;p.activePistons=0;p.pausedPistons=0;p.dropDownMenu=false;p.view="piston";p.init=function(r,t,s){if(p.$$destroyed){return}n.setStatusCallback(p.setStatus);n.listFuelStreams().then(function(w){if(p.$$destroyed){return}p.loading=false;p.initialized=true;if(!w||!w.fuelStreams||!(w.fuelStreams instanceof Array)){return}p.fuelStreams=w.fuelStreams;var u=[];for(i in p.fuelStreams){var v=p.fuelStreams[i];u.push(v.c)}p.canisters=u.unique().sort()})};p.selectCanister=function(r){p.selectedCanister=r};p.selectFuelStream=function(r){for(i in p.fuelStreams){p.fuelStreams[i].selected=(p.fuelStreams[i]==r)}p.prepareFuelStream(r);return;p.selectedFuelStream=r;var s=(p.selectedCanister?p.selectedCanister+" \\ ":"")+p.selectedFuelStream.n;n.listFuelStreamData(p.selectedFuelStream.i).then(function(t){if(t&&t.points&&(t.points instanceof Array)){for(i in t.points){p.chart.labels.push(new Date(t.points[i].t));p.chart.data[0].push(t.points[i].d)}}})};p.prepareFuelStream=function(r){if(r.selected&&!r.data){n.listFuelStreamData(r.i).then(function(s){if(s&&s.points&&(s.points instanceof Array)){r.data=s.points;p.populateChart()}})}else{p.populateChart()}};p.populateChart=function(){var v=0;var w=[];var t=[];for(i in p.fuelStreams){if(!!p.fuelStreams[i].selected&&!!p.fuelStreams[i].data){var r=p.fuelStreams[i];w.push((r.c?r.c+" \\ ":"")+r.n);var u=[];for(j in r.data){u.push({x:new Date(r.data[j].t),y:r.data[j].d})}t.push(u);v++}}p.initChart(w,t)};p.toggleFuelStream=function(r){r.selected=!r.selected;p.prepareFuelStream(r)};p.setStatus=function(r){if(a){c.cancel(a)}a=null;p.status=r;if(p.status){a=c(function(){p.setStatus()},10000)}};p.sortByDisplay=function(s,r){return(s.d>r.d)?1:((r.d>s.d)?-1:0)};p.sortByName=function(s,r){return(s.n>r.n)?1:((r.n>s.n)?-1:0)};p.home=function(){p.initialized=false;e.path("/")};p.initChart=function(s,r){p.chart={series:s,type:"line",data:r,options:{elements:{line:{fill:true,tension:0}},legend:{display:true},showLines:true,responsive:true,maintainAspectRatio:false,scales:{xAxes:[{type:"time"}],yAxes:[{id:"y-axis-1",type:"linear",display:true,position:"left",ticks:{steps:10,stepValue:5}}]},pan:{enabled:true,mode:"x"},zoom:{enabled:true,mode:"x"}}}};var q=navigator.userAgent||navigator.vendor||window.opera;if(q.match(/Android/i)){p.android=true}p.url=window.location.href;p.mobile=window.mobileCheck();p.tablet=(!p.mobile)&&(window.mobileOrTabletCheck());p.formatTime=formatTime;p.utcToString=utcToString;p.$$postDigest(function(){b.FB.XFBML.parse()});var h=setInterval(function(){if(n.ready()){clearInterval(h);p.init()}},1)}]);