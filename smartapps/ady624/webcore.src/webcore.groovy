...
private static Map virtualCommands() {
	...
	return [
		...
		httpRequest					: [ n: "Make a web request",		a: true, 	i: "anchor",				d: "Make a {1} request to {0} with type {2}{3}",				        p: [[n:"URL", t:"uri"],[n:"Method", t:"enum", o:["GET","POST","PUT","DELETE","PATCH","HEAD","TRACE"]],[n:"Request body type", t:"enum", o:["JSON","FORM","CUSTOM"]],[n:"Send variables", t:"variables", d:" and data {v}"],[n:"Request body", t:"string", d:" and data {v}"],[n:"Content type", t:"contenttype"],[n:"Authorization header", t:"string", d:"{v}"]],	],
