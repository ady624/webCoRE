...
private static Map comparisons() {
	return [
    	conditions: [
        	changed							: [ d: "changed",																	g:"bdims",						t: 1,	],
        	did_not_change					: [ d: "did not change",															g:"bdims",						t: 1,	],
    		is 								: [ d: "is",								dd: "are",								g:"bdims",	p: 1						],
    		is_not	 						: [ d: "is not",							dd: "are not",							g:"bdims",	p: 1						],
        ...
        triggers: [
    		changes 						: [ d: "changes",							dd: "change",							g:"bdims",								],
