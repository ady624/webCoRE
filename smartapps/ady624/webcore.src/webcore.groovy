...
private static Map virtualCommands() {
	...
	return [
		...
		httpRequest					: [ n: "Make a web request",		a: true, 	i: "anchor",				d: "Make a {1} request to {0}",				        p: [[n:"URL", t:"uri"],[n:"Method", t:"enum", o:["GET","POST","PUT","DELETE","HEAD"]],[n:"Request body type", t:"enum", o:["JSON","FORM","CUSTOM"], d: "{v} encoded"],[n:"Send variables", t:"variables", d:"data {v}"],[n:"Request body", t:"string", d:"data {v}"],[n:"Content type", t:"contenttype", d: "of type {v}"],[n:"Authorization header", t:"string", d:"{v}"]],	],
