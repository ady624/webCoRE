...
private static Map virtualCommands() {
	...
	return [
        ...
        setState					: [ n: "Set piston state...",		a: true,	i: "superscript", is:"r",			d: "Set piston state to \"{0}\"",										p: [[n:"State",t:"string"]],	],
        setTileColor				: [ n: "Set piston tile colors...",	a: true,	i: "superscript", is:"r",			d: "Set piston tile #{0} colors to {1} over {2}{3}",					p: [[n:"Tile Index",t:"enum",o:tileIndexes],[n:"Text Color",t:"color"],[n:"Background Color",t:"color"],[n:"Flash mode",t:"boolean",d:" (flashing)"]],	],
        setTileTitle				: [ n: "Set piston tile title...",	a: true,	i: "superscript", is:"r",			d: "Set piston tile #{0} title to \"{1}\"",								p: [[n:"Tile Index",t:"enum",o:tileIndexes],[n:"Title",t:"string"]],	],
        setTileText					: [ n: "Set piston tile text...",	a: true,	i: "superscript", is:"r",			d: "Set piston tile #{0} text to \"{1}\"",								p: [[n:"Tile Index",t:"enum",o:tileIndexes],[n:"Text",t:"string"]],	],
        setTileFooter				: [ n: "Set piston tile footer...",	a: true,	i: "superscript", is:"r",			d: "Set piston tile #{0} footer to \"{1}\"",							p: [[n:"Tile Index",t:"enum",o:tileIndexes],[n:"Footer",t:"string"]],	],
        setTile						: [ n: "Set piston tile...",		a: true,	i: "superscript", is:"r",			d: "Set piston tile #{0} title  to \"{1}\", text to \"{2}\", footer to \"{3}\", and colors to {4} over {5}{6}",		p: [[n:"Tile Index",t:"enum",o:tileIndexes],[n:"Title",t:"string"],[n:"Text",t:"string"],[n:"Footer",t:"string"],[n:"Text Color",t:"color"],[n:"Background Color",t:"color"],[n:"Flash mode",t:"boolean",d:" (flashing)"]],	],
        clearTile					: [ n: "Clear piston tile...",		a: true,	i: "superscript", is:"r",			d: "Clear piston tile #{0}",											p: [[n:"Tile Index",t:"enum",o:tileIndexes]],	],
