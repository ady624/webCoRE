 ...
 *  Version history
*/
public static String version() { return "v0.3.10b.20190514" }
/*
 *	02/23/2019 >>> v0.3.10b.20190514 - BETA M3 - Changed the device selection page to fix timeout issues in Asia-Pacific
